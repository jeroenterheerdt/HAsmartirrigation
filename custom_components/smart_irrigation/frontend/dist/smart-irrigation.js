...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class en extends Qi{constructor(e){if(super(e),this.et=V,e.type!==Ji)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===F)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}en.directiveName="unsafeHTML",en.resultType=1;const tn=(e=>(...t)=>({_$litDirective$:e,values:t}))(en);function an(e){return"on"===(e=null==e?void 0:e.toString().toLowerCase())||"true"===e||"1"===e}function nn(e,t){return(e=e.toString()).split(",")[t]}function sn(e,t){switch(t){case dt:return e.units==Me?Y`${tn(Ke)}`:Y`${tn(Xe)}`;case nt:return e.units==Me?Y`${tn("mm")}`:Y`${tn("in")}`;case Qe:return e.units==Me?Y`${tn("m<sup>2</sup>")}`:Y`${tn("sq ft")}`;case et:return e.units==Me?Y`${tn("l/minute")}`:Y`${tn("gal/minute")}`;default:return Y``}}function rn(e,t){!function(e,t){be(e,"show-dialog",{dialogTag:"error-dialog",dialogImport:()=>Promise.resolve().then((function(){return xn})),dialogParams:{error:t}})}(t,Y`
...
`;var ln="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",un="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";let dn=class extends(ft(ue)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(t),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ke+"_config_updated"})]}async _fetchData(){if(this.hass){this.isLoading=!0,this._scheduleUpdate();try{this.config=await ct(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}var e,t}}firstUpdated(){we().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,t;if(!this.hass||!this.config||!this.data)return Y`<div class="loading-indicator">
        ...
        <div class="card-content">
          ...
          <div class="card-content">
            <div class="zoneline">
              <label for="calctime"
                >${Xi("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language)}:</label
              >
              <input
                id="calctime"
                type="text"
      ...
      this.hass.language)}">${t}</ha-card>`;let a=Y` <div class="card-content">
          ...
          <div class="zoneline">
            ...
            <div>
              <input
                ...
                @change="${e=>{this.handleConfigChange({autoclearenabled:an(e.target.value)})}}"
        ...
        header="${Xi("panels.general.cards.automatic-clear.header",this.hass.language)}"
        >${a}</ha-card
          ...
          <div class="zoneline">
            ...
            <div>
              <input
                ...
                @change="${e=>{this.handleConfigChange({continuousupdates:an(e.target.value)})}}"
...
i.version="2.30.1",n(Za),i.fn=us,i.min=Ja,i.max=Qa,i.now=ei,i.utc=m,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ma,i.invalid=b,i.duration=Mi,i.isMoment=$,i.weekdays=ys,i.parseZone=cs,i.localeData=va,i.isDuration=ri,i.monthsShort=bs,i.weekdaysMin=ws,i.defineLocale=ga,i.updateLocale=fa,i.locales=ba,i.weekdaysShort=_s,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Bi,i.prototype=us,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i}()}(gn)),gn.exports),vn=hn(fn);let bn=class extends(ft(ue)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){we().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ke+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.isLoading=!0;const[e,t,a,i]=await Promise.all([ct(this.hass),ht(this.hass),pt(this.hass),mt(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:cn.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,t){this.hass&&(this.zones[e]=t,t.id&&this.zoneCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this.saveToHA(t).catch((e=>{console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;if(!this.zones[t]||null==a)return;const i=[...this.zones];var n,s;this.zones=this.zones.filter(((e,a)=>a!==t)),this.zoneCache.delete(a.toString()),this.isSaving=!0,(n=this.hass,s=a.toString(),n.callApi("POST",ke+"/zones",{id:s,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",ke+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",ke+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var t;const a=this.zones[e];if(!a||null==a.mapping)return;const i=`#weather-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var t;const a=this.zones[e];if(!a||null==a.id)return;const i=`#calendar-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const t=await gt(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,t)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const a of this.zones)if(void 0!==a.id)try{const i=await(e=this.hass,t=a.id.toString(),e.callWS({type:ke+"/watering_calendar",zone_id:t}));this.wateringCalendars.set(a.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${a.id}:`,e)}var e,t;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return Y``;const t=this.weatherRecords.get(e.id)||[];return Y`
            ...
            `:Y`
              <div class="weather-table">
                <div class="weather-header">
                  <span
                    >${Xi("panels.mappings.weather-records.timestamp",this.hass.language)}</span
                  >
                  <span
                    >${Xi("panels.mappings.weather-records.temperature",this.hass.language)}</span
                  >
                  <span
                    >${Xi("panels.mappings.weather-records.humidity",this.hass.language)}</span
                  >
                  <span
                    >${Xi("panels.mappings.weather-records.precipitation",this.hass.language)}</span
                  >
                  <span
                    >${Xi("panels.mappings.weather-records.retrieval-time",this.hass.language)}</span
                  >
                </div>
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return Y``;const t=this.wateringCalendars.get(e.id),a=t&&e.id in t?t[e.id]:null,i=(null==a?void 0:a.monthly_estimates)||[];return Y` <div class="watering-calendar">
      ...
      </div>`;let u;return null!=e.mapping&&(u=this.mappings.filter((t=>t.id===e.mapping))[0],null!=u&&null!=u.data_last_updated&&(e.last_updated=u.data_last_updated,null!=u.data&&(e.number_of_data_points=u.data.length))),Y`
      ...
      >
        <div class="card-content">
          ...
          <div class="zoneline">
            <label for="sizeInput"
              >${Xi("panels.zones.labels.size",this.hass.language)}:</label
            >
            <input id="sizeInput" type="number" />
          </div>
          <div class="zoneline">
            <label for="throughputInput"
              >${Xi("panels.zones.labels.throughput",this.hass.language)}:</label
            >
          ...
          <div class="zoneline">
            ...
            <button @click="${this.handleAddZone}" ?disabled="${this.isSaving}">
              ${this.isSaving?Xi("common.saving-messages.adding",this.hass.language):Xi("panels.zones.cards.add-zone.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `;if("boolean"==i.type)o=Y`${o}<input
      ...
      >
        <div class="card-content">
          ${this.isLoading?Y`<div class="loading-indicator">${Xi("common.loading-messages.general",this.hass.language)}</div>`:Y`
                <div class="zoneline">
                ...
                <div class="zoneline">
                  ...
                  >
                    ${this.isSaving?Xi("common.saving-messages.adding",this.hass.language):Xi("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
      ...
      ${this.isLoading?Y`<div class="loading-indicator">${Xi("common.loading-messages.modules",this.hass.language)}</div>`:Object.entries(this.modules).map((([e,t])=>this.renderModule(t,parseInt(e))))}
    ...
    `}renderSimpleRadioOptions(e,t,a){if(!this.hass||!this.config)return Y``;const i=t===ze||t===Ce,n=a[Fe];return Y`
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return Y`<option value="${e}" ?selected="${e===t}">
        ...
        </option>`,e}return Y``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return Y``;const a=function(e){switch(e){case Ae:case Pe:return[{unit:"°C",system:Me},{unit:"°F",system:Ee}];case De:case ze:return[{unit:"mm",system:Me},{unit:"in",system:Ee}];case Oe:return[{unit:Ke,system:Me},{unit:Xe,system:Ee}];case Te:return[{unit:"%",system:[Me,Ee]}];case He:return[{unit:"millibar",system:Me},{unit:"hPa",system:Me},{unit:"psi",system:Ee},{unit:"inch Hg",system:Ee}];case Ne:return[{unit:"km/h",system:Me},{unit:"meter/s",system:Me},{unit:"mile/h",system:Ee}];case Ce:return[{unit:"W/m2",system:Me},{unit:"MJ/day/m2",system:Me},{unit:"W/sq ft",system:Ee},{unit:"MJ/day/sq ft",system:Ee}];default:return[]}}(e);let i=t[We];const n=this.config.units;if(!t[We])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const t of e.system)if(n===t.system){i=e.unit;break}if(i===e.unit)break}return Y`
      ${a.map((e=>Y`
    ...
    `}render(){return this.hass?this.isLoading?Y`
        <ha-card header="${Xi("panels.mappings.title",this.hass.language)}">
          <div class="card-content">
            ${Xi("common.loading-messages.general",this.hass.language)}
          </div>
        </ha-card>
    ...
    `:Y`
        <ha-card header="${Xi("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${Xi("panels.info.configuration-not-available",this.hass.language)}
          </div>
        </ha-card>
      `:Y``}renderZoneBucketsCard(){if(!this.hass)return Y``;if(!this.zones||0===this.zones.length)return Y`
        <ha-card
          header="${Xi("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="info-item">
              <span class="value"
                >${Xi("panels.info.cards.zone-bucket-values.no-zones",this.hass.language)}</span
              >
            </div>
          </div>
        </ha-card>
      `;const e=this.config?sn(this.config,nt):"mm";return Y`
      <ha-card
        header="${Xi("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
      >
        <div class="card-content">
          ${this.zones.map((t=>{var a,i,n,s,r,o,l,u;return Y`
              <div class="info-item zone-info">
                ...
                <div class="zone-details">
                  <div class="zone-bucket">
                    <span class="label"
                      >${Xi("panels.info.cards.zone-bucket-values.labels.bucket",null!==(i=null===(a=this.hass)||void 0===a?void 0:a.language)&&void 0!==i?i:"en")}:</span
                    >
                    <span class="value">
                  ...
                  <div class="zone-duration">
                    <span class="label"
                      >${Xi("panels.info.cards.zone-bucket-values.labels.duration",null!==(s=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==s?s:"en")}:</span
                    >
                    <span class="value">
                      ${t.duration?`${Math.round(t.duration)} ${Xi("common.units.seconds",null!==(o=null===(r=this.hass)||void 0===r?void 0:r.language)&&void 0!==o?o:"en")}`:`0 ${Xi("common.units.seconds",null!==(u=null===(l=this.hass)||void 0===l?void 0:l.language)&&void 0!==u?u:"en")}`}
                    </span>
                  </div>
                </div>
              </div>
    ...
    `}renderNextIrrigationCard(){var e,t,a,i,n,s,r,o;return this.hass&&this.info?Y`
      <ha-card
        header="${Xi("panels.info.cards.next-irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${Xi("panels.info.cards.next-irrigation.labels.next-start",this.hass.language)}:</label
            >
            <span class="value">
          ...
          ${this.info.next_irrigation_duration?Y`
                <div class="info-item">
                  <label
                    >${Xi("panels.info.cards.next-irrigation.labels.duration",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${this.info.next_irrigation_duration}
                    ${Xi("common.units.seconds",this.hass.language)}</span
                  >
                </div>
              `:""}
          ${this.info.next_irrigation_zones&&this.info.next_irrigation_zones.length>0?Y`
                <div class="info-item">
                  <label
                    >${Xi("panels.info.cards.next-irrigation.labels.zones",this.hass.language)}:</label
                  >
                  <span class="value"
    ...
    `:Y`
        <ha-card
          header="${Xi("panels.info.cards.next-irrigation.title",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${Xi("panels.info.cards.next-irrigation.labels.next-start",null!==(i=null===(a=this.hass)||void 0===a?void 0:a.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
      ...
      <ha-card
        header="${Xi("panels.info.cards.irrigation-reason.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${Xi("panels.info.cards.irrigation-reason.labels.reason",this.hass.language)}:</label
            >
            <span class="value">
          ...
          ${this.info.sunrise_time?Y`
                <div class="info-item">
                  <label
                    >${Xi("panels.info.cards.irrigation-reason.labels.sunrise",this.hass.language)}:</label
                  >
                  <span class="value"
          ...
          ${void 0!==this.info.total_irrigation_duration?Y`
                <div class="info-item">
                  <label
                    >${Xi("panels.info.cards.irrigation-reason.labels.total-duration",this.hass.language)}:</label
                  >
                  <span class="value"
          ...
          ${this.info.irrigation_explanation?Y`
                <div class="info-item explanation">
                  <label
                    >${Xi("panels.info.cards.irrigation-reason.labels.explanation",this.hass.language)}:</label
                  >
    ...
    `:Y`
        <ha-card
          header="${Xi("panels.info.cards.irrigation-reason.title",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${Xi("panels.info.cards.irrigation-reason.labels.reason",null!==(i=null===(a=this.hass)||void 0===a?void 0:a.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
    ...
    `}getView(e){switch(e.page){case"info":return Y`
        ...
        `}}handlePageSelected(e){var t,a,i,n;const s=e.detail.name||e.detail.panel||(null===(a=null===(t=e.target)||void 0===t?void 0:t.getAttribute)||void 0===a?void 0:a.call(t,"panel"))||(null===(n=null===(i=e.detail.item)||void 0===i?void 0:i.getAttribute)||void 0===n?void 0:n.call(i,"panel"));s&&s!==$n().page?function(e,t,a){void 0===a&&(a=!1),a?history.replaceState(null,"",t):history.pushState(null,"",t),be(window,"location-changed",{replace:a})}(0,((e,...t)=>{let a={page:e,params:{}};t.forEach((e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}))}));const i=e=>{let t=Object.keys(e);t=t.filter((t=>e[t])),t.sort();let a="";return t.forEach((t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`})),a};let n=`/${ke}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n})(s)):scrollTo(0,0)}static get styles(){return c`
      ${kn} :host {
        color: var(--primary-text-color);
...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],Sn.prototype,"_params",void 0),Sn=n([ce("error-dialog")],Sn);var xn=Object.freeze({__proto__:null,get ErrorDialog(){return Sn}});Object.defineProperty(e,"__esModule",{value:!0})}({});
