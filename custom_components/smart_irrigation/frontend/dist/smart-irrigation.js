...
`;var ln="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",un="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";let dn=class extends(ft(ue)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(t),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ke+"_config_updated"})]}async _fetchData(){if(this.hass){this.isLoading=!0,this._scheduleUpdate();try{this.config=await ct(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}var e,t}}firstUpdated(){we().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){if(!this.hass||!this.config||!this.data)return Y`<div class="loading-indicator">
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${e=>{this.handleConfigChange({autocalcenabled:an(e.target.value)})}}"
      ...
      >`;let t=Y` <div class="card-content">
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${e=>{this.saveData({autoupdateenabled:an(e.target.value)})}}"
      ...
      this.hass.language)}">${t}</ha-card>`;let a=Y` <div class="card-content">
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${e=>{this.saveData({autoclearenabled:an(e.target.value)})}}"
          ...
          <div class="card-content">
            ...
            />
          </div>`),a=Y`<ha-card header="${Xi("panels.general.cards.automatic-clear.header",this.hass.language)}" >${a}</div></ha-card>`;let i=Y`<div class="card-content">
          <svg
            style="width:24px;height:24px"
            viewBox="0 0 24 24"
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${e=>{this.saveData({continuousupdates:an(e.target.value)})}}"
...
i.version="2.30.1",n(Za),i.fn=us,i.min=Ja,i.max=Qa,i.now=ei,i.utc=m,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ma,i.invalid=b,i.duration=Ai,i.isMoment=S,i.weekdays=ys,i.parseZone=cs,i.localeData=va,i.isDuration=ri,i.monthsShort=bs,i.weekdaysMin=ws,i.defineLocale=ga,i.updateLocale=fa,i.locales=ba,i.weekdaysShort=_s,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Bi,i.prototype=us,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i}()}(gn)),gn.exports),vn=hn(fn);let bn=class extends(ft(ue)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.isLoading=!0,this.isSaving=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){we().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ke+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.isLoading=!0;const[e,t,a,i]=await Promise.all([ct(this.hass),ht(this.hass),pt(this.hass),mt(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.mappings=i,this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",ke+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:cn.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,t){this.hass&&(this.zones[e]=t,t.id&&this.zoneCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this.saveToHA(t).catch((e=>{console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;if(!Object.values(this.zones).at(t)||null==a)return;const i=[...this.zones];var n,s;this.zones=this.zones.filter(((e,a)=>a!==t)),this.zoneCache.delete(a.toString()),this.isSaving=!0,(n=this.hass,s=a.toString(),n.callApi("POST",ke+"/zones",{id:s,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",ke+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",ke+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){const t=Object.values(this.zones).at(e);t&&null!=t.mapping&&this.hass&&alert(`${Xi("panels.zones.actions.view-weather-info-message",this.hass.language)} mapping ID: ${t.mapping}\n\n${Xi("panels.zones.actions.view-weather-info-todo",this.hass.language)}`)}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");var t,a;await(t=this.hass,a=e,t.callApi("POST",ke+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=Y`<option value="" ?selected=${void 0===t}">---${Xi("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=Y`${a}
        ...
        </svg>`;let r,o;return null!=e.mapping&&(r=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
    ...
    `}};n([pe()],yn.prototype,"config",void 0),n([pe({type:Array})],yn.prototype,"zones",void 0),n([pe({type:Array})],yn.prototype,"modules",void 0),n([pe({type:Array})],yn.prototype,"allmodules",void 0),n([pe({type:Boolean})],yn.prototype,"isLoading",void 0),n([pe({type:Boolean})],yn.prototype,"isSaving",void 0),n([me("#moduleInput")],yn.prototype,"moduleInput",void 0),yn=n([ce("smart-irrigation-view-modules")],yn);let _n=class extends(ft(ue)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}),this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()})))}firstUpdated(){we().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ke+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[e,t,a]=await Promise.all([ct(this.hass),ht(this.hass),mt(this.hass)]);this.config=e,this.zones=t,this.mappings=a,this._fetchWeatherRecords(),this.mappingCache.clear()}catch(t){console.error("Error fetching data:",t),rn({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"))}finally{this.isLoading=!1,this._scheduleUpdate()}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const t=await gt(this.hass,e.id.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for mapping ${e.id}:`,t)}this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||!e.id)return Y``;const t=this.weatherRecords.get(e.id)||[];return Y`
      <div class="weather-records">
        ...
        ${0===t.length?Y`
            <div class="weather-note">
              ...
              <br>
              ${Xi("panels.mappings.weather-records.backend-todo",this.hass.language)}
            </div>
          `:Y`
    ...
    `}renderSimpleRadioOptions(e,t,a){if(!this.hass||!this.config)return Y``;const i=t===Te||t===Ce,n=a[Fe];return Y`
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return Y`<option value="${e}" ?selected="${e===t}">
        ...
        <option
          ...
          ?selected="${a===Re}"
        >
          ${Xi("panels.mappings.cards.mapping.pressure_types."+Re,this.hass.language)}
        </option>`,e}return Y``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return Y``;const a=function(e){switch(e){case xe:case Pe:return[{unit:"°C",system:Ae},{unit:"°F",system:Me}];case Oe:case Te:return[{unit:"mm",system:Ae},{unit:"in",system:Me}];case ze:return[{unit:Ke,system:Ae},{unit:Xe,system:Me}];case De:return[{unit:"%",system:[Ae,Me]}];case He:return[{unit:"millibar",system:Ae},{unit:"hPa",system:Ae},{unit:"psi",system:Me},{unit:"inch Hg",system:Me}];case Ne:return[{unit:"km/h",system:Ae},{unit:"meter/s",system:Ae},{unit:"mile/h",system:Me}];case Ce:return[{unit:"W/m2",system:Ae},{unit:"MJ/day/m2",system:Ae},{unit:"W/sq ft",system:Me},{unit:"MJ/day/sq ft",system:Me}];default:return[]}}(e);let i=t[We];const n=this.config.units;if(!t[We])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const t of e.system)if(n===t.system){i=e.unit;break}if(i===e.unit)break}return Y`
      ${a.map((e=>Y`
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach((e=>{clearTimeout(e)})),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};n([pe()],_n.prototype,"config",void 0),n([pe({type:Array})],_n.prototype,"zones",void 0),n([pe({type:Array})],_n.prototype,"mappings",void 0),n([pe({type:Map})],_n.prototype,"weatherRecords",void 0),n([pe({type:Boolean})],_n.prototype,"isLoading",void 0),n([pe({type:Boolean})],_n.prototype,"isSaving",void 0),n([me("#mappingNameInput")],_n.prototype,"mappingNameInput",void 0),_n=n([ce("smart-irrigation-view-mappings")],_n);let wn=class extends(ft(ue)){constructor(){super(...arguments),this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){we().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:ke+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.isLoading=!0;const[e,t]=await Promise.all([ct(this.hass),(this.hass,Promise.resolve({next_irrigation_start:new Date(Date.now()+864e5),next_irrigation_duration:1800,next_irrigation_zones:["Zone 1","Zone 3"],irrigation_reason:"Soil moisture levels below threshold",sunrise_time:new Date(Date.now()+216e5),total_irrigation_duration:3600,irrigation_explanation:"Based on weather forecast and soil moisture sensors, irrigation is scheduled to maintain optimal growing conditions."}))]);this.config=e,this.info=t}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}render(){return this.hass?this.isLoading?Y`
    ...
    `:Y`
      ...
      `:Y``}renderNextIrrigationCard(){var e,t,a,i,n,s,r,o;return this.hass&&this.info?Y`
    ...
    `}getView(e){switch(e.page){case"general":return Y`
        ...
        `}}handlePageSelected(e){var t,a,i,n;const s=e.detail.name||e.detail.panel||(null===(a=null===(t=e.target)||void 0===t?void 0:t.getAttribute)||void 0===a?void 0:a.call(t,"panel"))||(null===(n=null===(i=e.detail.item)||void 0===i?void 0:i.getAttribute)||void 0===n?void 0:n.call(i,"panel"));s&&s!==kn().page?function(e,t,a){void 0===a&&(a=!1),a?history.replaceState(null,"",t):history.pushState(null,"",t),be(window,"location-changed",{replace:a})}(0,((e,...t)=>{let a={page:e,params:{}};t.forEach((e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}))}));const i=e=>{let t=Object.keys(e);t=t.filter((t=>e[t])),t.sort();let a="";return t.forEach((t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`})),a};let n=`/${ke}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n})(s)):scrollTo(0,0)}static get styles(){return c`
      ${on} :host {
        color: var(--primary-text-color);
    ...
    `}};n([pe({attribute:!1})],Sn.prototype,"hass",void 0),n([function(e){return pe({...e,state:!0})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],Sn.prototype,"_params",void 0),Sn=n([ce("error-dialog")],Sn);var $n=Object.freeze({__proto__:null,get ErrorDialog(){return Sn}});Object.defineProperty(e,"__esModule",{value:!0})}({});
