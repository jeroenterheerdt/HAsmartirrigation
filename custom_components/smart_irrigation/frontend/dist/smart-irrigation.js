!(function (e) {
  ...
  var Ra = new RegExp("^".concat($a.source, "*")),
    Ua = new RegExp("".concat($a.source, "*$"));
  function Ya(e, t) {
        ...
        if (ga(d))
          ...
          if (ya(d)) {
            if (!(b = d.options[h] || d.options.other))
              throw new Ai(d.value, h, Object.keys(d.options), r);
            ...
            if (!b) throw new Ai(d.value, h, Object.keys(d.options), r);
  ...
  function Yi(e, t) {
    switch (t) {
      case Ke:
        return e.units == $e ? Y`${Ii("mm")}` : Y`${Ii("in")}`;
      case We:
        return e.units == $e ? Y`${Ii("m<sup>2</sup>")}` : Y`${Ii("sq ft")}`;
      case Ze:
        return e.units == $e ? Y`${Ii("l/minute")}` : Y`${Ii("gal/minute")}`;
      default:
        return Y``;
    }
  }
    ...
    render() {
      ...
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2024.8.1-beta-1"}</div>
        </div>
