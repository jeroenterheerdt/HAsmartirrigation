...
`;let il=class extends ce{async showDialog(e){var a,t,i,n,r,s,o,l,d;if(this.params=e,e.createTrigger)this._trigger={type:$e,name:"",enabled:!0,offset_minutes:0,azimuth_angle:90,account_for_duration:!0};else if(e.trigger){const u=e.trigger;this._trigger=u.type===Ee?{type:u.type,name:null!==(a=u.name)&&void 0!==a?a:"",enabled:null===(t=u.enabled)||void 0===t||t,offset_minutes:null!==(i=u.offset_minutes)&&void 0!==i?i:0,azimuth_angle:null!==(n=u.azimuth_angle)&&void 0!==n?n:90,account_for_duration:null===(r=u.account_for_duration)||void 0===r||r}:{type:u.type,name:null!==(s=u.name)&&void 0!==s?s:"",enabled:null===(o=u.enabled)||void 0===o||o,offset_minutes:null!==(l=u.offset_minutes)&&void 0!==l?l:0,account_for_duration:null===(d=u.account_for_duration)||void 0===d||d}}else this._trigger=void 0;await this.updateComplete}_closeDialog(){this.params=void 0,this._trigger=void 0}_saveTrigger(){var e,a,t,i,r;if(!this._trigger||!this.params)return;const s=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-select");if(s){const e=null!==(t=null!==(a=s.value)&&void 0!==a?a:s.selected)&&void 0!==t?t:void 0;if(e&&e!==this._trigger.type){if(e===Ee)this._trigger=Object.assign(Object.assign({},this._trigger),{type:e,azimuth_angle:null!==(i=this._trigger.azimuth_angle)&&void 0!==i?i:90});else{const a=this._trigger,{azimuth_angle:t}=a,i=n(a,["azimuth_angle"]);this._trigger=Object.assign(Object.assign({},i),{type:e})}this.requestUpdate()}}if(null===(r=this._trigger.name)||void 0===r?void 0:r.trim()){if(this._trigger.type===Ee){if(void 0===this._trigger.azimuth_angle||isNaN(this._trigger.azimuth_angle))return void alert(Ro("irrigation_start_triggers.validation.azimuth_invalid",this.hass.language));this._trigger.azimuth_angle=this._trigger.azimuth_angle%360,this._trigger.azimuth_angle<0&&(this._trigger.azimuth_angle+=360)}this.dispatchEvent(new CustomEvent("trigger-save",{detail:{trigger:this._trigger,isNew:this.params.createTrigger,index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog()}else alert(Ro("irrigation_start_triggers.validation.name_required",this.hass.language))}_deleteTrigger(){this.params&&!this.params.createTrigger&&(this.dispatchEvent(new CustomEvent("trigger-delete",{detail:{index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog())}_updateTrigger(e){this._trigger?(this._trigger=Object.assign(Object.assign({},this._trigger),e),this.requestUpdate()):console.warn("_updateTrigger called with undefined _trigger",e)}render(){var e,a;if(!this.params||!this._trigger)return q``;const t=this.params.createTrigger,i=Ro(t?"irrigation_start_triggers.dialog.add_title":"irrigation_start_triggers.dialog.edit_title",this.hass.language);return q`
      <ha-dialog open .heading=${!0}>
        ...
        <div class="wrapper">
          <div class="dialog-help">
            ${Ro("irrigation_start_triggers.dialog.help",this.hass.language)}
            <code>smart_irrigation_start_irrigation_all_zones</code>
          </div>
          <div class="form-group">
            <label class="form-label"
              >${Ro("irrigation_start_triggers.fields.name.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="text"
          ...
          <div class="form-group">
            <ha-select
              .label=${Ro("irrigation_start_triggers.fields.type.name",this.hass.language)}
              .value=${this._trigger.type}
              @selected=${this._typeChanged}
            >
              <ha-dropdown-item value=${$e}>
                ${Ro("irrigation_start_triggers.trigger_types.sunrise",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${"sunset"}>
                ${Ro("irrigation_start_triggers.trigger_types.sunset",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${Ee}>
                ${Ro("irrigation_start_triggers.trigger_types.solar_azimuth",this.hass.language)}
              </ha-dropdown-item>
            </ha-select>
          </div>
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Ro("irrigation_start_triggers.fields.enabled.name",this.hass.language)}
            >
              <ha-switch
          ...
          <div class="form-group">
            <label class="form-label"
              >${Ro("irrigation_start_triggers.fields.offset_minutes.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="number"
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Ro("irrigation_start_triggers.fields.account_for_duration.name",this.hass.language)}
            >
              <ha-switch
          ...
          ${this._trigger.type===Ee?q`
                <div class="form-group">
                  <label class="form-label"
                    >${Ro("irrigation_start_triggers.fields.azimuth_angle.name",this.hass.language)}</label
                  >
                  <input
                    class="form-input"
                    type="number"
        ...
        <ha-dialog-footer slot="footer">
          ...
          >
            ${Ro("irrigation_start_triggers.dialog.cancel",this.hass.language)}
          </ha-button>
          ${t?"":q`
                <ha-button
                  slot="secondaryAction"
                ...
                >
                  ${Ro("irrigation_start_triggers.dialog.delete",this.hass.language)}
                </ha-button>
              `}
          <ha-button
            slot="primaryAction"
    ...
    `}_nameChanged(e){const a=e.target;this._updateTrigger({name:a.value})}_typeChanged(e){var a,t,i,n,r,s,o,l,d,u,c,p,m,g,h,v,f,b,k,y,_,z,w,x;const j=null!==(n=null!==(t=null===(a=null==e?void 0:e.detail)||void 0===a?void 0:a.value)&&void 0!==t?t:null===(i=e.target)||void 0===i?void 0:i.value)&&void 0!==n?n:null===(s=null===(r=this.shadowRoot)||void 0===r?void 0:r.querySelector("ha-select"))||void 0===s?void 0:s.value,S=String(j);let A;A=S===Ee?{type:Ee,name:null!==(l=null===(o=this._trigger)||void 0===o?void 0:o.name)&&void 0!==l?l:"",enabled:null===(u=null===(d=this._trigger)||void 0===d?void 0:d.enabled)||void 0===u||u,offset_minutes:null!==(p=null===(c=this._trigger)||void 0===c?void 0:c.offset_minutes)&&void 0!==p?p:0,azimuth_angle:null!==(g=null===(m=this._trigger)||void 0===m?void 0:m.azimuth_angle)&&void 0!==g?g:90,account_for_duration:null===(v=null===(h=this._trigger)||void 0===h?void 0:h.account_for_duration)||void 0===v||v}:{type:S,name:null!==(b=null===(f=this._trigger)||void 0===f?void 0:f.name)&&void 0!==b?b:"",enabled:null===(y=null===(k=this._trigger)||void 0===k?void 0:k.enabled)||void 0===y||y,offset_minutes:null!==(z=null===(_=this._trigger)||void 0===_?void 0:_.offset_minutes)&&void 0!==z?z:0,account_for_duration:null===(x=null===(w=this._trigger)||void 0===w?void 0:w.account_for_duration)||void 0===x||x},this._trigger=A,this.requestUpdate()}_enabledChanged(e){const a=e.target;this._updateTrigger({enabled:a.checked})}_offsetChanged(e){const a=e.target;this._updateTrigger({offset_minutes:parseInt(a.value)||0})}_accountForDurationChanged(e){const a=e.target;this._updateTrigger({account_for_duration:a.checked})}_azimuthChanged(e){var a;if((null===(a=this._trigger)||void 0===a?void 0:a.type)!==Ee)return;const t=e.target;let i=parseInt(t.value,10);isNaN(i)&&(i=90),this._updateTrigger({azimuth_angle:i})}static get styles(){return[tl,p`
      ...
      `]}};r([he({attribute:!1})],il.prototype,"hass",void 0),r([he({attribute:!1})],il.prototype,"params",void 0),r([ve()],il.prototype,"_trigger",void 0),il=r([me("smart-irrigation-trigger-dialog")],il);const nl=p`
...
`;let rl=class extends(La(ce)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return a=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(a),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{this.config=await Na(this.hass),this.data=(e=this.config,a=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],e?Object.entries(e).filter((([e])=>a.includes(e))).reduce(((e,[a,t])=>Object.assign(e,{[a]:t})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e,a}}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,a,t;if(!this.hass||!this.config||!this.data)return q`<div class="loading-indicator">
        ...
        <div class="card-content">
          ...
          <div class="card-content">
            ${this._timeRow(Ro("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language),this.config.calctime,(e=>this.handleConfigChange({calctime:e})))}
          </div>`),e=q`<ha-card
        header="${Ro("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let a=q` <div class="card-content">
          ${Ro("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            <div class="setting-row">
              <div class="setting-label">
                ${Ro("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
              </div>
              <div class="combo-field">
                ...
                <div class="select-wrap">
                  ...
                  >
                    ...
                    >
                      ${Ro("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                    </option>
                    <option
                      value="${Me}"
                      ?selected=${this.data.autoupdateschedule===Me}
                    >
                      ${Ro("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                    </option>
                    <option
                      value="${De}"
                      ?selected=${this.data.autoupdateschedule===De}
                    >
                      ${Ro("panels.general.cards.automatic-update.options.days",this.hass.language)}
                    </option>
                  </select>
          ...
          <div class="card-content">
            ${this._numRow(Ro("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language),"s",this.config.autoupdatedelay,(e=>this.saveData({autoupdatedelay:parseInt(e)})),1)}
          </div>`),a=q`<ha-card header="${Ro("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${a}</ha-card>`;let i=q` <div class="card-content">
          ${Ro("panels.general.cards.automatic-clear.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._timeRow(Ro("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language),this.config.cleardatatime,(e=>this.handleConfigChange({cleardatatime:e})))}
          </div>`),i=q`<ha-card
        header="${Ro("panels.general.cards.automatic-clear.header",this.hass.language)}"
        >${i}</ha-card
      >`;let n=q`<div class="card-content">
          ${Ro("panels.general.cards.continuousupdates.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._numRow(Ro("panels.general.cards.continuousupdates.labels.sensor_debounce",this.hass.language),"ms",this.config.sensor_debounce,(e=>this.handleConfigChange({sensor_debounce:parseInt(e)})),1)}
          </div>`),n=q`<ha-card
        header="${Ro("panels.general.cards.continuousupdates.header",this.hass.language)}"
        >${n}</ha-card
      > `;const r=this.renderTriggersCard(),s=this.renderWeatherSkipCard(),o=this.renderCoordinateCard(),l=this.renderDaysBetweenIrrigationCard(),d=this.renderObservedWateringCard();return q`<ha-card
          header="${Ro("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ro("panels.general.description",this.hass.language)}
          </div> </ha-card
      ...
      <ha-card
        header="${Ro("irrigation_start_triggers.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Ro("irrigation_start_triggers.description",this.hass.language)}
        </div>

        <div class="card-content trigger-usage">
          ${Ro("irrigation_start_triggers.usage_before",this.hass.language)}
          <code>smart_irrigation_start_irrigation_all_zones</code>${Ro("irrigation_start_triggers.usage_after",this.hass.language)}
        </div>

        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("irrigation_start_triggers.active_label",this.hass.language)}
            </div>
            <select
              class="field"
            ...
            >
              ...
              >
                ${Ro("irrigation_start_triggers.active_default",this.hass.language)}
              </option>
              ${e.map((e=>q`
                  <option
                    value="${e.name}"
          ...
          <div class="trigger-active-hint">
            ${Ro("irrigation_start_triggers.active_hint",this.hass.language)}
          </div>
        </div>
          ...
          <div class="triggers-list">
            ${0===e.length?q`
                  <div class="no-triggers">
                    ${Ro("irrigation_start_triggers.no_triggers",this.hass.language)}
                  </div>
                `:e.map(((e,a)=>this.renderTriggerItem(e,a)))}
          </div>

          <div class="add-trigger-section">
            ${this._actionBtn(Qo,Ro("irrigation_start_triggers.add_trigger",this.hass.language),(()=>this._addTrigger()))}
          </div>
        </div>
      </ha-card>
    `}renderTriggerItem(e,a){if(!this.hass)return q``;const t=Ro(`irrigation_start_triggers.trigger_types.${e.type}`,this.hass.language);let i="";if(e.type===$e&&0===e.offset_minutes)i=Ro("irrigation_start_triggers.offset_auto",this.hass.language);else{const a=Math.abs(e.offset_minutes),t=Math.floor(a/60),n=a%60,r=e.offset_minutes<0?Ro("common.labels.before",this.hass.language):Ro("common.labels.after",this.hass.language);i=t>0?`${t}h ${n}m ${r}`:`${n}m ${r}`}let n="";return e.type===Ee&&void 0!==e.azimuth_angle&&(n=` (${e.azimuth_angle}°)`),q`
      <div class="trigger-item ${e.enabled?"enabled":"disabled"}">
        <div class="trigger-main">
          ...
          <div class="trigger-status">
            ${e.enabled?Ro("common.labels.enabled",this.hass.language):Ro("common.labels.disabled",this.hass.language)}
          </div>
        </div>
    ...
    `}_addTrigger(){this._showTriggerDialog({createTrigger:!0})}_editTrigger(e){var a,t;const i=null===(t=null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||void 0===t?void 0:t[e];i&&this._showTriggerDialog({trigger:i,triggerIndex:e})}_deleteTrigger(e){var a,t;if(!(null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||!this.hass)return;const i=(null===(t=this.config.irrigation_start_triggers[e])||void 0===t?void 0:t.name)||"Unknown";if(confirm(Ro("irrigation_start_triggers.confirm_delete",this.hass.language).replace("{name}",i))){const a=[...this.config.irrigation_start_triggers];a.splice(e,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[Ae]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}}async _showTriggerDialog(e){if(!this.hass)return;const a=document.createElement("smart-irrigation-trigger-dialog");a.hass=this.hass,a.addEventListener("trigger-save",(e=>{this._handleTriggerSave(e.detail)})),a.addEventListener("trigger-delete",(e=>{this._handleTriggerDelete(e.detail)})),document.body.appendChild(a),await a.showDialog(e),a.addEventListener("closed",(e=>{const t=e.target;t&&"ha-dialog"===t.tagName.toLowerCase()&&document.body.removeChild(a)}))}_handleTriggerSave(e){if(!this.config)return;const a=this.config.irrigation_start_triggers?[...this.config.irrigation_start_triggers]:[];e.isNew?a.push(e.trigger):void 0!==e.index&&(a[e.index]=e.trigger),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[Ae]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}_handleTriggerDelete(e){var a;if(!(null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||void 0===e.index)return;const t=[...this.config.irrigation_start_triggers];t.splice(e.index,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[Ae]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}renderWeatherSkipCard(){return this.config&&this.data&&this.hass?q`
      <ha-card header="${Ro("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          ...
          ${this.config.skip_irrigation_on_precipitation?this._numRow(Ro("weather_skip.threshold_label",this.hass.language),Ea(this.config,Se),this.config.precipitation_threshold_mm,(e=>this.handleConfigChange({precipitation_threshold_mm:parseFloat(e)})),.1):""}
        </div>
      </ha-card>
    `:q``}renderObservedWateringCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.language;return q`
      <ha-card header="${Ro("observed_watering.title",e)}">
        <div class="card-content">
          ${Ro("observed_watering.description",e)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("observed_watering.enabled_label",e)}
            </div>
            <ha-switch
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("observed_watering.direct_control_label",e)}
            </div>
            <ha-switch
          ...
          ${this.config.direct_valve_control_enabled?q`
                <div class="card-content">
                  ${Ro("observed_watering.direct_control_description",e)}
                </div>
                <div class="setting-row">
                  <div class="setting-label">
                    ${Ro("observed_watering.sequencing_label",e)}
                  </div>
                  <select
                    class="field"
                  ...
                  >
                    ...
                    >
                      ${Ro("observed_watering.sequencing.sequential",e)}
                    </option>
                    <option
                      value="parallel"
                      ?selected=${"parallel"===this.config.zone_sequencing}
                    >
                      ${Ro("observed_watering.sequencing.parallel",e)}
                    </option>
                  </select>
                </div>
              `:""}
    ...
    `}renderCoordinateCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.config,a=(null==e?void 0:e.latitude)||0,t=(null==e?void 0:e.longitude)||0,i=(null==e?void 0:e.elevation)||0;return q`
      <ha-card
        header="${Ro("coordinate_config.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Ro("coordinate_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("coordinate_config.manual_enabled",this.hass.language)}
            </div>
            <ha-switch
            ...
            ${this.data.manual_coordinates_enabled?q`
                    ${this._numRow(Ro("coordinate_config.latitude",this.hass.language),"",this.data.manual_latitude||a,(e=>this.handleConfigChange({manual_latitude:parseFloat(e)})),.1)}
                    ${this._numRow(Ro("coordinate_config.longitude",this.hass.language),"",this.data.manual_longitude||t,(e=>this.handleConfigChange({manual_longitude:parseFloat(e)})),.1)}
                    ${this._numRow(Ro("coordinate_config.elevation",this.hass.language),"",this.data.manual_elevation||i,(e=>this.handleConfigChange({manual_elevation:parseFloat(e)})),1)}
                  `:q`
                    <div
                      class="zoneline"
                      style="color: var(--secondary-text-color); font-style: italic;"
                    >
                      ${Ro("coordinate_config.current_ha_coords",this.hass.language)}:<br />
                      ${Ro("coordinate_config.latitude",this.hass.language)}:
                      ${a}<br />
                      ${Ro("coordinate_config.longitude",this.hass.language)}:
                      ${t}<br />
                      ${Ro("coordinate_config.elevation",this.hass.language)}:
                      ${i}m
                    </div>
                  `}
                </div>
    ...
    `}renderDaysBetweenIrrigationCard(){return this.config&&this.data&&this.hass?q`
      <ha-card
        header="${Ro("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Ro("days_between_irrigation.description",this.hass.language)}
        </div>

        <div class="card-content">
          ${this._numRow(Ro("days_between_irrigation.label",this.hass.language),"",this.config.days_between_irrigation||0,(e=>this.handleConfigChange({days_between_irrigation:parseInt(e)})),1)}
          <div class="card-content">
            <div
              style="color: var(--secondary-text-color); font-size: 0.875rem; margin-top: 8px;"
            >
              ${Ro("days_between_irrigation.help_text",this.hass.language)}
            </div>
          </div>
        </div>
      </ha-card>
    `:q``}async saveData(e){if(this.hass&&this.data){this.isSaving=!0,this._scheduleUpdate(),this._suppressNextConfigUpdate=!0;try{this.data=Object.assign(Object.assign({},this.data),e),this.config=Object.assign(Object.assign({},this.config),e),this._scheduleUpdate(),await(a=this.hass,t=this.data,a.callApi("POST",je+"/config",t))}catch(e){this._suppressNextConfigUpdate=!1,console.error("Error saving config:",e),Da(e,this.shadowRoot.querySelector("ha-card")),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var a,t}}handleConfigChange(e){this.debouncedSave(e)}disconnectedCallback(){super.disconnectedCallback()}_textRow(e,a,t,i){return q`
      <div class="setting-row">
        <div class="setting-label">
    ...
    `}static get styles(){return p`
      ${al} ${nl} /* View-specific styles only - most common styles are now in globalStyle */
...
t.version="2.30.1",i(Gt),t.fn=or,t.min=Jt,t.max=Qt,t.now=Xt,t.utc=m,t.unix=lr,t.months=hr,t.isDate=u,t.locale=mt,t.invalid=f,t.duration=Si,t.isMoment=z,t.weekdays=fr,t.parseZone=dr,t.localeData=vt,t.isDuration=ri,t.monthsShort=vr,t.weekdaysMin=kr,t.defineLocale=gt,t.updateLocale=ht,t.locales=ft,t.weekdaysShort=br,t.normalizeUnits=ae,t.relativeTimeRounding=ts,t.relativeTimeThreshold=is,t.calendarFormat=Li,t.prototype=or,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t}()),yl.exports),wl=fl(zl);let xl=class extends(La(ce)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t,i]=await Promise.all([Na(this.hass),Pa(this.hass),Ca(this.hass),Ha(this.hass)]);this.config=e,this.zones=a,this.modules=t,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:vl.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,a){this.hass&&(this.zones[e]=a,a.id&&this.zoneCache.delete(a.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(a).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,a){if(!this.hass)return;const t=this.zones[a].id;if(!this.zones[a]||null==t)return;const i=[...this.zones];var n,r;this.zones=this.zones.filter(((e,t)=>t!==a)),this.zoneCache.delete(t.toString()),this.isSaving=!0,(n=this.hass,r=t.toString(),n.callApi("POST",je+"/zones",{id:r,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var a;const t=this.zones[e];if(!t||null==t.mapping)return;const i=`#weather-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var a;const t=this.zones[e];if(!t||null==t.id)return;const i=`#calendar-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const a=await Ia(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,a)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const t of this.zones)if(void 0!==t.id)try{const i=await(e=this.hass,a=t.id.toString(),e.callWS({type:je+"/watering_calendar",zone_id:a}));this.wateringCalendars.set(t.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${t.id}:`,e)}var e,a;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return q``;const a=this.weatherRecords.get(e.id)||[];return q`
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return q``;const a=this.wateringCalendars.get(e.id),t=a&&e.id in a?a[e.id]:null,i=(null==t?void 0:t.monthly_estimates)||[];return q` <div class="watering-calendar">
      ...
      ${0===i.length?q`
          ...
          `:q` <div class="calendar-table">
            ...
            ${(null==t?void 0:t.calculation_method)?q`
                ...
                `:""}`}
    </div>`}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");var a,t;await(a=this.hass,t=e,a.callApi("POST",je+"/zones",t))}handleZoneFormFocus(){this.isCreatingZone=!0}handleZoneFormBlur(){var e,a,t,i;(null===(a=null===(e=this.nameInput)||void 0===e?void 0:e.value)||void 0===a?void 0:a.trim())||(null===(t=this.sizeInput)||void 0===t?void 0:t.value)||(null===(i=this.throughputInput)||void 0===i?void 0:i.value)||(this.isCreatingZone=!1)}renderTheOptions(e,a){if(this.hass){let t=q`<option value="" ?selected=${void 0===a}">---${Ro("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>t=q`${t}
            <option
              value="${i.id}"
              ?selected="${a===i.id}"
            >
              ${i.id}: ${i.name}
            </option>`)),t}return q``}renderZone(e,a){var t,i,n;if(!this.hass)return q``;const r=this.hass.language,s=e.state===vl.Automatic,o=e.state===vl.Disabled||e.state===vl.Automatic,l=null!=e.explanation&&e.explanation.length>0;if(null!=e.mapping){const a=this.mappings.filter((a=>a.id===e.mapping))[0];null!=a&&null!=a.data&&(e.number_of_data_points=a.data.length)}const d=Ro("panels.zones.labels.states."+e.state,r),u=`${Math.round(Number(e.duration)||0)} s`,c=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="zone-card">
        ...
        ${c?q` <div class="zone-body">
              <div class="zone-meta">
                <div class="meta-item">
                  <span class="meta-label"
                    >${Ro("panels.zones.labels.last_calculated",r)}</span
                  >
                  <span class="meta-value"
                    >${e.last_calculated?wl(e.last_calculated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${Ro("panels.zones.labels.data-last-updated",r)}</span
                  >
                  <span class="meta-value"
                    >${e.last_updated?wl(e.last_updated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${Ro("panels.zones.labels.data-number-of-data-points",r)}</span
                  >
                  <span class="meta-value"
              ...
              <div class="settings">
                ${this._textRow(Ro("panels.zones.labels.name",r),"",e.name,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[oa]:t}))))}
                ${this._numRow(Ro("panels.zones.labels.size",r),Ea(this.config,la),e.size,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[la]:parseFloat(t)}))),.1)}
                ${this._numRow(Ro("panels.zones.labels.throughput",r),Ea(this.config,da),e.throughput,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[da]:parseFloat(t)}))),.1)}
                ${this._numRow(Ro("panels.zones.labels.drainage_rate",r),Ea(this.config,ya),e.drainage_rate,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ya]:parseFloat(t)}))),.1)}
                ${this._selectRow(Ro("panels.zones.labels.state",r),q`
                    <option
                      value="${vl.Automatic}"
                      ?selected=${e.state===vl.Automatic}
                    >
                      ${Ro("panels.zones.labels.states.automatic",r)}
                    </option>
                    <option
                      value="${vl.Disabled}"
                      ?selected=${e.state===vl.Disabled}
                    >
                      ${Ro("panels.zones.labels.states.disabled",r)}
                    </option>
                    <option
                      value="${vl.Manual}"
                      ?selected=${e.state===vl.Manual}
                    >
                      ${Ro("panels.zones.labels.states.manual",r)}
                    </option>
                  `,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ua]:t.target.value,[ca]:0}))))}
                ${this._selectRow(Ro("common.labels.module",r),this.renderTheOptions(this.modules,e.module),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[ma]:""===i?void 0:parseInt(i)}))}))}
                ${this._selectRow(Ro("panels.zones.labels.mapping",r),this.renderTheOptions(this.mappings,e.mapping),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[va]:""===i?void 0:parseInt(i)}))}))}
                ${this._numRow(Ro("panels.zones.labels.bucket",r),Ea(this.config,ga),Number(e.bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ga]:parseFloat(t)}))),.1)}
                ${this._numRow(Ro("panels.zones.labels.maximum-bucket",r),Ea(this.config,ga),Number(e.maximum_bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ka]:parseFloat(t)}))),.1)}
                ${this._numRow(Ro("panels.zones.labels.et-deficiency",r),Ea(this.config,ga),null!=e.et_deficiency?Number(e.et_deficiency).toFixed(2):"",(()=>{}),.01,!0)}
                ${(null===(i=this.config)||void 0===i?void 0:i.observed_watering_enabled)?this._entityRow(Ro("panels.zones.labels.linked-entity",r),Ro("panels.zones.labels.optional",r),e.linked_entity,["switch","valve","input_boolean","binary_sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[_a]:t||void 0}))),Ro("panels.zones.labels.linked-entity-hint",r)):""}
                ${(null===(n=this.config)||void 0===n?void 0:n.observed_watering_enabled)&&e.linked_entity?this._entityRow(Ro("panels.zones.labels.flow-sensor",r),Ro("panels.zones.labels.optional",r),e.flow_sensor,["sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[za]:t||void 0}))),Ro("panels.zones.labels.flow-sensor-hint",r)):""}
                ${this._numRow(Ro("panels.zones.labels.lead-time",r),"s",e.lead_time,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[fa]:parseInt(t,10)}))),1)}
                ${this._numRow(Ro("panels.zones.labels.maximum-duration",r),"s",e.maximum_duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ba]:parseInt(t,10)}))),1)}
                ${this._numRow(Ro("panels.zones.labels.multiplier",r),"",e.multiplier,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ha]:parseFloat(t)}))),.1)}
                ${this._numRow(Ro("panels.zones.labels.duration",r),"s",e.duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ca]:parseInt(t,10)}))),1,o)}
              </div>

              <div class="zone-actions">
                ${s?q`
                      ${this._actionBtn(qo,Ro("panels.zones.actions.calculate",r),(()=>this.handleCalculateZone(a)))}
                      ${this._actionBtn(Xo,Ro("panels.zones.actions.update",r),(()=>this.handleUpdateZone(a)))}
                    `:""}
                ${this._actionBtn(Jo,Ro("panels.zones.actions.reset-bucket",r),(()=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ga]:0}))))}
                ${null!=e.mapping?this._actionBtn(Go,Ro("panels.zones.actions.view-weather-info",r),(()=>this.handleViewWeatherInfo(a))):""}
                ${this._actionBtn("M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z",Ro("panels.zones.actions.view-watering-calendar",r),(()=>this.handleViewWateringCalendar(a)))}
                ${l?this._actionBtn("M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z",Ro("panels.zones.actions.information",r),(()=>this.toggleExplanation(a))):""}
                ${this._actionBtn(Yo,Ro("common.actions.delete",r),(e=>this.handleRemoveZone(e,a)),!0)}
              </div>

              ${l?q`<label class="hidden" id="calcresults${a}"
                    >${Aa("<br/>"+e.explanation)}</label
                  >`:""}
    ...
    `}toggleExplanation(e){var a;const t=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector("#calcresults"+e);t&&("hidden"!=t.className?t.className="hidden":t.className="explanation")}render(){return this.hass?this.isLoading?q`
        <ha-card header="${Ro("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${Ro("common.loading-messages.general",this.hass.language)}...
          </div>
        </ha-card>
      ...
      <ha-card header="${Ro("panels.zones.title",this.hass.language)}">
        <div class="card-content">
          ${Ro("panels.zones.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Ro("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("panels.zones.labels.name",this.hass.language)}
            </div>
            <input
              id="nameInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("panels.zones.labels.size",this.hass.language)}
              <span class="unit">(${Ea(this.config,la)})</span>
            </div>
            <input
              id="sizeInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("panels.zones.labels.throughput",this.hass.language)}
              <span class="unit"
                >(${Ea(this.config,da)})</span
              >
            </div>
            <input
              id="throughputInput"
          ...
          <div class="add-zone-actions">
            ...
            >
              ...
              ${this.isSaving?Ro("common.saving-messages.adding",this.hass.language):Ro("panels.zones.cards.add-zone.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>

      ${gl(this.zones,(e=>{var a;return null!==(a=e.id)&&void 0!==a?a:e.name}),((e,a)=>this.renderZone(e,a)))}

      <ha-card
        header="${Ro("panels.zones.cards.zone-actions.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zone-actions-grid">
            ${this._actionBtn(qo,Ro("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language),(()=>this.handleCalculateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Xo,Ro("panels.zones.cards.zone-actions.actions.update-all",this.hass.language),(()=>this.handleUpdateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Jo,Ro("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),(()=>this.handleResetAllBuckets()),!1,this.isSaving)}
            ${this._actionBtn(Go,Ro("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),(()=>this.handleClearAllWeatherdata()),!1,this.isSaving)}
          </div>
        </div>
      </ha-card>
        ...
        ${s?q` <div class="si-body">
              <div class="moduleconfig">
                <label class="subheader"
                  >${Ro("panels.modules.cards.module.labels.configuration",this.hass.language)}
                  (*
                  ${Ro("panels.modules.cards.module.labels.required",this.hass.language)})</label
                >
                <div class="settings">
              ...
              ${n?q`<div class="weather-note">
                    ${Ro("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                  </div>`:q`<div class="si-actions">
                    ${this._actionBtn(Yo,Ro("common.actions.delete",this.hass.language),(e=>this.handleRemoveModule(e,a)),!0)}
                  </div>`}
            </div>`:""}
      </ha-card>
    `;return this.moduleCache.set(l,d),d}renderConfig(e,a){const t=Object.values(this.modules).at(e);if(!t||!this.hass)return;const i=t.schema[a],n=i.name,r=function(e){if(e)return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}(n);let s="";null==t.config&&(t.config=[]),n in t.config&&(s=t.config[n]);const o=i.required?`${r} *`:null!=r?r:"";if("boolean"==i.type)return q`
      ...
      `;if("float"==i.type||"integer"==i.type)return this._numRow(o,"",t.config[n],(a=>this.handleEditConfig(e,Object.assign(Object.assign({},t),{config:Object.assign(Object.assign({},t.config),{[n]:a})}))),1);if("string"==i.type)return this._textRow(o,"",s,(a=>this.handleEditConfig(e,Object.assign(Object.assign({},t),{config:Object.assign(Object.assign({},t.config),{[n]:a})}))));if("select"==i.type){const a=this.hass.language,r=q`
        ${Object.entries(i.options).map((([e,t])=>q`<option
              ...
              ?selected="${s===$a(t,0)}"
            >
              ${Ro("panels.modules.cards.module.translated-options."+$a(t,1),a)}
            </option>`))}
    ...
    `}handleEditConfig(e,a){this.modules=Object.values(this.modules).map(((t,i)=>i===e?a:t)),this.moduleCache.clear(),this._scheduleUpdate(),this.debouncedSave(a)}renderOption(e,a){return this.hass?q`<option value="${e}>${a}</option>`:q``}render(){return this.hass?q`
      <ha-card header="${Ro("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Ro("panels.modules.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Ro("panels.modules.cards.add-module.header",this.hass.language)}"
      >
        <div class="card-content">
          ${this.isLoading?q`<div class="loading-indicator">
                ...
                <div class="setting-row">
                  <div class="setting-label">
                    ${Ro("common.labels.module",this.hass.language)}
                  </div>
                  <div class="select-wrap">
                    <select
                      id="moduleInput"
                ...
                <div class="si-form-actions">
                  ...
                  >
                    <ha-svg-icon slot="start" .path=${Qo}></ha-svg-icon>
                    ${this.isSaving?Ro("common.saving-messages.adding",this.hass.language):Ro("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </ha-button>
                </div>
              `}
        </div>
      ...
      ${this.isLoading?q`<div class="loading-indicator">
            ${Ro("common.loading-messages.modules",this.hass.language)}
          </div>`:gl(this.modules,(e=>{var a;return null!==(a=e.id)&&void 0!==a?a:e.name}),((e,a)=>this.renderModule(e,a)))}
    `:q``}disconnectedCallback(){super.disconnectedCallback(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.moduleCache.clear()}static get styles(){return p`
      ${al} ${nl} /* View-specific styles only - most common styles are now in globalStyle */
    `}};r([he()],jl.prototype,"config",void 0),r([he({type:Array})],jl.prototype,"zones",void 0),r([he({type:Array})],jl.prototype,"modules",void 0),r([he({type:Array})],jl.prototype,"allmodules",void 0),r([he({type:Boolean})],jl.prototype,"isLoading",void 0),r([he({type:Boolean})],jl.prototype,"isSaving",void 0),r([fe("#moduleInput")],jl.prototype,"moduleInput",void 0),jl=r([me("smart-irrigation-view-modules")],jl);let Sl=class extends(La(ce)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16,this._expanded=new Set}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}),this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()})))}_toggleItem(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t]=await Promise.all([Na(this.hass),Pa(this.hass),Ha(this.hass)]);this.config=e,this.zones=a,this.mappings=t,this._fetchWeatherRecords(),this.mappingCache.clear()}catch(a){console.error("Error fetching data:",a),Da({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"))}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const a=await Ia(this.hass,e.id.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for mapping ${e.id}:`,a),this.weatherRecords.set(e.id,[])}this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass)return q``;const a=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return q`
      <div class="weather-records">
        <h4>
          ${Ro("panels.mappings.weather-records.title",this.hass.language)}
        </h4>
        ...
        <div class="card-content">
          <div class="card-content">
            ...
            ${i?q`<div class="weather-note">
                  ${Ro("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:q` <div
                  class="action-button"
                ...
                >
                  ...
                  <span class="action-button-label">
                    ${Ro("common.actions.delete",this.hass.language)}
                  </span>
                </div>`}
          </div>
        </div>
    ...
    `;return this.mappingCache.set(t,n),n}renderMappingSetting(e,a){const t=this.mappings[e];if(!t||!this.hass)return q``;const i=t.mappings[a];return q`
      <div class="si-subgroup">
        <div class="si-subgroup-title">
          ${Ro(`panels.mappings.cards.mapping.items.${a.toLowerCase()}`,this.hass.language)}
        </div>
        ${this._selectRow(Ro("panels.mappings.cards.mapping.source",this.hass.language),this.renderSimpleRadioOptions(e,a,i),(t=>this.handleSimpleSourceChange(e,a,t)))}
        ${this.renderMappingInputs(e,a,i)}
      </div>
    `}renderSimpleRadioOptions(e,a,t){if(!this.hass||!this.config)return q``;const i=a===Ce||a===Ve,n=t[Xe],r=!!this.config.use_weather_service,s=i&&this.config.weather_service!==qe;return q`
      ${r?q`<option
            value="${We}"
            ?selected=${n===We}
          >
            ${Ro("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}${s?" (via Open-Meteo)":""}
          </option>`:""}
      ${i?q`<option
            value="${Qe}"
            ?selected=${n===Qe}
          >
            ${Ro("panels.mappings.cards.mapping.sources.none",this.hass.language)}
          </option>`:""}
      <option
        value="${Ge}"
        ?selected=${n===Ge}
      >
        ${Ro("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </option>
      <option
        value="${Ye}"
        ?selected=${n===Ye}
      >
        ${Ro("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </option>
    `}handleSimpleSourceChange(e,a,t){const i=this.mappings[e],n=t.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[Xe]:n,[ea]:""})})}))}handleSimpleInputChange(e,a,t,i){const n=this.mappings[e],r=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[a]:Object.assign(Object.assign({},n.mappings[a]),{[t]:r})})}))}renderSourceOptions(e,a,t){var i;if(!this.hass)return q``;const n=`${a}_${e}`,r=a===Ce||a===Ve,s=!!(null===(i=this.config)||void 0===i?void 0:i.use_weather_service);return q`
      <div class="mappingsettingline">
        <label for="${n}_source">
          ${Ro("panels.mappings.cards.mapping.source",this.hass.language)}:
        </label>
      </div>
    ...
    `}renderWeatherServiceOption(e,a,t){if(!this.hass||!this.config)return q``;const i=`${a}_${e}`,n=!this.config.use_weather_service,r=this.config.use_weather_service&&t[Xe]===We,s=(a===Ce||a===Ve)&&this.config.weather_service!==qe;return q`
    ...
    `}renderSensorInput(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${Ro("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}
        </div>
        <ha-entity-picker
          class="entity-field"
          .hass=${this.hass}
    ...
    `:q``}renderStaticValueInput(e,a,t){return this.hass?this._numRow(Ro("panels.mappings.cards.mapping.static_value",this.hass.language),"",t[aa]||"",(t=>this.handleStaticValueChange(e,a,{target:{value:t}})),.1):q``}renderUnitSelect(e,a,t){return this.hass&&this.config?this._selectRow(Ro("panels.mappings.cards.mapping.input-units",this.hass.language),this.renderUnitOptionsForMapping(a,t),(t=>this.handleUnitChange(e,a,t))):q``}renderPressureTypeSelect(e,a,t){return this.hass?this._selectRow(Ro("panels.mappings.cards.mapping.pressure-type",this.hass.language),this.renderPressureTypes(a,t),(t=>this.handlePressureTypeChange(e,a,t))):q``}renderAggregateSelect(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${Ro("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          <span class="unit"
            >${Ro("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</span
          >
        </div>
        <div class="select-wrap">
          <select
    ...
    `}renderAggregateOption(e,a){if(this.hass&&this.config){return q`<option value="${e}" ?selected="${e===a}">
        ${Ro("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return q``}renderPressureTypes(e,a){if(this.hass&&this.config){let e=q``;const t=a[Ze];return e=q`${e}
        <option
          value="${Ke}"
          ?selected="${t===Ke}"
        >
          ${Ro("panels.mappings.cards.mapping.pressure_types."+Ke,this.hass.language)}
        </option>
        <option
          value="${Je}"
          ?selected="${t===Je}"
        >
          ${Ro("panels.mappings.cards.mapping.pressure_types."+Je,this.hass.language)}
        </option>`,e}return q``}renderUnitOptionsForMapping(e,a){if(!this.hass||!this.config)return q``;const t=function(e){switch(e){case Pe:case Ue:return[{unit:"°C",system:Ne},{unit:"°F",system:Oe}];case Ie:case Ce:return[{unit:"mm",system:Ne},{unit:"in",system:Oe}];case Le:return[{unit:ra,system:Ne},{unit:sa,system:Oe}];case He:return[{unit:"%",system:[Ne,Oe]}];case Be:return[{unit:"millibar",system:Ne},{unit:"hPa",system:Ne},{unit:"psi",system:Oe},{unit:"inch Hg",system:Oe}];case Re:return[{unit:"km/h",system:Ne},{unit:"meter/s",system:Ne},{unit:"mile/h",system:Oe}];case Ve:return[{unit:"W/m2",system:Ne},{unit:"MJ/day/m2",system:Ne},{unit:"W/sq ft",system:Oe},{unit:"MJ/day/sq ft",system:Oe}];default:return[]}}(e);let i=a[ta];const n=this.config.units;if(!a[ta])for(const e of t)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const a of e.system)if(n===a.system){i=e.unit;break}if(i===e.unit)break}return q`
      ${t.map((e=>q`
    ...
    `}render(){return this.hass?this.isLoading?q`
        <ha-card
          header="${Ro("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ro("common.loading-messages.general",this.hass.language)}
          </div>
      ...
      >
        <div class="card-content">
          ${Ro("panels.mappings.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Ro("panels.mappings.cards.add-mapping.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Ro("panels.mappings.labels.mapping-name",this.hass.language)}
            </div>
          ...
          <div class="si-form-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Qo}></ha-svg-icon>
              ${this.isSaving?Ro("common.saving-messages.adding",this.hass.language):Ro("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
    ...
    `:q``}renderMappingsList(){const e=this.mappings.slice(0,Math.min(this.mappings.length,10)),a=this.mappings.slice(10);return q`
      ${gl(e,(e=>{var a;return null!==(a=e.id)&&void 0!==a?a:e.name}),((e,a)=>this.renderMappingCard(e,a)))}
      ${a.length>0?q`
            <div class="si-form-actions">
              ${this._actionBtn(Qo,`Load ${a.length} more mappings...`,(()=>this.loadMoreMappings()))}
            </div>
          `:""}
    `}renderMappingCard(e,a){if(!this.hass)return q``;const t=this.hass.language,i=this.zones.filter((a=>a.mapping===e.id)).length,n=Object.keys(e.mappings||{}).length,r=[];r.push(`${n} ${Ro("panels.mappings.title",t).toLowerCase()}`),i&&r.push(`${i} ${Ro("panels.zones.title",t).toLowerCase()}`);const s=r.join(" · "),o=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="si-card">
        <div
          class="si-head"
          role="button"
        ...
        ${o?q`<div class="si-body">
              <div class="settings">
                ${this._textRow(Ro("panels.mappings.labels.mapping-name",t),"",e.name,(t=>this.handleEditMapping(a,Object.assign(Object.assign({},e),{name:t}))))}
                ${this.renderMappingSettings(e,a)}
              </div>
              ${this.renderWeatherRecords(e)}
              <div class="si-actions">
                ${i?q`<div class="weather-note">
                      ${Ro("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",t)}
                    </div>`:this._actionBtn(Yo,Ro("common.actions.delete",t),(e=>this.handleRemoveMapping(e,a)),!0)}
              </div>
            </div>`:""}
      </ha-card>
      ...
      <ha-card header="${Ro("panels.weatherservice.title",a)}">
        ...
        <div class="card-content">
          ...
          ${this._use?q`
                <div class="setting-row">
                  <div class="setting-label">
                    ${Ro("panels.weatherservice.labels.service",a)}
                  </div>
                  <div class="select-wrap">
                    <select
                      class="field"
                ...
                ${this._service&&Fe.includes(this._service)?"":q`<div class="setting-row">
                      <div class="setting-label">
                        ${Ro("panels.weatherservice.labels.api-key",a)}
                      </div>
                      <input
                        class="field"
                        type="text"
                ...
                ${"Open Weather Map"===this._service?q`<div class="ws-note ws-note--hint">
                      ${Ro("panels.weatherservice.messages.owm-onecall-hint",a)}
                    </div>`:""}
              `:q`<div class="ws-note">
                ${Ro("panels.weatherservice.messages.no-service",a)}
              </div>`}
          ${this._error?q`<div class="ws-msg ws-msg--error">${this._error}</div>`:""}
          ${this._saved?q`<div class="ws-msg ws-msg--success">
                ${Ro("panels.weatherservice.messages.saved",a)}
              </div>`:""}
          ...
          <div class="ws-actions">
            <ha-button
              ...
              @click=${this._save}
            >
              ${this._saving?Ro("panels.weatherservice.actions.saving",a):Ro("panels.weatherservice.actions.save",a)}
            </ha-button>
          </div>
          <div class="ws-note ws-reload-note">
            ${Ro("panels.weatherservice.messages.reload-note",a)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
    ...
    `}};r([he()],Al.prototype,"narrow",void 0),r([he()],Al.prototype,"path",void 0),r([ve()],Al.prototype,"_info",void 0),r([ve()],Al.prototype,"_use",void 0),r([ve()],Al.prototype,"_service",void 0),r([ve()],Al.prototype,"_apiKey",void 0),r([ve()],Al.prototype,"_loading",void 0),r([ve()],Al.prototype,"_saving",void 0),r([ve()],Al.prototype,"_error",void 0),r([ve()],Al.prototype,"_saved",void 0),Al=r([me("smart-irrigation-view-weatherservice")],Al);let $l=class extends ce{constructor(){super(...arguments),this._busy=!1,this._error="",this._message="",this._pendingName=""}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}_reset(){this._error="",this._message="",this._pending=void 0,this._pendingName=""}async _export(){if(this.hass){this._reset(),this._busy=!0;try{const a=await(e=this.hass,e.callApi("GET",je+"/export")),t=JSON.stringify(a,null,2),i=new Blob([t],{type:"application/json"}),n=URL.createObjectURL(i),r=document.createElement("a");r.href=n;const s=(new Date).toISOString().slice(0,19).replace("T","_").replace(/:/g,"-");r.download=`smart_irrigation_backup_${s}.json`,r.click(),URL.revokeObjectURL(n),this._message=Ro("panels.backuprestore.messages.exported",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e}}async _onFile(e){this._reset();const a=e.target,t=a.files&&a.files[0];if(t)try{const e=await t.text(),a=JSON.parse(e);if(!a||"object"!=typeof a||!a.config)throw new Error(Ro("panels.backuprestore.messages.invalid-file",this.hass.language));this._pending=a,this._pendingName=t.name}catch(e){this._error=this._errText(e)}finally{a.value=""}}async _restore(){if(this.hass&&this._pending){this._busy=!0,this._error="",this._message="";try{const t=await(e=this.hass,a=this._pending,e.callApi("POST",je+"/restore",a));if(t&&!1===t.success)throw new Error(t.error||"restore failed");this._pending=void 0,this._pendingName="",this._message=Ro("panels.backuprestore.messages.restored",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e,a}}_count(e){const a=this._pending&&this._pending[e];return Array.isArray(a)?a.length:0}render(){if(!this.hass)return q``;const e=this.hass.language;return q`
      <ha-card header="${Ro("panels.backuprestore.title",e)}">
        <div class="card-content br-description">
          ${Ro("panels.backuprestore.description",e)}
        </div>
      </ha-card>

      <ha-card
        header="${Ro("panels.backuprestore.cards.backup.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${Ro("panels.backuprestore.cards.backup.description",e)}
          </div>
          ...
          <div class="br-actions">
            ...
            >
              ...
              ${Ro("panels.backuprestore.actions.export",e)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${Ro("panels.backuprestore.cards.restore.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${Ro("panels.backuprestore.cards.restore.description",e)}
          </div>
          ...
          <label class="br-file">
            ...
            ${Ro("panels.backuprestore.actions.choose-file",e)}
          </label>
                ...
                <div class="br-warning">
                  ...
                  <div>
                    <div class="br-warning-title">
                      ${Ro("panels.backuprestore.messages.confirm-title",e)}
                    </div>
                    <div class="br-file-name">${this._pendingName}</div>
                    <div class="br-summary">
                      ${Ro("panels.backuprestore.messages.summary",e)}:
                      ${this._count("zones")}
                      ${Ro("panels.zones.title",e)} ·
                      ${this._count("modules")}
                      ${Ro("panels.modules.title",e)} ·
                      ${this._count("mappings")}
                      ${Ro("panels.mappings.title",e)}
                    </div>
                    <div class="br-warning-text">
                      ${Ro("panels.backuprestore.messages.confirm-warning",e)}
                    </div>
                  </div>
                </div>
              `:""}
          ...
          ${this._pending?q`<div class="br-actions">
                <ha-button
                  ...
                  @click=${this._restore}
                >
                  <ha-svg-icon slot="start" .path=${el}></ha-svg-icon>
                  ${this._busy?Ro("panels.backuprestore.actions.restoring",e):Ro("panels.backuprestore.actions.restore",e)}
                </ha-button>
              </div>`:""}
          <div class="br-note">
            ${Ro("panels.backuprestore.messages.reload-note",e)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
    ...
    `}};r([he()],$l.prototype,"narrow",void 0),r([he()],$l.prototype,"path",void 0),r([ve()],$l.prototype,"_busy",void 0),r([ve()],$l.prototype,"_error",void 0),r([ve()],$l.prototype,"_message",void 0),r([ve()],$l.prototype,"_pending",void 0),r([ve()],$l.prototype,"_pendingName",void 0),$l=r([me("smart-irrigation-view-backuprestore")],$l);let El=class extends(La(ce)){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[a,t,i]=await Promise.all([Na(this.hass),(e=this.hass,e.callWS({type:je+"/info"})),Pa(this.hass)]);this.config=a,this.info=t,this.zones=i}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}_totalWaterVolume(){return this.zones.filter((e=>e.state===vl.Automatic||e.state===vl.Manual)).reduce(((e,a)=>e+Ma(a.duration,a.throughput)),0)}_renderWaterVolume(e){return q`${e.toFixed(1)}
    ${this.config?Ea(this.config,pa):"L"}`}render(){return this.hass?this.isLoading?q`
        <ha-card header="${Ro("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${Ro("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:this.config?q`
      <ha-card header="${Ro("panels.info.title",this.hass.language)}">
        <div class="card-content">
          ${Ro("panels.info.description",this.hass.language)}
        </div>
      </ha-card>
    ...
    `:q`
        <ha-card header="${Ro("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${Ro("panels.info.configuration-not-available",this.hass.language)}
          </div>
        </ha-card>
      `:q``}renderZoneBucketsCard(){if(!this.hass)return q``;if(!this.zones||0===this.zones.length)return q`
        <ha-card
          header="${Ro("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="info-item">
              <span class="value"
                >${Ro("panels.info.cards.zone-bucket-values.no-zones",this.hass.language)}</span
              >
            </div>
          </div>
        </ha-card>
      `;const e=this.config?Ea(this.config,ga):"mm";return q`
      <ha-card
        header="${Ro("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
      >
        <div class="card-content">
              ...
              <div class="zone-info">
                ...
                <div class="zone-details">
                  <div class="zone-bucket">
                    <span class="label"
                      >${Ro("panels.info.cards.zone-bucket-values.labels.bucket",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</span
                    >
                    <span class="value">
                  ...
                  <div class="zone-duration">
                    <span class="label"
                      >${Ro("panels.info.cards.zone-bucket-values.labels.duration",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}:</span
                    >
                    <span class="value">
                      ${Ta(a.duration)}
                    </span>
                  ...
                  <div class="zone-water">
                    <span class="label"
                      >${Ro("panels.info.cards.zone-bucket-values.labels.water",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}:</span
                    >
                    <span class="value">
                      ${this._renderWaterVolume(Ma(a.duration,a.throughput))}
                    </span>
                  </div>
                </div>
              </div>
    ...
    `}renderNextIrrigationCard(){var e,a,t,i,n,r,s,o;return this.hass&&this.info?q`
      <ha-card
        header="${Ro("panels.info.cards.next-irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${Ro("panels.info.cards.next-irrigation.labels.next-start",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.next_irrigation_start?wl(this.info.next_irrigation_start).format("YYYY-MM-DD HH:mm:ss"):Ro("panels.info.cards.next-irrigation.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.next_irrigation_duration?q`
                <div class="info-item">
                  <label
                    >${Ro("panels.info.cards.next-irrigation.labels.duration",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${Ta(this.info.next_irrigation_duration)}</span
                  >
                </div>
                <div class="info-item">
                  <label
                    >${Ro("panels.info.cards.next-irrigation.labels.water",this.hass.language)}:</label
                  >
                  <span class="value"
          ...
          ${this.info.next_irrigation_zones&&this.info.next_irrigation_zones.length>0?q`
                <div class="info-item">
                  <label
                    >${Ro("panels.info.cards.next-irrigation.labels.zones",this.hass.language)}:</label
                  >
                  <span class="value"
    ...
    `:q`
        <ha-card
          header="${Ro("panels.info.cards.next-irrigation.title",null!==(a=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==a?a:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${Ro("panels.info.cards.next-irrigation.labels.next-start",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${Ro("panels.info.cards.next-irrigation.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${Ro("panels.info.cards.next-irrigation.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}renderIrrigationReasonCard(){var e,a,t,i,n,r,s,o;return this.hass&&this.info?q`
      <ha-card
        header="${Ro("panels.info.cards.irrigation-reason.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${Ro("panels.info.cards.irrigation-reason.labels.reason",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.irrigation_reason||Ro("panels.info.cards.irrigation-reason.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.sunrise_time?q`
                <div class="info-item">
                  <label
                    >${Ro("panels.info.cards.irrigation-reason.labels.sunrise",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${wl(this.info.sunrise_time).format("HH:mm:ss")}</span
                  >
                </div>
              `:""}
          ${void 0!==this.info.total_irrigation_duration?q`
                <div class="info-item">
                  <label
                    >${Ro("panels.info.cards.irrigation-reason.labels.total-duration",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${Ta(this.info.total_irrigation_duration)}</span
                  >
                </div>
                <div class="info-item">
                  <label
                    >${Ro("panels.info.cards.irrigation-reason.labels.total-water",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${this._renderWaterVolume(this._totalWaterVolume())}</span
                  >
          ...
          ${this.info.irrigation_explanation?q`
                <div class="info-item explanation">
                  <label
                    >${Ro("panels.info.cards.irrigation-reason.labels.explanation",this.hass.language)}:</label
                  >
    ...
    `:q`
        <ha-card
          header="${Ro("panels.info.cards.irrigation-reason.title",null!==(a=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==a?a:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${Ro("panels.info.cards.irrigation-reason.labels.reason",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${Ro("panels.info.cards.irrigation-reason.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${Ro("panels.info.cards.irrigation-reason.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}static get styles(){return p`
    ...
    `}};r([he()],El.prototype,"config",void 0),r([he({type:Object})],El.prototype,"info",void 0),r([he({type:Array})],El.prototype,"zones",void 0),r([he({type:Boolean})],El.prototype,"isLoading",void 0),El=r([me("smart-irrigation-view-info")],El);const Tl=al,Ml=()=>{const e=e=>{let a={};for(let t=0;t<e.length;t+=2){const i=e[t],n=t<e.length?e[t+1]:void 0;a=Object.assign(Object.assign({},a),{[i]:n})}return a},a=window.location.pathname.split("/");let t={page:a[2]||"general",params:{}};if(a.length>3){let i=a.slice(3);if(a.includes("filter")){const a=i.findIndex((e=>"filter"==e)),n=i.slice(a+1);i=i.slice(0,a),t=Object.assign(Object.assign({},t),{filter:e(n)})}i.length&&(i.length%2&&(t=Object.assign(Object.assign({},t),{subpage:i.shift()})),i.length&&(t=Object.assign(Object.assign({},t),{params:e(i)})))}return t},Dl=(e,...a)=>{let t={page:e,params:{}};a.forEach((e=>{"string"==typeof e?t=Object.assign(Object.assign({},t),{subpage:e}):"params"in e?t=Object.assign(Object.assign({},t),{params:e.params}):"filter"in e&&(t=Object.assign(Object.assign({},t),{filter:e.filter}))}));const i=e=>{let a=Object.keys(e);a=a.filter((a=>e[a])),a.sort();let t="";return a.forEach((a=>{const i=e[a];t=t.length?`${t}/${a}/${i}`:`${a}/${i}`})),t};let n=`/${je}/${t.page}`;return t.subpage&&(n=`${n}/${t.subpage}`),i(t.params).length&&(n=`${n}/${i(t.params)}`),t.filter&&(n=`${n}/filter/${i(t.filter)}`),n};var Ol;!function(e){e.Info="info",e.General="general",e.Zones="zones",e.Modules="modules",e.Mappings="mappings",e.WeatherService="weatherservice",e.BackupRestore="backuprestore",e.Help="help"}(Ol||(Ol={})),e.SmartIrrigationPanel=class extends ce{constructor(){super(...arguments),this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}async firstUpdated(){const e=Ml();e.page&&Object.values(Ol).includes(e.page)?(window.addEventListener("location-changed",(()=>{if(!window.location.pathname.includes("smart_irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())})),_e().then((()=>{this._scheduleUpdate()})).catch((e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}))):Oa(0,Dl(Ol.General))}render(){const e=Ml(),a=!!customElements.get("ha-tab-group"),t=!!customElements.get("ha-tab-group-tab");return q`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Ro("title",this.hass.language)}</div>
              ...
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(Ol).map((a=>q`
                    <ha-tab-group-tab
                      ...
                      .active=${e.page===a}
                    >
                      ${Ro(`panels.${a}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `))}
              </ha-tab-group>
            `:q`
    ...
    `}getView(e){switch(e.page){case"info":return q`
        ...
        `;case"help":return q`<ha-card
          header="${Ro("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ro("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
            <a href="https://altmenorg.github.io/HAsmartirrigation/"
              >${Ro("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >.
            ${Ro("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${Ro("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${Ro("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a href="https://github.com/altmenorg/HAsmartirrigation/issues"
              >${Ro("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${Ro("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return q`
        ...
        `}}navigateToPage(e){if(e!==Ml().page){const a=Dl(e);Oa(0,a),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const a=e.detail.name;if(a!==Ml().page){const e=Dl(a);Oa(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Tl,p`
        :host {
          color: var(--primary-text-color);
    ...
    `}};r([he({attribute:!1})],Nl.prototype,"hass",void 0),r([ve()],Nl.prototype,"_params",void 0),Nl=r([me("smart-irrigation-error-dialog")],Nl);var Pl=Object.freeze({__proto__:null,get ErrorDialog(){return Nl}})}({});
