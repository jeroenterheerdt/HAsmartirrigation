...
`;var mi="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",gi="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";let fi=class extends(Je(le)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e,t;this.hass&&(this.config=await Ze(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{}))}firstUpdated(){(async()=>{await ye()})()}render(){if(this.hass&&this.config&&this.data){let e=Y` <div class="card-content"><svg
      style="width:24px;height:24px"
      viewBox="0 0 24 24"
      id="showcalcresults"
    >
      <title>
        ${ni("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
      </title>
      <path fill="#404040" d="${gi}" />
        ...
        >
          ...
          <div class="card-content">
            ...
            />
          </div>`),e=Y`<ha-card header="${ni("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}">
    ...
    >
      <title>
        ${ni("panels.general.cards.automatic-update.description",this.hass.language)}
      </title>
      <path fill="#404040" d="${gi}" />
      </svg></div><div class="card-content">
    ...
    >
      <title>
        ${ni("panels.general.cards.automatic-clear.description",this.hass.language)}
      </title>
      <path fill="#404040" d="${gi}" />
      </svg></div>
        ...
        >${t}${e}${a}`}return Y``}saveData(e){var t,a;this.hass&&this.data&&(this.data=Object.assign(Object.assign({},this.data),e),(t=this.hass,a=this.data,t.callApi("POST",_e+"/config",a)).catch((e=>di(e,this.shadowRoot.querySelector("ha-card")))).then())}toggleInformation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="information")}static get styles(){return c`
      ${pi}
      .hidden {
        display: none;
      }
...
a.version="2.29.4",i(Wa),a.fn=us,a.min=Xa,a.max=Ja,a.now=Qa,a.utc=p,a.unix=hs,a.months=vs,a.isDate=h,a.locale=pa,a.invalid=v,a.duration=Oi,a.isMoment=S,a.weekdays=ys,a.parseZone=cs,a.localeData=fa,a.isDuration=si,a.monthsShort=bs,a.weekdaysMin=ws,a.defineLocale=ma,a.updateLocale=ga,a.locales=va,a.weekdaysShort=_s,a.normalizeUnits=ae,a.relativeTimeRounding=nr,a.relativeTimeThreshold=sr,a.calendarFormat=ji,a.prototype=us,a.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},a}();var Si=bi(wi.exports);let Ei=class extends(Je(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Ze(this.hass),this.zones=await qe(this.hass),this.modules=await Ke(this.hass),this.mappings=await Xe(this.hass))}handleCalculateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{calculate_all:!0})}handleUpdateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{update_all:!0})}handleResetAllBuckets(){this.hass&&this.hass.callApi("POST",_e+"/zones",{reset_all_buckets:!0})}handleClearAllWeatherdata(){this.hass&&this.hass.callApi("POST",_e+"/zones",{clear_all_weatherdata:!0})}handleAddZone(){const e={id:this.zones.length,name:this.nameInput.value,size:parseFloat(this.sizeInput.value),throughput:parseFloat(this.throughputInput.value),state:vi.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0};this.zones=[...this.zones,e],this.saveToHA(e)}handleEditZone(e,t){this.hass&&(this.zones=Object.values(this.zones).map(((a,i)=>i===e?t:a)),this.saveToHA(t))}handleRemoveZone(e,t){if(!this.hass)return;const a=Object.values(this.zones).at(t);var i,n;a&&(this.zones=this.zones.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.id.toString(),i.callApi("POST",_e+"/zones",{id:n,remove:!0})))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,update:!0})))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=Y`<option value="" ?selected=${void 0===t}">---${ni("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=Y`${a}
        ...
        >
          ...
          <path fill="#404040" d="${gi}" />
        </svg>`),e.state===vi.Automatic&&(i=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        </svg>`),e.state===vi.Automatic&&(n=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        </svg>`;let r,o="-",l=0;return null!=e.mapping&&(r=this.mappings.filter((t=>t.id===e.mapping))[0],null!=r&&null!=r.data_last_updated&&(o=Si(r.data_last_updated).format("YYYY-MM-DD HH:mm:ss"),null!=r.data&&(l=r.data.length))),Y`
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              >${ni("panels.zones.labels.last_calculated",this.hass.language)}:
              ${e.last_calculated?Si(e.last_calculated).format("YYYY-MM-DD HH:mm:ss"):"-"}</label
            >
          </div>
          <div class="card-content">
          ...
          <div class="card-content">
            ...
            <div class="zoneline">
              ...
              <input
                ...
                type="number"
                .value="${e.duration}"
                ?readonly="${e.state===vi.Disabled||e.state===vi.Automatic}"
    ...
    `}};n([pe()],Ei.prototype,"config",void 0),n([pe({type:Array})],Ei.prototype,"zones",void 0),n([pe({type:Array})],Ei.prototype,"modules",void 0),n([pe({type:Array})],Ei.prototype,"mappings",void 0),n([me("#nameInput")],Ei.prototype,"nameInput",void 0),n([me("#sizeInput")],Ei.prototype,"sizeInput",void 0),n([me("#throughputInput")],Ei.prototype,"throughputInput",void 0),Ei=n([he("smart-irrigation-view-zones")],Ei);let $i=class extends(Je(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e;this.hass&&(this.config=await Ze(this.hass),this.zones=await qe(this.hass),this.modules=await Ke(this.hass),this.allmodules=await(e=this.hass,e.callWS({type:_e+"/allmodules"})))}handleAddModule(){const e=this.allmodules.filter((e=>e.name==this.moduleInput.selectedOptions[0].text))[0];if(!e)return;const t={id:this.modules.length,name:this.moduleInput.selectedOptions[0].text,description:e.description,config:e.config,schema:e.schema};this.modules=[...this.modules,t],this.saveToHA(t)}handleRemoveModule(e,t){var a,i;(this.modules=this.modules.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",_e+"/modules",{id:i,remove:!0}))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/modules",a),this._fetchData())}renderModule(e,t){if(this.hass){const a=this.zones.filter((t=>t.module===e.id)).length;return Y`
      ...
      >${s} </label
    `;if(console.log("name: "+n,"val: "+r),"boolean"==i.type)o=Y`${o}<input
          type="checkbox"
          id="${n+e}"
          .checked=${r}
    ...
    `}};n([pe()],$i.prototype,"config",void 0),n([pe({type:Array})],$i.prototype,"zones",void 0),n([pe({type:Array})],$i.prototype,"modules",void 0),n([pe({type:Array})],$i.prototype,"allmodules",void 0),n([me("#moduleInput")],$i.prototype,"moduleInput",void 0),$i=n([he("smart-irrigation-view-modules")],$i);let Ai=class extends(Je(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Ze(this.hass),this.zones=await qe(this.hass),this.mappings=await Xe(this.hass))}handleAddMapping(){const e={[ke]:"",[Me]:"",[Oe]:"",[Te]:"",[He]:"",[De]:"",[xe]:"",[Ne]:""},t={id:this.mappings.length,name:this.mappingNameInput.value,mappings:e};this.mappings=[...this.mappings,t],this.saveToHA(t),this._fetchData()}handleRemoveMapping(e,t){var a,i;(this.mappings=this.mappings.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",_e+"/mappings",{id:i,remove:!0}))}handleEditMapping(e,t){this.mappings=Object.values(this.mappings).map(((a,i)=>i===e?t:a)),this.saveToHA(t)}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/mappings",a))}renderMapping(e,t){if(this.hass){const a=this.zones.filter((t=>t.mapping===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            <label for="name${e.id}"
      ...
      </option>`}return Y``}renderUnitOptionsForMapping(e,t){if(this.hass&&this.config){const a=function(e){switch(e){case ke:case xe:return[{unit:"°C",system:Ae},{unit:"°F",system:$e}];case Te:case Me:return[{unit:"mm",system:Ae},{unit:"in",system:$e}];case Oe:return[{unit:"%",system:[Ae,$e]}];case He:return[{unit:"millibar",system:Ae},{unit:"hPa",system:Ae},{unit:"psi",system:$e},{unit:"inch Hg",system:$e}];case Ne:return[{unit:"km/h",system:Ae},{unit:"meter/s",system:Ae},{unit:"mile/h",system:$e}];case De:return[{unit:"W/m2",system:Ae},{unit:"MJ/day/m2",system:Ae},{unit:"W/sq ft",system:$e},{unit:"MJ/day/sq ft",system:$e}];default:return[]}}(e);let i=Y``,n=t[je];const s=this.config.units;return t[je]||a.forEach((function(e){"string"==typeof e.system?s==e.system&&(n=e.unit):e.system.forEach((function(t){s==t.system&&(n=e.unit)}))})),a.forEach((function(e){i=Y`${i}
    ...
    `}};n([pe()],Ai.prototype,"config",void 0),n([pe({type:Array})],Ai.prototype,"zones",void 0),n([pe({type:Array})],Ai.prototype,"mappings",void 0),n([me("#mappingNameInput")],Ai.prototype,"mappingNameInput",void 0),Ai=n([he("smart-irrigation-view-mappings")],Ai);const ki=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a};e.SmartIrrigationPanel=class extends le{async firstUpdated(){window.addEventListener("location-changed",(()=>{window.location.pathname.includes("smart-irrigation")&&this.requestUpdate()})),await ye(),this.requestUpdate()}render(){if(!customElements.get("ha-panel-config"))return Y` loading... `;const e=ki();return Y`
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2023.9.0-beta18"}</div>
        </div>
...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],Mi.prototype,"_params",void 0),Mi=n([he("error-dialog")],Mi);var Oi=Object.freeze({__proto__:null,get ErrorDialog(){return Mi}});Object.defineProperty(e,"__esModule",{value:!0})}({});
