!(function (e) {
  ...
  const ye = async () => {
    ...
    Ke = "duration",
    Xe = "bucket",
    Je = (e) => e.callWS({ type: _e + "/config" }),
    Qe = (e) => e.callWS({ type: _e + "/zones" }),
    et = (e) => e.callWS({ type: _e + "/modules" }),
    tt = (e) => e.callWS({ type: _e + "/mappings" }),
    at = (e) => {
      class t extends e {
        connectedCallback() {
  ...
  var it,
    ...
    sa = { common: ea, defaults: ta, module: aa, calcmodules: ia, panels: na },
    ra = Object.freeze({
      __proto__: null,
      common: ea,
      defaults: ta,
    ...
    for (var t = {}, a = 0, n = e; a < n.length; a++) {
      ...
      switch (s.stem) {
        ...
        case "integer-width":
          ...
          s.options[0].replace(Da, function (e, a, i, n, s, r) {
      ...
      if (Ha.test(s.stem)) t.minimumIntegerDigits = s.stem.length;
      else if (xa.test(s.stem)) {
        if (s.options.length > 1)
          throw new RangeError(
            "Fraction-precision stems only accept a single optional option"
          );
        s.stem.replace(xa, function (e, a, i, n, s, r) {
          return (
            "*" === i
        ...
        "w" === r
          ...
          : r && (t = i(i({}, t), Pa(r)));
      } else if (za.test(s.stem)) t = i(i({}, t), Pa(s.stem));
      else {
        var o = Na(s.stem);
        o && (t = i(i({}, t), o));
        var l = Ca(s.stem);
  ...
  function Ra(e) {
    ...
    return (
      ...
      (Ia[a || ""] || Ia[i || ""] || Ia["".concat(i, "-001")] || Ia["001"])[0]
    );
  }
  var Ua = new RegExp("^".concat(Aa.source, "*")),
  ...
  var Ga = !!String.prototype.startsWith,
    ...
    Za = !!String.prototype.codePointAt,
    qa = !!String.prototype.trimStart,
    Ka = !!String.prototype.trimEnd,
    Xa = !!Number.isSafeInteger
  ...
  try {
    Ja =
      "a" ===
      (null ===
        (Ba = ri("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
          "a"
        )) || void 0 === Ba
        ? void 0
        : Ba[0]);
  ...
  if (Ja) {
    var oi = ri("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    Qa = function (e, t) {
      var a;
      return (
        (oi.lastIndex = t),
        null !== (a = oi.exec(e)[1]) && void 0 !== a ? a : ""
      );
    };
  } else
    Qa = function (e, t) {
  ...
  var li = (function () {
    ...
    return (
          ...
          if (123 === n) {
            ...
            if (35 !== n || ("plural" !== t && "selectordinal" !== t)) {
              if (60 === n && !this.ignoreTag && 47 === this.peek()) {
                if (a) break;
                return this.error(
                  it.UNMATCHED_CLOSING_TAG,
                  Va(this.clonePosition(), this.clonePosition())
                );
              }
              if (60 === n && !this.ignoreTag && ui(this.peek() || 0)) {
              ...
              this.bump(),
                i.push({
                  type: nt.pound,
                  location: Va(r, this.clonePosition()),
                });
            }
          }
        }
        ...
        if ((this.bumpSpace(), this.bumpIf("/>")))
          return {
            val: {
              type: nt.literal,
              value: "<".concat(i, "/>"),
              location: Va(a, this.clonePosition()),
            },
            err: null,
          };
        if (this.bumpIf(">")) {
          ...
          if (this.bumpIf("</")) {
            if (this.isEOF() || !ui(this.char()))
              return this.error(it.INVALID_TAG, Va(r, this.clonePosition()));
            var o = this.clonePosition();
            return i !== this.parseTagName()
              ? this.error(
                  it.UNMATCHED_CLOSING_TAG,
                  Va(o, this.clonePosition())
                )
              : (this.bumpSpace(),
                this.bumpIf(">")
                  ? {
                  ...
                  : this.error(it.INVALID_TAG, Va(r, this.clonePosition())));
          }
          return this.error(it.UNCLOSED_TAG, Va(a, this.clonePosition()));
        }
        return this.error(it.INVALID_TAG, Va(a, this.clonePosition()));
      }),
      ...
      (e.prototype.parseLiteral = function (e, t) {
        ...
        var o = Va(a, this.clonePosition());
        return { val: { type: nt.literal, value: i, location: o }, err: null };
      }),
      (e.prototype.tryParseLeftAngleBracket = function () {
        return this.isEOF() ||
          60 !== this.char() ||
          (!this.ignoreTag && (ui((e = this.peek() || 0)) || 47 === e))
          ? null
          : (this.bump(), "<");
        var e;
      }),
      ...
      (e.prototype.parseArgument = function (e, t) {
        ...
        if ((this.bump(), this.bumpSpace(), this.isEOF()))
          return this.error(
            it.EXPECT_ARGUMENT_CLOSING_BRACE,
            Va(a, this.clonePosition())
          );
        if (125 === this.char())
          return (
            this.bump(),
            this.error(it.EMPTY_ARGUMENT, Va(a, this.clonePosition()))
          );
        var i = this.parseIdentifierIfPossible().value;
        if (!i)
          return this.error(it.MALFORMED_ARGUMENT, Va(a, this.clonePosition()));
      ...
      (e.prototype.parseIdentifierIfPossible = function () {
        var e = this.clonePosition(),
          ...
          i = t + a.length;
        return (
          this.bumpTo(i), { value: a, location: Va(e, this.clonePosition()) }
        );
      }),
      (e.prototype.parseArgumentOptions = function (e, t, a, n) {
        ...
        switch (o) {
          case "":
            return this.error(it.EXPECT_ARGUMENT_TYPE, Va(r, l));
          case "number":
          case "date":
          case "time":
            this.bumpSpace();
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (m = si(b.val)).length)
                return this.error(
                  it.EXPECT_ARGUMENT_STYLE,
                  Va(this.clonePosition(), this.clonePosition())
                );
              u = { style: m, styleLocation: Va(d, this.clonePosition()) };
            }
            if ((y = this.tryParseArgumentClose(n)).err) return y;
            var c = Va(n, this.clonePosition());
            if (u && ei(null == u ? void 0 : u.style, "::", 0)) {
              ...
              if (0 === h.length)
                return this.error(it.EXPECT_DATE_TIME_SKELETON, c);
              var p = h;
              this.locale &&
                (p = (function (e, t) {
              ...
              var m = {
                ...
                parsedOptions: this.shouldParseSkeletons ? Ta(p) : {},
              };
              return {
                val: {
            ...
            return {
              val: {
                type:
                  "number" === o ? nt.number : "date" === o ? nt.date : nt.time,
                value: a,
                location: c,
                style:
          ...
          case "select":
            ...
            if ((this.bumpSpace(), !this.bumpIf(",")))
              return this.error(
                it.EXPECT_SELECT_ARGUMENT_OPTIONS,
                Va(g, i({}, g))
              );
            this.bumpSpace();
            ...
            if ("select" !== o && "offset" === f.value) {
              if (!this.bumpIf(":"))
                return this.error(
                  it.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                  Va(this.clonePosition(), this.clonePosition())
                );
              var b;
              if (
                ...
                (b = this.tryParseDecimalInteger(
                  it.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                  it.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE
                )).err)
              )
                return b;
              this.bumpSpace(),
          ...
          default:
            return this.error(it.INVALID_ARGUMENT_TYPE, Va(r, l));
        }
      }),
        ...
        for (var e = 0, t = this.clonePosition(); !this.isEOF(); ) {
          switch (this.char()) {
            case 39:
              ...
              if (!this.bumpUntil("'"))
                return this.error(
                  it.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                  Va(a, this.clonePosition())
                );
              this.bump();
              break;
      ...
      (e.prototype.parseNumberSkeletonFromString = function (e, t) {
        ...
        try {
          a = (function (e) {
            ...
            for (
              var t = e.split(Oa).filter(function (e) {
                  return e.length > 0;
                }),
                a = [],
                i = 0,
      ...
      (e.prototype.tryParsePluralOrSelectOptions = function (e, t, a, i) {
        for (
          ...
          if (0 === l.length) {
            ...
            var c = this.tryParseDecimalInteger(
              it.EXPECT_PLURAL_ARGUMENT_SELECTOR,
              it.INVALID_PLURAL_ARGUMENT_SELECTOR
            );
            if (c.err) return c;
            (u = Va(d, this.clonePosition())),
              (l = this.message.slice(d.offset, this.offset()));
          }
          if (o.has(l))
            return this.error(
              "select" === t
                ? it.DUPLICATE_SELECT_ARGUMENT_SELECTOR
                : it.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
              u
            );
          ...
          if (!this.bumpIf("{"))
            return this.error(
              "select" === t
                ? it.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
                : it.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
              Va(this.clonePosition(), this.clonePosition())
            );
          ...
          if (m.err) return m;
          r.push([l, { value: p.val, location: Va(h, this.clonePosition()) }]),
            o.add(l),
            this.bumpSpace(),
        ...
        return 0 === r.length
          ? this.error(
              "select" === t
                ? it.EXPECT_SELECT_ARGUMENT_SELECTOR
                : it.EXPECT_PLURAL_ARGUMENT_SELECTOR,
              Va(this.clonePosition(), this.clonePosition())
            )
          : this.requiresOtherClause && !s
          ? this.error(
              it.MISSING_OTHER_CLAUSE,
              Va(this.clonePosition(), this.clonePosition())
            )
          : { val: r, err: null };
      }),
  ...
  function gi(e, t) {
    var a = t && t.cache ? t.cache : Si,
      i = t && t.serializer ? t.serializer : _i;
    return (t && t.strategy ? t.strategy : yi)(e, { cache: a, serializer: i });
  }
  function fi(e, t, a, i) {
    var n,
      s =
  ...
  var ki,
    ...
    Ei = {
      variadic: function (e, t) {
        return bi(e, this, vi, t.cache.create(), t.serializer);
      },
      monadic: function (e, t) {
        return bi(e, this, fi, t.cache.create(), t.serializer);
      },
    };
  !(function (e) {
  ...
  function zi(e, t, a, i, n, s, r) {
    if (1 === e.length && ga(e[0]))
      return [{ type: $i.literal, value: e[0].value }];
    for (var o = [], l = 0, u = e; l < u.length; l++) {
      var d = u[l];
      if (ga(d)) o.push({ type: $i.literal, value: d.value });
      else if (ka(d))
        "number" == typeof s &&
          o.push({ type: $i.literal, value: a.getNumberFormat(t).format(s) });
      else {
        var c = d.value;
        if (!n || !(c in n)) throw new Oi(c, r);
        var h = n[c];
        if (fa(d))
          (h && "string" != typeof h && "number" != typeof h) ||
            (h = "string" == typeof h || "number" == typeof h ? String(h) : ""),
            o.push({
              type: "string" == typeof h ? $i.literal : $i.object,
              value: h,
            });
        else if (ba(d)) {
          var p =
          ...
          if (Sa(d)) {
            var m = d.children,
              g = d.value,
              f = n[g];
            if (!xi(f)) throw new Ti(g, "function", r);
            var v = f(
              zi(m, t, a, i, n, s).map(function (e) {
                return e.value;
              })
            );
            Array.isArray(v) || (v = [v]),
          ...
          if (_a(d)) {
            if (!(b = d.options[h] || d.options.other))
              throw new Mi(d.value, h, Object.keys(d.options), r);
            ...
            if (!b) throw new Mi(d.value, h, Object.keys(d.options), r);
    ...
    return (function (e) {
      return e.length < 2
        ...
        : e.reduce(function (e, t) {
            var a = e[e.length - 1];
            return (
              a && a.type === $i.literal && t.type === $i.literal
                ? (a.value += t.value)
                : e.push(t),
              e
            );
  ...
  var Pi = (function () {
          ...
          (this.formatters =
              ...
              (r = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: gi(
                ...
                { cache: Hi(r.number), strategy: Ei.variadic }
              ),
              getDateTimeFormat: gi(
                ...
                { cache: Hi(r.dateTime), strategy: Ei.variadic }
              ),
              getPluralRules: gi(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                ...
                { cache: Hi(r.pluralRules), strategy: Ei.variadic }
              ),
            }));
      }
      return (
    ...
    Ni = Pi;
  const Ci = { de: pt, en: wt, es: Ot, fr: jt, it: Gt, nl: Qt, no: ra, sk: ma };
  function ji(e, t, ...a) {
    const i = t.replace(/['"]+/g, "");
    let n;
    try {
      n = e.split(".").reduce((e, t) => e[t], Ci[i]);
    } catch (t) {
      n = e.split(".").reduce((e, t) => e[t], Ci.en);
    }
    if (
      (void 0 === n && (n = e.split(".").reduce((e, t) => e[t], Ci.en)),
      !a.length)
    )
      return n;
    const s = {};
   ...
   */ class Ii extends Bi {
    constructor(e) {
      if ((super(e), (this.et = G), e.type !== Li))
        throw Error(
  ...
  function Vi(e, t) {
    switch (t) {
      case Xe:
        return e.units == $e ? Y`${Ri("mm")}` : Y`${Ri("in")}`;
      case Ze:
        return e.units == $e ? Y`${Ri("m<sup>2</sup>")}` : Y`${Ri("sq ft")}`;
      case qe:
        return e.units == $e ? Y`${Ri("l/minute")}` : Y`${Ri("gal/minute")}`;
      default:
        return Y``;
    }
  }
...
`;
  ...
  let qi = class extends at(le) {
    ...
    async _fetchData() {
      var e, t;
      this.hass &&
        ((this.config = await Je(this.hass)),
        (this.data =
          ((e = this.config),
          (t = [
            "calctime",
      ...
      this.hass.language)}">${t}</ha-card>`);
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autoclearenabled: Ui(e.target.value) });
            }}"
...
<input
            ...
            @change="${(e) => {
              this.saveData({ continuousupdates: Ui(e.target.value) });
            }}"
  ...
  var Ki;
  n([pe()], qi.prototype, "narrow", void 0),
    n([pe()], qi.prototype, "path", void 0),
    n([pe()], qi.prototype, "data", void 0),
    n([pe()], qi.prototype, "config", void 0),
    (qi = n([de("smart-irrigation-view-general")], qi)),
    (function (e) {
      (e.Disabled = "disabled"),
        (e.Manual = "manual"),
  ...
  var en = Xi(Qi.exports);
  let tn = class extends at(le) {
    constructor() {
      super(...arguments),
        (this.zones = []),
        (this.modules = []),
    ...
    async _fetchData() {
      this.hass &&
        ...
        (this.modules = await et(this.hass)),
        (this.mappings = await tt(this.hass)));
    }
    ...
    renderTheOptions(e, t) {
      if (this.hass) {
        let a = Y`<option value="" ?selected=${void 0 === t}">---${ji(
      ...
      if (this.hass) {
        ...
        const s = Y` <svg
          ...
          @click="${() =>
            this.handleEditZone(
              t,
              Object.assign(Object.assign({}, e), { [Xe]: 0 })
            )}"}"
        >
          <title>
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              ...
              ${
                e.last_calculated
                  ? en(e.last_calculated).format("YYYY-MM-DD HH:mm:ss")
                  : "-"
              }</label
            >
          </div>
          <div class="card-content">
            <label for="last_updated${t}"
              ...
              ${
                e.last_updated
                  ? en(e.last_updated).format("YYYY-MM-DD HH:mm:ss")
                  : "-"
              }</label
            >
          </div>
          ...
          <div class="card-content">
            ...
            <div class="zoneline">
              ...
              <input
                ...
                .value="${e.duration}"
                ?readonly="${
                  e.state === Ki.Disabled || e.state === Ki.Automatic
                }"
                @input="${(a) =>
                  this.handleEditZone(
                    t,
      ...
      return this.hass && this.config
        ...
        <ha-card header="${ji("panels.zones.title", this.hass.language)}">
          ...
          <ha-card header="${ji(
            ...
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${ji(
              ...
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${ji(
            ...
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${ji(
            "panels.zones.cards.zone-actions.actions.update-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleCalculateAllZones}">${ji(
            "panels.zones.cards.zone-actions.actions.calculate-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleResetAllBuckets}">${ji(
            "panels.zones.cards.zone-actions.actions.reset-all-buckets",
            this.hass.language
          )}</button>
      <button @click="${this.handleClearAllWeatherdata}">${ji(
  ...
  n([pe()], tn.prototype, "config", void 0),
    ...
    n([pe({ type: Array })], tn.prototype, "mappings", void 0),
    n([me("#nameInput")], tn.prototype, "nameInput", void 0),
    n([me("#sizeInput")], tn.prototype, "sizeInput", void 0),
    n([me("#throughputInput")], tn.prototype, "throughputInput", void 0),
    (tn = n([de("smart-irrigation-view-zones")], tn));
  let an = class extends at(le) {
    constructor() {
      super(...arguments),
        (this.zones = []),
        (this.modules = []),
        ...
        >
          ${Object.entries(i.options).map(
            ([e, a]) => Y`<option
              ...
              >
                ${ji(
                  "panels.modules.cards.module.translated-options." + Yi(a, 1),
                  t
                )}
              </option>`
          )}
  ...
  n([pe()], an.prototype, "config", void 0),
    ...
    n([pe({ type: Array })], an.prototype, "modules", void 0),
    n([pe({ type: Array })], an.prototype, "allmodules", void 0),
    n([me("#moduleInput")], an.prototype, "moduleInput", void 0),
    (an = n([de("smart-irrigation-view-modules")], an));
  let nn = class extends at(le) {
    constructor() {
    ...
    renderPressureTypes(e, t) {
      if (this.hass && this.config) {
        ...
        >
          ${ji(
            "panels.mappings.cards.mapping.pressure_types." + Ie,
            this.hass.language
          )}
        </option>`),
          e
  ...
  n([pe()], nn.prototype, "config", void 0),
    n([pe({ type: Array })], nn.prototype, "zones", void 0),
    n([pe({ type: Array })], nn.prototype, "mappings", void 0),
    n([me("#mappingNameInput")], nn.prototype, "mappingNameInput", void 0),
    (nn = n([de("smart-irrigation-view-mappings")], nn));
  const sn = () => {
    const e = (e) => {
        let t = {};
    ...
    render() {
      ...
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2024.8.1-beta-11"}</div>
        </div>
  ...
  n([pe({ attribute: !1 })], rn.prototype, "hass", void 0),
    n(
      [
        (function (e) {
          return pe({ ...e, state: !0 });
