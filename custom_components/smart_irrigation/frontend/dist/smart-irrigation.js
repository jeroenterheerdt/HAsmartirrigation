...
`;var Wi="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",Zi="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";let qi=class extends(at(le)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e,t;this.hass&&(this.config=await Je(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{}))}firstUpdated(){(async()=>{await ye()})()}render(){if(this.hass&&this.config&&this.data){let e=Y` <div class="card-content">
          <svg
          ...
          >
            >
            <title>
              ${ji("panels.zones.actions.information",this.hass.language)}
            </title>
        ...
        <div class="card-content">
          <label class="hidden" id="autocalcdescription">
            ${ji("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autocalcenabled"
            >${ji("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autocalcon"
          ...
          /><label for="autocalcon"
            >${ji("common.labels.yes",this.hass.language)}</label
          >
          <input
            type="radio"
            id="autocalcoff"
          ...
          /><label for="autocalcoff"
            >${ji("common.labels.no",this.hass.language)}</label
          >
        </div>`;this.data.autocalcenabled&&(e=Y`${e}
          <div class="card-content">
            <label for="calctime"
              >${ji("panels.general.cards.automatic-duration-calculation.labels.auto-calc-time",this.hass.language)}</label
            >:
            <input
              id="calctime"
              type="text"
        ...
        header="${ji("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let t=Y` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autoupdatedescription">
            ${ji("panels.general.cards.automatic-update.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autoupdateenabled"
            >${ji("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autoupdateon"
          ...
          <div class="card-content">
            <label for="autoupdateinterval"
              >${ji("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}:</label
            >
            <input
            ...
            >
              ...
              >
                ${ji("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
              </option>
              <option
                value="${ke}"
                ?selected="${this.data.autoupdateschedule===ke}"
              >
                ${ji("panels.general.cards.automatic-update.options.hours",this.hass.language)}
              </option>
              <option
                value="${Se}"
                ?selected="${this.data.autoupdateschedule===Se}"
              >
                ${ji("panels.general.cards.automatic-update.options.days",this.hass.language)}
              </option>
            </select>
          </div>
          <div class="card-content">
            <label for="updatedelay"
              >${ji("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
              (s):</label
            >
            <input
              id="updatedelay"
            ...
            />
          </div>`),t=Y`<ha-card header="${ji("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;let a=Y` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autocleardescription">
            ${ji("panels.general.cards.automatic-clear.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autoclearenabled"
            >${ji("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autoclearon"
          ...
          <div class="card-content">
            <label for="calctime"
              >${ji("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language)}</label
            >:
            <input
              id="cleardatatime"
              type="text"
            ...
            />
          </div>`),a=Y`<ha-card header="${ji("panels.general.cards.automatic-clear.header",this.hass.language)}" >${a}</div></ha-card>`;let i=Y`<ha-card
        header="${ji("panels.general.cards.continuousupdates.header",this.hass.language)}"
      >
        <div class="card-content">
          <svg
            style="width:24px;height:24px"
        ...
        <div class="card-content">
          <label class="hidden" id="continuousupdatesdescription">
            ${ji("panels.general.cards.continuousupdates.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="continuousupdates"
            >${ji("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}:</label
          >
<input
            type="radio"
            ...
            @change="${e=>{this.saveData({continuousupdates:Ui(e.target.value)})}}"
          ...
          header="${ji("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${ji("panels.general.description",this.hass.language)}
          </div> </ha-card
...
i.version="2.29.4",n(Za),i.fn=us,i.min=Ja,i.max=Qa,i.now=ei,i.utc=m,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ma,i.invalid=b,i.duration=Mi,i.isMoment=S,i.weekdays=ys,i.parseZone=cs,i.localeData=va,i.isDuration=ri,i.monthsShort=bs,i.weekdaysMin=ws,i.defineLocale=ga,i.updateLocale=fa,i.locales=ba,i.weekdaysShort=_s,i.normalizeUnits=ie,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Ii,i.prototype=us,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i}()}(Qi);var en=Xi(Qi.exports);let tn=class extends(at(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Je(this.hass),this.zones=await Qe(this.hass),this.modules=await et(this.hass),this.mappings=await tt(this.hass))}handleCalculateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{calculate_all:!0})}handleUpdateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{update_all:!0})}handleResetAllBuckets(){this.hass&&this.hass.callApi("POST",_e+"/zones",{reset_all_buckets:!0})}handleClearAllWeatherdata(){this.hass&&this.hass.callApi("POST",_e+"/zones",{clear_all_weatherdata:!0})}handleAddZone(){const e={name:this.nameInput.value,size:parseFloat(this.sizeInput.value),throughput:parseFloat(this.throughputInput.value),state:Ki.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0};this.zones=[...this.zones,e],this.saveToHA(e)}handleEditZone(e,t){this.hass&&(this.zones=Object.values(this.zones).map(((a,i)=>i===e?t:a)),this.saveToHA(t))}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;var i,n;Object.values(this.zones).at(t)&&null!=a&&(this.zones=this.zones.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/zones",{id:n,remove:!0})))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,update:!0})))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=Y`<option value="" ?selected=${void 0===t}">---${ji("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=Y`${a}
        ...
        >
          ...
          <path fill="#404040" d="${Zi}" />
        </svg>`),e.state===Ki.Automatic&&(i=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
          @click="${()=>this.handleCalculateZone(t)}"
        >
          <title>
            ${ji("panels.zones.actions.calculate",this.hass.language)}
          </title>
        ...
        </svg>`),e.state===Ki.Automatic&&(n=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
          @click="${()=>this.handleUpdateZone(t)}"
        >
          <title>
            ${ji("panels.zones.actions.update",this.hass.language)}
          </title>
        ...
        >
          <title>
            ${ji("panels.zones.actions.reset-bucket",this.hass.language)}
          </title>
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              >${ji("panels.zones.labels.last_calculated",this.hass.language)}:
              ${e.last_calculated?en(e.last_calculated).format("YYYY-MM-DD HH:mm:ss"):"-"}</label
            >
          </div>
          <div class="card-content">
            <label for="last_updated${t}"
              >${ji("panels.zones.labels.data-last-updated",this.hass.language)}:
              ${e.last_updated?en(e.last_updated).format("YYYY-MM-DD HH:mm:ss"):"-"}</label
            >
          </div>
          <div class="card-content">
            <label for="last_updated${t}"
              >${ji("panels.zones.labels.data-number-of-data-points",this.hass.language)}:
              ${e.number_of_data_points}</label
            >
          </div>
          <div class="card-content">
            <label for="name${t}"
              >${ji("panels.zones.labels.name",this.hass.language)}:</label
            >
            <input
              id="name${t}"
              type="text"
            ...
            <div class="zoneline">
              <label for="size${t}"
                >${ji("panels.zones.labels.size",this.hass.language)}
                (${Vi(this.config,Ze)}):</label
              >
            ...
            <div class="zoneline">
              <label for="throughput${t}"
                >${ji("panels.zones.labels.throughput",this.hass.language)}
                (${Vi(this.config,qe)}):</label
              >
              <input
                class="shortinput"
                id="throughput${t}"
            ...
            <div class="zoneline">
              <label for="state${t}"
                >${ji("panels.zones.labels.state",this.hass.language)}:</label
              >
              <select
                required
                id="state${t}"
              ...
              >
                <option
                  value="${Ki.Automatic}"
                  ?selected="${e.state===Ki.Automatic}"
                >
                  ${ji("panels.zones.labels.states.automatic",this.hass.language)}
                </option>
                <option
                  value="${Ki.Disabled}"
                  ?selected="${e.state===Ki.Disabled}"
                >
                  ${ji("panels.zones.labels.states.disabled",this.hass.language)}
                </option>
                <option
                  value="${Ki.Manual}"
                  ?selected="${e.state===Ki.Manual}"
                >
                  ${ji("panels.zones.labels.states.manual",this.hass.language)}
                </option>
              </select>
              <label for="module${t}"
                >${ji("common.labels.module",this.hass.language)}:</label
              >
              ...
              <label for="module${t}"
                >${ji("panels.zones.labels.mapping",this.hass.language)}:</label
              >
            ...
            <div class="zoneline">
              <label for="bucket${t}"
                >${ji("panels.zones.labels.bucket",this.hass.language)}
                (${Vi(this.config,Xe)}):</label
              >
              <input
                class="shortinput"
                id="bucket${t}"
              ...
              <label for="maximum-bucket${t}"
                >${ji("panels.zones.labels.maximum-bucket",this.hass.language)}
                (${Vi(this.config,Xe)}):</label
              >
              <input
                class="shortinput"
              ...
              <label for="lead_time${t}"
                >${ji("panels.zones.labels.lead-time",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
              ...
              <label for="maximum-duration${t}"
                >${ji("panels.zones.labels.maximum-duration",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
            ...
            <div class="zoneline">
              <label for="multiplier${t}"
                >${ji("panels.zones.labels.multiplier",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="multiplier${t}"
              ...
              <label for="duration${t}"
                >${ji("panels.zones.labels.duration",this.hass.language)}
                (${"s"}):</label
              >
              <input
                class="shortinput"
                ...
                type="number"
                .value="${e.duration}"
                ?readonly="${e.state===Ki.Disabled||e.state===Ki.Automatic}"
            ...
            <div class="zoneline">
              ...
              >
                <title>
                  ${ji("common.actions.delete",this.hass.language)}
                </title>
      ...
      `}return Y``}toggleExplanation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#calcresults"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="explanation")}render(){return this.hass&&this.config?Y`
        <ha-card header="${ji("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${ji("panels.zones.description",this.hass.language)}
          </div>
        </ha-card>
          <ha-card header="${ji("panels.zones.cards.add-zone.header",this.hass.language)}">
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${ji("panels.zones.labels.name",this.hass.language)}:</label>
              <input id="nameInput" type="text"/>
              </div>
              <div class="zoneline">
              <label for="sizeInput">${ji("panels.zones.labels.size",this.hass.language)} (${Vi(this.config,Ze)}):</label>
              <input class="shortinput" id="sizeInput" type="number"/>
              </div>
              <div class="zoneline">
              <label for="throughputInput">${ji("panels.zones.labels.throughput",this.hass.language)} (${Vi(this.config,qe)}):</label>
              <input id="throughputInput" class="shortinput" type="number"/>
              </div>
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${ji("panels.zones.cards.add-zone.actions.add",this.hass.language)}</button>
              </div>
            </div>
            </ha-card>
            <ha-card header="${ji("panels.zones.cards.zone-actions.header",this.hass.language)}">
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${ji("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}</button>
                <button @click="${this.handleCalculateAllZones}">${ji("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}</button>
                <button @click="${this.handleResetAllBuckets}">${ji("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}</button>
      <button @click="${this.handleClearAllWeatherdata}">${ji("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}</button>
            </div>
          </ha-card>
    ...
    `}};n([pe()],tn.prototype,"config",void 0),n([pe({type:Array})],tn.prototype,"zones",void 0),n([pe({type:Array})],tn.prototype,"modules",void 0),n([pe({type:Array})],tn.prototype,"mappings",void 0),n([me("#nameInput")],tn.prototype,"nameInput",void 0),n([me("#sizeInput")],tn.prototype,"sizeInput",void 0),n([me("#throughputInput")],tn.prototype,"throughputInput",void 0),tn=n([de("smart-irrigation-view-zones")],tn);let an=class extends(at(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e;this.hass&&(this.config=await Je(this.hass),this.zones=await Qe(this.hass),this.modules=await et(this.hass),this.allmodules=await(e=this.hass,e.callWS({type:_e+"/allmodules"})))}handleAddModule(){const e=this.allmodules.filter((e=>e.name==this.moduleInput.selectedOptions[0].text))[0];if(!e)return;const t={name:this.moduleInput.selectedOptions[0].text,description:e.description,config:e.config,schema:e.schema};this.modules=[...this.modules,t],this.saveToHA(t)}handleRemoveModule(e,t){const a=this.modules[t].id;var i,n;(this.modules=this.modules.filter(((e,a)=>a!==t)),this.hass&&null!=a)&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/modules",{id:n,remove:!0}))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/modules",a),this._fetchData())}renderModule(e,t){if(this.hass){const a=this.zones.filter((t=>t.module===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            <div class="moduledescription${t}">${e.description}</div>
            <div class="moduleconfig">
              <label class="subheader"
                >${ji("panels.modules.cards.module.labels.configuration",this.hass.language)}
                (*
                ${ji("panels.modules.cards.module.labels.required",this.hass.language)})</label
              >
              ${e.schema?Object.entries(e.schema).map((([e])=>this.renderConfig(t,e))):null}
            </div>
            ${a?Y` ${ji("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}`:Y` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
    ...
    `;if("boolean"==i.type)o=Y`${o}<input
        ...
        >
          ${Object.entries(i.options).map((([e,a])=>Y`<option
                ...
                ?selected="${r===Yi(a,0)}"
              >
                ${ji("panels.modules.cards.module.translated-options."+Yi(a,1),t)}
              </option>`))}
        ...
        <ha-card
          header="${ji("panels.modules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${ji("panels.modules.description",this.hass.language)}
          </div>
        </ha-card>
        <ha-card
          header="${ji("panels.modules.cards.add-module.header",this.hass.language)}"
        >
          <div class="card-content">
            ...
            <button @click="${this.handleAddModule}">
              ${ji("panels.modules.cards.add-module.actions.add",this.hass.language)}
            </button>
          </div>
        </ha-card>
    ...
    `}};n([pe()],an.prototype,"config",void 0),n([pe({type:Array})],an.prototype,"zones",void 0),n([pe({type:Array})],an.prototype,"modules",void 0),n([pe({type:Array})],an.prototype,"allmodules",void 0),n([me("#moduleInput")],an.prototype,"moduleInput",void 0),an=n([de("smart-irrigation-view-modules")],an);let nn=class extends(at(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Je(this.hass),this.zones=await Qe(this.hass),this.mappings=await tt(this.hass))}handleAddMapping(){const e={[Ae]:"",[Me]:"",[Te]:"",[Oe]:"",[xe]:"",[ze]:"",[De]:"",[He]:"",[Pe]:""},t={name:this.mappingNameInput.value,mappings:e};this.mappings=[...this.mappings,t],this.saveToHA(t),this._fetchData()}handleRemoveMapping(e,t){const a=this.mappings[t].id;var i,n;null!=a&&(this.mappings=this.mappings.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/mappings",{id:n,remove:!0})))}handleEditMapping(e,t){this.mappings=Object.values(this.mappings).map(((a,i)=>i===e?t:a)),console.log(t),this.saveToHA(t)}saveToHA(e){if(!this.hass)return;let t=!0;for(const a in e.mappings)if(null!=e.mappings[a].sensorentity&&""!=e.mappings[a].sensorentity.trim()&&(e.mappings[a].sensorentity=e.mappings[a].sensorentity.trim(),!(e.mappings[a].sensorentity in this.hass.states))){t=!1,Gi({body:{message:ji("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+e.mappings[a].sensorentity},error:ji("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},this.shadowRoot.querySelector("ha-card"));break}var a,i;t&&(a=this.hass,i=e,a.callApi("POST",_e+"/mappings",i))}renderMapping(e,t){if(this.hass){const a=this.zones.filter((t=>t.mapping===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            <label for="name${e.id}"
              >${ji("panels.mappings.labels.mapping-name",this.hass.language)}:</label
            >
            <input
              id="name${e.id}"
              type="text"
            ...
            ${a?Y`${ji("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}`:Y` <svg
                    style="width:24px;height:24px"
                    viewBox="0 0 24 24"
                    id="deleteZone${e.id}"
      ...
      <label for="${t+e}"
        >${ji("panels.mappings.cards.mapping.items."+t.toLowerCase(),this.hass.language)}
      </label>
    </div> `;if(o=Y`${o}
      <div class="mappingsettingline">
        <label for="${t+e+Ue}"
          >${ji("panels.mappings.cards.mapping.source",this.hass.language)}:</label
        >
      </div>`,t==Me||t==De)o=Y`${o}
        <input
          type="radio"
        ...
        /><label for="${t+e+Re}"
          >${ji("panels.mappings.cards.mapping.sources.none",this.hass.language)}</label
        ...
        /><label
          class="${l}"
          for="${t+e+Ne}"
          >${ji("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}</label
        >`}return o=Y`${o}
        <input
          type="radio"
          id="${t+e+Ce}"
        ...
        /><label for="${t+e+Ce}"
          >${ji("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}</label
        >
      </div>`,o=Y`${o}
      <input
        type="radio"
        ...
        @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ue]:a.target.value,[Ye]:""})})}))}"
      /><label for="${t+e+je}"
        >${ji("panels.mappings.cards.mapping.sources.static",this.hass.language)}</label
      >
    </div>`,r[Ue]==Ce&&(o=Y`${o}
        <div class="mappingsettingline">
          <label for="${t+e+Ye}"
            >${ji("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+Ye}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ve}"
            >${ji("panels.mappings.cards.mapping.static_value",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+Ve}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ge}"
            >${ji("panels.mappings.cards.mapping.input-units",this.hass.language)}:</label
          >
          <select
            type="text"
            id="${t+e+Ge}"
          ...
          <div class="mappingsettingline">
            <label for="${t+e+Le}"
              >${ji("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:</label
            >
            <select
              type="text"
              id="${t+e+Le}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Fe}"
            >${ji("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          </label>
          <select
            type="text"
            id="${t+e+Fe}"
          ...
          <label for="${t+e+Fe}"
            >${ji("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</label
          >
        </div>`),o=Y`<div class="mappingline">${o}</div>`,o}renderAggregateOptionsForMapping(e,t){if(this.hass&&this.config){let a=Y``,i="average";e===Oe&&(i="maximum"),t[Fe]&&(i=t[Fe]);for(const e of We){const t=this.renderAggregateOption(e,i);a=Y`${a}${t}`}return a}return Y``}renderAggregateOption(e,t){if(this.hass&&this.config){return Y`<option value="${e}" ?selected="${e===t}">
        ${ji("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return Y``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=Y``;const a=t[Le];return e=Y`${e}
        <option
          value="${Be}"
          ?selected="${a===Be}"
        >
          ${ji("panels.mappings.cards.mapping.pressure_types."+Be,this.hass.language)}
        </option>
        <option
          value="${Ie}"
          ?selected="${a===Ie}"
        >
          ${ji("panels.mappings.cards.mapping.pressure_types."+Ie,this.hass.language)}
        ...
        <ha-card
          header="${ji("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${ji("panels.mappings.description",this.hass.language)}.
          </div>
        </ha-card>
        <ha-card
          header="${ji("panels.mappings.cards.add-mapping.header",this.hass.language)}"
        >
          <div class="card-content">
            ...
            <button @click="${this.handleAddMapping}">
              ${ji("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </ha-card>
    ...
    `}};n([pe()],nn.prototype,"config",void 0),n([pe({type:Array})],nn.prototype,"zones",void 0),n([pe({type:Array})],nn.prototype,"mappings",void 0),n([me("#mappingNameInput")],nn.prototype,"mappingNameInput",void 0),nn=n([de("smart-irrigation-view-mappings")],nn);const sn=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a};e.SmartIrrigationPanel=class extends le{async firstUpdated(){window.addEventListener("location-changed",(()=>{window.location.pathname.includes("smart-irrigation")&&this.requestUpdate()})),await ye(),this.requestUpdate()}render(){if(!customElements.get("ha-panel-config"))return Y` loading... `;const e=sn();return Y`
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2024.8.1-beta-10"}</div>
        </div>
        ...
        >
          <paper-tab page-name="general">
            ${ji("panels.general.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="zones">
            ${ji("panels.zones.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="modules"
            >${ji("panels.modules.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="mappings"
            >${ji("panels.mappings.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="help"
            >${ji("panels.help.title",this.hass.language)}</paper-tab
          >
        </ha-tabs>
      </div>
    ...
    `}getView(e){switch(e.page){case"general":return Y`
        ...
        `;case"help":return Y`<ha-card
          header="${ji("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
          ${ji("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)} <a href="https://github.com/jeroenterheerdt/HAsmartirrigation/wiki"
              >${ji("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >. ${ji("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${ji("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${ji("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a
              href="https://github.com/jeroenterheerdt/HAsmartirrigation/issues"
              >${ji("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${ji("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return Y`
    ...
    `}};n([pe({attribute:!1})],rn.prototype,"hass",void 0),n([function(e){return pe({...e,state:!0})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],rn.prototype,"_params",void 0),rn=n([de("error-dialog")],rn);var on=Object.freeze({__proto__:null,get ErrorDialog(){return rn}});Object.defineProperty(e,"__esModule",{value:!0})}({});
