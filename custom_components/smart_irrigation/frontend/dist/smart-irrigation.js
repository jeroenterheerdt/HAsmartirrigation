...
/**
     ...
     */
const r=window,o=r.ShadowRoot&&(void 0===r.ShadyCSS||r.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,l=Symbol(),u=new WeakMap;class c{constructor(e,t,a){if(this._$cssResult$=!0,a!==l)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(o&&void 0===e){const a=void 0!==t&&1===t.length;a&&(e=u.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),a&&u.set(t,e))}return e}toString(){return this.cssText}}const d=(e,...t)=>{const a=1===e.length?e[0]:t.reduce(((t,a,i)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[i+1]),e[0]);return new c(a,e,l)},h=o?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const a of e.cssRules)t+=a.cssText;return(e=>new c("string"==typeof e?e:e+"",void 0,l))(t)})(e):e
/**
     * @license
...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
var S;k[w]=!0,k.elementProperties=new Map,k.elementStyles=[],k.shadowRootOptions={mode:"open"},null==v||v({ReactiveElement:k}),(null!==(p=m.reactiveElementVersions)&&void 0!==p?p:m.reactiveElementVersions=[]).push("1.6.2");const E=window,$=E.trustedTypes,A=$?$.createPolicy("lit-html",{createHTML:e=>e}):void 0,M="$lit$",O=`lit$${(Math.random()+"").slice(9)}$`,T="?"+O,D=`<${T}>`,H=document,x=()=>H.createComment(""),z=e=>null===e||"object"!=typeof e&&"function"!=typeof e,P=Array.isArray,N="[ \t\n\f\r]",C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,j=/-->/g,L=/>/g,B=RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),R=/'/g,I=/"/g,U=/^(?:script|style|textarea|title)$/i,Y=(e=>(t,...a)=>({_$litType$:e,strings:t,values:a}))(1),G=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),F=new WeakMap,W=H.createTreeWalker(H,129,null,!1),Z=(e,t)=>{const a=e.length-1,i=[];let n,s=2===t?"<svg>":"",r=C;for(let t=0;t<a;t++){const a=e[t];let o,l,u=-1,c=0;for(;c<a.length&&(r.lastIndex=c,l=r.exec(a),null!==l);)c=r.lastIndex,r===C?"!--"===l[1]?r=j:void 0!==l[1]?r=L:void 0!==l[2]?(U.test(l[2])&&(n=RegExp("</"+l[2],"g")),r=B):void 0!==l[3]&&(r=B):r===B?">"===l[0]?(r=null!=n?n:C,u=-1):void 0===l[1]?u=-2:(u=r.lastIndex-l[2].length,o=l[1],r=void 0===l[3]?B:'"'===l[3]?I:R):r===I||r===R?r=B:r===j||r===L?r=C:(r=B,n=void 0);const d=r===B&&e[t+1].startsWith("/>")?" ":"";s+=r===C?a+D:u>=0?(i.push(o),a.slice(0,u)+M+a.slice(u)+O+d):a+O+(-2===u?(i.push(void 0),t):d)}const o=s+(e[a]||"<?>")+(2===t?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==A?A.createHTML(o):o,i]};class q{constructor({strings:e,_$litType$:t},a){let i;this.parts=[];let n=0,s=0;const r=e.length-1,o=this.parts,[l,u]=Z(e,t);if(this.el=q.createElement(l,a),W.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(i=W.nextNode())&&o.length<r;){if(1===i.nodeType){if(i.hasAttributes()){const e=[];for(const t of i.getAttributeNames())if(t.endsWith(M)||t.startsWith(O)){const a=u[s++];if(e.push(t),void 0!==a){const e=i.getAttribute(a.toLowerCase()+M).split(O),t=/([.?@])?(.*)/.exec(a);o.push({type:1,index:n,name:t[2],strings:e,ctor:"."===t[1]?ee:"?"===t[1]?ae:"@"===t[1]?ie:Q})}else o.push({type:6,index:n})}for(const t of e)i.removeAttribute(t)}if(U.test(i.tagName)){const e=i.textContent.split(O),t=e.length-1;if(t>0){i.textContent=$?$.emptyScript:"";for(let a=0;a<t;a++)i.append(e[a],x()),W.nextNode(),o.push({type:2,index:++n});i.append(e[t],x())}}}else if(8===i.nodeType)if(i.data===T)o.push({type:2,index:n});else{let e=-1;for(;-1!==(e=i.data.indexOf(O,e+1));)o.push({type:7,index:n}),e+=O.length-1}n++}}static createElement(e,t){const a=H.createElement("template");return a.innerHTML=e,a}}function K(e,t,a=e,i){var n,s,r,o;if(t===G)return t;let l=void 0!==i?null===(n=a._$Co)||void 0===n?void 0:n[i]:a._$Cl;const u=z(t)?void 0:t._$litDirective$;return(null==l?void 0:l.constructor)!==u&&(null===(s=null==l?void 0:l._$AO)||void 0===s||s.call(l,!1),void 0===u?l=void 0:(l=new u(e),l._$AT(e,a,i)),void 0!==i?(null!==(r=(o=a)._$Co)&&void 0!==r?r:o._$Co=[])[i]=l:a._$Cl=l),void 0!==l&&(t=K(e,l._$AS(e,t.values),l,i)),t}class X{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:a},parts:i}=this._$AD,n=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:H).importNode(a,!0);W.currentNode=n;let s=W.nextNode(),r=0,o=0,l=i[0];for(;void 0!==l;){if(r===l.index){let t;2===l.type?t=new J(s,s.nextSibling,this,e):1===l.type?t=new l.ctor(s,l.name,l.strings,this,e):6===l.type&&(t=new ne(s,this,e)),this._$AV.push(t),l=i[++o]}r!==(null==l?void 0:l.index)&&(s=W.nextNode(),r++)}return W.currentNode=H,n}v(e){let t=0;for(const a of this._$AV)void 0!==a&&(void 0!==a.strings?(a._$AI(e,a,t),t+=a.strings.length-2):a._$AI(e[t])),t++}}class J{constructor(e,t,a,i){var n;this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=a,this.options=i,this._$Cp=null===(n=null==i?void 0:i.isConnected)||void 0===n||n}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===(null==e?void 0:e.nodeType)&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=K(this,e,t),z(e)?e===V||null==e||""===e?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==G&&this._(e):void 0!==e._$litType$?this.g(e):void 0!==e.nodeType?this.$(e):(e=>P(e)||"function"==typeof(null==e?void 0:e[Symbol.iterator]))(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==V&&z(this._$AH)?this._$AA.nextSibling.data=e:this.$(H.createTextNode(e)),this._$AH=e}g(e){var t;const{values:a,_$litType$:i}=e,n="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=q.createElement(i.h,this.options)),i);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===n)this._$AH.v(a);else{const e=new X(n,this),t=e.u(this.options);e.v(a),this.$(t),this._$AH=e}}_$AC(e){let t=F.get(e.strings);return void 0===t&&F.set(e.strings,t=new q(e)),t}T(e){P(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let a,i=0;for(const n of e)i===t.length?t.push(a=new J(this.k(x()),this.k(x()),this,this.options)):a=t[i],a._$AI(n),i++;i<t.length&&(this._$AR(a&&a._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var a;for(null===(a=this._$AP)||void 0===a||a.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$Cp=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class Q{constructor(e,t,a,i,n){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,a.length>2||""!==a[0]||""!==a[1]?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=V}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,a,i){const n=this.strings;let s=!1;if(void 0===n)e=K(this,e,t,0),s=!z(e)||e!==this._$AH&&e!==G,s&&(this._$AH=e);else{const i=e;let r,o;for(e=n[0],r=0;r<n.length-1;r++)o=K(this,i[a+r],t,r),o===G&&(o=this._$AH[r]),s||(s=!z(o)||o!==this._$AH[r]),o===V?e=V:e!==V&&(e+=(null!=o?o:"")+n[r+1]),this._$AH[r]=o}s&&!i&&this.j(e)}j(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class ee extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===V?void 0:e}}const te=$?$.emptyScript:"";class ae extends Q{constructor(){super(...arguments),this.type=4}j(e){e&&e!==V?this.element.setAttribute(this.name,te):this.element.removeAttribute(this.name)}}class ie extends Q{constructor(e,t,a,i,n){super(e,t,a,i,n),this.type=5}_$AI(e,t=this){var a;if((e=null!==(a=K(this,e,t,0))&&void 0!==a?a:V)===G)return;const i=this._$AH,n=e===V&&i!==V||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==V&&(i===V||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,a;"function"==typeof this._$AH?this._$AH.call(null!==(a=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==a?a:this.element,e):this._$AH.handleEvent(e)}}class ne{constructor(e,t,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){K(this,e)}}const se=E.litHtmlPolyfillSupport;null==se||se(q,J),(null!==(S=E.litHtmlVersions)&&void 0!==S?S:E.litHtmlVersions=[]).push("2.7.4");
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */,de=(e,t)=>"method"===t.kind&&t.descriptor&&!("value"in t.descriptor)?{...t,finisher(a){a.createProperty(t.key,e)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){"function"==typeof t.initializer&&(this[t.key]=t.initializer.call(this))},finisher(a){a.createProperty(t.key,e)}},he=(e,t,a)=>{t.constructor.createProperty(a,e)};function pe(e){return(t,a)=>void 0!==a?he(e,t,a):de(e,t)
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
`;var ki="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",Si="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";let Ei=class extends(tt(le)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e,t;this.hass&&(this.config=await Xe(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{}))}firstUpdated(){(async()=>{await ye()})()}render(){if(this.hass&&this.config&&this.data){let e=Y` <div class="card-content">
          ...
          >
            >
            <title>
              ${hi("panels.zones.actions.information",this.hass.language)}
            </title>
        ...
        <div class="card-content">
          <label class="hidden" id="autocalcdescription">
            ${hi("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autocalcenabled"
            >${hi("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autocalcon"
            ...
            @change="${e=>{this.saveData({autocalcenabled:vi(e.target.value)})}}"
          /><label for="autocalcon"
            >${hi("common.labels.yes",this.hass.language)}</label
          >
          <input
            type="radio"
            id="autocalcoff"
          ...
          /><label for="autocalcoff"
            >${hi("common.labels.no",this.hass.language)}</label
          >
        </div>`;this.data.autocalcenabled&&(e=Y`${e}
          <div class="card-content">
            <label for="calctime"
              >${hi("panels.general.cards.automatic-duration-calculation.labels.auto-calc-time",this.hass.language)}</label
            >:
            <input
              id="calctime"
              type="text"
        ...
        header="${hi("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let t=Y` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autoupdatedescription">
            ${hi("panels.general.cards.automatic-update.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autoupdateenabled"
            >${hi("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autoupdateon"
            ...
            @change="${e=>{this.saveData({autoupdateenabled:vi(e.target.value)})}}"
          ...
          <div class="card-content">
            <label for="autoupdateinterval"
              >${hi("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}:</label
            >
            <input
            ...
            >
              ...
              >
                ${hi("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
              </option>
              <option
                value="${ke}"
                ?selected="${this.data.autoupdateschedule===ke}"
              >
                ${hi("panels.general.cards.automatic-update.options.hours",this.hass.language)}
              </option>
              <option
                value="${Se}"
                ?selected="${this.data.autoupdateschedule===Se}"
              >
                ${hi("panels.general.cards.automatic-update.options.days",this.hass.language)}
              </option>
            </select>
          </div>
          <div class="card-content">
            <label for="updatedelay"
              >${hi("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
              (s):</label
            >
            <input
              id="updatedelay"
            ...
            />
          </div>`),t=Y`<ha-card header="${hi("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;let a=Y` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autocleardescription">
            ${hi("panels.general.cards.automatic-clear.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autoclearenabled"
            >${hi("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autoclearon"
            ...
            @change="${e=>{this.saveData({autoclearenabled:vi(e.target.value)})}}"
          ...
          <div class="card-content">
            <label for="calctime"
              >${hi("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language)}</label
            >:
            <input
              id="cleardatatime"
              type="text"
            ...
            />
          </div>`),a=Y`<ha-card header="${hi("panels.general.cards.automatic-clear.header",this.hass.language)}" >${a}</div></ha-card>`;return Y`<ha-card
          header="${hi("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${hi("panels.general.description",this.hass.language)}
          </div> </ha-card
        >${t}${e}${a}`}return Y``}saveData(e){var t,a;this.hass&&this.data&&(this.data=Object.assign(Object.assign({},this.data),e),(t=this.hass,a=this.data,t.callApi("POST",_e+"/config",a)).catch((e=>_i(e,this.shadowRoot.querySelector("ha-card")))).then())}toggleInformation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="information")}static get styles(){return d`
      ${wi}
      .hidden {
        display: none;
      }
...
a.version="2.29.4",i(Wa),a.fn=us,a.min=Xa,a.max=Ja,a.now=Qa,a.utc=p,a.unix=cs,a.months=vs,a.isDate=c,a.locale=pa,a.invalid=v,a.duration=Ai,a.isMoment=k,a.weekdays=ys,a.parseZone=ds,a.localeData=fa,a.isDuration=si,a.monthsShort=bs,a.weekdaysMin=ws,a.defineLocale=ma,a.updateLocale=ga,a.locales=va,a.weekdaysShort=_s,a.normalizeUnits=ae,a.relativeTimeRounding=nr,a.relativeTimeThreshold=sr,a.calendarFormat=Ii,a.prototype=us,a.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},a}();var Di=Ai(Ti.exports);let Hi=class extends(tt(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Xe(this.hass),this.zones=await Je(this.hass),this.modules=await Qe(this.hass),this.mappings=await et(this.hass))}handleCalculateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{calculate_all:!0})}handleUpdateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{update_all:!0})}handleResetAllBuckets(){this.hass&&this.hass.callApi("POST",_e+"/zones",{reset_all_buckets:!0})}handleClearAllWeatherdata(){this.hass&&this.hass.callApi("POST",_e+"/zones",{clear_all_weatherdata:!0})}handleAddZone(){const e={id:this.zones.length,name:this.nameInput.value,size:parseFloat(this.sizeInput.value),throughput:parseFloat(this.throughputInput.value),state:$i.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0};this.zones=[...this.zones,e],this.saveToHA(e)}handleEditZone(e,t){this.hass&&(this.zones=Object.values(this.zones).map(((a,i)=>i===e?t:a)),this.saveToHA(t))}handleRemoveZone(e,t){if(!this.hass)return;const a=Object.values(this.zones).at(t);var i,n;a&&(this.zones=this.zones.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.id.toString(),i.callApi("POST",_e+"/zones",{id:n,remove:!0})))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,update:!0})))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=Y`<option value="" ?selected=${void 0===t}">---${hi("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=Y`${a}
        ...
        >
          ...
          <path fill="#404040" d="${Si}" />
        </svg>`),e.state===$i.Automatic&&(i=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        </svg>`),e.state===$i.Automatic&&(n=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              >${hi("panels.zones.labels.last_calculated",this.hass.language)}:
          ...
          <div class="card-content">
            <label for="name${t}"
              >${hi("panels.zones.labels.name",this.hass.language)}:</label
            >
            <input
              id="name${t}"
              type="text"
            ...
            <div class="zoneline">
              <label for="size${t}"
                >${hi("panels.zones.labels.size",this.hass.language)}
            ...
            <div class="zoneline">
              <label for="throughput${t}"
                >${hi("panels.zones.labels.throughput",this.hass.language)}
            ...
            <div class="zoneline">
              <label for="state${t}"
                >${hi("panels.zones.labels.state",this.hass.language)}:</label
              >
              <select
                required
                id="state${t}"
              ...
              >
                <option
                  value="${$i.Automatic}"
                  ?selected="${e.state===$i.Automatic}"
                >
                  ${hi("panels.zones.labels.states.automatic",this.hass.language)}
                </option>
                <option
                  value="${$i.Disabled}"
                  ?selected="${e.state===$i.Disabled}"
                >
                  ${hi("panels.zones.labels.states.disabled",this.hass.language)}
                </option>
                <option
                  value="${$i.Manual}"
                  ?selected="${e.state===$i.Manual}"
                >
                  ${hi("panels.zones.labels.states.manual",this.hass.language)}
                </option>
              </select>
              <label for="module${t}"
                >${hi("common.labels.module",this.hass.language)}:</label
              >
              ...
              <label for="module${t}"
                >${hi("panels.zones.labels.mapping",this.hass.language)}:</label
              >
            ...
            <div class="zoneline">
              ...
              <label for="maximum-bucket${t}"
                >${hi("panels.zones.labels.maximum-bucket",this.hass.language)}
                (${yi(this.config,Ke)}):</label
              >
              <input
                class="shortinput"
              ...
              <label for="lead_time${t}"
                >${hi("panels.zones.labels.lead-time",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
              ...
              <label for="maximum-duration${t}"
                >${hi("panels.zones.labels.maximum-duration",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
            ...
            <div class="zoneline">
              <label for="multiplier${t}"
                >${hi("panels.zones.labels.multiplier",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="multiplier${t}"
              ...
              <label for="duration${t}"
                >${hi("panels.zones.labels.duration",this.hass.language)}
                (${"s"}):</label
              >
              <input
                class="shortinput"
                ...
                type="number"
                .value="${e.duration}"
                ?readonly="${e.state===$i.Disabled||e.state===$i.Automatic}"
            ...
            <div class="zoneline">
              ...
              >
                <title>
                  ${hi("common.actions.delete",this.hass.language)}
                </title>
      ...
      `}return Y``}toggleExplanation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#calcresults"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="explanation")}render(){return this.hass&&this.config?Y`
        <ha-card header="${hi("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${hi("panels.zones.description",this.hass.language)}
          </div>
        </ha-card>
          <ha-card header="${hi("panels.zones.cards.add-zone.header",this.hass.language)}">
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${hi("panels.zones.labels.name",this.hass.language)}:</label>
              <input id="nameInput" type="text"/>
              </div>
              <div class="zoneline">
              <label for="sizeInput">${hi("panels.zones.labels.size",this.hass.language)} (${yi(this.config,We)}):</label>
              <input class="shortinput" id="sizeInput" type="number"/>
              </div>
              <div class="zoneline">
              <label for="throughputInput">${hi("panels.zones.labels.throughput",this.hass.language)} (${yi(this.config,Ze)}):</label>
              <input id="throughputInput" class="shortinput" type="number"/>
              </div>
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${hi("panels.zones.cards.add-zone.actions.add",this.hass.language)}</button>
              </div>
            </div>
            </ha-card>
            <ha-card header="${hi("panels.zones.cards.zone-actions.header",this.hass.language)}">
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${hi("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}</button>
                <button @click="${this.handleCalculateAllZones}">${hi("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}</button>
                <button @click="${this.handleResetAllBuckets}">${hi("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}</button>
      <button @click="${this.handleClearAllWeatherdata}">${hi("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}</button>
            </div>
          </ha-card>

          ${Object.entries(this.zones).map((([e,t])=>this.renderZone(t,parseInt(e))))}
        </ha-card>
      `:Y``}static get styles(){return d`
      ${wi}
      .zone {
        margin-top: 25px;
        margin-bottom: 25px;
    ...
    `}};n([pe()],Hi.prototype,"config",void 0),n([pe({type:Array})],Hi.prototype,"zones",void 0),n([pe({type:Array})],Hi.prototype,"modules",void 0),n([pe({type:Array})],Hi.prototype,"mappings",void 0),n([me("#nameInput")],Hi.prototype,"nameInput",void 0),n([me("#sizeInput")],Hi.prototype,"sizeInput",void 0),n([me("#throughputInput")],Hi.prototype,"throughputInput",void 0),Hi=n([ce("smart-irrigation-view-zones")],Hi);let xi=class extends(tt(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e;this.hass&&(this.config=await Xe(this.hass),this.zones=await Je(this.hass),this.modules=await Qe(this.hass),this.allmodules=await(e=this.hass,e.callWS({type:_e+"/allmodules"})))}handleAddModule(){const e=this.allmodules.filter((e=>e.name==this.moduleInput.selectedOptions[0].text))[0];if(!e)return;const t={id:this.modules.length,name:this.moduleInput.selectedOptions[0].text,description:e.description,config:e.config,schema:e.schema};this.modules=[...this.modules,t],this.saveToHA(t)}handleRemoveModule(e,t){var a,i;(this.modules=this.modules.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",_e+"/modules",{id:i,remove:!0}))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/modules",a),this._fetchData())}renderModule(e,t){if(this.hass){const a=this.zones.filter((t=>t.module===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            <div class="moduledescription${t}">${e.description}</div>
            <div class="moduleconfig">
              <label class="subheader"
                >${hi("panels.modules.cards.module.labels.configuration",this.hass.language)}
                (*
                ${hi("panels.modules.cards.module.labels.required",this.hass.language)})</label
              >
              ${e.schema?Object.entries(e.schema).map((([e])=>this.renderConfig(t,e))):null}
            </div>
            ${a?Y` ${hi("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}`:Y` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
    ...
    `;if("boolean"==i.type)o=Y`${o}<input
        ...
        >
          ${Object.entries(i.options).map((([e,a])=>Y`<option
                ...
                ?selected="${r===bi(a,0)}"
              >
                ${hi("panels.modules.cards.module.translated-options."+bi(a,1),t)}
              </option>`))}
        ...
        <ha-card
          header="${hi("panels.modules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${hi("panels.modules.description",this.hass.language)}
          </div>
        </ha-card>
        <ha-card
          header="${hi("panels.modules.cards.add-module.header",this.hass.language)}"
        >
          <div class="card-content">
            ...
            <button @click="${this.handleAddModule}">
              ${hi("panels.modules.cards.add-module.actions.add",this.hass.language)}
            </button>
          </div>
        </ha-card>
    ...
    `}};n([pe()],xi.prototype,"config",void 0),n([pe({type:Array})],xi.prototype,"zones",void 0),n([pe({type:Array})],xi.prototype,"modules",void 0),n([pe({type:Array})],xi.prototype,"allmodules",void 0),n([me("#moduleInput")],xi.prototype,"moduleInput",void 0),xi=n([ce("smart-irrigation-view-modules")],xi);let zi=class extends(tt(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Xe(this.hass),this.zones=await Je(this.hass),this.mappings=await et(this.hass))}handleAddMapping(){const e={[Ae]:"",[Me]:"",[Oe]:"",[Te]:"",[De]:"",[He]:"",[xe]:"",[ze]:""},t={id:this.mappings.length,name:this.mappingNameInput.value,mappings:e};this.mappings=[...this.mappings,t],this.saveToHA(t),this._fetchData()}handleRemoveMapping(e,t){var a,i;(this.mappings=this.mappings.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",_e+"/mappings",{id:i,remove:!0}))}handleEditMapping(e,t){this.mappings=Object.values(this.mappings).map(((a,i)=>i===e?t:a)),this.saveToHA(t)}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/mappings",a))}renderMapping(e,t){if(this.hass){const a=this.zones.filter((t=>t.mapping===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            <label for="name${e.id}"
              >${hi("panels.mappings.labels.mapping-name",this.hass.language)}:</label
            >
            <input
              id="name${e.id}"
              type="text"
            ...
            ${a?Y`${hi("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}`:Y` <svg
                    style="width:24px;height:24px"
                    viewBox="0 0 24 24"
                    id="deleteZone${t}"
      ...
      <label for="${t+e}"
        >${hi("panels.mappings.cards.mapping.items."+t.toLowerCase(),this.hass.language)}
      </label>
    </div> `;if(o=Y`${o}
      <div class="mappingsettingline">
        <label for="${t+e+Ie}"
          >${hi("panels.mappings.cards.mapping.source",this.hass.language)}:</label
        >
      </div>`,t==Me||t==He)o=Y`${o}
        <input
          type="radio"
        ...
        /><label for="${t+e+Re}"
          >${hi("panels.mappings.cards.mapping.sources.none",this.hass.language)}</label
        ...
        <input
          ...
          ?checked="${(null===(n=this.config)||void 0===n?void 0:n.use_owm)&&r[Ie]===Pe}"
          @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{source:a.target.value})})}))}"
        /><label
          class="${l}"
          for="${t+e+Pe}"
          >${hi("panels.mappings.cards.mapping.sources.openweathermap",this.hass.language)}</label
        >`}return o=Y`${o}
        <input
          type="radio"
          id="${t+e+Ne}"
          ...
          name="${t+e+Ie}"
          ?checked="${r[Ie]===Ne}"
          @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ie]:a.target.value})})}))}"
        /><label for="${t+e+Ne}"
          >${hi("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}</label
        >
      </div>`,o=Y`${o}
      <input
        type="radio"
        ...
        @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ie]:a.target.value})})}))}"
      /><label for="${t+e+Ce}"
        >${hi("panels.mappings.cards.mapping.sources.static",this.hass.language)}</label
      >
    </div>`,r[Ie]==Ne&&(o=Y`${o}
        <div class="mappingsettingline">
          <label for="${t+e+Ue}"
            >${hi("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+Ue}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ye}"
            >${hi("panels.mappings.cards.mapping.static_value",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+Ye}"
          ...
          />
        </div>`),r[Ie]!=Ne&&r[Ie]!=Ce||(o=Y`${o}
        <div class="mappingsettingline">
          <label for="${t+e+Ge}"
            >${hi("panels.mappings.cards.mapping.input-units",this.hass.language)}:</label
          >
          <select
            type="text"
            id="${t+e+Ge}"
          ...
          <div class="mappingsettingline">
            <label for="${t+e+je}"
              >${hi("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:</label
            >
            <select
              type="text"
              id="${t+e+je}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ve}"
            >${hi("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          </label>
          <select
            type="text"
            id="${t+e+Ve}"
            @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ve]:a.target.value})})}))}"
          >
            ${this.renderAggregateOptionsForMapping(t,r)}
          </select>
          <label for="${t+e+Ve}"
            >${hi("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</label
          >
        </div>`),o=Y`<div class="mappingline">${o}</div>`,o}renderAggregateOptionsForMapping(e,t){if(this.hass&&this.config){let a=Y``,i="average";e===Te&&(i="maximum"),t[Ve]&&(i=t[Ve]);for(const e of Fe){const t=this.renderAggregateOption(e,i);a=Y`${a}${t}`}return a}return Y``}renderAggregateOption(e,t){if(this.hass&&this.config){return Y`<option value="${e}" ?selected="${e===t}">
        ${hi("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return Y``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=Y``;const a=t[je];return e=Y`${e}
        <option
          value="${Le}"
          ?selected="${a===Le}"
        >
          ${hi("panels.mappings.cards.mapping.pressure_types."+Le,this.hass.language)}
        </option>
        <option
          value="${Be}"
          ?selected="${a===Be}"
        >
          ${hi("panels.mappings.cards.mapping.pressure_types."+Be,this.hass.language)}
        </option>`,e}return Y``}renderUnitOptionsForMapping(e,t){if(this.hass&&this.config){const a=function(e){switch(e){case Ae:case xe:return[{unit:"°C",system:$e},{unit:"°F",system:Ee}];case Te:case Me:return[{unit:"mm",system:$e},{unit:"in",system:Ee}];case Oe:return[{unit:"%",system:[$e,Ee]}];case De:return[{unit:"millibar",system:$e},{unit:"hPa",system:$e},{unit:"psi",system:Ee},{unit:"inch Hg",system:Ee}];case ze:return[{unit:"km/h",system:$e},{unit:"meter/s",system:$e},{unit:"mile/h",system:Ee}];case He:return[{unit:"W/m2",system:$e},{unit:"MJ/day/m2",system:$e},{unit:"W/sq ft",system:Ee},{unit:"MJ/day/sq ft",system:Ee}];default:return[]}}(e);let i=Y``,n=t[Ge];const s=this.config.units;return t[Ge]||a.forEach((function(e){"string"==typeof e.system?s==e.system&&(n=e.unit):e.system.forEach((function(t){s==t.system&&(n=e.unit)}))})),a.forEach((function(e){i=Y`${i}
          <option value="${e.unit}" ?selected="${n===e.unit}">
            ${e.unit}
          </option>`})),i}return Y``}render(){return this.hass?Y`
        <ha-card
          header="${hi("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${hi("panels.mappings.description",this.hass.language)}.
          </div>
        </ha-card>
        <ha-card
          header="${hi("panels.mappings.cards.add-mapping.header",this.hass.language)}"
        >
          <div class="card-content">
            ...
            <button @click="${this.handleAddMapping}">
              ${hi("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </ha-card>
    ...
    `}};n([pe()],zi.prototype,"config",void 0),n([pe({type:Array})],zi.prototype,"zones",void 0),n([pe({type:Array})],zi.prototype,"mappings",void 0),n([me("#mappingNameInput")],zi.prototype,"mappingNameInput",void 0),zi=n([ce("smart-irrigation-view-mappings")],zi);const Pi=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a};e.SmartIrrigationPanel=class extends le{async firstUpdated(){window.addEventListener("location-changed",(()=>{window.location.pathname.includes("smart-irrigation")&&this.requestUpdate()})),await ye(),this.requestUpdate()}render(){if(!customElements.get("ha-panel-config"))return Y` loading... `;const e=Pi();return Y`
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2023.12.2"}</div>
        </div>
        ...
        >
          <paper-tab page-name="general">
            ${hi("panels.general.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="zones">
            ${hi("panels.zones.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="modules"
            >${hi("panels.modules.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="mappings"
            >${hi("panels.mappings.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="help"
            >${hi("panels.help.title",this.hass.language)}</paper-tab
          >
        </ha-tabs>
      </div>
    ...
    `}getView(e){switch(e.page){case"general":return Y`
        ...
        `;case"help":return Y`<ha-card
          header="${hi("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
          ${hi("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)} <a href="https://github.com/jeroenterheerdt/HAsmartirrigation/wiki"
              >${hi("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >. ${hi("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${hi("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${hi("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a
              href="https://github.com/jeroenterheerdt/HAsmartirrigation/issues"
              >${hi("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${hi("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return Y`
    ...
    `}};n([pe({attribute:!1})],Ni.prototype,"hass",void 0),n([function(e){return pe({...e,state:!0})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],Ni.prototype,"_params",void 0),Ni=n([ce("error-dialog")],Ni);var Ci=Object.freeze({__proto__:null,get ErrorDialog(){return Ni}});Object.defineProperty(e,"__esModule",{value:!0})}({});
