!(function (e) {
  ...
  const q = (e, t) => {
    ...
    for (let t = 0; t < a; t++) {
      ...
      let o,
        ...
        u = -1,
        d = 0;
      for (; d < a.length && ((r.lastIndex = d), (l = r.exec(a)), null !== l); )
        (d = r.lastIndex),
          r === C
            ? "!--" === l[1]
              ? (r = j)
    ...
    return (
      (null == l ? void 0 : l.constructor) !== u &&
        ...
        void 0 !== i
          ...
          : (a._$Cl = l)),
      void 0 !== l && (t = X(e, l._$AS(e, t.values), l, i)),
      t
    );
  }
  class J {
    ...
    u(e) {
      ...
      for (; void 0 !== l; ) {
        if (r === l.index) {
          let t;
          2 === l.type
            ? (t = new Q(s, s.nextSibling, this, e))
            : 1 === l.type
              ? (t = new l.ctor(s, l.name, l.strings, this, e))
              : 6 === l.type && (t = new se(s, this, e)),
            this._$AV.push(t),
            (l = i[++o]);
        }
  ...
  class Q {
      ...
      const { values: a, _$litType$: i } = e,
        n =
          "number" == typeof i
            ? this._$AC(e)
            : (void 0 === i.el &&
                (i.el = K.createElement(Z(i.h, i.h[0]), this.options)),
              i);
    ...
    T(e) {
      ...
      for (const n of e)
        i === t.length
          ? t.push((a = new Q(this.k(D()), this.k(D()), this, this.options)))
          : (a = t[i]),
          a._$AI(n),
          i++;
  ...
  class ne extends ee {
    ...
    _$AI(e, t = this) {
      var a;
      if ((e = null !== (a = X(this, e, t, 0)) && void 0 !== a ? a : F) === V)
        return;
      const i = this._$AH,
        n =
          (e === F && i !== F) ||
  ...
  (ue.finalized = !0),
    ...
    null === (oe = globalThis.litElementHydrateSupport) ||
      void 0 === oe ||
      oe.call(globalThis, { LitElement: ue });
  const de = globalThis.litElementPolyfillSupport;
  null == de || de({ LitElement: ue }),
    (null !== (le = globalThis.litElementVersions) && void 0 !== le
      ? le
  ...
  const ye = async () => {
    ...
    ot = "maximum_bucket",
    lt = "drainage_rate",
    ut = (e) => e.callWS({ type: _e + "/config" }),
    dt = (e) => e.callWS({ type: _e + "/zones" }),
    ct = (e) => e.callWS({ type: _e + "/modules" }),
    ht = (e) => e.callWS({ type: _e + "/mappings" }),
    pt = (e) => {
      class t extends e {
        connectedCallback() {
  ...
  var mt = {
    ...
    Et = {
      calculation: {
        explanation: {
          ...
          "drainage-rate-is": "drainage rate is",
        },
      },
    },
    $t = {
      ...
      general: {
        cards: {
          ...
          continuousupdates: {
            ...
            description:
              "This experimental feature will continuously update the sensor data. This is useful for sensor groups that use sources that provide continuous data, such as weather stations. This feature cannot be used for sensor groups that at least partly rely on weather services as continous polling of APIs will incur costs. Keep in mind that this is experimental and may not work as expected. Use at your own risk.",
            labels: { continuousupdates: "Enable continuous updates" },
          },
        },
        ...
        cards: {
          ...
          mapping: {
            ...
            errors: {
              ...
              fonte_non_esiste:
                "La fonte non esiste. Inserire una fonte valida, ad esempio 'sensor.mysensor'.",
            },
            items: {
    ...
    pa = { common: la, defaults: ua, module: da, calcmodules: ca, panels: ha },
    ma = Object.freeze({
      __proto__: null,
      common: la,
      defaults: ua,
  ...
  function Sa(e, t) {
    ...
    return (t && t.strategy ? t.strategy : Ma)(e, { cache: a, serializer: i });
  }
  function Ea(e, t, a, i) {
    var n,
      s =
  ...
  function Na(e) {
    return e.type === xa.literal;
  }
  function Ca(e) {
    return e.type === xa.argument;
  }
  function ja(e) {
    return e.type === xa.number;
  }
  function La(e) {
    return e.type === xa.date;
  }
  function Ba(e) {
    return e.type === xa.time;
  }
  function Ia(e) {
    return e.type === xa.select;
  }
  function Ra(e) {
    return e.type === xa.plural;
  }
  function Ua(e) {
    return e.type === xa.pound;
  }
  function Ya(e) {
    return e.type === xa.tag;
  }
  function Va(e) {
  ...
  function ni(e) {
    for (var t = {}, a = 0, n = e; a < n.length; a++) {
      ...
      if (Qa.test(s.stem)) t.minimumIntegerDigits = s.stem.length;
      else if (Ka.test(s.stem)) {
        if (s.options.length > 1)
          throw new RangeError(
        ...
        "w" === r
          ...
          : r && (t = i(i({}, t), ei(r)));
      } else if (Xa.test(s.stem)) t = i(i({}, t), ei(s.stem));
      else {
        var o = ti(s.stem);
        o && (t = i(i({}, t), o));
        var l = ai(s.stem);
  ...
  function oi(e) {
    ...
    return (
      ...
      (ri[a || ""] || ri[i || ""] || ri["".concat(i, "-001")] || ri["001"])[0]
    );
  }
  ...
  try {
    bi =
      "a" ===
      (null ===
        (si = Ai("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
          "a"
        )) || void 0 === si
        ? void 0
        : si[0]);
    ...
    Oi = (function () {
      ...
      return (
            ...
            if (123 === n) {
              ...
              if (35 !== n || ("plural" !== t && "selectordinal" !== t)) {
                if (60 === n && !this.ignoreTag && 47 === this.peek()) {
                  if (a) break;
                  return this.error(
                    za.UNMATCHED_CLOSING_TAG,
                    di(this.clonePosition(), this.clonePosition())
                  );
                }
          ...
          if (this.bumpIf(">")) {
            ...
            if (this.bumpIf("</")) {
              if (this.isEOF() || !zi(this.char()))
                return this.error(za.INVALID_TAG, di(r, this.clonePosition()));
              var o = this.clonePosition();
              return i !== this.parseTagName()
                ? this.error(
                    za.UNMATCHED_CLOSING_TAG,
                    di(o, this.clonePosition())
                  )
                : (this.bumpSpace(),
                  this.bumpIf(">")
                    ? {
                    ...
                    : this.error(za.INVALID_TAG, di(r, this.clonePosition())));
            }
            return this.error(za.UNCLOSED_TAG, di(a, this.clonePosition()));
          }
          return this.error(za.INVALID_TAG, di(a, this.clonePosition()));
        }),
        ...
        (e.prototype.parseLiteral = function (e, t) {
          ...
          return {
            val: { type: xa.literal, value: i, location: o },
            err: null,
          };
        }),
        (e.prototype.tryParseLeftAngleBracket = function () {
          return this.isEOF() ||
            60 !== this.char() ||
            (!this.ignoreTag && (zi((e = this.peek() || 0)) || 47 === e))
            ? null
            : (this.bump(), "<");
          var e;
        }),
        ...
        (e.prototype.parseArgument = function (e, t) {
          ...
          if ((this.bump(), this.bumpSpace(), this.isEOF()))
            return this.error(
              za.EXPECT_ARGUMENT_CLOSING_BRACE,
              di(a, this.clonePosition())
            );
          if (125 === this.char())
            return (
              this.bump(),
              this.error(za.EMPTY_ARGUMENT, di(a, this.clonePosition()))
            );
          var i = this.parseIdentifierIfPossible().value;
          if (!i)
            return this.error(
              za.MALFORMED_ARGUMENT,
              di(a, this.clonePosition())
            );
        ...
        (e.prototype.parseIdentifierIfPossible = function () {
          var e = this.clonePosition(),
            ...
            i = t + a.length;
          return (
            this.bumpTo(i), { value: a, location: di(e, this.clonePosition()) }
          );
        }),
        (e.prototype.parseArgumentOptions = function (e, t, a, n) {
          ...
          switch (o) {
            case "":
              return this.error(za.EXPECT_ARGUMENT_TYPE, di(r, l));
            case "number":
            case "date":
            case "time":
              this.bumpSpace();
              ...
              if (this.bumpIf(",")) {
                ...
                if (0 === (m = $i(b.val)).length)
                  return this.error(
                    za.EXPECT_ARGUMENT_STYLE,
                    di(this.clonePosition(), this.clonePosition())
                  );
                u = { style: m, styleLocation: di(d, this.clonePosition()) };
              }
              ...
              if (u && _i(null == u ? void 0 : u.style, "::", 0)) {
                ...
                if (0 === h.length)
                  return this.error(za.EXPECT_DATE_TIME_SKELETON, c);
                var p = h;
                this.locale &&
                  (p = (function (e, t) {
            ...
            case "select":
              ...
              if ((this.bumpSpace(), !this.bumpIf(",")))
                return this.error(
                  za.EXPECT_SELECT_ARGUMENT_OPTIONS,
                  di(g, i({}, g))
                );
              this.bumpSpace();
              ...
              if ("select" !== o && "offset" === f.value) {
                if (!this.bumpIf(":"))
                  return this.error(
                    za.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                    di(this.clonePosition(), this.clonePosition())
                  );
                var b;
                if (
                  ...
                  (b = this.tryParseDecimalInteger(
                    za.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                    za.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE
                  )).err)
                )
                  return b;
                this.bumpSpace(),
            ...
            default:
              return this.error(za.INVALID_ARGUMENT_TYPE, di(r, l));
          }
        }),
          ...
          for (var e = 0, t = this.clonePosition(); !this.isEOF(); ) {
            switch (this.char()) {
              case 39:
                ...
                if (!this.bumpUntil("'"))
                  return this.error(
                    za.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                    di(a, this.clonePosition())
                  );
                this.bump();
                break;
        ...
        (e.prototype.parseNumberSkeletonFromString = function (e, t) {
          ...
          try {
            a = (function (e) {
              ...
              for (
                var t = e.split(qa).filter(function (e) {
                    return e.length > 0;
                  }),
                  a = [],
                  i = 0,
        ...
        (e.prototype.tryParsePluralOrSelectOptions = function (e, t, a, i) {
          for (
            ...
            if (0 === l.length) {
              ...
              var c = this.tryParseDecimalInteger(
                za.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                za.INVALID_PLURAL_ARGUMENT_SELECTOR
              );
              if (c.err) return c;
              (u = di(d, this.clonePosition())),
                (l = this.message.slice(d.offset, this.offset()));
            }
            if (o.has(l))
              return this.error(
                "select" === t
                  ? za.DUPLICATE_SELECT_ARGUMENT_SELECTOR
                  : za.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
                u
              );
            ...
            if (!this.bumpIf("{"))
              return this.error(
                "select" === t
                  ? za.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
                  : za.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
                di(this.clonePosition(), this.clonePosition())
              );
            ...
            r.push([
              l,
              { value: p.val, location: di(h, this.clonePosition()) },
            ]),
              o.add(l),
              this.bumpSpace(),
          ...
          return 0 === r.length
            ? this.error(
                "select" === t
                  ? za.EXPECT_SELECT_ARGUMENT_SELECTOR
                  : za.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                di(this.clonePosition(), this.clonePosition())
              )
            : this.requiresOtherClause && !s
              ? this.error(
                  za.MISSING_OTHER_CLAUSE,
                  di(this.clonePosition(), this.clonePosition())
                )
              : { val: r, err: null };
        }),
  ...
  function Pi(e) {
    e.forEach(function (e) {
      if ((delete e.location, Ia(e) || Ra(e)))
        for (var t in e.options)
          delete e.options[t].location, Pi(e.options[t].value);
      else
        (ja(e) && Va(e.style)) || ((La(e) || Ba(e)) && Fa(e.style))
  ...
  function Ui(e, t, a, i, n, s, r) {
    if (1 === e.length && Na(e[0]))
      return [{ type: Ci.literal, value: e[0].value }];
    for (var o = [], l = 0, u = e; l < u.length; l++) {
      var d = u[l];
      if (Na(d)) o.push({ type: Ci.literal, value: d.value });
      else if (Ua(d))
        "number" == typeof s &&
          o.push({ type: Ci.literal, value: a.getNumberFormat(t).format(s) });
      else {
        var c = d.value;
        ...
        if (Ca(d))
          ...
          if (Ia(d)) {
            if (!(b = d.options[h] || d.options.other))
              throw new Li(d.value, h, Object.keys(d.options), r);
    ...
    return (function (e) {
      return e.length < 2
        ...
        : e.reduce(function (e, t) {
            var a = e[e.length - 1];
            return (
              a && a.type === Ci.literal && t.type === Ci.literal
                ? (a.value += t.value)
                : e.push(t),
              e
            );
  ...
  var Fi = (function () {
          ...
          (this.formatters =
              ...
              (o = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: Sa(
                ...
                { cache: Vi(o.number), strategy: Pa.variadic }
              ),
              getDateTimeFormat: Sa(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                    t[a] = arguments[a];
                ...
                { cache: Vi(o.dateTime), strategy: Pa.variadic }
              ),
              getPluralRules: Sa(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                ...
                { cache: Vi(o.pluralRules), strategy: Pa.variadic }
              ),
            }));
      }
      return (
    ...
    Gi = Fi;
  const Wi = { de: wt, en: Ot, es: jt, fr: Ft, it: Qt, nl: oa, no: ma, sk: ka };
  function Zi(e, t, ...a) {
    const i = t.replace(/['"]+/g, "");
    let n;
    try {
    ...
    if (
      (void 0 === n && (n = e.split(".").reduce((e, t) => e[t], Wi.en)),
      !a.length)
    )
      return n;
    const s = {};
   ...
   */ class Xi extends Ki {
    constructor(e) {
      if ((super(e), (this.et = F), e.type !== qi))
        throw Error(
  ...
  function Qi(e) {
    return (
      "on" === (e = null == e ? void 0 : e.toString().toLowerCase()) ||
      "true" === e ||
      "1" === e
    );
  }
...
`;
  ...
  let on = class extends pt(ue) {
    ...
    async _fetchData() {
      var e, t;
      this.hass &&
        ((this.config = await ut(this.hass)),
        (this.data =
          ((e = this.config),
          (t = [
            "calctime",
      ...
      if (this.hass && this.config && this.data) {
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autocalcenabled: Qi(e.target.value) });
            }}"
      ...
      >`);
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autoupdateenabled: Qi(e.target.value) });
            }}"
        ...
        this.data.autoupdateenabled &&
          ...
          (t = Y`<ha-card header="${Zi("panels.general.cards.automatic-update.header", this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`);
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autoclearenabled: Qi(e.target.value) });
            }}"
      ...
      >
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ continuousupdates: Qi(e.target.value) });
            }}"
    ...
    saveData(e) {
      ...
      this.hass &&
        ...
        ((t = this.hass), (a = this.data), t.callApi("POST", _e + "/config", a))
          .catch((e) => an(e, this.shadowRoot.querySelector("ha-card")))
          .then());
    }
    toggleInformation(e) {
      var t;
  ...
  n([pe()], on.prototype, "narrow", void 0),
    n([pe()], on.prototype, "path", void 0),
    n([pe()], on.prototype, "data", void 0),
    n([pe()], on.prototype, "config", void 0),
    (on = n([ce("smart-irrigation-view-general")], on)),
    (function (e) {
      (e.Disabled = "disabled"),
        (e.Manual = "manual"),
      ...
      (cn ||
        ...
        (function (e) {
          e.exports = (function () {
            ...
            function S(e) {
              return (
                e instanceof k || (null != e && null != e._isAMomentObject)
              );
            }
            function E(e) {
            ...
            function se(e) {
              var t,
                a = [];
              for (t in e) o(e, t) && a.push({ unit: t, priority: ne[t] });
              return (
                a.sort(function (e, t) {
            ...
            I("Y", 0, 0, function () {
              ...
              He("YYYY", function (e, t) {
                t[je] = 2 === e.length ? i.parseTwoDigitYear(e) : xe(e);
              }),
              He("YY", function (e, t) {
            ...
            function Ke(e, t) {
              return function (a) {
                return null != a
                  ? (Je(this, e, a), i.updateOffset(this, t), this)
                  : Xe(this, e);
              };
            }
            function Xe(e, t) {
            ...
            function Je(e, t, a) {
              ...
              if (e.isValid() && !isNaN(a)) {
                ...
                (s = a),
                  (r = e.month()),
                  (o = 29 !== (o = e.date()) || 1 !== r || Ce(s) ? o : 28),
                  n ? i.setUTCFullYear(s, r, o) : i.setFullYear(s, r, o);
              }
            }
            function Qe(e) {
            ...
            function ct(e, t, a) {
              ...
              for (
                ...
                if (
                  ...
                  return i;
                if (a && "MMM" === t && this._shortMonthsParse[i].test(e))
                  return i;
            ...
            function ht(e, t) {
              ...
              var a = t,
                i = e.date();
              return (
                (i = i < 29 ? i : Math.min(i, at(e.year(), a))),
                e._isUTC ? e._d.setUTCMonth(a, i) : e._d.setMonth(a, i),
                e
              );
            }
            function pt(e) {
            ...
            function gt(e) {
              return this._monthsParseExact
                ? (o(this, "_monthsRegex") || vt.call(this),
            ...
            function Yt(e, t, a) {
              ...
              for (
                ...
                if (a && "ddd" === t && this._shortWeekdaysParse[i].test(e))
                  return i;
                if (a && "dd" === t && this._minWeekdaysParse[i].test(e))
                  return i;
            ...
            function Kt() {
              ...
              for (t = 0; t < 7; t++)
                (a = m([2e3, 1]).day(t)),
                  (i = Oe(this.weekdaysMin(a, ""))),
                  (n = Oe(this.weekdaysShort(a, ""))),
                  (s = Oe(this.weekdays(a, ""))),
                  r.push(i),
                  o.push(n),
                  l.push(s),
                  u.push(i),
            ...
            I("H", ["HH", 2], 0, "hour"),
              ...
              He(["h", "hh"], function (e, t, a) {
                (t[Ie] = xe(e)), (f(a).bigHour = !0);
              }),
              He("hmm", function (e, t, a) {
                var i = e.length - 2;
                (t[Ie] = xe(e.substr(0, i))),
                  (t[Re] = xe(e.substr(i))),
                  (f(a).bigHour = !0);
              }),
              He("hmmss", function (e, t, a) {
                var i = e.length - 4,
                  n = e.length - 2;
                (t[Ie] = xe(e.substr(0, i))),
                  (t[Re] = xe(e.substr(i, 2))),
                  (t[Ue] = xe(e.substr(n))),
                  (f(a).bigHour = !0);
              }),
              He("Hmm", function (e, t, a) {
                var i = e.length - 2;
                (t[Ie] = xe(e.substr(0, i))), (t[Re] = xe(e.substr(i)));
              }),
              He("Hmmss", function (e, t, a) {
                var i = e.length - 4,
                  n = e.length - 2;
              ...
              return (
                a &&
                  ...
                  ((t =
                    a[Le] < 0 || a[Le] > 11
                      ? Le
                      : a[Be] < 1 || a[Be] > at(a[je], a[Le])
                        ? Be
                        : a[Ie] < 0 ||
                            a[Ie] > 24 ||
                            (24 === a[Ie] &&
                              (0 !== a[Re] || 0 !== a[Ue] || 0 !== a[Ye]))
                          ? Ie
                          : a[Re] < 0 || a[Re] > 59
                            ? Re
                            : a[Ue] < 0 || a[Ue] > 59
                              ...
                              : a[Ye] < 0 || a[Ye] > 999
                                ? Ye
                                : -1),
                  f(e)._overflowDayOfYear && (t < je || t > Be) && (t = Be),
                  f(e)._overflowWeeks && -1 === t && (t = Ve),
                  f(e)._overflowWeekday && -1 === t && (t = Fe),
                  (f(e).overflow = t)),
                e
              );
            }
            ...
            function La(e) {
              ...
              if (!e._d) {
                ...
                24 === e._a[Ie] &&
                  ...
                  0 === e._a[Ue] &&
                  0 === e._a[Ye] &&
                  ((e._nextDay = !0), (e._a[Ie] = 0)),
                  (e._d = (e._useUTC ? yt : bt).apply(null, r)),
                  (n = e._useUTC ? e._d.getUTCDay() : e._d.getDay()),
                  null != e._tzm &&
                    e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm),
                  e._nextDay && (e._a[Ie] = 24),
                  e._w &&
                    void 0 !== e._w.d &&
                    e._w.d !== n &&
            ...
            function Ba(e) {
              ...
              null != (t = e._w).GG || null != t.W || null != t.E
                ? ((s = 1),
                  (r = 4),
                  (a = Ca(t.GG, e._a[je], kt(Za(), 1, 4).year)),
                  (i = Ca(t.W, 1)),
                  ((n = Ca(t.E, 1)) < 1 || n > 7) && (l = !0))
                : ((s = e._locale._week.dow),
                  (r = e._locale._week.doy),
                  (u = kt(Za(), s, r)),
                  (a = Ca(t.gg, e._a[je], u.year)),
                  (i = Ca(t.w, u.week)),
                  null != t.d
                    ? ((n = t.d) < 0 || n > 6) && (l = !0)
                    : null != t.e
              ...
              if (e._f !== i.ISO_8601)
                if (e._f !== i.RFC_2822) {
                  ...
                  (f(e).charsLeftOver = d - c),
                    ...
                    (e._a[Ie] = Ra(e._locale, e._a[Ie], e._meridiem)),
                    null !== (o = f(e).era) &&
              ...
              return (
                ...
                null === t || (void 0 === a && "" === t)
                  ...
                  : ("string" == typeof t && (e._i = t = e._locale.preparse(t)),
                    S(t)
                      ? new k(ya(t))
                      : (c(t) ? (e._d = t) : s(a) ? Ua(e) : a ? Ia(e) : Ga(e),
                        v(e) || (e._d = null),
                        e))
              );
            }
            ...
            function ai(e) {
              ...
              for (t in e)
                if (
                  o(e, t) &&
                  (-1 === We.call(ti, t) || (null != e[t] && isNaN(e[t])))
                )
                  return !1;
              for (a = 0; a < n; ++a)
                if (e[ti[a]]) {
                  if (i) return !1;
                  parseFloat(e[ti[a]]) !== xe(e[ti[a]]) && (i = !0);
                }
              return !0;
            }
            function ii() {
            ...
            function hi(e, t) {
              ...
              return t._isUTC
                ? ((a = t.clone()),
                  (n =
                    (S(e) || c(e) ? e.valueOf() : Za(e).valueOf()) -
                    a.valueOf()),
            ...
            function Di(e, t, a, n) {
              ...
              e.isValid() &&
                ((n = null == n || n),
                o && ht(e, Xe(e, "Month") + o * a),
                r && Je(e, "Date", Xe(e, "Date") + r * a),
            ...
            function Ci(e) {
              return (
                S(e) || c(e) || Ni(e) || d(e) || Li(e) || ji(e) || null == e
              );
            }
            function ji(e) {
              var t,
            ...
            function Ri(e, t) {
              ...
              return this.format(
                r || this.localeData().calendar(s, this, Za(a))
              );
            }
            function Ui() {
              return new k(this);
            ...
            function qi(e, t, a) {
              ...
              switch (
                ((n = 6e4 * (i.utcOffset() - this.utcOffset())), (t = ae(t)))
              ) {
                case "year":
                  s = Ki(this, i) / 12;
                  break;
              ...
              switch (((a = this._isUTC ? fn : gn), e)) {
                ...
                case "hour":
                  (t = this._d.valueOf()),
                    (t +=
                      hn -
                      mn(t + (this._isUTC ? 0 : this.utcOffset() * cn), hn) -
                      1);
                  break;
                case "minute":
            ...
            I("N", 0, 0, "eraAbbr"),
              ...
              Ae("NNNN", In),
              Ae("NNNNN", Rn),
              He(["N", "NN", "NNN", "NNNN", "NNNNN"], function (e, t, a, i) {
              ...
              Ae("GGGGG", ve, ce),
              Ae("ggggg", ve, ce),
              Pe(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, a, i) {
                t[i.substr(0, 2)] = xe(e);
              }),
  ...
  let gn = class extends pt(ue) {
    ...
    async _fetchData() {
      this.hass &&
        ((this.config = await ut(this.hass)),
        (this.zones = await dt(this.hass)),
        (this.modules = await ct(this.hass)),
        (this.mappings = await ht(this.hass)));
    }
  ...
  n([pe()], gn.prototype, "config", void 0),
    n([pe({ type: Array })], gn.prototype, "zones", void 0),
    n([pe({ type: Array })], gn.prototype, "modules", void 0),
    n([pe({ type: Array })], gn.prototype, "mappings", void 0),
    n([me("#nameInput")], gn.prototype, "nameInput", void 0),
    n([me("#sizeInput")], gn.prototype, "sizeInput", void 0),
    n([me("#throughputInput")], gn.prototype, "throughputInput", void 0),
    (gn = n([ce("smart-irrigation-view-zones")], gn));
  let fn = class extends pt(ue) {
    ...
    handleRemoveModule(e, t) {
      ...
      var i, n;
      ((this.modules = this.modules.filter((e, a) => a !== t)),
      this.hass && null != a) &&
        ((i = this.hass),
        (n = a.toString()),
        i.callApi("POST", _e + "/modules", { id: n, remove: !0 }));
    }
    saveToHA(e) {
      var t, a;
      this.hass &&
      ...
      if (this.hass) {
        ...
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            ...
            ${
              a
                ? Y` ${Zi("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it", this.hass.language)}`
                : Y` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
  ...
  n([pe()], fn.prototype, "config", void 0),
    n([pe({ type: Array })], fn.prototype, "zones", void 0),
    n([pe({ type: Array })], fn.prototype, "modules", void 0),
    n([pe({ type: Array })], fn.prototype, "allmodules", void 0),
    n([me("#moduleInput")], fn.prototype, "moduleInput", void 0),
    (fn = n([ce("smart-irrigation-view-modules")], fn));
  let vn = class extends pt(ue) {
    ...
    handleAddMapping() {
      const e = {
        ...
        t = { name: this.mappingNameInput.value, mappings: e };
    ...
    handleRemoveMapping(e, t) {
      ...
      var i, n;
      null != a &&
        ((this.mappings = this.mappings.filter((e, a) => a !== t)),
        this.hass &&
          ((i = this.hass),
          (n = a.toString()),
          i.callApi("POST", _e + "/mappings", { id: n, remove: !0 })));
    }
    ...
    saveToHA(e) {
      ...
      for (const a in e.mappings)
        if (
          ...
          "" != e.mappings[a].sensorentity.trim() &&
          ((e.mappings[a].sensorentity = e.mappings[a].sensorentity.trim()),
      ...
      if (this.hass) {
        ...
        <div class="card-content">
          <div class="card-content">
            ...
            ${
              a
                ? Y`${Zi("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it", this.hass.language)}`
                : Y` <svg
                    style="width:24px;height:24px"
                    viewBox="0 0 24 24"
                    id="deleteZone${e.id}"
  ...
  n([pe()], vn.prototype, "config", void 0),
    n([pe({ type: Array })], vn.prototype, "zones", void 0),
    n([pe({ type: Array })], vn.prototype, "mappings", void 0),
    n([me("#mappingNameInput")], vn.prototype, "mappingNameInput", void 0),
    (vn = n([ce("smart-irrigation-view-mappings")], vn));
  const bn = () => {
    const e = (e) => {
        let t = {};
  ...
  n([pe({ attribute: !1 })], yn.prototype, "hass", void 0),
    n(
      [
        (function (e) {
          return pe({ ...e, state: !0 });
