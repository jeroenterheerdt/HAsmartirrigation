    ...
    Oi = (function () {
      ...
      return (
          ...
          if (this.bumpIf(">")) {
            ...
            if (this.bumpIf("</")) {
              if (this.isEOF() || !xi(this.char()))
                return this.error(xa.INVALID_TAG, di(r, this.clonePosition()));
        ...
        (e.prototype.parseLiteral = function (e, t) {
          ...
          return {
            val: { type: za.literal, value: i, location: o },
            err: null,
          };
        }),
        (e.prototype.tryParseLeftAngleBracket = function () {
          return this.isEOF() ||
            60 !== this.char() ||
            (!this.ignoreTag && (xi((e = this.peek() || 0)) || 47 === e))
            ? null
            : (this.bump(), "<");
          var e;
        }),
        ...
        (e.prototype.parseArgument = function (e, t) {
          ...
          if ((this.bump(), this.bumpSpace(), this.isEOF()))
            return this.error(
              xa.EXPECT_ARGUMENT_CLOSING_BRACE,
              di(a, this.clonePosition())
            );
          if (125 === this.char())
            return (
              this.bump(),
              this.error(xa.EMPTY_ARGUMENT, di(a, this.clonePosition()))
            );
          var i = this.parseIdentifierIfPossible().value;
          if (!i)
            return this.error(
              xa.MALFORMED_ARGUMENT,
              di(a, this.clonePosition())
            );
          ...
          switch (o) {
            ...
            case "time":
              ...
              if (u && _i(null == u ? void 0 : u.style, "::", 0)) {
                ...
                if (0 === h.length)
                  return this.error(xa.EXPECT_DATE_TIME_SKELETON, c);
                var p = h;
                this.locale &&
                  (p = (function (e, t) {
            ...
            case "select":
              ...
              if ((this.bumpSpace(), !this.bumpIf(",")))
                return this.error(
                  xa.EXPECT_SELECT_ARGUMENT_OPTIONS,
                  di(g, i({}, g))
                );
              this.bumpSpace();
              ...
              if ("select" !== o && "offset" === f.value) {
                if (!this.bumpIf(":"))
                  return this.error(
                    xa.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                    di(this.clonePosition(), this.clonePosition())
                  );
                var b;
                if (
                  ...
                  (b = this.tryParseDecimalInteger(
                    xa.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                    xa.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE
                  )).err)
                )
                  return b;
                this.bumpSpace(),
          ...
          for (var e = 0, t = this.clonePosition(); !this.isEOF(); ) {
            switch (this.char()) {
              case 39:
                ...
                if (!this.bumpUntil("'"))
                  return this.error(
                    xa.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                    di(a, this.clonePosition())
                  );
                this.bump();
                break;
        ...
        (e.prototype.tryParsePluralOrSelectOptions = function (e, t, a, i) {
          for (
            ...
            if (0 === l.length) {
              ...
              var c = this.tryParseDecimalInteger(
                xa.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                xa.INVALID_PLURAL_ARGUMENT_SELECTOR
              );
              if (c.err) return c;
            ...
            if (o.has(l))
              return this.error(
                "select" === t
                  ? xa.DUPLICATE_SELECT_ARGUMENT_SELECTOR
                  : xa.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
                u
              );
            ...
            if (!this.bumpIf("{"))
              return this.error(
                "select" === t
                  ? xa.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
                  : xa.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
                di(this.clonePosition(), this.clonePosition())
              );
          ...
          return 0 === r.length
            ? this.error(
                "select" === t
                  ? xa.EXPECT_SELECT_ARGUMENT_SELECTOR
                  : xa.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                di(this.clonePosition(), this.clonePosition())
              )
            : this.requiresOtherClause && !s
              ? this.error(
                  xa.MISSING_OTHER_CLAUSE,
                  di(this.clonePosition(), this.clonePosition())
                )
              : { val: r, err: null };
        }),
        ...
        this.data.continuousupdates &&
          ...
          <div class="card-content">
            ...
            <input
              ...
              @input=${(e) => {
                this.saveData({ sensor_debounce: parseInt(e.target.value) });
              }}
            />
          </div>`),
          (i = Y`<ha-card
    ...
    render() {
      ...
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2025.6.1-beta0"}</div>
        </div>
