...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */var me,fe,be;null===(me=window.HTMLSlotElement)||void 0===me||me.prototype.assignedElements,function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(fe||(fe={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(be||(be={}));var ve=function(e,t,a,i){i=i||{},a=null==a?{}:a;var s=new Event(t,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return s.detail=a,e.dispatchEvent(s),s};const ye=async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()},$e="smart_irrigation",Ee="minutes",_e="hours",Ae="days",we="imperial",He="metric",Se="Dewpoint",Te="Evapotranspiration",Oe="Humidity",Be="Maximum Temperature",Me="Minimum Temperature",Pe="Precipitation",xe="Pressure",Ce="Solar Radiation",Ie="Temperature",Le="Windspeed",Ne="owm",ke="sensor",Re="static",Ue="none",je="source",ze="sensorentity",De="static_value",Ge="unit",Fe="aggregate",Ve=["average","first","last","maximum","median","minimum","sum"],Ze="size",We="throughput",Ke="duration",Xe=e=>e.callWS({type:$e+"/config"}),Ye=e=>e.callWS({type:$e+"/zones"}),qe=e=>e.callWS({type:$e+"/modules"}),Je=e=>e.callWS({type:$e+"/mappings"}),Qe=e=>{class t extends e{connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then((e=>e())):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return[]}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}}return s([de({attribute:!1})],t.prototype,"hass",void 0),t};var et,tt,at,it={actions:{delete:"Delete"},labels:{module:"Module",no:"No",select:"Select",yes:"Yes"}},st={general:{cards:{"automatic-duration-calculation":{header:"Automatic duration calculation",labels:{"auto-calc-enabled":"Automatically calculate zone durations","auto-calc-time":"Calculate at"}},"automatic-update":{errors:{"warning-update-time-on-or-after-calc-time":"Warning: weatherdata update time on or after calculation time"},header:"Automatic weather data update",labels:{"auto-update-enabled":"Automatically update weather data","auto-update-first-update":"(First) Update at","auto-update-interval":"Update sensor data every"},options:{days:"days",hours:"hours",minutes:"minutes"}}},description:"This page provides global settings.",title:"General"},help:{title:"Help",cards:{"how-to-get-help":{title:"How to get help","first-read-the":"First, read the",wiki:"Wiki","if-you-still-need-help":"If you still need help reach out on the","community-forum":"Community forum","or-open-a":"or open a","github-issue":"Github Issue","english-only":"English only"}}},mappings:{cards:{"add-mapping":{actions:{add:"Add sensor group"},header:"Add sensor groups"},mapping:{aggregates:{average:"Average",first:"First",last:"Last",maximum:"Maximum",median:"Median",minimum:"Minimum",sum:"Sum"},errors:{"cannot-delete-mapping-because-zones-use-it":"You cannot delete this sensor group because there is at least one zone using it."},items:{dewpoint:"Dewpoint",evapotranspiration:"Evapotranspiration",humidity:"Humidity","maximum temperature":"Maximum temperature","minimum temperature":"Minimum temperature",precipitation:"Total precipitation",pressure:"Pressure","solar radiation":"Solar radiation",temperature:"Temperature",windspeed:"Wind speed"},"sensor-aggregate-of-sensor-values-to-calculate":"of sensor values to calculate duration","sensor-aggregate-use-the":"Use the","sensor-entity":"Sensor entity",static_value:"Value","input-units":"Input provides values in",source:"Source",sources:{none:"None",openweathermap:"OpenWeatherMap",sensor:"Sensor",static:"Static value"}}},description:"Add one or more sensor groups that retrieve weather data from OpenWeatherMap, from sensors or a combination of these. You can map each sensor group to one or more zones",labels:{"mapping-name":"Name"},no_items:"There are no sensor group defined yet.",title:"Sensor Groups"},modules:{cards:{"add-module":{actions:{add:"Add module"},header:"Add module"},module:{errors:{"cannot-delete-module-because-zones-use-it":"You cannot delete this module because there is at least one zone using it."},labels:{configuration:"Configuration",required:"indicates a required field"},"translated-options":{DontEstimate:"Do not estimate",EstimateFromSunHours:"Estimate from sun hours",EstimateFromTemp:"Estimate from temperature"}}},description:"Add one or more modules that calculate irrigation duration. Each module comes with its own configuration and can be used to calculate duration for one or more zones.",no_items:"There are no modules defined yet.",title:"Modules"},zones:{actions:{add:"Add",calculate:"Calculate",information:"Information",update:"Update"},cards:{"add-zone":{actions:{add:"Add zone"},header:"Add zone"},"zone-actions":{actions:{"calculate-all":"Calculate all zones","update-all":"Update all zones"},header:"Actions on all zones"}},description:"Specify one or more irrigation zones here. The irrigation duration is calculated per zone, depending on size, throughput, state, module and sensor group.",labels:{bucket:"Bucket",duration:"Duration","lead-time":"Lead time",mapping:"Sensor Group","maximum-duration":"Maximum duration",multiplier:"Multiplier",name:"Name",size:"Size",state:"State",states:{automatic:"Automatic",disabled:"Disabled",manual:"Manual"},throughput:"Throughput","maximum-bucket":"Maximum bucket"},no_items:"There are no zones defined yet.",title:"Zones"}},nt="Smart Irrigation",rt={common:it,panels:st,title:nt},ot=Object.freeze({__proto__:null,common:it,panels:st,title:nt,default:rt}),lt={actions:{delete:"Verwijderen"},labels:{module:"Module",no:"Nee",select:"Kies",yes:"Ja"}},ht={general:{cards:{"automatic-duration-calculation":{header:"Automatische berekening van irrigatietijd",labels:{"auto-calc-enabled":"Automatisch irrigatietijd berekening voor elke zone","auto-calc-time":"Berekenen op"}},"automatic-update":{errors:{"warning-update-time-on-or-after-calc-time":"Let op: het automatisch bijwerken van weer gegevens vind plaats op of na de automatische berekening van irrigatietijd"},header:"Automatisch bijwerken van weer gegevens",labels:{"auto-update-enabled":"Automatisch weergegevens bijwerken","auto-update-first-update":"(Eerste keer) Bijwerken op ","auto-update-interval":"Sensor data bijwerken elke"},options:{days:"dagen",hours:"uren",minutes:"minuten"}}},description:"Dit zijn de algemene instellingen.",title:"Algemeen"},help:{title:"Hulp",cards:{"how-to-get-help":{title:"Hulp vragen","first-read-the":"Allereerst, lees de",wiki:"Wiki","if-you-still-need-help":"Als je hierna nog steeds hulp nodig hebt, laat een bericht achter op het","community-forum":"Community forum","or-open-a":"of open een","github-issue":"Github Issue","english-only":"alleen Engels"}}},mappings:{cards:{"add-mapping":{actions:{add:"Toevoegen"},header:"Voeg sensorgroep toe"},mapping:{aggregates:{average:"Gemiddelde",first:"Eerste",last:"Laatste",maximum:"Maximum",median:"Mediaan",minimum:"Minimum",sum:"Totaal"},errors:{"cannot-delete-mapping-because-zones-use-it":"Deze sensorgroep kan niet worden verwijderd omdat er minimaal een zone gebruik van maakt."},items:{dewpoint:"Dauwpunt",evapotranspiration:"Verdamping",humidity:"Vochtigheid","maximum temperature":"Maximum temperatuur","minimum temperature":"Minimum temperatuur",precipitation:"Totale neerslag",pressure:"Druk","solar radiation":"Zonnestraling",temperature:"Temperatuur",windspeed:"Wind snelheid"},"sensor-aggregate-of-sensor-values-to-calculate":"van de sensor waardes om irrigatietijd te berekenen","sensor-aggregate-use-the":"Gebruik de/het","sensor-entity":"Sensor entiteit","input-units":"Invoer geeft waardes in",static_value:"Waarde",source:"Bron",sources:{none:"Geen",openweathermap:"OpenWeatherMap",sensor:"Sensor",static:"Vaste waarde"}}},description:"Voeg een of meer sensorgroepen toe die weergegevens ophalen van OpenWeatherMap, van sensoren of een combinatie. Elke sensorgroep kan worden gebruikt voor een of meerdere zones",labels:{"mapping-name":"Name"},no_items:"Er zijn nog geen sensorgroepen.",title:"Sensorgroepen"},modules:{cards:{"add-module":{actions:{add:"Toevoegen"},header:"Voeg module toe"},module:{errors:{"cannot-delete-module-because-zones-use-it":"Deze module kan niet worden verwijderd omdat er minimaal een zone gebruik van maakt."},labels:{configuration:"Instellingen",required:"verplicht veld"},"translated-options":{DontEstimate:"Niet berekenen",EstimateFromSunHours:"Gebaseerd op zon uren",EstimateFromTemp:"Gebaseerd op temperatuur"}}},description:"Voeg een of meerdere modules toe. Modules berekenen irrigatietijd. Elke module heeft zijn eigen configuratie and kan worden gebruikt voor het berekening van irrigatietijd voor een of meerdere zones.",no_items:"Er zijn nog geen modules.",title:"Modules"},zones:{actions:{add:"Toevoegen",calculate:"Bereken",information:"Informatie",update:"Bijwerken"},cards:{"add-zone":{actions:{add:"Toevoegen"},header:"Voeg zone toe"},"zone-actions":{actions:{"calculate-all":"Bereken alle zones","update-all":"Werk alle zone data bij"},header:"Acties voor alle zones"}},description:"Voeg een of meerdere zones toe. Per zone wordt de irrigatietijd berekend, afhankelijk van de afmeting, doorvoer, status, module en sensorgroep.",labels:{bucket:"Voorraad",duration:"Irrigatieduur","lead-time":"Aanlooptijd",mapping:"Sensorgroep","maximum-duration":"Maximale duur",multiplier:"Vermenigvuldiger",name:"Naam",size:"Afmeting",state:"Status",states:{automatic:"Automatisch",disabled:"Uit",manual:"Manueel"},throughput:"Doorvoer","maximum-bucket":"Maximale voorraad"},no_items:"Er zijn nog geen zones.",title:"Zones"}},ut="Smart Irrigation",ct={common:lt,panels:ht,title:ut},pt=Object.freeze({__proto__:null,common:lt,panels:ht,title:ut,default:ct}),dt={actions:{delete:"Lösche"},labels:{module:"Modul",no:"Nein",select:"Wähle",yes:"Ja"}},gt={general:{cards:{"automatic-duration-calculation":{header:"Automatische Berechnung der Bewässerungsdauer",labels:{"auto-calc-enabled":"Automatische Berechnung der Dauer pro Zone","auto-calc-time":"Berechne um"}},"automatic-update":{errors:{"warning-update-time-on-or-after-calc-time":"Hinweis: Die automatische Aktualisierung der Wetterdaten erfolgt bei oder nach der automatischen Berechnung der Bewässerungsdauer"},header:"Automatische Aktualisierung der Wetterdaten",labels:{"auto-update-enabled":"Automatisches Update der Wetterdaten","auto-update-first-update":"(Erster) Update um","auto-update-interval":"Update der Sensordaten alle"},options:{days:"Tage",hours:"Stunden",minutes:"Minuten"}}},description:"Diese Seite ist für allgemeine Einstellungen.",title:"Allgemein"},help:{title:"Hilfe"},mappings:{cards:{"add-mapping":{actions:{add:"Hinzufügen"},header:"Sensorgruppe hinzufügen"},mapping:{aggregates:{average:"Durchschnitt",first:"Erster",last:"Letzter",maximum:"Maximum",median:"Median",minimum:"Minimum",sum:"Summe"},errors:{"cannot-delete-mapping-because-zones-use-it":"Diese Sensorgruppe kann nicht entfernt werden, da sie von mindestens einer Zone verwendet wird."},items:{dewpoint:"Taupunkt",evapotranspiration:"Verdunstung",humidity:"Feuchtigkeit","maximum temperature":"Maximum-Temperatur","minimum temperature":"Minimum-Temperatur",precipitation:"Gesamtniederschlag",pressure:"Luftdruck","solar radiation":"Sonnenstrahlung",temperature:"Temperatur",windspeed:"Windgeschwindikeit"},"sensor-aggregate-of-sensor-values-to-calculate":"des Sensors für die Berechnung.","sensor-aggregate-use-the":"Nutze den/die/das","sensor-entity":"Sensor Entität","input-units":"Sensor Werte in",source:"Quelle",sources:{none:"Kein",openweathermap:"OpenWeatherMap",sensor:"Sensor"}}},description:"Füge eine oder mehrere Sensorgruppen hinzu, die Wetterdaten von OpenWeatherMap, Sensoren oder einer Kombination daraus abrufen. Jede Sensorgruppe kann für eine oder mehrere Zonen verwendet werden",labels:{"mapping-name":"Name"},no_items:"Es ist noch keine Sensorgruppe angelegt.",title:"Sensorgruppen"},modules:{cards:{"add-module":{actions:{add:"Hinzufügen"},header:"Modul hinzufügen"},module:{errors:{"cannot-delete-module-because-zones-use-it":"Dieses Modul kann nicht entfernt werden, da es von mindestens einer Zone verwendet wird."},labels:{configuration:"Konfiguration",required:"Feld ist erforderlich"},"translated-options":{DontEstimate:"Nicht berechnen",EstimateFromSunHours:"Basierend auf den Sonnenstunden",EstimateFromTemp:"Basierend auf der Temperatur"}}},description:"Füge ein oder mehrere Module hinzu. Module berechnen die Bewässerungsdauer. Jedes Modul hat seine eigene Konfiguration und kann zur Berechnung der Bewässerungsdauer für eine oder mehrere Zonen verwendet werden.",no_items:"Es ist noch kein Module angelegt.",title:"Module"},zones:{actions:{add:"Hinzufügen",calculate:"Bewässerungsdauer berechnen.",information:"Information",update:"Wetterdaten aktualisieren."},cards:{"add-zone":{actions:{add:"Hinzufügen"},header:"Zone hinzufügen"},"zone-actions":{actions:{"calculate-all":"Alle Zonen berechnen","update-all":"Alle Zonen aktualisieren"},header:"Aktionen für alle Zonen"}},description:"Füge eine oder mehrere Zonen hinzu. Die Bewässerungsdauer wird pro Zone, abhängig von Größe, Durchsatz, Status, Modul und Sensorgruppe berechnet.",labels:{bucket:"Vorrat",duration:"Dauer","lead-time":"Anlaufzeit",mapping:"Sensorgruppe","maximum-duration":"Maximale Dauer",multiplier:"Multiplikator",name:"Name",size:"Größe",state:"Berechnung",states:{automatic:"Automatisch",disabled:"Aus",manual:"Manuell"},throughput:"Durchfluss"},no_items:"Es ist noch keine Zone vorhanden.",title:"Zonen"}},mt="Smart Irrigation",ft={common:dt,panels:gt,title:mt},bt=Object.freeze({__proto__:null,common:dt,panels:gt,title:mt,default:ft});function vt(e){return e.type===tt.literal}function yt(e){return e.type===tt.argument}function $t(e){return e.type===tt.number}function Et(e){return e.type===tt.date}function _t(e){return e.type===tt.time}function At(e){return e.type===tt.select}function wt(e){return e.type===tt.plural}function Ht(e){return e.type===tt.pound}function St(e){return e.type===tt.tag}function Tt(e){return!(!e||"object"!=typeof e||e.type!==at.number)}function Ot(e){return!(!e||"object"!=typeof e||e.type!==at.dateTime)}!function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"}(et||(et={})),function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"}(tt||(tt={})),function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"}(at||(at={}));var Bt=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/,Mt=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Pt(e){var t={};return e.replace(Mt,(function(e){var a=e.length;switch(e[0]){case"G":t.era=4===a?"long":5===a?"narrow":"short";break;case"y":t.year=2===a?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=4===a?"short":5===a?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][a-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][a-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][a-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][a-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][a-1];break;case"s":t.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""})),t}var xt=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;var Ct=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,It=/^(@+)?(\+|#+)?[rs]?$/g,Lt=/(\*)(0+)|(#+)(0+)|(0+)/g,Nt=/^(0+)$/;function kt(e){var t={};return"r"===e[e.length-1]?t.roundingPriority="morePrecision":"s"===e[e.length-1]&&(t.roundingPriority="lessPrecision"),e.replace(It,(function(e,a,i){return"string"!=typeof i?(t.minimumSignificantDigits=a.length,t.maximumSignificantDigits=a.length):"+"===i?t.minimumSignificantDigits=a.length:"#"===a[0]?t.maximumSignificantDigits=a.length:(t.minimumSignificantDigits=a.length,t.maximumSignificantDigits=a.length+("string"==typeof i?i.length:0)),""})),t}function Rt(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Ut(e){var t;if("E"===e[0]&&"E"===e[1]?(t={notation:"engineering"},e=e.slice(2)):"E"===e[0]&&(t={notation:"scientific"},e=e.slice(1)),t){var a=e.slice(0,2);if("+!"===a?(t.signDisplay="always",e=e.slice(2)):"+?"===a&&(t.signDisplay="exceptZero",e=e.slice(2)),!Nt.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function jt(e){var t=Rt(e);return t||{}}function zt(e){for(var t={},a=0,s=e;a<s.length;a++){var n=s[a];switch(n.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=n.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=n.options[0].replace(/^(.*?)-/,"");continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=i(i(i({},t),{notation:"scientific"}),n.options.reduce((function(e,t){return i(i({},e),jt(t))}),{}));continue;case"engineering":t=i(i(i({},t),{notation:"engineering"}),n.options.reduce((function(e,t){return i(i({},e),jt(t))}),{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(n.options[0]);continue;case"integer-width":if(n.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");n.options[0].replace(Lt,(function(e,a,i,s,n,r){if(a)t.minimumIntegerDigits=i.length;else{if(s&&n)throw new Error("We currently do not support maximum integer digits");if(r)throw new Error("We currently do not support exact integer digits")}return""}));continue}if(Nt.test(n.stem))t.minimumIntegerDigits=n.stem.length;else if(Ct.test(n.stem)){if(n.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");n.stem.replace(Ct,(function(e,a,i,s,n,r){return"*"===i?t.minimumFractionDigits=a.length:s&&"#"===s[0]?t.maximumFractionDigits=s.length:n&&r?(t.minimumFractionDigits=n.length,t.maximumFractionDigits=n.length+r.length):(t.minimumFractionDigits=a.length,t.maximumFractionDigits=a.length),""}));var r=n.options[0];"w"===r?t=i(i({},t),{trailingZeroDisplay:"stripIfInteger"}):r&&(t=i(i({},t),kt(r)))}else if(It.test(n.stem))t=i(i({},t),kt(n.stem));else{var o=Rt(n.stem);o&&(t=i(i({},t),o));var l=Ut(n.stem);l&&(t=i(i({},t),l))}}return t}var Dt,Gt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Ft(e){var t=e.hourCycle;if(void 0===t&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var a,i=e.language;return"root"!==i&&(a=e.maximize().region),(Gt[a||""]||Gt[i||""]||Gt["".concat(i,"-001")]||Gt["001"])[0]}var Vt=new RegExp("^".concat(Bt.source,"*")),Zt=new RegExp("".concat(Bt.source,"*$"));function Wt(e,t){return{start:e,end:t}}var Kt=!!String.prototype.startsWith,Xt=!!String.fromCodePoint,Yt=!!Object.fromEntries,qt=!!String.prototype.codePointAt,Jt=!!String.prototype.trimStart,Qt=!!String.prototype.trimEnd,ea=!!Number.isSafeInteger?Number.isSafeInteger:function(e){return"number"==typeof e&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},ta=!0;try{ta="a"===(null===(Dt=ha("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu").exec("a"))||void 0===Dt?void 0:Dt[0])}catch(k){ta=!1}var aa,ia=Kt?function(e,t,a){return e.startsWith(t,a)}:function(e,t,a){return e.slice(a,a+t.length)===t},sa=Xt?String.fromCodePoint:function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];for(var a,i="",s=e.length,n=0;s>n;){if((a=e[n++])>1114111)throw RangeError(a+" is not a valid code point");i+=a<65536?String.fromCharCode(a):String.fromCharCode(55296+((a-=65536)>>10),a%1024+56320)}return i},na=Yt?Object.fromEntries:function(e){for(var t={},a=0,i=e;a<i.length;a++){var s=i[a],n=s[0],r=s[1];t[n]=r}return t},ra=qt?function(e,t){return e.codePointAt(t)}:function(e,t){var a=e.length;if(!(t<0||t>=a)){var i,s=e.charCodeAt(t);return s<55296||s>56319||t+1===a||(i=e.charCodeAt(t+1))<56320||i>57343?s:i-56320+(s-55296<<10)+65536}},oa=Jt?function(e){return e.trimStart()}:function(e){return e.replace(Vt,"")},la=Qt?function(e){return e.trimEnd()}:function(e){return e.replace(Zt,"")};function ha(e,t){return new RegExp(e,t)}if(ta){var ua=ha("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu");aa=function(e,t){var a;return ua.lastIndex=t,null!==(a=ua.exec(e)[1])&&void 0!==a?a:""}}else aa=function(e,t){for(var a=[];;){var i=ra(e,t);if(void 0===i||ga(i)||ma(i))break;a.push(i),t+=i>=65536?2:1}return sa.apply(void 0,a)};var ca=function(){function e(e,t){void 0===t&&(t={}),this.message=e,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(0!==this.offset())throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(e,t,a){for(var i=[];!this.isEOF();){var s=this.char();if(123===s){if((n=this.parseArgument(e,a)).err)return n;i.push(n.val)}else{if(125===s&&e>0)break;if(35!==s||"plural"!==t&&"selectordinal"!==t){if(60===s&&!this.ignoreTag&&47===this.peek()){if(a)break;return this.error(et.UNMATCHED_CLOSING_TAG,Wt(this.clonePosition(),this.clonePosition()))}if(60===s&&!this.ignoreTag&&pa(this.peek()||0)){if((n=this.parseTag(e,t)).err)return n;i.push(n.val)}else{var n;if((n=this.parseLiteral(e,t)).err)return n;i.push(n.val)}}else{var r=this.clonePosition();this.bump(),i.push({type:tt.pound,location:Wt(r,this.clonePosition())})}}}return{val:i,err:null}},e.prototype.parseTag=function(e,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:tt.literal,value:"<".concat(i,"/>"),location:Wt(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var s=this.parseMessage(e+1,t,!0);if(s.err)return s;var n=s.val,r=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!pa(this.char()))return this.error(et.INVALID_TAG,Wt(r,this.clonePosition()));var o=this.clonePosition();return i!==this.parseTagName()?this.error(et.UNMATCHED_CLOSING_TAG,Wt(o,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:tt.tag,value:i,children:n,location:Wt(a,this.clonePosition())},err:null}:this.error(et.INVALID_TAG,Wt(r,this.clonePosition())))}return this.error(et.UNCLOSED_TAG,Wt(a,this.clonePosition()))}return this.error(et.INVALID_TAG,Wt(a,this.clonePosition()))},e.prototype.parseTagName=function(){var e=this.offset();for(this.bump();!this.isEOF()&&da(this.char());)this.bump();return this.message.slice(e,this.offset())},e.prototype.parseLiteral=function(e,t){for(var a=this.clonePosition(),i="";;){var s=this.tryParseQuote(t);if(s)i+=s;else{var n=this.tryParseUnquoted(e,t);if(n)i+=n;else{var r=this.tryParseLeftAngleBracket();if(!r)break;i+=r}}}var o=Wt(a,this.clonePosition());return{val:{type:tt.literal,value:i,location:o},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return this.isEOF()||60!==this.char()||!this.ignoreTag&&(pa(e=this.peek()||0)||47===e)?null:(this.bump(),"<");var e},e.prototype.tryParseQuote=function(e){if(this.isEOF()||39!==this.char())return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if("plural"===e||"selectordinal"===e)break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(39===a){if(39!==this.peek()){this.bump();break}t.push(39),this.bump()}else t.push(a);this.bump()}return sa.apply(void 0,t)},e.prototype.tryParseUnquoted=function(e,t){if(this.isEOF())return null;var a=this.char();return 60===a||123===a||35===a&&("plural"===t||"selectordinal"===t)||125===a&&e>0?null:(this.bump(),sa(a))},e.prototype.parseArgument=function(e,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(et.EXPECT_ARGUMENT_CLOSING_BRACE,Wt(a,this.clonePosition()));if(125===this.char())return this.bump(),this.error(et.EMPTY_ARGUMENT,Wt(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(et.MALFORMED_ARGUMENT,Wt(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(et.EXPECT_ARGUMENT_CLOSING_BRACE,Wt(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:tt.argument,value:i,location:Wt(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(et.EXPECT_ARGUMENT_CLOSING_BRACE,Wt(a,this.clonePosition())):this.parseArgumentOptions(e,t,i,a);default:return this.error(et.MALFORMED_ARGUMENT,Wt(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var e=this.clonePosition(),t=this.offset(),a=aa(this.message,t),i=t+a.length;return this.bumpTo(i),{value:a,location:Wt(e,this.clonePosition())}},e.prototype.parseArgumentOptions=function(e,t,a,s){var n,r=this.clonePosition(),o=this.parseIdentifierIfPossible().value,l=this.clonePosition();switch(o){case"":return this.error(et.EXPECT_ARGUMENT_TYPE,Wt(r,l));case"number":case"date":case"time":this.bumpSpace();var h=null;if(this.bumpIf(",")){this.bumpSpace();var u=this.clonePosition();if((v=this.parseSimpleArgStyleIfPossible()).err)return v;if(0===(g=la(v.val)).length)return this.error(et.EXPECT_ARGUMENT_STYLE,Wt(this.clonePosition(),this.clonePosition()));h={style:g,styleLocation:Wt(u,this.clonePosition())}}if((y=this.tryParseArgumentClose(s)).err)return y;var c=Wt(s,this.clonePosition());if(h&&ia(null==h?void 0:h.style,"::",0)){var p=oa(h.style.slice(2));if("number"===o)return(v=this.parseNumberSkeletonFromString(p,h.styleLocation)).err?v:{val:{type:tt.number,value:a,location:c,style:v.val},err:null};if(0===p.length)return this.error(et.EXPECT_DATE_TIME_SKELETON,c);var d=p;this.locale&&(d=function(e,t){for(var a="",i=0;i<e.length;i++){var s=e.charAt(i);if("j"===s){for(var n=0;i+1<e.length&&e.charAt(i+1)===s;)n++,i++;var r=1+(1&n),o=n<2?1:3+(n>>1),l=Ft(t);for("H"!=l&&"k"!=l||(o=0);o-- >0;)a+="a";for(;r-- >0;)a=l+a}else a+="J"===s?"H":s}return a}(p,this.locale));var g={type:at.dateTime,pattern:d,location:h.styleLocation,parsedOptions:this.shouldParseSkeletons?Pt(d):{}};return{val:{type:"date"===o?tt.date:tt.time,value:a,location:c,style:g},err:null}}return{val:{type:"number"===o?tt.number:"date"===o?tt.date:tt.time,value:a,location:c,style:null!==(n=null==h?void 0:h.style)&&void 0!==n?n:null},err:null};case"plural":case"selectordinal":case"select":var m=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(et.EXPECT_SELECT_ARGUMENT_OPTIONS,Wt(m,i({},m)));this.bumpSpace();var f=this.parseIdentifierIfPossible(),b=0;if("select"!==o&&"offset"===f.value){if(!this.bumpIf(":"))return this.error(et.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,Wt(this.clonePosition(),this.clonePosition()));var v;if(this.bumpSpace(),(v=this.tryParseDecimalInteger(et.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,et.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE)).err)return v;this.bumpSpace(),f=this.parseIdentifierIfPossible(),b=v.val}var y,$=this.tryParsePluralOrSelectOptions(e,o,t,f);if($.err)return $;if((y=this.tryParseArgumentClose(s)).err)return y;var E=Wt(s,this.clonePosition());return"select"===o?{val:{type:tt.select,value:a,options:na($.val),location:E},err:null}:{val:{type:tt.plural,value:a,options:na($.val),offset:b,pluralType:"plural"===o?"cardinal":"ordinal",location:E},err:null};default:return this.error(et.INVALID_ARGUMENT_TYPE,Wt(r,l))}},e.prototype.tryParseArgumentClose=function(e){return this.isEOF()||125!==this.char()?this.error(et.EXPECT_ARGUMENT_CLOSING_BRACE,Wt(e,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var e=0,t=this.clonePosition();!this.isEOF();){switch(this.char()){case 39:this.bump();var a=this.clonePosition();if(!this.bumpUntil("'"))return this.error(et.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,Wt(a,this.clonePosition()));this.bump();break;case 123:e+=1,this.bump();break;case 125:if(!(e>0))return{val:this.message.slice(t.offset,this.offset()),err:null};e-=1;break;default:this.bump()}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(e,t){var a=[];try{a=function(e){if(0===e.length)throw new Error("Number skeleton cannot be empty");for(var t=e.split(xt).filter((function(e){return e.length>0})),a=[],i=0,s=t;i<s.length;i++){var n=s[i].split("/");if(0===n.length)throw new Error("Invalid number skeleton");for(var r=n[0],o=n.slice(1),l=0,h=o;l<h.length;l++)if(0===h[l].length)throw new Error("Invalid number skeleton");a.push({stem:r,options:o})}return a}(e)}catch(e){return this.error(et.INVALID_NUMBER_SKELETON,t)}return{val:{type:at.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?zt(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(e,t,a,i){for(var s,n=!1,r=[],o=new Set,l=i.value,h=i.location;;){if(0===l.length){var u=this.clonePosition();if("select"===t||!this.bumpIf("="))break;var c=this.tryParseDecimalInteger(et.EXPECT_PLURAL_ARGUMENT_SELECTOR,et.INVALID_PLURAL_ARGUMENT_SELECTOR);if(c.err)return c;h=Wt(u,this.clonePosition()),l=this.message.slice(u.offset,this.offset())}if(o.has(l))return this.error("select"===t?et.DUPLICATE_SELECT_ARGUMENT_SELECTOR:et.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,h);"other"===l&&(n=!0),this.bumpSpace();var p=this.clonePosition();if(!this.bumpIf("{"))return this.error("select"===t?et.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:et.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,Wt(this.clonePosition(),this.clonePosition()));var d=this.parseMessage(e+1,t,a);if(d.err)return d;var g=this.tryParseArgumentClose(p);if(g.err)return g;r.push([l,{value:d.val,location:Wt(p,this.clonePosition())}]),o.add(l),this.bumpSpace(),l=(s=this.parseIdentifierIfPossible()).value,h=s.location}return 0===r.length?this.error("select"===t?et.EXPECT_SELECT_ARGUMENT_SELECTOR:et.EXPECT_PLURAL_ARGUMENT_SELECTOR,Wt(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!n?this.error(et.MISSING_OTHER_CLAUSE,Wt(this.clonePosition(),this.clonePosition())):{val:r,err:null}},e.prototype.tryParseDecimalInteger=function(e,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var s=!1,n=0;!this.isEOF();){var r=this.char();if(!(r>=48&&r<=57))break;s=!0,n=10*n+(r-48),this.bump()}var o=Wt(i,this.clonePosition());return s?ea(n*=a)?{val:n,err:null}:this.error(t,o):this.error(e,o)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var e=this.position.offset;if(e>=this.message.length)throw Error("out of bound");var t=ra(this.message,e);if(void 0===t)throw Error("Offset ".concat(e," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(e,t){return{val:null,err:{kind:e,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var e=this.char();10===e?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=e<65536?1:2)}},e.prototype.bumpIf=function(e){if(ia(this.message,e,this.offset())){for(var t=0;t<e.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(e){var t=this.offset(),a=this.message.indexOf(e,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(e){if(this.offset()>e)throw Error("targetOffset ".concat(e," must be greater than or equal to the current offset ").concat(this.offset()));for(e=Math.min(e,this.message.length);;){var t=this.offset();if(t===e)break;if(t>e)throw Error("targetOffset ".concat(e," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&ga(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var e=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(e>=65536?2:1));return null!=a?a:null},e}();function pa(e){return e>=97&&e<=122||e>=65&&e<=90}function da(e){return 45===e||46===e||e>=48&&e<=57||95===e||e>=97&&e<=122||e>=65&&e<=90||183==e||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function ga(e){return e>=9&&e<=13||32===e||133===e||e>=8206&&e<=8207||8232===e||8233===e}function ma(e){return e>=33&&e<=35||36===e||e>=37&&e<=39||40===e||41===e||42===e||43===e||44===e||45===e||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||91===e||92===e||93===e||94===e||96===e||123===e||124===e||125===e||126===e||161===e||e>=162&&e<=165||166===e||167===e||169===e||171===e||172===e||174===e||176===e||177===e||182===e||187===e||191===e||215===e||247===e||e>=8208&&e<=8213||e>=8214&&e<=8215||8216===e||8217===e||8218===e||e>=8219&&e<=8220||8221===e||8222===e||8223===e||e>=8224&&e<=8231||e>=8240&&e<=8248||8249===e||8250===e||e>=8251&&e<=8254||e>=8257&&e<=8259||8260===e||8261===e||8262===e||e>=8263&&e<=8273||8274===e||8275===e||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||8608===e||e>=8609&&e<=8610||8611===e||e>=8612&&e<=8613||8614===e||e>=8615&&e<=8621||8622===e||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||8658===e||8659===e||8660===e||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||8968===e||8969===e||8970===e||8971===e||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||9001===e||9002===e||e>=9003&&e<=9083||9084===e||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||9655===e||e>=9656&&e<=9664||9665===e||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||9839===e||e>=9840&&e<=10087||10088===e||10089===e||10090===e||10091===e||10092===e||10093===e||10094===e||10095===e||10096===e||10097===e||10098===e||10099===e||10100===e||10101===e||e>=10132&&e<=10175||e>=10176&&e<=10180||10181===e||10182===e||e>=10183&&e<=10213||10214===e||10215===e||10216===e||10217===e||10218===e||10219===e||10220===e||10221===e||10222===e||10223===e||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||10627===e||10628===e||10629===e||10630===e||10631===e||10632===e||10633===e||10634===e||10635===e||10636===e||10637===e||10638===e||10639===e||10640===e||10641===e||10642===e||10643===e||10644===e||10645===e||10646===e||10647===e||10648===e||e>=10649&&e<=10711||10712===e||10713===e||10714===e||10715===e||e>=10716&&e<=10747||10748===e||10749===e||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||11158===e||e>=11159&&e<=11263||e>=11776&&e<=11777||11778===e||11779===e||11780===e||11781===e||e>=11782&&e<=11784||11785===e||11786===e||11787===e||11788===e||11789===e||e>=11790&&e<=11798||11799===e||e>=11800&&e<=11801||11802===e||11803===e||11804===e||11805===e||e>=11806&&e<=11807||11808===e||11809===e||11810===e||11811===e||11812===e||11813===e||11814===e||11815===e||11816===e||11817===e||e>=11818&&e<=11822||11823===e||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||11840===e||11841===e||11842===e||e>=11843&&e<=11855||e>=11856&&e<=11857||11858===e||e>=11859&&e<=11903||e>=12289&&e<=12291||12296===e||12297===e||12298===e||12299===e||12300===e||12301===e||12302===e||12303===e||12304===e||12305===e||e>=12306&&e<=12307||12308===e||12309===e||12310===e||12311===e||12312===e||12313===e||12314===e||12315===e||12316===e||12317===e||e>=12318&&e<=12319||12320===e||12336===e||64830===e||64831===e||e>=65093&&e<=65094}function fa(e){e.forEach((function(e){if(delete e.location,At(e)||wt(e))for(var t in e.options)delete e.options[t].location,fa(e.options[t].value);else $t(e)&&Tt(e.style)||(Et(e)||_t(e))&&Ot(e.style)?delete e.style.location:St(e)&&fa(e.children)}))}function ba(e,t){void 0===t&&(t={}),t=i({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var a=new ca(e,t).parse();if(a.err){var s=SyntaxError(et[a.err.kind]);throw s.location=a.err.location,s.originalMessage=a.err.message,s}return(null==t?void 0:t.captureLocation)||fa(a.val),a.val}function va(e,t){var a=t&&t.cache?t.cache:Sa,i=t&&t.serializer?t.serializer:Aa;return(t&&t.strategy?t.strategy:_a)(e,{cache:a,serializer:i})}function ya(e,t,a,i){var s,n=null==(s=i)||"number"==typeof s||"boolean"==typeof s?i:a(i),r=t.get(n);return void 0===r&&(r=e.call(this,i),t.set(n,r)),r}function $a(e,t,a){var i=Array.prototype.slice.call(arguments,3),s=a(i),n=t.get(s);return void 0===n&&(n=e.apply(this,i),t.set(s,n)),n}function Ea(e,t,a,i,s){return a.bind(t,e,i,s)}function _a(e,t){return Ea(e,this,1===e.length?ya:$a,t.cache.create(),t.serializer)}var Aa=function(){return JSON.stringify(arguments)};function wa(){this.cache=Object.create(null)}wa.prototype.get=function(e){return this.cache[e]},wa.prototype.set=function(e,t){this.cache[e]=t};var Ha,Sa={create:function(){return new wa}},Ta={variadic:function(e,t){return Ea(e,this,$a,t.cache.create(),t.serializer)},monadic:function(e,t){return Ea(e,this,ya,t.cache.create(),t.serializer)}};!function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"}(Ha||(Ha={}));var Oa,Ba=function(e){function t(t,a,i){var s=e.call(this,t)||this;return s.code=a,s.originalMessage=i,s}return a(t,e),t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error),Ma=function(e){function t(t,a,i,s){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),Ha.INVALID_VALUE,s)||this}return a(t,e),t}(Ba),Pa=function(e){function t(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),Ha.INVALID_VALUE,i)||this}return a(t,e),t}(Ba),xa=function(e){function t(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),Ha.MISSING_VALUE,a)||this}return a(t,e),t}(Ba);function Ca(e){return"function"==typeof e}function Ia(e,t,a,i,s,n,r){if(1===e.length&&vt(e[0]))return[{type:Oa.literal,value:e[0].value}];for(var o=[],l=0,h=e;l<h.length;l++){var u=h[l];if(vt(u))o.push({type:Oa.literal,value:u.value});else if(Ht(u))"number"==typeof n&&o.push({type:Oa.literal,value:a.getNumberFormat(t).format(n)});else{var c=u.value;if(!s||!(c in s))throw new xa(c,r);var p=s[c];if(yt(u))p&&"string"!=typeof p&&"number"!=typeof p||(p="string"==typeof p||"number"==typeof p?String(p):""),o.push({type:"string"==typeof p?Oa.literal:Oa.object,value:p});else if(Et(u)){var d="string"==typeof u.style?i.date[u.style]:Ot(u.style)?u.style.parsedOptions:void 0;o.push({type:Oa.literal,value:a.getDateTimeFormat(t,d).format(p)})}else if(_t(u)){d="string"==typeof u.style?i.time[u.style]:Ot(u.style)?u.style.parsedOptions:i.time.medium;o.push({type:Oa.literal,value:a.getDateTimeFormat(t,d).format(p)})}else if($t(u)){(d="string"==typeof u.style?i.number[u.style]:Tt(u.style)?u.style.parsedOptions:void 0)&&d.scale&&(p*=d.scale||1),o.push({type:Oa.literal,value:a.getNumberFormat(t,d).format(p)})}else{if(St(u)){var g=u.children,m=u.value,f=s[m];if(!Ca(f))throw new Pa(m,"function",r);var b=f(Ia(g,t,a,i,s,n).map((function(e){return e.value})));Array.isArray(b)||(b=[b]),o.push.apply(o,b.map((function(e){return{type:"string"==typeof e?Oa.literal:Oa.object,value:e}})))}if(At(u)){if(!(v=u.options[p]||u.options.other))throw new Ma(u.value,p,Object.keys(u.options),r);o.push.apply(o,Ia(v.value,t,a,i,s))}else if(wt(u)){var v;if(!(v=u.options["=".concat(p)])){if(!Intl.PluralRules)throw new Ba('Intl.PluralRules is not available in this environment.\nTry polyfilling it using "@formatjs/intl-pluralrules"\n',Ha.MISSING_INTL_API,r);var y=a.getPluralRules(t,{type:u.pluralType}).select(p-(u.offset||0));v=u.options[y]||u.options.other}if(!v)throw new Ma(u.value,p,Object.keys(u.options),r);o.push.apply(o,Ia(v.value,t,a,i,s,p-(u.offset||0)))}else;}}}return function(e){return e.length<2?e:e.reduce((function(e,t){var a=e[e.length-1];return a&&a.type===Oa.literal&&t.type===Oa.literal?a.value+=t.value:e.push(t),e}),[])}(o)}function La(e,t){return t?Object.keys(e).reduce((function(a,s){var n,r;return a[s]=(n=e[s],(r=t[s])?i(i(i({},n||{}),r||{}),Object.keys(n).reduce((function(e,t){return e[t]=i(i({},n[t]),r[t]||{}),e}),{})):n),a}),i({},e)):e}function Na(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,a){e[t]=a}}}}}!function(e){e[e.literal=0]="literal",e[e.object=1]="object"}(Oa||(Oa={}));var ka=function(){function e(t,a,i,s){var r,o=this;if(void 0===a&&(a=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(e){var t=o.formatToParts(e);if(1===t.length)return t[0].value;var a=t.reduce((function(e,t){return e.length&&t.type===Oa.literal&&"string"==typeof e[e.length-1]?e[e.length-1]+=t.value:e.push(t.value),e}),[]);return a.length<=1?a[0]||"":a},this.formatToParts=function(e){return Ia(o.ast,o.locales,o.formatters,o.formats,e,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=a,this.resolvedLocale=e.resolveLocale(a),"string"==typeof t){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:null==s?void 0:s.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=La(e.formats,i),this.formatters=s&&s.formatters||(void 0===(r=this.formatterCache)&&(r={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:va((function(){for(var e,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((e=Intl.NumberFormat).bind.apply(e,n([void 0],t,!1)))}),{cache:Na(r.number),strategy:Ta.variadic}),getDateTimeFormat:va((function(){for(var e,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((e=Intl.DateTimeFormat).bind.apply(e,n([void 0],t,!1)))}),{cache:Na(r.dateTime),strategy:Ta.variadic}),getPluralRules:va((function(){for(var e,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((e=Intl.PluralRules).bind.apply(e,n([void 0],t,!1)))}),{cache:Na(r.pluralRules),strategy:Ta.variadic})})}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=(new Intl.NumberFormat).resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(e){var t=Intl.NumberFormat.supportedLocalesOf(e);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale("string"==typeof e?e:e[0])},e.__parse=ba,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}(),Ra=ka;const Ua={de:bt,en:ot,nl:pt};function ja(e,t,...a){const i=t.replace(/['"]+/g,"");let s;try{s=e.split(".").reduce(((e,t)=>e[t]),Ua[i])}catch(t){s=e.split(".").reduce(((e,t)=>e[t]),Ua.en)}if(void 0===s&&(s=e.split(".").reduce(((e,t)=>e[t]),Ua.en)),!a.length)return s;const n={};for(let e=0;e<a.length;e+=2){let t=a[e];t=t.replace(/^{([^}]+)?}$/,"$1"),n[t]=a[e+1]}try{return new Ra(s,t).format(n)}catch(e){return"Translation "+e}}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const za=2;class Da{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,a){this._$Ct=e,this._$AM=t,this._$Ci=a}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class Ga extends Da{constructor(e){if(super(e),this.et=V,e.type!==za)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===F)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ga.directiveName="unsafeHTML",Ga.resultType=1;const Fa=(e=>(...t)=>({_$litDirective$:e,values:t}))(Ga);function Va(e){return"true"===(e=null==e?void 0:e.toString().toLowerCase())||"1"===e}function Za(e,t){return(e=e.toString()).split(",")[t]}function Wa(e,t){switch(t){case Ze:return e.units==He?G`${Fa("m<sup>2</sup>")}`:G`${Fa("sq ft")}`;case We:return e.units==He?G`${Fa("l/minute")}`:G`${Fa("gal/minute")}`;default:return G``}}function Ka(e,t){!function(e,t){const a=e.hasOwnProperty("tagName")?e:e.target;ve(a,"show-dialog",{dialogTag:"error-dialog",dialogImport:()=>Promise.resolve().then((function(){return si})),dialogParams:{error:t}})}(t,G`
...
`;let Ya=class extends(Qe(le)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:$e+"_config_updated"})]}async _fetchData(){var e,t;this.hass&&(this.config=await Xe(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{}))}firstUpdated(){(async()=>{await ye()})()}render(){if(this.hass&&this.config&&this.data){let e=G` <div class="card-content">
        <label for="autocalcenabled"
          >${ja("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}:</label
        >
        <input
          type="radio"
          id="autocalcon"
          ...
          @change="${e=>{this.saveData({autocalcenabled:Va(e.target.value)})}}"
        /><label for="autocalcon"
          >${ja("common.labels.yes",this.hass.language)}</label
        >
        <input
          type="radio"
          id="autocalcoff"
        ...
        /><label for="autocalcoff"
          >${ja("common.labels.no",this.hass.language)}</label
        >
      </div>`;this.data.autocalcenabled&&(e=G`${e}
          <div class="card-content">
            <label for="calctime"
              >${ja("panels.general.cards.automatic-duration-calculation.labels.auto-calc-time",this.hass.language)}</label
            >
            <input
              id="calctime"
              type="text"
            ...
            />
          </div>`),e=G`<ha-card header="${ja("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}" >${e}</div></ha-card>`;let t=G` <div class="card-content">
        <label for="autoupdateenabled"
          >${ja("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}:</label
        >
        <input
          type="radio"
          id="autoupdateon"
          ...
          @change="${e=>{this.saveData({autoupdateenabled:Va(e.target.value)})}}"
        ...
        >
          ...
          <div class="card-content">
            <label for="autoupdateinterval"
              >${ja("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}:</label
            >
            <input
          ...
          <div class="card-content">
            <label for="updatetime"
              >${ja("panels.general.cards.automatic-update.labels.auto-update-first-update",this.hass.language)}:</label
            >
            <input
              id="updatetime"
              type="text"
            ...
            <div class="card-content">
              ${ja("panels.general.cards.automatic-update.errors.warning-update-time-on-or-after-calc-time",this.hass.language)}!
            </div>`),t=G`<ha-card header="${ja("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;return G`<ha-card
          header="${ja("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${ja("panels.general.description",this.hass.language)}
          </div> </ha-card
        >${t}${e}`}return G``}saveData(e){var t,a;this.hass&&this.data&&(this.data=Object.assign(Object.assign({},this.data),e),(t=this.hass,a=this.data,t.callApi("POST",$e+"/config",a)).catch((e=>Ka(e,this.shadowRoot.querySelector("ha-card")))).then())}static get styles(){return c`
      ${Xa}
      .hidden {
        display: none;
      }
    ...
    `}};s([de()],Ya.prototype,"narrow",void 0),s([de()],Ya.prototype,"path",void 0),s([de()],Ya.prototype,"data",void 0),s([de()],Ya.prototype,"config",void 0),Ya=s([ue("smart-irrigation-view-general")],Ya);var qa,Ja="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";!function(e){e.Disabled="disabled",e.Manual="manual",e.Automatic="automatic"}(qa||(qa={}));let Qa=class extends(Qe(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:$e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Xe(this.hass),this.zones=await Ye(this.hass),this.modules=await qe(this.hass),this.mappings=await Je(this.hass))}handleCalculateAllZones(){this.hass&&this.hass.callApi("POST",$e+"/zones",{calculate_all:!0})}handleUpdateAllZones(){this.hass&&this.hass.callApi("POST",$e+"/zones",{update_all:!0})}handleAddZone(){const e={id:this.zones.length,name:this.nameInput.value,size:parseFloat(this.sizeInput.value),throughput:parseFloat(this.throughputInput.value),state:qa.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0};this.zones=[...this.zones,e],this.saveToHA(e)}handleEditZone(e,t){this.hass&&(this.zones=Object.values(this.zones).map(((a,i)=>i===e?t:a)),this.saveToHA(t))}handleRemoveZone(e,t){if(!this.hass)return;const a=Object.values(this.zones).at(t);var i,s;a&&(this.zones=this.zones.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,s=a.id.toString(),i.callApi("POST",$e+"/zones",{id:s,remove:!0})))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",$e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",$e+"/zones",{id:i,update:!0})))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",$e+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=G`<option value="" ?selected=${void 0===t}">---${ja("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=G`${a}
            <option
              value="${i.id}"
              ?selected="${t===i.id}"
            >
              ${i.id}: ${i.name}
            </option>`)),a}return G``}renderZone(e,t){if(this.hass){let a,i,s;return null!=e.explanation&&e.explanation.length>0&&(a=G`<svg
        ...
        >
          <title>
            ${ja("panels.zones.actions.information",this.hass.language)}
          </title>
        ...
        </svg>`),e.state===qa.Automatic&&(i=G` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        </svg>`),e.state===qa.Automatic&&(s=G` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="name${t}"
              >${ja("panels.zones.labels.name",this.hass.language)}:</label
            >
            <input
              id="name${t}"
              type="text"
            ...
            <div class="zoneline">
              <label for="state${t}"
                >${ja("panels.zones.labels.state",this.hass.language)}:</label
              >
              <select
                required
                id="state${t}"
              ...
              <label for="module${t}"
                >${ja("common.labels.module",this.hass.language)}:</label
              >
              ...
              <label for="module${t}"
                >${ja("panels.zones.labels.mapping",this.hass.language)}:</label
              >
            ...
            <div class="zoneline">
              <label for="bucket${t}"
                >${ja("panels.zones.labels.bucket",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="bucket${t}"
                ...
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{bucket:parseFloat(a.target.value)}))}"
              />
              <label for="maximum-bucket${t}"
                >${ja("panels.zones.labels.maximum-bucket",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="maximum-bucket${t}"
            ...
            <div class="zoneline">
              <label for="multiplier${t}"
                >${ja("panels.zones.labels.multiplier",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="multiplier${t}"
              ...
              <input
                ...
                type="number"
                .value="${e.duration}"
                ?readonly="${e.state===qa.Disabled||e.state===qa.Automatic}"
            ...
            <div class="zoneline">
              ...
              >
                ...
                <path fill="#404040" d="${Ja}" />
              </svg>
            </div>
            <div class="zoneline">
              <div>
                <label class="hidden" id="calcresults${t}"
                  >${Fa("<br/>"+e.explanation)}</label
                >
              </div>
            </div>
          </div>
      ...
      `}return G``}toggleExplanation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#calcresults"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="explanation")}render(){return this.hass&&this.config?G`
        <ha-card header="${ja("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${ja("panels.zones.description",this.hass.language)}
          </div>
        </ha-card>
          <ha-card header="${ja("panels.zones.cards.add-zone.header",this.hass.language)}">
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${ja("panels.zones.labels.name",this.hass.language)}:</label>
              <input id="nameInput" type="text"/>
              </div>
              <div class="zoneline">
              <label for="sizeInput">${ja("panels.zones.labels.size",this.hass.language)} (${Wa(this.config,Ze)}):</label>
              <input class="shortinput" id="sizeInput" type="number"/>
              </div>
              <div class="zoneline">
              <label for="throughputInput">${ja("panels.zones.labels.throughput",this.hass.language)} (${Wa(this.config,We)}):</label>
              <input id="throughputInput" class="shortinput" type="number"/>
              </div>
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${ja("panels.zones.cards.add-zone.actions.add",this.hass.language)}</button>
              </div>
            </div>
            </ha-card>
            <ha-card header="${ja("panels.zones.cards.zone-actions.header",this.hass.language)}">
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${ja("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}</button>
                <button @click="${this.handleCalculateAllZones}">${ja("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}</button>
            </div>
          </ha-card>
    ...
    `}};s([de()],Qa.prototype,"config",void 0),s([de({type:Array})],Qa.prototype,"zones",void 0),s([de({type:Array})],Qa.prototype,"modules",void 0),s([de({type:Array})],Qa.prototype,"mappings",void 0),s([ge("#nameInput")],Qa.prototype,"nameInput",void 0),s([ge("#sizeInput")],Qa.prototype,"sizeInput",void 0),s([ge("#throughputInput")],Qa.prototype,"throughputInput",void 0),Qa=s([ue("smart-irrigation-view-zones")],Qa);let ei=class extends(Qe(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:$e+"_config_updated"})]}async _fetchData(){var e;this.hass&&(this.config=await Xe(this.hass),this.zones=await Ye(this.hass),this.modules=await qe(this.hass),this.allmodules=await(e=this.hass,e.callWS({type:$e+"/allmodules"})))}handleAddModule(){const e=this.allmodules.filter((e=>e.name==this.moduleInput.selectedOptions[0].text))[0];if(!e)return;const t={id:this.modules.length,name:this.moduleInput.selectedOptions[0].text,description:e.description,config:e.config,schema:e.schema};this.modules=[...this.modules,t],this.saveToHA(t),this._fetchData()}handleRemoveModule(e,t){var a,i;(this.modules=this.modules.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",$e+"/modules",{id:i,remove:!0}))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",$e+"/modules",a))}renderModule(e,t){if(this.hass){const a=this.zones.filter((t=>t.module===e.id)).length;return G`
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            ...
            ${a?G` ${ja("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}.`:G` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
    ...
    `;if("boolean"==i.type)o=G`${o}<input
        ...
        >
          ...
          ${Object.entries(i.options).map((([e,a])=>G`<option
                ...
                ?selected="${r===Za(a,0)}"
              >
                ${ja("panels.modules.cards.module.translated-options."+Za(a,1),t)}
              </option>`))}
        ...
        <ha-card
          header="${ja("panels.modules.title",this.hass.language)}"
        >
          <div class="card-content">
        ...
        <ha-card
          header="${ja("panels.modules.cards.add-module.header",this.hass.language)}"
        >
          <div class="card-content">
            ...
            <button @click="${this.handleAddModule}">
              ${ja("panels.modules.cards.add-module.actions.add",this.hass.language)}
            </button>
          </div>
        </ha-card>
    ...
    `}};s([de()],ei.prototype,"config",void 0),s([de({type:Array})],ei.prototype,"zones",void 0),s([de({type:Array})],ei.prototype,"modules",void 0),s([de({type:Array})],ei.prototype,"allmodules",void 0),s([ge("#moduleInput")],ei.prototype,"moduleInput",void 0),ei=s([ue("smart-irrigation-view-modules")],ei);let ti=class extends(Qe(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:$e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Xe(this.hass),this.zones=await Ye(this.hass),this.mappings=await Je(this.hass))}handleAddMapping(){const e={[Se]:"",[Te]:"",[Oe]:"",[Be]:"",[Me]:"",[Pe]:"",[xe]:"",[Ce]:"",[Ie]:"",[Le]:""},t={id:this.mappings.length,name:this.mappingNameInput.value,mappings:e};this.mappings=[...this.mappings,t],this.saveToHA(t),this._fetchData()}handleRemoveMapping(e,t){var a,i;(this.mappings=this.mappings.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",$e+"/mappings",{id:i,remove:!0}))}handleEditMapping(e,t){this.mappings=Object.values(this.mappings).map(((a,i)=>i===e?t:a)),this.saveToHA(t)}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",$e+"/mappings",a))}renderMapping(e,t){if(this.hass){const a=this.zones.filter((t=>t.mapping===e.id)).length;return G`
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            ...
            ${a?G`${ja("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}`:G` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
      ...
      <div class="mappingsettingline">
        ...
        /><label for="${t+e+Ue}"
          >${ja("panels.mappings.cards.mapping.sources.none",this.hass.language)}</label
        ...
        /><label
          class="${l}"
          for="${t+e+Ne}"
          >${ja("panels.mappings.cards.mapping.sources.openweathermap",this.hass.language)}</label
        >`}return o=G`${o}
        <input
          type="radio"
          id="${t+e+ke}"
        ...
        /><label for="${t+e+ke}"
          >${ja("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}</label
        >
      </div>`,o=G`${o}
      <input
        type="radio"
        ...
        @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[t]:Object.assign(Object.assign({},n.mappings[t]),{[je]:a.target.value})})}))}"
      /><label for="${t+e+Re}"
        >${ja("panels.mappings.cards.mapping.sources.static",this.hass.language)}</label
      >
    </div>`,r[je]==ke&&(o=G`${o}
        <div class="mappingsettingline">
          <label for="${t+e+ze}"
            >${ja("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+ze}"
            value="${r[ze]}"
            @input="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[t]:Object.assign(Object.assign({},n.mappings[t]),{[ze]:a.target.value})})}))}"
          />
        </div>`),r[je]==Re&&(o=G`${o}
        <div class="mappingsettingline">
          <label for="${t+e+De}"
            >${ja("panels.mappings.cards.mapping.static_value",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+De}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ge}"
            >${ja("panels.mappings.cards.mapping.input-units",this.hass.language)}:</label
          >
          <select
            type="text"
            id="${t+e+Ge}"
        ...
        <div class="mappingsettingline">
          ...
          <label for="${t+e+Fe}"
            >${ja("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</label
          >
      ...
      </option>`}return G``}renderUnitOptionsForMapping(e,t){if(this.hass&&this.config){const a=function(e){switch(e){case Se:case Me:case Be:case Ie:return[{unit:"°C",system:He},{unit:"°F",system:we}];case Pe:case Te:return[{unit:"mm",system:He},{unit:"in",system:we}];case Oe:return[{unit:"%",system:[He,we]}];case xe:return[{unit:"millibar",system:He},{unit:"hPa",system:He},{unit:"psi",system:we},{unit:"inch Hg",system:we}];case Le:return[{unit:"km/h",system:He},{unit:"meter/s",system:He},{unit:"mile/h",system:we}];case Ce:return[{unit:"W/m2",system:He},{unit:"MJ/day/m2",system:He},{unit:"W/sq ft",system:we},{unit:"MJ/day/sq ft",system:we}];default:return[]}}(e);let i=G``,s=t[Ge];const n=this.config.units;return t[Ge]||a.forEach((function(e){"string"==typeof e.system?n==e.system&&(s=e.unit):e.system.forEach((function(t){n==t.system&&(s=e.unit)}))})),a.forEach((function(e){i=G`${i}
        ...
        <ha-card
          header="${ja("panels.mappings.cards.add-mapping.header",this.hass.language)}"
        >
          <div class="card-content">
    ...
    `}};s([de()],ti.prototype,"config",void 0),s([de({type:Array})],ti.prototype,"zones",void 0),s([de({type:Array})],ti.prototype,"mappings",void 0),s([ge("#mappingNameInput")],ti.prototype,"mappingNameInput",void 0),ti=s([ue("smart-irrigation-view-mappings")],ti);const ai=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],s=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:s})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),s=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(s)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a};e.SmartIrrigationPanel=class extends le{async firstUpdated(){window.addEventListener("location-changed",(()=>{window.location.pathname.includes("smart-irrigation")&&this.requestUpdate()})),await ye(),this.requestUpdate()}render(){if(!customElements.get("ha-panel-config"))return G` loading... `;const e=ai();return G`
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2023.9.0-beta8"}</div>
        </div>
        ...
        >
          ...
          <paper-tab page-name="modules"
            >${ja("panels.modules.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="mappings"
            >${ja("panels.mappings.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="help"
            >${ja("panels.help.title",this.hass.language)}</paper-tab
          >
        </ha-tabs>
      </div>
    ...
    `}getView(e){switch(e.page){case"general":return G`
        ...
        >
          <div class="card-content">
          ${ja("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)} <a href="https://github.com/jeroenterheerdt/HAsmartirrigation/wiki"
    ...
    `}};s([de({attribute:!1})],ii.prototype,"hass",void 0),s([function(e){return de({...e,state:!0})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],ii.prototype,"_params",void 0),ii=s([ue("error-dialog")],ii);var si=Object.freeze({__proto__:null,get ErrorDialog(){return ii}});Object.defineProperty(e,"__esModule",{value:!0})}({});
