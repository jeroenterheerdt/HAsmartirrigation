!(function (e) {
      ...
      for (let t = 0; t < a; t++) {
        ...
        s +=
          r === z
            ? a + H
            : u >= 0
            ? (i.push(o), a.slice(0, u) + M + a.slice(u) + O + c)
            : a + O + (-2 === u ? (i.push(void 0), t) : c);
      }
      const o = s + (e[a] || "<?>") + (2 === t ? "</svg>" : "");
      if (!Array.isArray(e) || !e.hasOwnProperty("raw"))
        throw Error("invalid template strings array");
      return [void 0 !== k ? k.createHTML(o) : o, i];
    };
  class q {
  ...
  const se = $.litHtmlPolyfillSupport;
  null == se || se(q, J),
    (null !== (E = $.litHtmlVersions) && void 0 !== E
      ? E
      : ($.litHtmlVersions = [])
    ).push("2.7.4");
  /**
  ...
  const ye = async () => {
    ...
    Ge = "unit",
    Fe = "aggregate",
    Ve = ["average", "first", "last", "maximum", "median", "minimum", "sum"],
    We = "size",
    Ze = "throughput",
    qe = "duration",
    Ke = "bucket",
  ...
  var at,
    ...
    dt = "Smart Irrigation",
    pt = { common: ht, panels: ct, title: dt },
    mt = Object.freeze({
      __proto__: null,
      common: ht,
      panels: ct,
    ...
    St = "Smart Irrigation",
    Et = { common: _t, panels: wt, title: St },
    $t = Object.freeze({
      __proto__: null,
      common: _t,
      panels: wt,
    ...
    Ot = { common: At, panels: kt, title: Mt },
    Tt = Object.freeze({
      __proto__: null,
      common: At,
      panels: kt,
    ...
    xt = "Smart Irrigation",
    Nt = { common: Ht, panels: Dt, title: xt },
    Pt = Object.freeze({
      __proto__: null,
      common: Ht,
      panels: Dt,
    ...
    for (var t = {}, a = 0, n = e; a < n.length; a++) {
      ...
      switch (s.stem) {
        ...
        case "integer-width":
          ...
          s.options[0].replace(aa, function (e, a, i, n, s, r) {
      ...
      if (ia.test(s.stem)) t.minimumIntegerDigits = s.stem.length;
      else if (ea.test(s.stem)) {
        if (s.options.length > 1)
          throw new RangeError(
            "Fraction-precision stems only accept a single optional option"
          );
        s.stem.replace(ea, function (e, a, i, n, s, r) {
          return (
            "*" === i
        ...
        "w" === r
          ...
          : r && (t = i(i({}, t), na(r)));
      } else if (ta.test(s.stem)) t = i(i({}, t), na(s.stem));
      else {
        var o = sa(s.stem);
        o && (t = i(i({}, t), o));
        var l = ra(s.stem);
  ...
  function ca(e) {
    ...
    return (
      ...
      (ha[a || ""] || ha[i || ""] || ha["".concat(i, "-001")] || ha["001"])[0]
    );
  }
  var da = new RegExp("^".concat(Kt.source, "*")),
    pa = new RegExp("".concat(Kt.source, "*$"));
  function ma(e, t) {
    return { start: e, end: t };
  }
  var ga = !!String.prototype.startsWith,
    fa = !!String.fromCodePoint,
    va = !!Object.fromEntries,
    ba = !!String.prototype.codePointAt,
    ya = !!String.prototype.trimStart,
    _a = !!String.prototype.trimEnd,
    wa = !!Number.isSafeInteger
  ...
  try {
    Sa =
      "a" ===
      (null ===
        (ua = Ha("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
          "a"
        )) || void 0 === ua
        ? void 0
        : ua[0]);
  ...
  if (Sa) {
    var Da = Ha("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    Ea = function (e, t) {
      var a;
      return (
        (Da.lastIndex = t),
        null !== (a = Da.exec(e)[1]) && void 0 !== a ? a : ""
      );
    };
  } else
    Ea = function (e, t) {
  ...
  var xa = (function () {
    ...
    return (
            ...
            if (35 !== n || ("plural" !== t && "selectordinal" !== t)) {
              if (60 === n && !this.ignoreTag && 47 === this.peek()) {
                ...
                return this.error(
                  ...
                  ma(this.clonePosition(), this.clonePosition())
                );
              }
              if (60 === n && !this.ignoreTag && Na(this.peek() || 0)) {
              ...
              this.bump(),
                i.push({
                  type: it.pound,
                  location: ma(r, this.clonePosition()),
                });
            }
          }
        }
        ...
        if ((this.bumpSpace(), this.bumpIf("/>")))
          return {
            val: {
              type: it.literal,
              value: "<".concat(i, "/>"),
              location: ma(a, this.clonePosition()),
            },
            err: null,
          };
        if (this.bumpIf(">")) {
          ...
          if (this.bumpIf("</")) {
            if (this.isEOF() || !Na(this.char()))
              return this.error(at.INVALID_TAG, ma(r, this.clonePosition()));
            var o = this.clonePosition();
            return i !== this.parseTagName()
              ? this.error(
                  at.UNMATCHED_CLOSING_TAG,
                  ma(o, this.clonePosition())
                )
              : (this.bumpSpace(),
                this.bumpIf(">")
                  ? {
                  ...
                  : this.error(at.INVALID_TAG, ma(r, this.clonePosition())));
          }
          return this.error(at.UNCLOSED_TAG, ma(a, this.clonePosition()));
        }
        return this.error(at.INVALID_TAG, ma(a, this.clonePosition()));
      }),
      (e.prototype.parseTagName = function () {
        var e = this.offset();
        for (this.bump(); !this.isEOF() && Pa(this.char()); ) this.bump();
      ...
      (e.prototype.parseLiteral = function (e, t) {
        ...
        var o = ma(a, this.clonePosition());
        return { val: { type: it.literal, value: i, location: o }, err: null };
      }),
      (e.prototype.tryParseLeftAngleBracket = function () {
        return this.isEOF() ||
          60 !== this.char() ||
          (!this.ignoreTag && (Na((e = this.peek() || 0)) || 47 === e))
          ? null
          : (this.bump(), "<");
        var e;
      }),
      ...
      (e.prototype.parseArgument = function (e, t) {
        ...
        if ((this.bump(), this.bumpSpace(), this.isEOF()))
          return this.error(
            ...
            ma(a, this.clonePosition())
          );
        if (125 === this.char())
          return (
            this.bump(),
            this.error(at.EMPTY_ARGUMENT, ma(a, this.clonePosition()))
          );
        var i = this.parseIdentifierIfPossible().value;
        if (!i)
          return this.error(at.MALFORMED_ARGUMENT, ma(a, this.clonePosition()));
      ...
      (e.prototype.parseIdentifierIfPossible = function () {
        var e = this.clonePosition(),
          ...
          i = t + a.length;
        return (
          this.bumpTo(i), { value: a, location: ma(e, this.clonePosition()) }
        );
      }),
      (e.prototype.parseArgumentOptions = function (e, t, a, n) {
        ...
        switch (o) {
          case "":
            return this.error(at.EXPECT_ARGUMENT_TYPE, ma(r, l));
          case "number":
          case "date":
          case "time":
            this.bumpSpace();
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (m = Ta(b.val)).length)
                return this.error(
                  at.EXPECT_ARGUMENT_STYLE,
                  ma(this.clonePosition(), this.clonePosition())
                );
              u = { style: m, styleLocation: ma(h, this.clonePosition()) };
            }
            if ((y = this.tryParseArgumentClose(n)).err) return y;
            var c = ma(n, this.clonePosition());
            if (u && $a(null == u ? void 0 : u.style, "::", 0)) {
              var d = Oa(u.style.slice(2));
              if ("number" === o)
              ...
              var m = {
                ...
                parsedOptions: this.shouldParseSkeletons ? Jt(p) : {},
              };
              return {
                val: {
          ...
          default:
            return this.error(at.INVALID_ARGUMENT_TYPE, ma(r, l));
        }
      }),
      ...
      (e.prototype.parseNumberSkeletonFromString = function (e, t) {
        ...
        try {
          a = (function (e) {
            ...
            for (
              var t = e.split(Qt).filter(function (e) {
                  return e.length > 0;
                }),
                a = [],
                i = 0,
        ...
        return {
          val: {
            ...
            tokens: a,
            location: t,
            parsedOptions: this.shouldParseSkeletons ? la(a) : {},
          },
          err: null,
        };
      }),
      (e.prototype.tryParsePluralOrSelectOptions = function (e, t, a, i) {
        for (
          ...
          if (m.err) return m;
          r.push([l, { value: p.val, location: ma(d, this.clonePosition()) }]),
            o.add(l),
            this.bumpSpace(),
  ...
  function La(e) {
    e.forEach(function (e) {
      if ((delete e.location, Gt(e) || Ft(e)))
        for (var t in e.options)
          delete e.options[t].location, La(e.options[t].value);
      else
        (jt(e) && Zt(e.style)) || ((Ut(e) || Yt(e)) && qt(e.style))
  ...
  function Ba(e, t) {
    ...
    return (null == t ? void 0 : t.captureLocation) || La(a.val), a.val;
  }
  function Ra(e, t) {
    var a = t && t.cache ? t.cache : Wa,
      i = t && t.serializer ? t.serializer : Ga;
    return (t && t.strategy ? t.strategy : Ya)(e, { cache: a, serializer: i });
  }
  function Ia(e, t, a, i) {
    var n,
      s =
  ...
  var Va,
    ...
    Za = {
      variadic: function (e, t) {
        return Ua(e, this, ja, t.cache.create(), t.serializer);
      },
      monadic: function (e, t) {
        return Ua(e, this, Ia, t.cache.create(), t.serializer);
      },
    };
  !(function (e) {
  ...
  function ti(e, t, a, i, n, s, r) {
    if (1 === e.length && Rt(e[0]))
      return [{ type: qa.literal, value: e[0].value }];
    for (var o = [], l = 0, u = e; l < u.length; l++) {
      var h = u[l];
      if (Rt(h)) o.push({ type: qa.literal, value: h.value });
      else if (Vt(h))
        "number" == typeof s &&
          o.push({ type: qa.literal, value: a.getNumberFormat(t).format(s) });
      else {
        var c = h.value;
        if (!n || !(c in n)) throw new Qa(c, r);
        var d = n[c];
        if (It(h))
          (d && "string" != typeof d && "number" != typeof d) ||
            (d = "string" == typeof d || "number" == typeof d ? String(d) : ""),
            o.push({
              type: "string" == typeof d ? qa.literal : qa.object,
              value: d,
            });
        else if (Ut(h)) {
          var p =
          ...
          if (Wt(h)) {
            var m = h.children,
              g = h.value,
              f = n[g];
            if (!ei(f)) throw new Ja(g, "function", r);
            var v = f(
              ti(m, t, a, i, n, s).map(function (e) {
                return e.value;
              })
            );
            Array.isArray(v) || (v = [v]),
              o.push.apply(
                ...
                v.map(function (e) {
                  return {
                    type: "string" == typeof e ? qa.literal : qa.object,
                    value: e,
                  };
                })
              );
          ...
          if (Gt(h)) {
            if (!(b = h.options[d] || h.options.other))
              throw new Xa(h.value, d, Object.keys(h.options), r);
            o.push.apply(o, ti(b.value, t, a, i, n));
          } else if (Ft(h)) {
            var b;
            ...
            if (!b) throw new Xa(h.value, d, Object.keys(h.options), r);
            o.push.apply(o, ti(b.value, t, a, i, n, d - (h.offset || 0)));
          } else;
        }
      }
    }
    return (function (e) {
      return e.length < 2
        ...
        : e.reduce(function (e, t) {
            var a = e[e.length - 1];
            return (
              a && a.type === qa.literal && t.type === qa.literal
                ? (a.value += t.value)
                : e.push(t),
              e
            );
  ...
  var ni = (function () {
          ...
          (this.formatters =
              ...
              (r = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: Ra(
                ...
                { cache: ii(r.number), strategy: Za.variadic }
              ),
              getDateTimeFormat: Ra(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                    t[a] = arguments[a];
                ...
                { cache: ii(r.dateTime), strategy: Za.variadic }
              ),
              getPluralRules: Ra(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                ...
                { cache: ii(r.pluralRules), strategy: Za.variadic }
              ),
            }));
      }
      return (
    ...
    si = ni;
  const ri = { de: ut, en: mt, es: yt, fr: $t, it: Tt, nl: Pt, no: Bt };
  function oi(e, t, ...a) {
    const i = t.replace(/['"]+/g, "");
    let n;
    try {
      n = e.split(".").reduce((e, t) => e[t], ri[i]);
    } catch (t) {
      n = e.split(".").reduce((e, t) => e[t], ri.en);
    }
    if (
      (void 0 === n && (n = e.split(".").reduce((e, t) => e[t], ri.en)),
      !a.length)
    )
      return n;
    const s = {};
   ...
   */ class hi extends ui {
    constructor(e) {
      if ((super(e), (this.et = F), e.type !== li))
        throw Error(
  ...
  function mi(e, t) {
    switch (t) {
      case We:
        return e.units == Ae ? Y`${ci("m<sup>2</sup>")}` : Y`${ci("sq ft")}`;
      case Ze:
        return e.units == Ae ? Y`${ci("l/minute")}` : Y`${ci("gal/minute")}`;
      default:
        return Y``;
    }
  }
...
`;
  ...
  let yi = class extends tt(le) {
    ...
    render() {
      if (this.hass && this.config && this.data) {
        let e = Y` <div class="card-content"><svg
    ...
    >
      ...
      <path fill="#404040" d="${bi}" />
        ...
        <input
          ...
          @change="${(e) => {
            this.saveData({ autocalcenabled: di(e.target.value) });
          }}"
    ...
    >
      ...
      <path fill="#404040" d="${bi}" />
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autoupdateenabled: di(e.target.value) });
            }}"
      ...
      <path fill="#404040" d="${bi}" />
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autoclearenabled: di(e.target.value) });
            }}"
    ...
    saveData(e) {
      ...
      this.hass &&
        ...
        ((t = this.hass), (a = this.data), t.callApi("POST", _e + "/config", a))
          .catch((e) => gi(e, this.shadowRoot.querySelector("ha-card")))
          .then());
    }
    toggleInformation(e) {
      var t;
  ...
  var _i;
  n([pe()], yi.prototype, "narrow", void 0),
    n([pe()], yi.prototype, "path", void 0),
    n([pe()], yi.prototype, "data", void 0),
    n([pe()], yi.prototype, "config", void 0),
    (yi = n([he("smart-irrigation-view-general")], yi)),
    (function (e) {
      (e.Disabled = "disabled"),
        (e.Manual = "manual"),
  ...
  (Ei = $i).exports = (function () {
    ...
    function U(e, t) {
      return e.isValid()
        ? ((t = Y(t, e.localeData())), (L[t] = L[t] || j(t)), L[t](e))
    ...
    function Y(e, t) {
      ...
      for (z.lastIndex = 0; a >= 0 && z.test(e); )
        (e = e.replace(z, i)), (z.lastIndex = 0), (a -= 1);
      return e;
    }
    var G = {
      LTS: "h:mm:ss A",
    ...
    function pt() {
      ...
      for (i.sort(e), n.sort(e), s.sort(e), t = 0; t < 12; t++)
        (i[t] = ze(i[t])), (n[t] = ze(n[t]));
      for (t = 0; t < 24; t++) s[t] = ze(s[t]);
    ...
    function Wt(e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = zt),
    ...
    function Zt(e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Lt),
    ...
    function qt() {
      ...
      for (t = 0; t < 7; t++)
        (a = p([2e3, 1]).day(t)),
          (i = ze(this.weekdaysMin(a, ""))),
          (n = ze(this.weekdaysShort(a, ""))),
          (s = ze(this.weekdays(a, ""))),
          r.push(i),
          o.push(n),
          l.push(s),
          u.push(i),
    ...
    function da(e) {
      var t = null;
      if (void 0 === ra[e] && Ei && Ei.exports && ca(e))
        try {
          (t = na._abbr), Si("./locale/" + e), pa(t);
        } catch (t) {
          ra[e] = null;
        }
      return ra[e];
    ...
    function Li(e) {
      return S(e) || h(e) || zi(e) || u(e) || Ri(e) || Bi(e) || null == e;
    }
    function Bi(e) {
      var t,
        a,
    ...
    function Yn() {
      ...
      for (e = 0, t = r.length; e < t; ++e)
        i.push(ze(r[e].name)),
          a.push(ze(r[e].abbr)),
          n.push(ze(r[e].narrow)),
          s.push(ze(r[e].name)),
          s.push(ze(r[e].abbr)),
          s.push(ze(r[e].narrow));
    ...
    (us.add = Pi),
      ...
      (us.months = $("months accessor is deprecated. Use month instead", ut)),
      (us.years = $("years accessor is deprecated. Use year instead", gt)),
      (us.zone = $(
    ...
    (ps.calendar = N),
      ...
      (a.lang = $("moment.lang is deprecated. Use moment.locale instead.", pa)),
      (a.langData = $(
  ...
  let ki = class extends tt(le) {
    ...
    renderTheOptions(e, t) {
      if (this.hass) {
        let a = Y`<option value="" ?selected=${void 0 === t}">---${oi(
        ...
        return (
          null != e.mapping &&
            ...
            null != r &&
              ...
              ((o = Ai(r.data_last_updated).format("YYYY-MM-DD HH:mm:ss")),
              null != r.data && (l = r.data.length))),
          Y`
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              ...
              ${
                e.last_calculated
                  ? Ai(e.last_calculated).format("YYYY-MM-DD HH:mm:ss")
                  : "-"
              }</label
            >
          </div>
          ...
          <div class="card-content">
            ...
            <div class="zoneline">
              ...
              <input
                ...
                .value="${e.duration}"
                ?readonly="${
                  e.state === _i.Disabled || e.state === _i.Automatic
                }"
                @input="${(a) =>
                  this.handleEditZone(
                    t,
      ...
      return this.hass && this.config
        ...
        <ha-card header="${oi("panels.zones.title", this.hass.language)}">
          ...
          <ha-card header="${oi(
            ...
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${oi(
              ...
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${oi(
            ...
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${oi(
            "panels.zones.cards.zone-actions.actions.update-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleCalculateAllZones}">${oi(
            "panels.zones.cards.zone-actions.actions.calculate-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleResetAllBuckets}">${oi(
            "panels.zones.cards.zone-actions.actions.reset-all-buckets",
            this.hass.language
          )}</button>
      <button @click="${this.handleClearAllWeatherdata}">${oi(
  ...
  n([pe()], ki.prototype, "config", void 0),
    n([pe({ type: Array })], ki.prototype, "zones", void 0),
    n([pe({ type: Array })], ki.prototype, "modules", void 0),
    n([pe({ type: Array })], ki.prototype, "mappings", void 0),
    n([me("#nameInput")], ki.prototype, "nameInput", void 0),
    n([me("#sizeInput")], ki.prototype, "sizeInput", void 0),
    n([me("#throughputInput")], ki.prototype, "throughputInput", void 0),
    (ki = n([he("smart-irrigation-view-zones")], ki));
  let Mi = class extends tt(le) {
    constructor() {
      super(...arguments),
        (this.zones = []),
        (this.modules = []),
        ...
        >
          ${Object.entries(i.options).map(
            ([e, a]) => Y`<option
              ...
              >
                ${oi(
                  "panels.modules.cards.module.translated-options." + pi(a, 1),
                  t
                )}
              </option>`
          )}
  ...
  n([pe()], Mi.prototype, "config", void 0),
    n([pe({ type: Array })], Mi.prototype, "zones", void 0),
    n([pe({ type: Array })], Mi.prototype, "modules", void 0),
    n([pe({ type: Array })], Mi.prototype, "allmodules", void 0),
    n([me("#moduleInput")], Mi.prototype, "moduleInput", void 0),
    (Mi = n([he("smart-irrigation-view-modules")], Mi));
  let Oi = class extends tt(le) {
    constructor() {
    ...
    renderPressureTypes(e, t) {
      if (this.hass && this.config) {
        ...
        >
          ${oi(
            "panels.mappings.cards.mapping.pressure_types." + Re,
            this.hass.language
          )}
        </option>`),
          e
      ...
      if (this.hass && this.config) {
        const a = (function (e) {
          switch (e) {
            ...
            case Oe:
              return [{ unit: "%", system: [Ae, $e] }];
            case He:
              return [
                { unit: "millibar", system: Ae },
                { unit: "hPa", system: Ae },
                { unit: "psi", system: $e },
                { unit: "inch Hg", system: $e },
              ];
            case Ne:
              return [
                { unit: "km/h", system: Ae },
                { unit: "meter/s", system: Ae },
                { unit: "mile/h", system: $e },
              ];
            case De:
              return [
                { unit: "W/m2", system: Ae },
                { unit: "MJ/day/m2", system: Ae },
                { unit: "W/sq ft", system: $e },
                { unit: "MJ/day/sq ft", system: $e },
              ];
            default:
              return [];
          }
  ...
  n([pe()], Oi.prototype, "config", void 0),
    n([pe({ type: Array })], Oi.prototype, "zones", void 0),
    n([pe({ type: Array })], Oi.prototype, "mappings", void 0),
    n([me("#mappingNameInput")], Oi.prototype, "mappingNameInput", void 0),
    (Oi = n([he("smart-irrigation-view-mappings")], Oi));
  const Ti = () => {
    const e = (e) => {
        let t = {};
  ...
  n([pe({ attribute: !1 })], Hi.prototype, "hass", void 0),
    n(
      [
        (function (e) {
          return pe({ ...e, state: !0 });
