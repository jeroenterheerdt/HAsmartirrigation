...
`;let nl=class extends ce{async showDialog(e){var a,t,i,n,r,s,o,l,d;if(this.params=e,e.createTrigger)this._trigger={type:$e,name:"",enabled:!0,offset_minutes:0,azimuth_angle:90,account_for_duration:!0};else if(e.trigger){const u=e.trigger;this._trigger=u.type===Ee?{type:u.type,name:null!==(a=u.name)&&void 0!==a?a:"",enabled:null===(t=u.enabled)||void 0===t||t,offset_minutes:null!==(i=u.offset_minutes)&&void 0!==i?i:0,azimuth_angle:null!==(n=u.azimuth_angle)&&void 0!==n?n:90,account_for_duration:null===(r=u.account_for_duration)||void 0===r||r}:{type:u.type,name:null!==(s=u.name)&&void 0!==s?s:"",enabled:null===(o=u.enabled)||void 0===o||o,offset_minutes:null!==(l=u.offset_minutes)&&void 0!==l?l:0,account_for_duration:null===(d=u.account_for_duration)||void 0===d||d}}else this._trigger=void 0;await this.updateComplete}_closeDialog(){this.params=void 0,this._trigger=void 0}_saveTrigger(){var e,a,t,i,r;if(!this._trigger||!this.params)return;const s=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-select");if(s){const e=null!==(t=null!==(a=s.value)&&void 0!==a?a:s.selected)&&void 0!==t?t:void 0;if(e&&e!==this._trigger.type){if(e===Ee)this._trigger=Object.assign(Object.assign({},this._trigger),{type:e,azimuth_angle:null!==(i=this._trigger.azimuth_angle)&&void 0!==i?i:90});else{const a=this._trigger,{azimuth_angle:t}=a,i=n(a,["azimuth_angle"]);this._trigger=Object.assign(Object.assign({},i),{type:e})}this.requestUpdate()}}if(null===(r=this._trigger.name)||void 0===r?void 0:r.trim()){if(this._trigger.type===Ee){if(void 0===this._trigger.azimuth_angle||isNaN(this._trigger.azimuth_angle))return void alert(qo("irrigation_start_triggers.validation.azimuth_invalid",this.hass.language));this._trigger.azimuth_angle=this._trigger.azimuth_angle%360,this._trigger.azimuth_angle<0&&(this._trigger.azimuth_angle+=360)}this.dispatchEvent(new CustomEvent("trigger-save",{detail:{trigger:this._trigger,isNew:this.params.createTrigger,index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog()}else alert(qo("irrigation_start_triggers.validation.name_required",this.hass.language))}_deleteTrigger(){this.params&&!this.params.createTrigger&&(this.dispatchEvent(new CustomEvent("trigger-delete",{detail:{index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog())}_updateTrigger(e){this._trigger?(this._trigger=Object.assign(Object.assign({},this._trigger),e),this.requestUpdate()):console.warn("_updateTrigger called with undefined _trigger",e)}render(){var e,a;if(!this.params||!this._trigger)return q``;const t=this.params.createTrigger,i=qo(t?"irrigation_start_triggers.dialog.add_title":"irrigation_start_triggers.dialog.edit_title",this.hass.language);return q`
      <ha-dialog open .heading=${!0}>
        ...
        <div class="wrapper">
          <div class="dialog-help">
            ${qo("irrigation_start_triggers.dialog.help",this.hass.language)}
            <code>smart_irrigation_start_irrigation_all_zones</code>
          </div>
          <div class="form-group">
            <label class="form-label"
              >${qo("irrigation_start_triggers.fields.name.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="text"
          ...
          <div class="form-group">
            <ha-select
              .label=${qo("irrigation_start_triggers.fields.type.name",this.hass.language)}
              .value=${this._trigger.type}
              @selected=${this._typeChanged}
            >
              <ha-dropdown-item value=${$e}>
                ${qo("irrigation_start_triggers.trigger_types.sunrise",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${"sunset"}>
                ${qo("irrigation_start_triggers.trigger_types.sunset",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${Ee}>
                ${qo("irrigation_start_triggers.trigger_types.solar_azimuth",this.hass.language)}
              </ha-dropdown-item>
            </ha-select>
          </div>
          ...
          <div class="form-group">
            <ha-formfield
              .label=${qo("irrigation_start_triggers.fields.enabled.name",this.hass.language)}
            >
              <ha-switch
          ...
          <div class="form-group">
            <label class="form-label"
              >${qo("irrigation_start_triggers.fields.offset_minutes.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="number"
          ...
          <div class="form-group">
            <ha-formfield
              .label=${qo("irrigation_start_triggers.fields.account_for_duration.name",this.hass.language)}
            >
              <ha-switch
          ...
          ${this._trigger.type===Ee?q`
                <div class="form-group">
                  <label class="form-label"
                    >${qo("irrigation_start_triggers.fields.azimuth_angle.name",this.hass.language)}</label
                  >
                  <input
                    class="form-input"
                    type="number"
        ...
        <ha-dialog-footer slot="footer">
          ...
          >
            ${qo("irrigation_start_triggers.dialog.cancel",this.hass.language)}
          </ha-button>
          ${t?"":q`
                <ha-button
                  slot="secondaryAction"
                ...
                >
                  ${qo("irrigation_start_triggers.dialog.delete",this.hass.language)}
                </ha-button>
              `}
          <ha-button
            slot="primaryAction"
    ...
    `}_nameChanged(e){const a=e.target;this._updateTrigger({name:a.value})}_typeChanged(e){var a,t,i,n,r,s,o,l,d,u,c,p,m,g,h,v,f,b,k,y,_,z,w,x;const j=null!==(n=null!==(t=null===(a=null==e?void 0:e.detail)||void 0===a?void 0:a.value)&&void 0!==t?t:null===(i=e.target)||void 0===i?void 0:i.value)&&void 0!==n?n:null===(s=null===(r=this.shadowRoot)||void 0===r?void 0:r.querySelector("ha-select"))||void 0===s?void 0:s.value,S=String(j);let A;A=S===Ee?{type:Ee,name:null!==(l=null===(o=this._trigger)||void 0===o?void 0:o.name)&&void 0!==l?l:"",enabled:null===(u=null===(d=this._trigger)||void 0===d?void 0:d.enabled)||void 0===u||u,offset_minutes:null!==(p=null===(c=this._trigger)||void 0===c?void 0:c.offset_minutes)&&void 0!==p?p:0,azimuth_angle:null!==(g=null===(m=this._trigger)||void 0===m?void 0:m.azimuth_angle)&&void 0!==g?g:90,account_for_duration:null===(v=null===(h=this._trigger)||void 0===h?void 0:h.account_for_duration)||void 0===v||v}:{type:S,name:null!==(b=null===(f=this._trigger)||void 0===f?void 0:f.name)&&void 0!==b?b:"",enabled:null===(y=null===(k=this._trigger)||void 0===k?void 0:k.enabled)||void 0===y||y,offset_minutes:null!==(z=null===(_=this._trigger)||void 0===_?void 0:_.offset_minutes)&&void 0!==z?z:0,account_for_duration:null===(x=null===(w=this._trigger)||void 0===w?void 0:w.account_for_duration)||void 0===x||x},this._trigger=A,this.requestUpdate()}_enabledChanged(e){const a=e.target;this._updateTrigger({enabled:a.checked})}_offsetChanged(e){const a=e.target;this._updateTrigger({offset_minutes:parseInt(a.value)||0})}_accountForDurationChanged(e){const a=e.target;this._updateTrigger({account_for_duration:a.checked})}_azimuthChanged(e){var a;if((null===(a=this._trigger)||void 0===a?void 0:a.type)!==Ee)return;const t=e.target;let i=parseInt(t.value,10);isNaN(i)&&(i=90),this._updateTrigger({azimuth_angle:i})}static get styles(){return[il,p`
      ...
      `]}};r([he({attribute:!1})],nl.prototype,"hass",void 0),r([he({attribute:!1})],nl.prototype,"params",void 0),r([ve()],nl.prototype,"_trigger",void 0),nl=r([me("smart-irrigation-trigger-dialog")],nl);const rl=p`
...
`;let sl=class extends(Ba(ce)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return a=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(a),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{this.config=await Pa(this.hass),this.data=(e=this.config,a=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],e?Object.entries(e).filter((([e])=>a.includes(e))).reduce(((e,[a,t])=>Object.assign(e,{[a]:t})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e,a}}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,a,t;if(!this.hass||!this.config||!this.data)return q`<div class="loading-indicator">
        ...
        <div class="card-content">
          ...
          <div class="card-content">
            ${this._timeRow(qo("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language),this.config.calctime,(e=>this.handleConfigChange({calctime:e})))}
          </div>`),e=q`<ha-card
        header="${qo("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let a=q` <div class="card-content">
          ${qo("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            <div class="setting-row">
              <div class="setting-label">
                ${qo("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
              </div>
              <div class="combo-field">
                ...
                <div class="select-wrap">
                  ...
                  >
                    ...
                    >
                      ${qo("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                    </option>
                    <option
                      value="${Me}"
                      ?selected=${this.data.autoupdateschedule===Me}
                    >
                      ${qo("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                    </option>
                    <option
                      value="${De}"
                      ?selected=${this.data.autoupdateschedule===De}
                    >
                      ${qo("panels.general.cards.automatic-update.options.days",this.hass.language)}
                    </option>
                  </select>
          ...
          <div class="card-content">
            ${this._numRow(qo("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language),"s",this.config.autoupdatedelay,(e=>this.saveData({autoupdatedelay:parseInt(e)})),1)}
          </div>`),a=q`<ha-card header="${qo("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${a}</ha-card>`;let i=q` <div class="card-content">
          ${qo("panels.general.cards.automatic-clear.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._timeRow(qo("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language),this.config.cleardatatime,(e=>this.handleConfigChange({cleardatatime:e})))}
          </div>`),i=q`<ha-card
        header="${qo("panels.general.cards.automatic-clear.header",this.hass.language)}"
        >${i}</ha-card
      >`;let n=q`<div class="card-content">
          ${qo("panels.general.cards.continuousupdates.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._numRow(qo("panels.general.cards.continuousupdates.labels.sensor_debounce",this.hass.language),"ms",this.config.sensor_debounce,(e=>this.handleConfigChange({sensor_debounce:parseInt(e)})),1)}
          </div>`),n=q`<ha-card
        header="${qo("panels.general.cards.continuousupdates.header",this.hass.language)}"
        >${n}</ha-card
      > `;const r=this.renderTriggersCard(),s=this.renderWeatherSkipCard(),o=this.renderCoordinateCard(),l=this.renderDaysBetweenIrrigationCard(),d=this.renderObservedWateringCard();return q`<ha-card
          header="${qo("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${qo("panels.general.description",this.hass.language)}
          </div> </ha-card
      ...
      <ha-card
        header="${qo("irrigation_start_triggers.title",this.hass.language)}"
      >
        <div class="card-content">
          ${qo("irrigation_start_triggers.description",this.hass.language)}
        </div>

        <div class="card-content trigger-usage">
          ${qo("irrigation_start_triggers.usage_before",this.hass.language)}
          <code>smart_irrigation_start_irrigation_all_zones</code>${qo("irrigation_start_triggers.usage_after",this.hass.language)}
        </div>

        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("irrigation_start_triggers.active_label",this.hass.language)}
            </div>
            <select
              class="field"
            ...
            >
              ...
              >
                ${qo("irrigation_start_triggers.active_default",this.hass.language)}
              </option>
              ${e.map((e=>q`
                  <option
                    value="${e.name}"
          ...
          <div class="trigger-active-hint">
            ${qo("irrigation_start_triggers.active_hint",this.hass.language)}
          </div>
        </div>
          ...
          <div class="triggers-list">
            ${0===e.length?q`
                  <div class="no-triggers">
                    ${qo("irrigation_start_triggers.no_triggers",this.hass.language)}
                  </div>
                `:e.map(((e,a)=>this.renderTriggerItem(e,a)))}
          </div>

          <div class="add-trigger-section">
            ${this._actionBtn(Xo,qo("irrigation_start_triggers.add_trigger",this.hass.language),(()=>this._addTrigger()))}
          </div>
        </div>
      </ha-card>
    `}renderTriggerItem(e,a){if(!this.hass)return q``;const t=qo(`irrigation_start_triggers.trigger_types.${e.type}`,this.hass.language);let i="";if(e.type===$e&&0===e.offset_minutes)i=qo("irrigation_start_triggers.offset_auto",this.hass.language);else{const a=Math.abs(e.offset_minutes),t=Math.floor(a/60),n=a%60,r=e.offset_minutes<0?qo("common.labels.before",this.hass.language):qo("common.labels.after",this.hass.language);i=t>0?`${t}h ${n}m ${r}`:`${n}m ${r}`}let n="";return e.type===Ee&&void 0!==e.azimuth_angle&&(n=` (${e.azimuth_angle}°)`),q`
      <div class="trigger-item ${e.enabled?"enabled":"disabled"}">
        <div class="trigger-main">
          ...
          <div class="trigger-status">
            ${e.enabled?qo("common.labels.enabled",this.hass.language):qo("common.labels.disabled",this.hass.language)}
          </div>
        </div>
    ...
    `}_addTrigger(){this._showTriggerDialog({createTrigger:!0})}_editTrigger(e){var a,t;const i=null===(t=null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||void 0===t?void 0:t[e];i&&this._showTriggerDialog({trigger:i,triggerIndex:e})}_deleteTrigger(e){var a,t;if(!(null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||!this.hass)return;const i=(null===(t=this.config.irrigation_start_triggers[e])||void 0===t?void 0:t.name)||"Unknown";if(confirm(qo("irrigation_start_triggers.confirm_delete",this.hass.language).replace("{name}",i))){const a=[...this.config.irrigation_start_triggers];a.splice(e,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[Ae]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}}async _showTriggerDialog(e){if(!this.hass)return;const a=document.createElement("smart-irrigation-trigger-dialog");a.hass=this.hass,a.addEventListener("trigger-save",(e=>{this._handleTriggerSave(e.detail)})),a.addEventListener("trigger-delete",(e=>{this._handleTriggerDelete(e.detail)})),document.body.appendChild(a),await a.showDialog(e),a.addEventListener("closed",(e=>{const t=e.target;t&&"ha-dialog"===t.tagName.toLowerCase()&&document.body.removeChild(a)}))}_handleTriggerSave(e){if(!this.config)return;const a=this.config.irrigation_start_triggers?[...this.config.irrigation_start_triggers]:[];e.isNew?a.push(e.trigger):void 0!==e.index&&(a[e.index]=e.trigger),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[Ae]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}_handleTriggerDelete(e){var a;if(!(null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||void 0===e.index)return;const t=[...this.config.irrigation_start_triggers];t.splice(e.index,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[Ae]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}renderWeatherSkipCard(){return this.config&&this.data&&this.hass?q`
      <ha-card header="${qo("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          ...
          ${this.config.skip_irrigation_on_precipitation?this._numRow(qo("weather_skip.threshold_label",this.hass.language),Da(this.config,Se),this.config.precipitation_threshold_mm,(e=>this.handleConfigChange({precipitation_threshold_mm:parseFloat(e)})),.1):""}
        </div>
      </ha-card>
    `:q``}renderObservedWateringCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.language;return q`
      <ha-card header="${qo("observed_watering.title",e)}">
        <div class="card-content">
          ${qo("observed_watering.description",e)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("observed_watering.enabled_label",e)}
            </div>
            <ha-switch
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${qo("observed_watering.direct_control_label",e)}
            </div>
            <ha-switch
          ...
          ${this.config.direct_valve_control_enabled?q`
                <div class="card-content">
                  ${qo("observed_watering.direct_control_description",e)}
                </div>
                <div class="setting-row">
                  <div class="setting-label">
                    ${qo("observed_watering.sequencing_label",e)}
                  </div>
                  <select
                    class="field"
                  ...
                  >
                    ...
                    >
                      ${qo("observed_watering.sequencing.sequential",e)}
                    </option>
                    <option
                      value="parallel"
                      ?selected=${"parallel"===this.config.zone_sequencing}
                    >
                      ${qo("observed_watering.sequencing.parallel",e)}
                    </option>
                  </select>
                </div>
              `:""}
    ...
    `}renderCoordinateCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.config,a=(null==e?void 0:e.latitude)||0,t=(null==e?void 0:e.longitude)||0,i=(null==e?void 0:e.elevation)||0;return q`
      <ha-card
        header="${qo("coordinate_config.title",this.hass.language)}"
      >
        <div class="card-content">
          ${qo("coordinate_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("coordinate_config.manual_enabled",this.hass.language)}
            </div>
            <ha-switch
            ...
            ${this.data.manual_coordinates_enabled?q`
                    ${this._numRow(qo("coordinate_config.latitude",this.hass.language),"",this.data.manual_latitude||a,(e=>this.handleConfigChange({manual_latitude:parseFloat(e)})),.1)}
                    ${this._numRow(qo("coordinate_config.longitude",this.hass.language),"",this.data.manual_longitude||t,(e=>this.handleConfigChange({manual_longitude:parseFloat(e)})),.1)}
                    ${this._numRow(qo("coordinate_config.elevation",this.hass.language),"",this.data.manual_elevation||i,(e=>this.handleConfigChange({manual_elevation:parseFloat(e)})),1)}
                  `:q`
                    <div
                      class="zoneline"
                      style="color: var(--secondary-text-color); font-style: italic;"
                    >
                      ${qo("coordinate_config.current_ha_coords",this.hass.language)}:<br />
                      ${qo("coordinate_config.latitude",this.hass.language)}:
                      ${a}<br />
                      ${qo("coordinate_config.longitude",this.hass.language)}:
                      ${t}<br />
                      ${qo("coordinate_config.elevation",this.hass.language)}:
                      ${i}m
                    </div>
                  `}
                </div>
    ...
    `}renderDaysBetweenIrrigationCard(){return this.config&&this.data&&this.hass?q`
      <ha-card
        header="${qo("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          ${qo("days_between_irrigation.description",this.hass.language)}
        </div>

        <div class="card-content">
          ${this._numRow(qo("days_between_irrigation.label",this.hass.language),"",this.config.days_between_irrigation||0,(e=>this.handleConfigChange({days_between_irrigation:parseInt(e)})),1)}
          <div class="card-content">
            <div
              style="color: var(--secondary-text-color); font-size: 0.875rem; margin-top: 8px;"
            >
              ${qo("days_between_irrigation.help_text",this.hass.language)}
            </div>
          </div>
        </div>
      </ha-card>
    `:q``}async saveData(e){if(this.hass&&this.data){this.isSaving=!0,this._scheduleUpdate(),this._suppressNextConfigUpdate=!0;try{this.data=Object.assign(Object.assign({},this.data),e),this.config=Object.assign(Object.assign({},this.config),e),this._scheduleUpdate(),await(a=this.hass,t=this.data,a.callApi("POST",je+"/config",t))}catch(e){this._suppressNextConfigUpdate=!1,console.error("Error saving config:",e),Oa(e,this.shadowRoot.querySelector("ha-card")),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var a,t}}handleConfigChange(e){this.debouncedSave(e)}disconnectedCallback(){super.disconnectedCallback()}_textRow(e,a,t,i){return q`
      <div class="setting-row">
        <div class="setting-label">
    ...
    `}static get styles(){return p`
      ${tl} ${rl} /* View-specific styles only - most common styles are now in globalStyle */
...
t.version="2.30.1",i(Gt),t.fn=or,t.min=Jt,t.max=Qt,t.now=Xt,t.utc=m,t.unix=lr,t.months=hr,t.isDate=u,t.locale=mt,t.invalid=f,t.duration=Si,t.isMoment=z,t.weekdays=fr,t.parseZone=dr,t.localeData=vt,t.isDuration=ri,t.monthsShort=vr,t.weekdaysMin=kr,t.defineLocale=gt,t.updateLocale=ht,t.locales=ft,t.weekdaysShort=br,t.normalizeUnits=ae,t.relativeTimeRounding=ts,t.relativeTimeThreshold=is,t.calendarFormat=Li,t.prototype=or,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t}()),_l.exports),xl=bl(wl);let jl=class extends(Ba(ce)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t,i]=await Promise.all([Pa(this.hass),Ca(this.hass),Ha(this.hass),Ia(this.hass)]);this.config=e,this.zones=a,this.modules=t,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:fl.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,a){this.hass&&(this.zones[e]=a,a.id&&this.zoneCache.delete(a.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(a).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,a){if(!this.hass)return;const t=this.zones[a].id;if(!this.zones[a]||null==t)return;const i=[...this.zones];var n,r;this.zones=this.zones.filter(((e,t)=>t!==a)),this.zoneCache.delete(t.toString()),this.isSaving=!0,(n=this.hass,r=t.toString(),n.callApi("POST",je+"/zones",{id:r,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var a;const t=this.zones[e];if(!t||null==t.mapping)return;const i=`#weather-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var a;const t=this.zones[e];if(!t||null==t.id)return;const i=`#calendar-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const a=await La(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,a)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const t of this.zones)if(void 0!==t.id)try{const i=await(e=this.hass,a=t.id.toString(),e.callWS({type:je+"/watering_calendar",zone_id:a}));this.wateringCalendars.set(t.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${t.id}:`,e)}var e,a;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return q``;const a=this.weatherRecords.get(e.id)||[];return q`
              ...
              <div class="weather-table">
                ...
                ${a.slice(0,10).map((e=>q`
                    <div class="weather-row">
                      ...
                      >
                      <span
                        >${e.retrieval_time?xl(e.retrieval_time).format("MM-DD HH:mm"):"-"}</span
                      >
                    </div>
                  `))}
              </div>
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return q``;const a=this.wateringCalendars.get(e.id),t=a&&e.id in a?a[e.id]:null,i=(null==t?void 0:t.monthly_estimates)||[];return q` <div class="watering-calendar">
      ...
      ${0===i.length?q`
          ...
          `:q` <div class="calendar-table">
            ...
            ${(null==t?void 0:t.calculation_method)?q`
                ...
                `:""}`}
    </div>`}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");var a,t;await(a=this.hass,t=e,a.callApi("POST",je+"/zones",t))}handleZoneFormFocus(){this.isCreatingZone=!0}handleZoneFormBlur(){var e,a,t,i;(null===(a=null===(e=this.nameInput)||void 0===e?void 0:e.value)||void 0===a?void 0:a.trim())||(null===(t=this.sizeInput)||void 0===t?void 0:t.value)||(null===(i=this.throughputInput)||void 0===i?void 0:i.value)||(this.isCreatingZone=!1)}renderTheOptions(e,a){if(this.hass){let t=q`<option value="" ?selected=${void 0===a}">---${qo("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>t=q`${t}
            <option
              value="${i.id}"
              ?selected="${a===i.id}"
            >
              ${i.id}: ${i.name}
            </option>`)),t}return q``}renderZone(e,a){var t,i,n,r;if(!this.hass)return q``;const s=this.hass.language,o=e.state===fl.Automatic,l=e.state===fl.Disabled||e.state===fl.Automatic,d=null!=e.explanation&&e.explanation.length>0;if(null!=e.mapping){const a=this.mappings.filter((a=>a.id===e.mapping))[0];null!=a&&null!=a.data&&(e.number_of_data_points=a.data.length)}const u=qo("panels.zones.labels.states."+e.state,s),c=`${Math.round(Number(e.duration)||0)} s`,p=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="zone-card">
        ...
        ${p?q` <div class="zone-body">
              <div class="zone-meta">
                <div class="meta-item">
                  <span class="meta-label"
                    >${qo("panels.zones.labels.last_calculated",s)}</span
                  >
                  <span class="meta-value"
                    >${e.last_calculated?xl(e.last_calculated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${qo("panels.zones.labels.data-last-updated",s)}</span
                  >
                  <span class="meta-value"
                    >${e.last_updated?xl(e.last_updated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${qo("panels.zones.labels.data-number-of-data-points",s)}</span
                  >
                  <span class="meta-value"
              ...
              <div class="settings">
                ${this._textRow(qo("panels.zones.labels.name",s),"",e.name,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[oa]:t}))))}
                ${this._selectRow(qo("panels.zones.labels.input-method",s),q`
                    <option
                      value="${wa}"
                      ?selected=${(null!==(i=e.input_method)&&void 0!==i?i:wa)===wa}
                    >
                      ${qo("panels.zones.labels.input-methods.throughput",s)}
                    </option>
                    <option
                      value="${xa}"
                      ?selected=${e.input_method===xa}
                    >
                      ${qo("panels.zones.labels.input-methods.direct",s)}
                    </option>
                  `,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[za]:t.target.value}))))}
                ${e.input_method===xa?this._numRow(qo("panels.zones.labels.precipitation-rate",s),Da(this.config,ja),e.precipitation_rate,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ja]:parseFloat(t)}))),.1):q`
                      ${this._numRow(qo("panels.zones.labels.size",s),Da(this.config,la),e.size,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[la]:parseFloat(t)}))),.1)}
                      ${this._numRow(qo("panels.zones.labels.throughput",s),Da(this.config,da),e.throughput,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[da]:parseFloat(t)}))),.1)}
                    `}
                ${this._numRow(qo("panels.zones.labels.drainage_rate",s),Da(this.config,ka),e.drainage_rate,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ka]:parseFloat(t)}))),.1)}
                ${this._selectRow(qo("panels.zones.labels.state",s),q`
                    <option
                      value="${fl.Automatic}"
                      ?selected=${e.state===fl.Automatic}
                    >
                      ${qo("panels.zones.labels.states.automatic",s)}
                    </option>
                    <option
                      value="${fl.Disabled}"
                      ?selected=${e.state===fl.Disabled}
                    >
                      ${qo("panels.zones.labels.states.disabled",s)}
                    </option>
                    <option
                      value="${fl.Manual}"
                      ?selected=${e.state===fl.Manual}
                    >
                      ${qo("panels.zones.labels.states.manual",s)}
                    </option>
                  `,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ua]:t.target.value,[ca]:0}))))}
                ${this._selectRow(qo("common.labels.module",s),this.renderTheOptions(this.modules,e.module),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[pa]:""===i?void 0:parseInt(i)}))}))}
                ${this._selectRow(qo("panels.zones.labels.mapping",s),this.renderTheOptions(this.mappings,e.mapping),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[ha]:""===i?void 0:parseInt(i)}))}))}
                ${this._numRow(qo("panels.zones.labels.bucket",s),Da(this.config,ma),Number(e.bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ma]:parseFloat(t)}))),.1)}
                ${this._numRow(qo("panels.zones.labels.maximum-bucket",s),Da(this.config,ma),Number(e.maximum_bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ba]:parseFloat(t)}))),.1)}
                ${this._numRow(qo("panels.zones.labels.et-deficiency",s),Da(this.config,ma),null!=e.et_deficiency?Number(e.et_deficiency).toFixed(2):"",(()=>{}),.01,!0)}
                ${(null===(n=this.config)||void 0===n?void 0:n.observed_watering_enabled)?this._entityRow(qo("panels.zones.labels.linked-entity",s),qo("panels.zones.labels.optional",s),e.linked_entity,["switch","valve","input_boolean","binary_sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ya]:t||void 0}))),qo("panels.zones.labels.linked-entity-hint",s)):""}
                ${(null===(r=this.config)||void 0===r?void 0:r.observed_watering_enabled)&&e.linked_entity?this._entityRow(qo("panels.zones.labels.flow-sensor",s),qo("panels.zones.labels.optional",s),e.flow_sensor,["sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[_a]:t||void 0}))),qo("panels.zones.labels.flow-sensor-hint",s)):""}
                ${this._numRow(qo("panels.zones.labels.lead-time",s),"s",e.lead_time,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[va]:parseInt(t,10)}))),1)}
                ${this._numRow(qo("panels.zones.labels.maximum-duration",s),"s",e.maximum_duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[fa]:parseInt(t,10)}))),1)}
                ${this._numRow(qo("panels.zones.labels.multiplier",s),"",e.multiplier,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ga]:parseFloat(t)}))),.1)}
                ${this._numRow(qo("panels.zones.labels.duration",s),"s",e.duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ca]:parseInt(t,10)}))),1,l)}
              </div>

              <div class="zone-actions">
                ${o?q`
                      ${this._actionBtn(Fo,qo("panels.zones.actions.calculate",s),(()=>this.handleCalculateZone(a)))}
                      ${this._actionBtn(el,qo("panels.zones.actions.update",s),(()=>this.handleUpdateZone(a)))}
                    `:""}
                ${this._actionBtn(Qo,qo("panels.zones.actions.reset-bucket",s),(()=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ma]:0}))))}
                ${null!=e.mapping?this._actionBtn(Yo,qo("panels.zones.actions.view-weather-info",s),(()=>this.handleViewWeatherInfo(a))):""}
                ${this._actionBtn("M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z",qo("panels.zones.actions.view-watering-calendar",s),(()=>this.handleViewWateringCalendar(a)))}
                ${d?this._actionBtn("M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z",qo("panels.zones.actions.information",s),(()=>this.toggleExplanation(a))):""}
                ${this._actionBtn(Zo,qo("common.actions.delete",s),(e=>this.handleRemoveZone(e,a)),!0)}
              </div>

              ${d?q`<label class="hidden" id="calcresults${a}"
                    >${Ta("<br/>"+e.explanation)}</label
                  >`:""}
    ...
    `}toggleExplanation(e){var a;const t=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector("#calcresults"+e);t&&("hidden"!=t.className?t.className="hidden":t.className="explanation")}render(){return this.hass?this.isLoading?q`
        <ha-card header="${qo("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${qo("common.loading-messages.general",this.hass.language)}...
          </div>
        </ha-card>
      ...
      <ha-card header="${qo("panels.zones.title",this.hass.language)}">
        <div class="card-content">
          ${qo("panels.zones.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${qo("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("panels.zones.labels.name",this.hass.language)}
            </div>
            <input
              id="nameInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${qo("panels.zones.labels.size",this.hass.language)}
              <span class="unit">(${Da(this.config,la)})</span>
            </div>
            <input
              id="sizeInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${qo("panels.zones.labels.throughput",this.hass.language)}
              <span class="unit"
                >(${Da(this.config,da)})</span
              >
            </div>
            <input
              id="throughputInput"
          ...
          <div class="add-zone-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Xo}></ha-svg-icon>
              ${this.isSaving?qo("common.saving-messages.adding",this.hass.language):qo("panels.zones.cards.add-zone.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>

      ${hl(this.zones,(e=>{var a;return null!==(a=e.id)&&void 0!==a?a:e.name}),((e,a)=>this.renderZone(e,a)))}

      <ha-card
        header="${qo("panels.zones.cards.zone-actions.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zone-actions-grid">
            ${this._actionBtn(Fo,qo("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language),(()=>this.handleCalculateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(el,qo("panels.zones.cards.zone-actions.actions.update-all",this.hass.language),(()=>this.handleUpdateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Qo,qo("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),(()=>this.handleResetAllBuckets()),!1,this.isSaving)}
            ${this._actionBtn(Yo,qo("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),(()=>this.handleClearAllWeatherdata()),!1,this.isSaving)}
          </div>
        </div>
      </ha-card>
        ...
        ${s?q` <div class="si-body">
              <div class="moduleconfig">
                <label class="subheader"
                  >${qo("panels.modules.cards.module.labels.configuration",this.hass.language)}
                  (*
                  ${qo("panels.modules.cards.module.labels.required",this.hass.language)})</label
                >
                <div class="settings">
              ...
              ${n?q`<div class="weather-note">
                    ${qo("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                  </div>`:q`<div class="si-actions">
                    ${this._actionBtn(Zo,qo("common.actions.delete",this.hass.language),(e=>this.handleRemoveModule(e,a)),!0)}
                  </div>`}
            </div>`:""}
      </ha-card>
    `;return this.moduleCache.set(l,d),d}renderConfig(e,a){const t=Object.values(this.modules).at(e);if(!t||!this.hass)return;const i=t.schema[a],n=i.name,r=function(e){if(e)return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}(n);let s="";null==t.config&&(t.config=[]),n in t.config&&(s=t.config[n]);const o=i.required?`${r} *`:null!=r?r:"";if("boolean"==i.type)return q`
      ...
      `;if("float"==i.type||"integer"==i.type)return this._numRow(o,"",t.config[n],(a=>this.handleEditConfig(e,Object.assign(Object.assign({},t),{config:Object.assign(Object.assign({},t.config),{[n]:a})}))),1);if("string"==i.type)return this._textRow(o,"",s,(a=>this.handleEditConfig(e,Object.assign(Object.assign({},t),{config:Object.assign(Object.assign({},t.config),{[n]:a})}))));if("select"==i.type){const a=this.hass.language,r=q`
        ${Object.entries(i.options).map((([e,t])=>q`<option
              ...
              ?selected="${s===Ma(t,0)}"
            >
              ${qo("panels.modules.cards.module.translated-options."+Ma(t,1),a)}
            </option>`))}
    ...
    `}handleEditConfig(e,a){this.modules=Object.values(this.modules).map(((t,i)=>i===e?a:t)),this.moduleCache.clear(),this._scheduleUpdate(),this.debouncedSave(a)}renderOption(e,a){return this.hass?q`<option value="${e}>${a}</option>`:q``}render(){return this.hass?q`
      <ha-card header="${qo("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${qo("panels.modules.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${qo("panels.modules.cards.add-module.header",this.hass.language)}"
      >
        <div class="card-content">
          ${this.isLoading?q`<div class="loading-indicator">
                ...
                <div class="setting-row">
                  <div class="setting-label">
                    ${qo("common.labels.module",this.hass.language)}
                  </div>
                  <div class="select-wrap">
                    <select
                      id="moduleInput"
                ...
                <div class="si-form-actions">
                  ...
                  >
                    <ha-svg-icon slot="start" .path=${Xo}></ha-svg-icon>
                    ${this.isSaving?qo("common.saving-messages.adding",this.hass.language):qo("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </ha-button>
                </div>
              `}
        </div>
      ...
      ${this.isLoading?q`<div class="loading-indicator">
            ${qo("common.loading-messages.modules",this.hass.language)}
          </div>`:hl(this.modules,(e=>{var a;return null!==(a=e.id)&&void 0!==a?a:e.name}),((e,a)=>this.renderModule(e,a)))}
    `:q``}disconnectedCallback(){super.disconnectedCallback(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.moduleCache.clear()}static get styles(){return p`
      ${tl} ${rl} /* View-specific styles only - most common styles are now in globalStyle */
    `}};r([he()],Sl.prototype,"config",void 0),r([he({type:Array})],Sl.prototype,"zones",void 0),r([he({type:Array})],Sl.prototype,"modules",void 0),r([he({type:Array})],Sl.prototype,"allmodules",void 0),r([he({type:Boolean})],Sl.prototype,"isLoading",void 0),r([he({type:Boolean})],Sl.prototype,"isSaving",void 0),r([fe("#moduleInput")],Sl.prototype,"moduleInput",void 0),Sl=r([me("smart-irrigation-view-modules")],Sl);let Al=class extends(Ba(ce)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16,this._expanded=new Set}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}),this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()})))}_toggleItem(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t]=await Promise.all([Pa(this.hass),Ca(this.hass),Ia(this.hass)]);this.config=e,this.zones=a,this.mappings=t,this._fetchWeatherRecords(),this.mappingCache.clear()}catch(a){console.error("Error fetching data:",a),Oa({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"))}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const a=await La(this.hass,e.id.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for mapping ${e.id}:`,a),this.weatherRecords.set(e.id,[])}this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass)return q``;const a=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return q`
      <div class="weather-records">
        <h4>
          ${qo("panels.mappings.weather-records.title",this.hass.language)}
        </h4>
        ...
        <div class="card-content">
          <div class="card-content">
            ...
            ${i?q`<div class="weather-note">
                  ${qo("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:q` <div
                  class="action-button"
                  @click="${e=>this.handleRemoveMapping(e,a)}"
                >
                  <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    <path fill="#404040" d="${Zo}" />
                  </svg>
                  <span class="action-button-label">
                    ${qo("common.actions.delete",this.hass.language)}
                  </span>
                </div>`}
          </div>
        </div>
    ...
    `;return this.mappingCache.set(t,n),n}renderMappingSetting(e,a){const t=this.mappings[e];if(!t||!this.hass)return q``;const i=t.mappings[a];return q`
      <div class="si-subgroup">
        <div class="si-subgroup-title">
          ${qo(`panels.mappings.cards.mapping.items.${a.toLowerCase()}`,this.hass.language)}
        </div>
        ${this._selectRow(qo("panels.mappings.cards.mapping.source",this.hass.language),this.renderSimpleRadioOptions(e,a,i),(t=>this.handleSimpleSourceChange(e,a,t)))}
        ${this.renderMappingInputs(e,a,i)}
      </div>
    `}renderSimpleRadioOptions(e,a,t){if(!this.hass||!this.config)return q``;const i=a===Ce||a===Re,n=t[Xe],r=!!this.config.use_weather_service,s=i&&this.config.weather_service!==qe;return q`
      ${r?q`<option
            value="${We}"
            ?selected=${n===We}
          >
            ${qo("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}${s?" (via Open-Meteo)":""}
          </option>`:""}
      ${i?q`<option
            value="${Qe}"
            ?selected=${n===Qe}
          >
            ${qo("panels.mappings.cards.mapping.sources.none",this.hass.language)}
          </option>`:""}
      <option
        value="${Ge}"
        ?selected=${n===Ge}
      >
        ${qo("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </option>
      <option
        value="${Ye}"
        ?selected=${n===Ye}
      >
        ${qo("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </option>
    `}handleSimpleSourceChange(e,a,t){const i=this.mappings[e],n=t.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[a]:Object.assign(Object.assign({},i.mappings[a]),{[Xe]:n,[ea]:""})})}))}handleSimpleInputChange(e,a,t,i){const n=this.mappings[e],r=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[a]:Object.assign(Object.assign({},n.mappings[a]),{[t]:r})})}))}renderSourceOptions(e,a,t){var i;if(!this.hass)return q``;const n=`${a}_${e}`,r=a===Ce||a===Re,s=!!(null===(i=this.config)||void 0===i?void 0:i.use_weather_service);return q`
      <div class="mappingsettingline">
        <label for="${n}_source">
          ${qo("panels.mappings.cards.mapping.source",this.hass.language)}:
        </label>
      </div>
    ...
    `}renderWeatherServiceOption(e,a,t){if(!this.hass||!this.config)return q``;const i=`${a}_${e}`,n=!this.config.use_weather_service,r=this.config.use_weather_service&&t[Xe]===We,s=(a===Ce||a===Re)&&this.config.weather_service!==qe;return q`
    ...
    `}renderSensorInput(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${qo("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}
        </div>
        <ha-entity-picker
          class="entity-field"
          .hass=${this.hass}
    ...
    `:q``}renderStaticValueInput(e,a,t){return this.hass?this._numRow(qo("panels.mappings.cards.mapping.static_value",this.hass.language),"",t[aa]||"",(t=>this.handleStaticValueChange(e,a,{target:{value:t}})),.1):q``}renderUnitSelect(e,a,t){return this.hass&&this.config?this._selectRow(qo("panels.mappings.cards.mapping.input-units",this.hass.language),this.renderUnitOptionsForMapping(a,t),(t=>this.handleUnitChange(e,a,t))):q``}renderPressureTypeSelect(e,a,t){return this.hass?this._selectRow(qo("panels.mappings.cards.mapping.pressure-type",this.hass.language),this.renderPressureTypes(a,t),(t=>this.handlePressureTypeChange(e,a,t))):q``}renderAggregateSelect(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${qo("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          <span class="unit"
            >${qo("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</span
          >
        </div>
        <div class="select-wrap">
          <select
    ...
    `}renderAggregateOption(e,a){if(this.hass&&this.config){return q`<option value="${e}" ?selected="${e===a}">
        ${qo("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return q``}renderPressureTypes(e,a){if(this.hass&&this.config){let e=q``;const t=a[Ze];return e=q`${e}
        <option
          value="${Ke}"
          ?selected="${t===Ke}"
        >
          ${qo("panels.mappings.cards.mapping.pressure_types."+Ke,this.hass.language)}
        </option>
        <option
          value="${Je}"
          ?selected="${t===Je}"
        >
          ${qo("panels.mappings.cards.mapping.pressure_types."+Je,this.hass.language)}
    ...
    `}render(){return this.hass?this.isLoading?q`
        <ha-card
          header="${qo("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${qo("common.loading-messages.general",this.hass.language)}
          </div>
      ...
      >
        <div class="card-content">
          ${qo("panels.mappings.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${qo("panels.mappings.cards.add-mapping.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${qo("panels.mappings.labels.mapping-name",this.hass.language)}
            </div>
          ...
          <div class="si-form-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Xo}></ha-svg-icon>
              ${this.isSaving?qo("common.saving-messages.adding",this.hass.language):qo("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
    ...
    `:q``}renderMappingsList(){const e=this.mappings.slice(0,Math.min(this.mappings.length,10)),a=this.mappings.slice(10);return q`
      ${hl(e,(e=>{var a;return null!==(a=e.id)&&void 0!==a?a:e.name}),((e,a)=>this.renderMappingCard(e,a)))}
      ${a.length>0?q`
            <div class="si-form-actions">
              ${this._actionBtn(Xo,`Load ${a.length} more mappings...`,(()=>this.loadMoreMappings()))}
            </div>
          `:""}
    `}renderMappingCard(e,a){if(!this.hass)return q``;const t=this.hass.language,i=this.zones.filter((a=>a.mapping===e.id)).length,n=Object.keys(e.mappings||{}).length,r=[];r.push(`${n} ${qo("panels.mappings.title",t).toLowerCase()}`),i&&r.push(`${i} ${qo("panels.zones.title",t).toLowerCase()}`);const s=r.join(" · "),o=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="si-card">
        <div
          class="si-head"
          role="button"
        ...
        ${o?q`<div class="si-body">
              <div class="settings">
                ${this._textRow(qo("panels.mappings.labels.mapping-name",t),"",e.name,(t=>this.handleEditMapping(a,Object.assign(Object.assign({},e),{name:t}))))}
                ${this.renderMappingSettings(e,a)}
              </div>
              ${this.renderWeatherRecords(e)}
              <div class="si-actions">
                ${i?q`<div class="weather-note">
                      ${qo("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",t)}
                    </div>`:this._actionBtn(Zo,qo("common.actions.delete",t),(e=>this.handleRemoveMapping(e,a)),!0)}
              </div>
            </div>`:""}
      </ha-card>
      ...
      <ha-card header="${qo("panels.weatherservice.title",a)}">
        ...
        <div class="card-content">
          ...
          ${this._use?q`
                <div class="setting-row">
                  <div class="setting-label">
                    ${qo("panels.weatherservice.labels.service",a)}
                  </div>
                  <div class="select-wrap">
                    <select
                      class="field"
                ...
                ${this._service&&Fe.includes(this._service)?"":q`<div class="setting-row">
                      <div class="setting-label">
                        ${qo("panels.weatherservice.labels.api-key",a)}
                      </div>
                      <input
                        class="field"
                        type="text"
                ...
                ${"Open Weather Map"===this._service?q`<div class="ws-note ws-note--hint">
                      ${qo("panels.weatherservice.messages.owm-onecall-hint",a)}
                    </div>`:""}
              `:q`<div class="ws-note">
                ${qo("panels.weatherservice.messages.no-service",a)}
              </div>`}
          ${this._error?q`<div class="ws-msg ws-msg--error">${this._error}</div>`:""}
          ${this._saved?q`<div class="ws-msg ws-msg--success">
                ${qo("panels.weatherservice.messages.saved",a)}
              </div>`:""}
          ...
          <div class="ws-actions">
            <ha-button
              ...
              @click=${this._save}
            >
              ${this._saving?qo("panels.weatherservice.actions.saving",a):qo("panels.weatherservice.actions.save",a)}
            </ha-button>
          </div>
          <div class="ws-note ws-reload-note">
            ${qo("panels.weatherservice.messages.reload-note",a)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
    ...
    `}};r([he()],$l.prototype,"narrow",void 0),r([he()],$l.prototype,"path",void 0),r([ve()],$l.prototype,"_info",void 0),r([ve()],$l.prototype,"_use",void 0),r([ve()],$l.prototype,"_service",void 0),r([ve()],$l.prototype,"_apiKey",void 0),r([ve()],$l.prototype,"_loading",void 0),r([ve()],$l.prototype,"_saving",void 0),r([ve()],$l.prototype,"_error",void 0),r([ve()],$l.prototype,"_saved",void 0),$l=r([me("smart-irrigation-view-weatherservice")],$l);let El=class extends ce{constructor(){super(...arguments),this._busy=!1,this._error="",this._message="",this._pendingName=""}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}_reset(){this._error="",this._message="",this._pending=void 0,this._pendingName=""}async _export(){if(this.hass){this._reset(),this._busy=!0;try{const a=await(e=this.hass,e.callApi("GET",je+"/export")),t=JSON.stringify(a,null,2),i=new Blob([t],{type:"application/json"}),n=URL.createObjectURL(i),r=document.createElement("a");r.href=n;const s=(new Date).toISOString().slice(0,19).replace("T","_").replace(/:/g,"-");r.download=`smart_irrigation_backup_${s}.json`,r.click(),URL.revokeObjectURL(n),this._message=qo("panels.backuprestore.messages.exported",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e}}async _onFile(e){this._reset();const a=e.target,t=a.files&&a.files[0];if(t)try{const e=await t.text(),a=JSON.parse(e);if(!a||"object"!=typeof a||!a.config)throw new Error(qo("panels.backuprestore.messages.invalid-file",this.hass.language));this._pending=a,this._pendingName=t.name}catch(e){this._error=this._errText(e)}finally{a.value=""}}async _restore(){if(this.hass&&this._pending){this._busy=!0,this._error="",this._message="";try{const t=await(e=this.hass,a=this._pending,e.callApi("POST",je+"/restore",a));if(t&&!1===t.success)throw new Error(t.error||"restore failed");this._pending=void 0,this._pendingName="",this._message=qo("panels.backuprestore.messages.restored",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e,a}}_count(e){const a=this._pending&&this._pending[e];return Array.isArray(a)?a.length:0}render(){if(!this.hass)return q``;const e=this.hass.language;return q`
      <ha-card header="${qo("panels.backuprestore.title",e)}">
        <div class="card-content br-description">
          ${qo("panels.backuprestore.description",e)}
        </div>
      </ha-card>

      <ha-card
        header="${qo("panels.backuprestore.cards.backup.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${qo("panels.backuprestore.cards.backup.description",e)}
          </div>
          ...
          <div class="br-actions">
            ...
            >
              ...
              ${qo("panels.backuprestore.actions.export",e)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${qo("panels.backuprestore.cards.restore.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${qo("panels.backuprestore.cards.restore.description",e)}
          </div>
          ...
          <label class="br-file">
            <input
              ...
              @change=${this._onFile}
            />
            <ha-svg-icon .path=${al}></ha-svg-icon>
            ${qo("panels.backuprestore.actions.choose-file",e)}
          </label>
                ...
                <div class="br-warning">
                  ...
                  <div>
                    <div class="br-warning-title">
                      ${qo("panels.backuprestore.messages.confirm-title",e)}
                    </div>
                    <div class="br-file-name">${this._pendingName}</div>
                    <div class="br-summary">
                      ${qo("panels.backuprestore.messages.summary",e)}:
                      ${this._count("zones")}
                      ${qo("panels.zones.title",e)} ·
                      ${this._count("modules")}
                      ${qo("panels.modules.title",e)} ·
                      ${this._count("mappings")}
                      ${qo("panels.mappings.title",e)}
                    </div>
                    <div class="br-warning-text">
                      ${qo("panels.backuprestore.messages.confirm-warning",e)}
                    </div>
                  </div>
                </div>
              `:""}
          ...
          ${this._pending?q`<div class="br-actions">
                <ha-button
                  ...
                  @click=${this._restore}
                >
                  <ha-svg-icon slot="start" .path=${al}></ha-svg-icon>
                  ${this._busy?qo("panels.backuprestore.actions.restoring",e):qo("panels.backuprestore.actions.restore",e)}
                </ha-button>
              </div>`:""}
          <div class="br-note">
            ${qo("panels.backuprestore.messages.reload-note",e)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
    ...
    `}};r([he()],El.prototype,"narrow",void 0),r([he()],El.prototype,"path",void 0),r([ve()],El.prototype,"_busy",void 0),r([ve()],El.prototype,"_error",void 0),r([ve()],El.prototype,"_message",void 0),r([ve()],El.prototype,"_pending",void 0),r([ve()],El.prototype,"_pendingName",void 0),El=r([me("smart-irrigation-view-backuprestore")],El);let Tl=class extends(Ba(ce)){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[a,t,i]=await Promise.all([Pa(this.hass),(e=this.hass,e.callWS({type:je+"/info"})),Ca(this.hass)]);this.config=a,this.info=t,this.zones=i}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}render(){return this.hass?this.isLoading?q`
        <ha-card header="${qo("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${qo("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:this.config?q`
      <ha-card header="${qo("panels.info.title",this.hass.language)}">
        <div class="card-content">
          ${qo("panels.info.description",this.hass.language)}
        </div>
      </ha-card>
    ...
    `:q`
        <ha-card header="${qo("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${qo("panels.info.configuration-not-available",this.hass.language)}
          </div>
        </ha-card>
      `:q``}renderZoneBucketsCard(){if(!this.hass)return q``;if(!this.zones||0===this.zones.length)return q`
        <ha-card
          header="${qo("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="info-item">
              <span class="value"
                >${qo("panels.info.cards.zone-bucket-values.no-zones",this.hass.language)}</span
              >
            </div>
          </div>
        </ha-card>
      `;const e=this.config?Da(this.config,ma):"mm";return q`
      <ha-card
        header="${qo("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
      >
        <div class="card-content">
              ...
              <div class="zone-info">
                ...
                <div class="zone-details">
                  <div class="zone-bucket">
                    <span class="label"
                      >${qo("panels.info.cards.zone-bucket-values.labels.bucket",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</span
                    >
                    <span class="value">
                  ...
                  <div class="zone-duration">
                    <span class="label"
                      >${qo("panels.info.cards.zone-bucket-values.labels.duration",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}:</span
                    >
                    <span class="value">
                      ${a.duration?`${Math.round(a.duration)} ${qo("common.units.seconds",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}`:`0 ${qo("common.units.seconds",null!==(d=null===(l=this.hass)||void 0===l?void 0:l.language)&&void 0!==d?d:"en")}`}
                    </span>
                  </div>
                </div>
              </div>
    ...
    `}renderNextIrrigationCard(){var e,a,t,i,n,r,s,o;return this.hass&&this.info?q`
      <ha-card
        header="${qo("panels.info.cards.next-irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${qo("panels.info.cards.next-irrigation.labels.next-start",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.next_irrigation_start?xl(this.info.next_irrigation_start).format("YYYY-MM-DD HH:mm:ss"):qo("panels.info.cards.next-irrigation.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.next_irrigation_duration?q`
                <div class="info-item">
                  <label
                    >${qo("panels.info.cards.next-irrigation.labels.duration",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${this.info.next_irrigation_duration}
                    ${qo("common.units.seconds",this.hass.language)}</span
                  >
                </div>
              `:""}
          ${this.info.next_irrigation_zones&&this.info.next_irrigation_zones.length>0?q`
                <div class="info-item">
                  <label
                    >${qo("panels.info.cards.next-irrigation.labels.zones",this.hass.language)}:</label
                  >
                  <span class="value"
    ...
    `:q`
        <ha-card
          header="${qo("panels.info.cards.next-irrigation.title",null!==(a=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==a?a:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${qo("panels.info.cards.next-irrigation.labels.next-start",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${qo("panels.info.cards.next-irrigation.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${qo("panels.info.cards.next-irrigation.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}renderIrrigationReasonCard(){var e,a,t,i,n,r,s,o;return this.hass&&this.info?q`
      <ha-card
        header="${qo("panels.info.cards.irrigation-reason.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${qo("panels.info.cards.irrigation-reason.labels.reason",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.irrigation_reason||qo("panels.info.cards.irrigation-reason.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.sunrise_time?q`
                <div class="info-item">
                  <label
                    >${qo("panels.info.cards.irrigation-reason.labels.sunrise",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${xl(this.info.sunrise_time).format("HH:mm:ss")}</span
                  >
                </div>
              `:""}
          ${void 0!==this.info.total_irrigation_duration?q`
                <div class="info-item">
                  <label
                    >${qo("panels.info.cards.irrigation-reason.labels.total-duration",this.hass.language)}:</label
                  >
                  <span class="value"
          ...
          ${this.info.irrigation_explanation?q`
                <div class="info-item explanation">
                  <label
                    >${qo("panels.info.cards.irrigation-reason.labels.explanation",this.hass.language)}:</label
                  >
    ...
    `:q`
        <ha-card
          header="${qo("panels.info.cards.irrigation-reason.title",null!==(a=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==a?a:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${qo("panels.info.cards.irrigation-reason.labels.reason",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${qo("panels.info.cards.irrigation-reason.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${qo("panels.info.cards.irrigation-reason.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}static get styles(){return p`
    ...
    `}};r([he()],Tl.prototype,"config",void 0),r([he({type:Object})],Tl.prototype,"info",void 0),r([he({type:Array})],Tl.prototype,"zones",void 0),r([he({type:Boolean})],Tl.prototype,"isLoading",void 0),Tl=r([me("smart-irrigation-view-info")],Tl);const Ml=tl,Dl=()=>{const e=e=>{let a={};for(let t=0;t<e.length;t+=2){const i=e[t],n=t<e.length?e[t+1]:void 0;a=Object.assign(Object.assign({},a),{[i]:n})}return a},a=window.location.pathname.split("/");let t={page:a[2]||"general",params:{}};if(a.length>3){let i=a.slice(3);if(a.includes("filter")){const a=i.findIndex((e=>"filter"==e)),n=i.slice(a+1);i=i.slice(0,a),t=Object.assign(Object.assign({},t),{filter:e(n)})}i.length&&(i.length%2&&(t=Object.assign(Object.assign({},t),{subpage:i.shift()})),i.length&&(t=Object.assign(Object.assign({},t),{params:e(i)})))}return t},Ol=(e,...a)=>{let t={page:e,params:{}};a.forEach((e=>{"string"==typeof e?t=Object.assign(Object.assign({},t),{subpage:e}):"params"in e?t=Object.assign(Object.assign({},t),{params:e.params}):"filter"in e&&(t=Object.assign(Object.assign({},t),{filter:e.filter}))}));const i=e=>{let a=Object.keys(e);a=a.filter((a=>e[a])),a.sort();let t="";return a.forEach((a=>{const i=e[a];t=t.length?`${t}/${a}/${i}`:`${a}/${i}`})),t};let n=`/${je}/${t.page}`;return t.subpage&&(n=`${n}/${t.subpage}`),i(t.params).length&&(n=`${n}/${i(t.params)}`),t.filter&&(n=`${n}/filter/${i(t.filter)}`),n};var Nl;!function(e){e.Info="info",e.General="general",e.Zones="zones",e.Modules="modules",e.Mappings="mappings",e.WeatherService="weatherservice",e.BackupRestore="backuprestore",e.Help="help"}(Nl||(Nl={})),e.SmartIrrigationPanel=class extends ce{constructor(){super(...arguments),this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}async firstUpdated(){const e=Dl();e.page&&Object.values(Nl).includes(e.page)?(window.addEventListener("location-changed",(()=>{if(!window.location.pathname.includes("smart_irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())})),_e().then((()=>{this._scheduleUpdate()})).catch((e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}))):Na(0,Ol(Nl.General))}render(){const e=Dl(),a=!!customElements.get("ha-tab-group"),t=!!customElements.get("ha-tab-group-tab");return q`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${qo("title",this.hass.language)}</div>
          <div class="version">${"v2026.8.1"}</div>
        </div>

        ${a&&t?q`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(Nl).map((a=>q`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${a}"
                      .active=${e.page===a}
                    >
                      ${qo(`panels.${a}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `))}
              </ha-tab-group>
            `:q`
    ...
    `}getView(e){switch(e.page){case"info":return q`
        ...
        `;case"help":return q`<ha-card
          header="${qo("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
            ${qo("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
            <a href="https://altmenorg.github.io/HAsmartirrigation/"
              >${qo("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >.
            ${qo("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${qo("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${qo("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a href="https://github.com/altmenorg/HAsmartirrigation/issues"
              >${qo("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${qo("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return q`
        ...
        `}}navigateToPage(e){if(e!==Dl().page){const a=Ol(e);Na(0,a),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const a=e.detail.name;if(a!==Dl().page){const e=Ol(a);Na(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Ml,p`
        :host {
          color: var(--primary-text-color);
    ...
    `}};r([he({attribute:!1})],Pl.prototype,"hass",void 0),r([ve()],Pl.prototype,"_params",void 0),Pl=r([me("smart-irrigation-error-dialog")],Pl);var Cl=Object.freeze({__proto__:null,get ErrorDialog(){return Pl}})}({});
