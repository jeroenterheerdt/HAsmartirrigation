...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */,ce=(e,t)=>"method"===t.kind&&t.descriptor&&!("value"in t.descriptor)?{...t,finisher(a){a.createProperty(t.key,e)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){"function"==typeof t.initializer&&(this[t.key]=t.initializer.call(this))},finisher(a){a.createProperty(t.key,e)}},he=(e,t,a)=>{t.constructor.createProperty(a,e)};function pe(e){return(t,a)=>void 0!==a?he(e,t,a):ce(e,t)
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
`;var Ki="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",Xi="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";let Ji=class extends(st(le)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e,t;this.hass&&(this.config=await tt(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{}))}firstUpdated(){(async()=>{await ye()})()}render(){if(this.hass&&this.config&&this.data){let e=Y` <div class="card-content">
          <svg
          ...
          >
            >
            <title>
              ${Ii("panels.zones.actions.information",this.hass.language)}
            </title>
            <path fill="#404040" d="${Xi}" />
          </svg>
        </div>

        <div class="card-content">
          <label class="hidden" id="autocalcdescription">
            ${Ii("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autocalcenabled"
            >${Ii("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autocalcon"
            ...
            @change="${e=>{this.saveData({autocalcenabled:Fi(e.target.value)})}}"
          /><label for="autocalcon"
            >${Ii("common.labels.yes",this.hass.language)}</label
          >
          <input
            type="radio"
            id="autocalcoff"
          ...
          /><label for="autocalcoff"
            >${Ii("common.labels.no",this.hass.language)}</label
          >
        </div>`;this.data.autocalcenabled&&(e=Y`${e}
          <div class="card-content">
            <label for="calctime"
              >${Ii("panels.general.cards.automatic-duration-calculation.labels.auto-calc-time",this.hass.language)}</label
            >:
            <input
              id="calctime"
              type="text"
        ...
        header="${Ii("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let t=Y` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autoupdatedescription">
            ${Ii("panels.general.cards.automatic-update.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autoupdateenabled"
            >${Ii("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autoupdateon"
            ...
            @change="${e=>{this.saveData({autoupdateenabled:Fi(e.target.value)})}}"
          ...
          <div class="card-content">
            <label for="autoupdateinterval"
              >${Ii("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}:</label
            >
            <input
            ...
            >
              ...
              >
                ${Ii("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
              </option>
              <option
                value="${ke}"
                ?selected="${this.data.autoupdateschedule===ke}"
              >
                ${Ii("panels.general.cards.automatic-update.options.hours",this.hass.language)}
              </option>
              <option
                value="${Se}"
                ?selected="${this.data.autoupdateschedule===Se}"
              >
                ${Ii("panels.general.cards.automatic-update.options.days",this.hass.language)}
              </option>
            </select>
          </div>
          <div class="card-content">
            <label for="updatedelay"
              >${Ii("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
              (s):</label
            >
            <input
              id="updatedelay"
            ...
            />
          </div>`),t=Y`<ha-card header="${Ii("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;let a=Y` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autocleardescription">
            ${Ii("panels.general.cards.automatic-clear.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="autoclearenabled"
            >${Ii("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}:</label
          >
          <input
            type="radio"
            id="autoclearon"
            ...
            @change="${e=>{this.saveData({autoclearenabled:Fi(e.target.value)})}}"
          ...
          <div class="card-content">
            <label for="calctime"
              >${Ii("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language)}</label
            >:
            <input
              id="cleardatatime"
              type="text"
            ...
            />
          </div>`),a=Y`<ha-card header="${Ii("panels.general.cards.automatic-clear.header",this.hass.language)}" >${a}</div></ha-card>`;let i=Y`<ha-card
        header="${Ii("panels.general.cards.continuousupdates.header",this.hass.language)}"
      >
        <div class="card-content">
          <svg
            style="width:24px;height:24px"
        ...
        <div class="card-content">
          <label class="hidden" id="continuousupdatesdescription">
            ${Ii("panels.general.cards.continuousupdates.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <label for="continuousupdates"
            >${Ii("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}:</label
          >
<input
            type="radio"
            ...
            @change="${e=>{this.saveData({continuousupdates:Fi(e.target.value)})}}"
          ...
          header="${Ii("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ii("panels.general.description",this.hass.language)}
          </div> </ha-card
        >${t}${e}${a}${i}`}return Y``}saveData(e){var t,a;this.hass&&this.data&&(this.data=Object.assign(Object.assign({},this.data),e),(t=this.hass,a=this.data,t.callApi("POST",_e+"/config",a)).catch((e=>Zi(e,this.shadowRoot.querySelector("ha-card")))).then())}toggleInformation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="information")}static get styles(){return c`
      ${qi}
      .hidden {
        display: none;
      }
...
i.version="2.29.4",n(Za),i.fn=us,i.min=Ja,i.max=Qa,i.now=ei,i.utc=m,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ma,i.invalid=b,i.duration=Mi,i.isMoment=S,i.weekdays=ys,i.parseZone=cs,i.localeData=va,i.isDuration=ri,i.monthsShort=bs,i.weekdaysMin=ws,i.defineLocale=ga,i.updateLocale=fa,i.locales=ba,i.weekdaysShort=_s,i.normalizeUnits=ie,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Ii,i.prototype=us,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i}()}(an);var nn=en(an.exports);let sn=class extends(st(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await tt(this.hass),this.zones=await at(this.hass),this.modules=await it(this.hass),this.mappings=await nt(this.hass))}handleCalculateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{calculate_all:!0})}handleUpdateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{update_all:!0})}handleResetAllBuckets(){this.hass&&this.hass.callApi("POST",_e+"/zones",{reset_all_buckets:!0})}handleClearAllWeatherdata(){this.hass&&this.hass.callApi("POST",_e+"/zones",{clear_all_weatherdata:!0})}handleAddZone(){const e={name:this.nameInput.value,size:parseFloat(this.sizeInput.value),throughput:parseFloat(this.throughputInput.value),state:Qi.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0};this.zones=[...this.zones,e],this.saveToHA(e)}handleEditZone(e,t){this.hass&&(this.zones=Object.values(this.zones).map(((a,i)=>i===e?t:a)),this.saveToHA(t))}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;var i,n;Object.values(this.zones).at(t)&&null!=a&&(this.zones=this.zones.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/zones",{id:n,remove:!0})))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,update:!0})))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=Y`<option value="" ?selected=${void 0===t}">---${Ii("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=Y`${a}
        ...
        >
          ...
          <path fill="#404040" d="${Xi}" />
        </svg>`),e.state===Qi.Automatic&&(i=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
          @click="${()=>this.handleCalculateZone(t)}"
        >
          <title>
            ${Ii("panels.zones.actions.calculate",this.hass.language)}
          </title>
        ...
        </svg>`),e.state===Qi.Automatic&&(n=Y` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
          @click="${()=>this.handleUpdateZone(t)}"
        >
          <title>
            ${Ii("panels.zones.actions.update",this.hass.language)}
          </title>
          ...
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
          @click="${()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Qe]:0}))}"}"
        >
          <title>
            ${Ii("panels.zones.actions.reset-bucket",this.hass.language)}
          </title>
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              >${Ii("panels.zones.labels.last_calculated",this.hass.language)}:
              ${e.last_calculated?nn(e.last_calculated).format("YYYY-MM-DD HH:mm:ss"):"-"}</label
            >
          </div>
          <div class="card-content">
            <label for="last_updated${t}"
              >${Ii("panels.zones.labels.data-last-updated",this.hass.language)}:
              ${e.last_updated?nn(e.last_updated).format("YYYY-MM-DD HH:mm:ss"):"-"}</label
            >
          </div>
          <div class="card-content">
            <label for="last_updated${t}"
              >${Ii("panels.zones.labels.data-number-of-data-points",this.hass.language)}:
              ${e.number_of_data_points}</label
            >
          </div>
          <div class="card-content">
            <label for="name${t}"
              >${Ii("panels.zones.labels.name",this.hass.language)}:</label
            >
            <input
              id="name${t}"
              type="text"
            ...
            <div class="zoneline">
              <label for="size${t}"
                >${Ii("panels.zones.labels.size",this.hass.language)}
                (${Wi(this.config,Ke)}):</label
              >
            ...
            <div class="zoneline">
              <label for="throughput${t}"
                >${Ii("panels.zones.labels.throughput",this.hass.language)}
                (${Wi(this.config,Xe)}):</label
              >
              <input
                class="shortinput"
                id="throughput${t}"
            ...
            <div class="zoneline">
              <label for="drainage_rate${t}"
                >${Ii("panels.zones.labels.drainage_rate",this.hass.language)}
                (${Wi(this.config,et)}):</label
              >
              <input
                class="shortinput"
                id="drainage_rate${t}"
            ...
            <div class="zoneline">
              <label for="state${t}"
                >${Ii("panels.zones.labels.state",this.hass.language)}:</label
              >
              <select
                required
                id="state${t}"
                @change="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{state:a.target.value,[Je]:0}))}"
              >
                <option
                  value="${Qi.Automatic}"
                  ?selected="${e.state===Qi.Automatic}"
                >
                  ${Ii("panels.zones.labels.states.automatic",this.hass.language)}
                </option>
                <option
                  value="${Qi.Disabled}"
                  ?selected="${e.state===Qi.Disabled}"
                >
                  ${Ii("panels.zones.labels.states.disabled",this.hass.language)}
                </option>
                <option
                  value="${Qi.Manual}"
                  ?selected="${e.state===Qi.Manual}"
                >
                  ${Ii("panels.zones.labels.states.manual",this.hass.language)}
                </option>
              </select>
              <label for="module${t}"
                >${Ii("common.labels.module",this.hass.language)}:</label
              >
              ...
              <label for="module${t}"
                >${Ii("panels.zones.labels.mapping",this.hass.language)}:</label
              >
            ...
            <div class="zoneline">
              <label for="bucket${t}"
                >${Ii("panels.zones.labels.bucket",this.hass.language)}
                (${Wi(this.config,Qe)}):</label
              >
              <input
                class="shortinput"
                id="bucket${t}"
              ...
              <label for="maximum-bucket${t}"
                >${Ii("panels.zones.labels.maximum-bucket",this.hass.language)}
                (${Wi(this.config,Qe)}):</label
              >
              <input
                class="shortinput"
              ...
              <label for="lead_time${t}"
                >${Ii("panels.zones.labels.lead-time",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
              ...
              <label for="maximum-duration${t}"
                >${Ii("panels.zones.labels.maximum-duration",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
            ...
            <div class="zoneline">
              <label for="multiplier${t}"
                >${Ii("panels.zones.labels.multiplier",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="multiplier${t}"
              ...
              <label for="duration${t}"
                >${Ii("panels.zones.labels.duration",this.hass.language)}
                (${"s"}):</label
              >
              <input
                class="shortinput"
                ...
                type="number"
                .value="${e.duration}"
                ?readonly="${e.state===Qi.Disabled||e.state===Qi.Automatic}"
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Je]:parseInt(a.target.value,10)}))}"
              />
            </div>
            <div class="zoneline">
              ${n} ${i}
              ...
              >
                <title>
                  ${Ii("common.actions.delete",this.hass.language)}
                </title>
                <path fill="#404040" d="${Ki}" />
              </svg>
            </div>
            <div class="zoneline">
              <div>
      ...
      `}return Y``}toggleExplanation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#calcresults"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="explanation")}render(){return this.hass&&this.config?Y`
        <ha-card header="${Ii("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${Ii("panels.zones.description",this.hass.language)}
          </div>
        </ha-card>
          <ha-card header="${Ii("panels.zones.cards.add-zone.header",this.hass.language)}">
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${Ii("panels.zones.labels.name",this.hass.language)}:</label>
              <input id="nameInput" type="text"/>
              </div>
              <div class="zoneline">
              <label for="sizeInput">${Ii("panels.zones.labels.size",this.hass.language)} (${Wi(this.config,Ke)}):</label>
              <input class="shortinput" id="sizeInput" type="number"/>
              </div>
              <div class="zoneline">
              <label for="throughputInput">${Ii("panels.zones.labels.throughput",this.hass.language)} (${Wi(this.config,Xe)}):</label>
              <input id="throughputInput" class="shortinput" type="number"/>
              </div>
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${Ii("panels.zones.cards.add-zone.actions.add",this.hass.language)}</button>
              </div>
            </div>
            </ha-card>
            <ha-card header="${Ii("panels.zones.cards.zone-actions.header",this.hass.language)}">
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${Ii("panels.zones.cards.zone-actions.actions.update-all",this.hass.language)}</button>
                <button @click="${this.handleCalculateAllZones}">${Ii("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language)}</button>
                <button @click="${this.handleResetAllBuckets}">${Ii("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}</button>
      <button @click="${this.handleClearAllWeatherdata}">${Ii("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}</button>
            </div>
          </ha-card>
    ...
    `}};n([pe()],sn.prototype,"config",void 0),n([pe({type:Array})],sn.prototype,"zones",void 0),n([pe({type:Array})],sn.prototype,"modules",void 0),n([pe({type:Array})],sn.prototype,"mappings",void 0),n([me("#nameInput")],sn.prototype,"nameInput",void 0),n([me("#sizeInput")],sn.prototype,"sizeInput",void 0),n([me("#throughputInput")],sn.prototype,"throughputInput",void 0),sn=n([de("smart-irrigation-view-zones")],sn);let rn=class extends(st(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e;this.hass&&(this.config=await tt(this.hass),this.zones=await at(this.hass),this.modules=await it(this.hass),this.allmodules=await(e=this.hass,e.callWS({type:_e+"/allmodules"})))}handleAddModule(){const e=this.allmodules.filter((e=>e.name==this.moduleInput.selectedOptions[0].text))[0];if(!e)return;const t={name:this.moduleInput.selectedOptions[0].text,description:e.description,config:e.config,schema:e.schema};this.modules=[...this.modules,t],this.saveToHA(t)}handleRemoveModule(e,t){const a=this.modules[t].id;var i,n;(this.modules=this.modules.filter(((e,a)=>a!==t)),this.hass&&null!=a)&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/modules",{id:n,remove:!0}))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/modules",a),this._fetchData())}renderModule(e,t){if(this.hass){const a=this.zones.filter((t=>t.module===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            <div class="moduledescription${t}">${e.description}</div>
            <div class="moduleconfig">
              <label class="subheader"
                >${Ii("panels.modules.cards.module.labels.configuration",this.hass.language)}
                (*
                ${Ii("panels.modules.cards.module.labels.required",this.hass.language)})</label
              >
              ${e.schema?Object.entries(e.schema).map((([e])=>this.renderConfig(t,e))):null}
            </div>
            ${a?Y` ${Ii("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}`:Y` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
    ...
    `;if("boolean"==i.type)o=Y`${o}<input
        ...
        >
          ${Object.entries(i.options).map((([e,a])=>Y`<option
                ...
                ?selected="${r===Gi(a,0)}"
              >
                ${Ii("panels.modules.cards.module.translated-options."+Gi(a,1),t)}
              </option>`))}
        ...
        <ha-card
          header="${Ii("panels.modules.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ii("panels.modules.description",this.hass.language)}
          </div>
        </ha-card>
        <ha-card
          header="${Ii("panels.modules.cards.add-module.header",this.hass.language)}"
        >
          <div class="card-content">
            ...
            <button @click="${this.handleAddModule}">
              ${Ii("panels.modules.cards.add-module.actions.add",this.hass.language)}
            </button>
          </div>
        </ha-card>
    ...
    `}};n([pe()],rn.prototype,"config",void 0),n([pe({type:Array})],rn.prototype,"zones",void 0),n([pe({type:Array})],rn.prototype,"modules",void 0),n([pe({type:Array})],rn.prototype,"allmodules",void 0),n([me("#moduleInput")],rn.prototype,"moduleInput",void 0),rn=n([de("smart-irrigation-view-modules")],rn);let on=class extends(st(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await tt(this.hass),this.zones=await at(this.hass),this.mappings=await nt(this.hass))}handleAddMapping(){const e={[Ae]:"",[Me]:"",[Te]:"",[Oe]:"",[xe]:"",[ze]:"",[De]:"",[He]:"",[Pe]:""},t={name:this.mappingNameInput.value,mappings:e};this.mappings=[...this.mappings,t],this.saveToHA(t),this._fetchData()}handleRemoveMapping(e,t){const a=this.mappings[t].id;var i,n;null!=a&&(this.mappings=this.mappings.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/mappings",{id:n,remove:!0})))}handleEditMapping(e,t){this.mappings=Object.values(this.mappings).map(((a,i)=>i===e?t:a)),console.log(t),this.saveToHA(t)}saveToHA(e){if(!this.hass)return;let t=!0;for(const a in e.mappings)if(null!=e.mappings[a].sensorentity&&""!=e.mappings[a].sensorentity.trim()&&(e.mappings[a].sensorentity=e.mappings[a].sensorentity.trim(),!(e.mappings[a].sensorentity in this.hass.states))){t=!1,Zi({body:{message:Ii("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+e.mappings[a].sensorentity},error:Ii("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},this.shadowRoot.querySelector("ha-card"));break}var a,i;t&&(a=this.hass,i=e,a.callApi("POST",_e+"/mappings",i))}renderMapping(e,t){if(this.hass){const a=this.zones.filter((t=>t.mapping===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            <label for="name${e.id}"
              >${Ii("panels.mappings.labels.mapping-name",this.hass.language)}:</label
            >
            <input
              id="name${e.id}"
              type="text"
            ...
            ${a?Y`${Ii("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}`:Y` <svg
                    style="width:24px;height:24px"
                    viewBox="0 0 24 24"
                    id="deleteZone${e.id}"
      ...
      <label for="${t+e}"
        >${Ii("panels.mappings.cards.mapping.items."+t.toLowerCase(),this.hass.language)}
      </label>
    </div> `;if(o=Y`${o}
      <div class="mappingsettingline">
        ...
        /><label for="${t+e+Re}"
          >${Ii("panels.mappings.cards.mapping.sources.none",this.hass.language)}</label
        ...
        /><label
          class="${l}"
          for="${t+e+Ne}"
          >${Ii("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}</label
        >`}return o=Y`${o}
        <input
          type="radio"
          id="${t+e+Ce}"
        ...
        /><label for="${t+e+Ce}"
          >${Ii("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}</label
        >
      </div>`,o=Y`${o}
      <input
        type="radio"
        ...
        @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ue]:a.target.value,[Ye]:""})})}))}"
      /><label for="${t+e+je}"
        >${Ii("panels.mappings.cards.mapping.sources.static",this.hass.language)}</label
      >
    </div>`,r[Ue]==Ce&&(o=Y`${o}
        <div class="mappingsettingline">
          <label for="${t+e+Ye}"
            >${Ii("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+Ye}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ve}"
            >${Ii("panels.mappings.cards.mapping.static_value",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+Ve}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Fe}"
            >${Ii("panels.mappings.cards.mapping.input-units",this.hass.language)}:</label
          >
          <select
            type="text"
            id="${t+e+Fe}"
          ...
          <div class="mappingsettingline">
            <label for="${t+e+Le}"
              >${Ii("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:</label
            >
            <select
              type="text"
              id="${t+e+Le}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ge}"
            >${Ii("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          </label>
          <select
            type="text"
            id="${t+e+Ge}"
          ...
          <label for="${t+e+Ge}"
            >${Ii("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</label
          >
        ...
        ${Ii("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return Y``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=Y``;const a=t[Le];return e=Y`${e}
        <option
          value="${Be}"
          ?selected="${a===Be}"
        >
          ${Ii("panels.mappings.cards.mapping.pressure_types."+Be,this.hass.language)}
        </option>
        <option
          value="${Ie}"
          ?selected="${a===Ie}"
        >
          ${Ii("panels.mappings.cards.mapping.pressure_types."+Ie,this.hass.language)}
        </option>`,e}return Y``}renderUnitOptionsForMapping(e,t){if(this.hass&&this.config){const a=function(e){switch(e){case Ae:case He:return[{unit:"°C",system:$e},{unit:"°F",system:Ee}];case Oe:case Me:case xe:return[{unit:Ze,system:$e},{unit:qe,system:Ee}];case Te:return[{unit:"%",system:[$e,Ee]}];case ze:return[{unit:"millibar",system:$e},{unit:"hPa",system:$e},{unit:"psi",system:Ee},{unit:"inch Hg",system:Ee}];case Pe:return[{unit:"km/h",system:$e},{unit:"meter/s",system:$e},{unit:"mile/h",system:Ee}];case De:return[{unit:"W/m2",system:$e},{unit:"MJ/day/m2",system:$e},{unit:"W/sq ft",system:Ee},{unit:"MJ/day/sq ft",system:Ee}];default:return[]}}(e);let i=Y``,n=t[Fe];const s=this.config.units;return t[Fe]||a.forEach((function(e){"string"==typeof e.system?s==e.system&&(n=e.unit):e.system.forEach((function(t){s==t.system&&(n=e.unit)}))})),a.forEach((function(e){i=Y`${i}
          <option value="${e.unit}" ?selected="${n===e.unit}">
            ${e.unit}
          </option>`})),i}return Y``}render(){return this.hass?Y`
        <ha-card
          header="${Ii("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Ii("panels.mappings.description",this.hass.language)}.
          </div>
        </ha-card>
        <ha-card
          header="${Ii("panels.mappings.cards.add-mapping.header",this.hass.language)}"
        >
          <div class="card-content">
            ...
            <button @click="${this.handleAddMapping}">
              ${Ii("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </ha-card>
    ...
    `}};n([pe()],on.prototype,"config",void 0),n([pe({type:Array})],on.prototype,"zones",void 0),n([pe({type:Array})],on.prototype,"mappings",void 0),n([me("#mappingNameInput")],on.prototype,"mappingNameInput",void 0),on=n([de("smart-irrigation-view-mappings")],on);const ln=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a};e.SmartIrrigationPanel=class extends le{async firstUpdated(){window.addEventListener("location-changed",(()=>{window.location.pathname.includes("smart-irrigation")&&this.requestUpdate()})),await ye(),this.requestUpdate()}render(){if(!customElements.get("ha-panel-config"))return Y` loading... `;const e=ln();return Y`
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2024.10.1"}</div>
        </div>
        ...
        >
          <paper-tab page-name="general">
            ${Ii("panels.general.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="zones">
            ${Ii("panels.zones.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="modules"
            >${Ii("panels.modules.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="mappings"
            >${Ii("panels.mappings.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="help"
            >${Ii("panels.help.title",this.hass.language)}</paper-tab
          >
        </ha-tabs>
      </div>
    ...
    `}getView(e){switch(e.page){case"general":return Y`
        ...
        `;case"help":return Y`<ha-card
          header="${Ii("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
          ${Ii("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)} <a href="https://github.com/jeroenterheerdt/HAsmartirrigation/wiki"
              >${Ii("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >. ${Ii("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${Ii("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${Ii("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a
              href="https://github.com/jeroenterheerdt/HAsmartirrigation/issues"
              >${Ii("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${Ii("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return Y`
    ...
    `}},n([pe()],e.SmartIrrigationPanel.prototype,"hass",void 0),n([pe({type:Boolean,reflect:!0})],e.SmartIrrigationPanel.prototype,"narrow",void 0),e.SmartIrrigationPanel=n([de("smart-irrigation")],e.SmartIrrigationPanel);let un=class extends le{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?Y`
      <ha-dialog
        open
        .heading=${!0}
    ...
    `}};n([pe({attribute:!1})],un.prototype,"hass",void 0),n([function(e){return pe({...e,state:!0})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],un.prototype,"_params",void 0),un=n([de("error-dialog")],un);var dn=Object.freeze({__proto__:null,get ErrorDialog(){return un}});Object.defineProperty(e,"__esModule",{value:!0})}({});
