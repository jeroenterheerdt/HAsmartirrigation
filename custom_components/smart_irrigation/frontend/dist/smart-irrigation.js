!function (e) {
  ...
  function Li(e) {
    e.forEach(function (e) {
      if (delete e.location, Ya(e) || Fa(e)) for (var t in e.options) delete e.options[t].location, Li(e.options[t].value);else Ba(e) && Ga(e.style) || (Ra(e) || Ua(e)) && Za(e.style) ? delete e.style.location : Wa(e) && Li(e.children);
    });
  }
  function ji(e, t) {
    void 0 === t && (t = {}), t = i({
...
`;
  ...
  let bn = class extends ft(ue) {
    ...
    handleViewWeatherInfo(e) {
      var t;
      console.log("handleViewWeatherInfo called for index:", e);
      const a = this.zones[e];
      if (console.log("Zone data:", a), !a || null == a.mapping) return;
      const i = `#weather-section-${a.id}`;
      console.log("Selector for weather section:", i);
      const n = null === (t = this.shadowRoot) || void 0 === t ? void 0 : t.querySelector(i);
      console.log("Weather section element:", n), n && (n.hasAttribute("hidden") ? n.removeAttribute("hidden") : n.setAttribute("hidden", ""));
    }
    handleViewWateringCalendar(e) {
      var t;
      console.log("handleViewWateringCalendar called for index:", e);
      const a = this.zones[e];
      if (console.log("Zone data:", a), !a || null == a.id) return;
      const i = `#calendar-section-${a.id}`;
      console.log("Selector for calendar section:", i);
      const n = null === (t = this.shadowRoot) || void 0 === t ? void 0 : t.querySelector(i);
      console.log("Calendar section element:", n), n && (n.hasAttribute("hidden") ? n.removeAttribute("hidden") : n.setAttribute("hidden", ""));
    }
    async _fetchWeatherRecords() {
      if (this.hass) {
        for (const e of this.zones) if (console.log("zone id", e.id), console.log("zone mapping", e.mapping), void 0 !== e.id && void 0 !== e.mapping) try {
    ...
    render() {
      ...
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2025.7.1-beta0"}</div>
        </div>
