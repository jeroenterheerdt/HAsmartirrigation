...
`;let Uo=class extends oe{async showDialog(e){var t,a,i,n,s,r,o,l,d;if(this.params=e,e.createTrigger)this._trigger={type:xe,name:"",enabled:!0,offset_minutes:0,azimuth_angle:90,account_for_duration:!0};else if(e.trigger){const u=e.trigger;this._trigger=u.type===je?{type:u.type,name:null!==(t=u.name)&&void 0!==t?t:"",enabled:null===(a=u.enabled)||void 0===a||a,offset_minutes:null!==(i=u.offset_minutes)&&void 0!==i?i:0,azimuth_angle:null!==(n=u.azimuth_angle)&&void 0!==n?n:90,account_for_duration:null===(s=u.account_for_duration)||void 0===s||s}:{type:u.type,name:null!==(r=u.name)&&void 0!==r?r:"",enabled:null===(o=u.enabled)||void 0===o||o,offset_minutes:null!==(l=u.offset_minutes)&&void 0!==l?l:0,account_for_duration:null===(d=u.account_for_duration)||void 0===d||d}}else this._trigger=void 0;await this.updateComplete}_closeDialog(){this.params=void 0,this._trigger=void 0}_saveTrigger(){var e,a,i,n,s,r,o;if(!this._trigger||!this.params)return;const l=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-select");if(l){const e=null!==(i=null!==(a=l.value)&&void 0!==a?a:l.selected)&&void 0!==i?i:void 0;if(e&&e!==this._trigger.type){if(e===je)this._trigger=Object.assign(Object.assign({},this._trigger),{type:e,azimuth_angle:null!==(n=this._trigger.azimuth_angle)&&void 0!==n?n:90});else if(e===Se){const a=this._trigger,{azimuth_angle:i}=a,n=t(a,["azimuth_angle"]);this._trigger=Object.assign(Object.assign({},n),{type:e,at:null!==(s=this._trigger.at)&&void 0!==s?s:"06:00"})}else{const a=this._trigger,{azimuth_angle:i,at:n}=a,s=t(a,["azimuth_angle","at"]);this._trigger=Object.assign(Object.assign({},s),{type:e})}this.requestUpdate()}}if(null===(r=this._trigger.name)||void 0===r?void 0:r.trim())if(this._trigger.type!==Se||/^\d{1,2}:\d{2}$/.test(null!==(o=this._trigger.at)&&void 0!==o?o:"")){if(this._trigger.type===je){if(void 0===this._trigger.azimuth_angle||isNaN(this._trigger.azimuth_angle))return void alert(Eo("irrigation_start_triggers.validation.azimuth_invalid",this.hass.language));this._trigger.azimuth_angle=this._trigger.azimuth_angle%360,this._trigger.azimuth_angle<0&&(this._trigger.azimuth_angle+=360)}this.dispatchEvent(new CustomEvent("trigger-save",{detail:{trigger:this._trigger,isNew:this.params.createTrigger,index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog()}else alert(Eo("irrigation_start_triggers.validation.time_invalid",this.hass.language));else alert(Eo("irrigation_start_triggers.validation.name_required",this.hass.language))}_deleteTrigger(){this.params&&!this.params.createTrigger&&(this.dispatchEvent(new CustomEvent("trigger-delete",{detail:{index:this.params.triggerIndex},bubbles:!0,composed:!0})),this._closeDialog())}_updateTrigger(e){this._trigger?(this._trigger=Object.assign(Object.assign({},this._trigger),e),this.requestUpdate()):console.warn("_updateTrigger called with undefined _trigger",e)}render(){var e,t;if(!this.params||!this._trigger)return B``;const a=this.params.createTrigger,i=Eo(a?"irrigation_start_triggers.dialog.add_title":"irrigation_start_triggers.dialog.edit_title",this.hass.language);return B`
      <ha-dialog open .heading=${!0}>
        ...
        <div class="wrapper">
          <div class="dialog-help">
            ${Eo("irrigation_start_triggers.dialog.help",this.hass.language)}
            <code>smart_irrigation_start_irrigation_all_zones</code>
          </div>
          <div class="form-group">
            <label class="form-label"
              >${Eo("irrigation_start_triggers.fields.name.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="text"
          ...
          <div class="form-group">
            <ha-select
              .label=${Eo("irrigation_start_triggers.fields.type.name",this.hass.language)}
              .value=${this._trigger.type}
              @selected=${this._typeChanged}
            >
              <ha-dropdown-item value=${xe}>
                ${Eo("irrigation_start_triggers.trigger_types.sunrise",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${"sunset"}>
                ${Eo("irrigation_start_triggers.trigger_types.sunset",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${je}>
                ${Eo("irrigation_start_triggers.trigger_types.solar_azimuth",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${Se}>
                ${Eo("irrigation_start_triggers.trigger_types.time",this.hass.language)}
              </ha-dropdown-item>
            </ha-select>
          </div>
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Eo("irrigation_start_triggers.fields.enabled.name",this.hass.language)}
            >
              <ha-switch
          ...
          <div class="form-group">
            <label class="form-label"
              >${Eo("irrigation_start_triggers.fields.offset_minutes.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="number"
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Eo("irrigation_start_triggers.fields.account_for_duration.name",this.hass.language)}
            >
              <ha-switch
          ...
          ${this._trigger.type===Se?B`
                <div class="form-group">
                  <label class="form-label"
                    >${Eo("irrigation_start_triggers.fields.at.name",this.hass.language)}</label
                  >
                  <input
                    class="form-input"
                    type="time"
          ...
          ${this._trigger.type===je?B`
                <div class="form-group">
                  <label class="form-label"
                    >${Eo("irrigation_start_triggers.fields.azimuth_angle.name",this.hass.language)}</label
                  >
                  <input
                    class="form-input"
                    type="number"
        ...
        <ha-dialog-footer slot="footer">
          ...
          >
            ${Eo("irrigation_start_triggers.dialog.cancel",this.hass.language)}
          </ha-button>
          ${a?"":B`
                <ha-button
                  slot="secondaryAction"
                ...
                >
                  ${Eo("irrigation_start_triggers.dialog.delete",this.hass.language)}
                </ha-button>
              `}
          <ha-button
            slot="primaryAction"
    ...
    `}_nameChanged(e){const t=e.target;this._updateTrigger({name:t.value})}_typeChanged(e){var t,a,i,n,s,r,o,l,d,u,c,p,m,g,h,v,f,b,k,y,_,z,w,x;const j=null!==(n=null!==(a=null===(t=null==e?void 0:e.detail)||void 0===t?void 0:t.value)&&void 0!==a?a:null===(i=e.target)||void 0===i?void 0:i.value)&&void 0!==n?n:null===(r=null===(s=this.shadowRoot)||void 0===s?void 0:s.querySelector("ha-select"))||void 0===r?void 0:r.value,S=String(j);let A;A=S===je?{type:je,name:null!==(l=null===(o=this._trigger)||void 0===o?void 0:o.name)&&void 0!==l?l:"",enabled:null===(u=null===(d=this._trigger)||void 0===d?void 0:d.enabled)||void 0===u||u,offset_minutes:null!==(p=null===(c=this._trigger)||void 0===c?void 0:c.offset_minutes)&&void 0!==p?p:0,azimuth_angle:null!==(g=null===(m=this._trigger)||void 0===m?void 0:m.azimuth_angle)&&void 0!==g?g:90,account_for_duration:null===(v=null===(h=this._trigger)||void 0===h?void 0:h.account_for_duration)||void 0===v||v}:{type:S,name:null!==(b=null===(f=this._trigger)||void 0===f?void 0:f.name)&&void 0!==b?b:"",enabled:null===(y=null===(k=this._trigger)||void 0===k?void 0:k.enabled)||void 0===y||y,offset_minutes:null!==(z=null===(_=this._trigger)||void 0===_?void 0:_.offset_minutes)&&void 0!==z?z:0,account_for_duration:null===(x=null===(w=this._trigger)||void 0===w?void 0:w.account_for_duration)||void 0===x||x},this._trigger=A,this.requestUpdate()}_enabledChanged(e){const t=e.target;this._updateTrigger({enabled:t.checked})}_offsetChanged(e){const t=e.target;this._updateTrigger({offset_minutes:parseInt(t.value)||0})}_accountForDurationChanged(e){const t=e.target;this._updateTrigger({account_for_duration:t.checked})}_atChanged(e){const t=e.target.value;this._trigger=Object.assign(Object.assign({},this._trigger),{at:t})}_azimuthChanged(e){var t;if((null===(t=this._trigger)||void 0===t?void 0:t.type)!==je)return;const a=e.target;let i=parseInt(a.value,10);isNaN(i)&&(i=90),this._updateTrigger({azimuth_angle:i})}static get styles(){return[Vo,l`
      ...
      `]}};a([ce({attribute:!1})],Uo.prototype,"hass",void 0),a([ce({attribute:!1})],Uo.prototype,"params",void 0),a([pe()],Uo.prototype,"_trigger",void 0),Uo=a([de("smart-irrigation-trigger-dialog")],Uo);const Ro=l`
...
`;let Fo=class extends(qt(oe)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(t),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{this.config=await Mt(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e,t}}firstUpdated(){fe().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,t,a;if(!this.hass||!this.config||!this.data)return B`<div class="loading-indicator">
        ...
        <div class="card-content">
          ...
          <div class="card-content">
            ${this._timeRow(Eo("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language),this.config.calctime,(e=>this.handleConfigChange({calctime:e})))}
          </div>`),e=B`<ha-card
        header="${Eo("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let t=B` <div class="card-content">
          ${Eo("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            <div class="setting-row">
              <div class="setting-label">
                ${Eo("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
              </div>
              <div class="combo-field">
                ...
                <div class="select-wrap">
                  ...
                  >
                    ...
                    >
                      ${Eo("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                    </option>
                    <option
                      value="${$e}"
                      ?selected=${this.data.autoupdateschedule===$e}
                    >
                      ${Eo("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                    </option>
                    <option
                      value="${Ee}"
                      ?selected=${this.data.autoupdateschedule===Ee}
                    >
                      ${Eo("panels.general.cards.automatic-update.options.days",this.hass.language)}
                    </option>
                  </select>
          ...
          <div class="card-content">
            ${this._numRow(Eo("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language),"s",this.config.autoupdatedelay,(e=>this.saveData({autoupdatedelay:parseInt(e)})),1)}
          </div>`),t=B`<ha-card header="${Eo("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;let i=B` <div class="card-content">
          ${Eo("panels.general.cards.automatic-clear.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._timeRow(Eo("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language),this.config.cleardatatime,(e=>this.handleConfigChange({cleardatatime:e})))}
          </div>`),i=B`<ha-card
        header="${Eo("panels.general.cards.automatic-clear.header",this.hass.language)}"
        >${i}</ha-card
      >`;let n=B`<div class="card-content">
          ${Eo("panels.general.cards.continuousupdates.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            ${this._numRow(Eo("panels.general.cards.continuousupdates.labels.sensor_debounce",this.hass.language),"ms",this.config.sensor_debounce,(e=>this.handleConfigChange({sensor_debounce:parseInt(e)})),1)}
          </div>`),n=B`<ha-card
        header="${Eo("panels.general.cards.continuousupdates.header",this.hass.language)}"
        >${n}</ha-card
      > `;const s=this.renderTriggersCard(),r=this.renderWeatherSkipCard(),o=this.renderCoordinateCard(),l=this.renderDaysBetweenIrrigationCard(),d=this.renderObservedWateringCard();return B`<ha-card
          header="${Eo("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Eo("panels.general.description",this.hass.language)}
          </div> </ha-card
      ...
      <ha-card
        header="${Eo("irrigation_start_triggers.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Eo("irrigation_start_triggers.description",this.hass.language)}
        </div>

        <div class="card-content trigger-usage">
          ${Eo("irrigation_start_triggers.usage_before",this.hass.language)}
          <code>smart_irrigation_start_irrigation_all_zones</code>${Eo("irrigation_start_triggers.usage_after",this.hass.language)}
        </div>

        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("irrigation_start_triggers.active_label",this.hass.language)}
            </div>
            <select
              class="field"
            ...
            >
              ...
              >
                ${Eo("irrigation_start_triggers.active_default",this.hass.language)}
              </option>
              ${e.map((e=>B`
                  <option
                    value="${e.name}"
          ...
          <div class="trigger-active-hint">
            ${Eo("irrigation_start_triggers.active_hint",this.hass.language)}
          </div>
        </div>
          ...
          <div class="triggers-list">
            ${0===e.length?B`
                  <div class="no-triggers">
                    ${Eo("irrigation_start_triggers.no_triggers",this.hass.language)}
                  </div>
                `:e.map(((e,t)=>this.renderTriggerItem(e,t)))}
          </div>

          <div class="add-trigger-section">
            ${this._actionBtn(Io,Eo("irrigation_start_triggers.add_trigger",this.hass.language),(()=>this._addTrigger()))}
          </div>
        </div>
      </ha-card>
    `}renderTriggerItem(e,t){if(!this.hass)return B``;const a=Eo(`irrigation_start_triggers.trigger_types.${e.type}`,this.hass.language);let i="";if(e.type===xe&&0===e.offset_minutes)i=Eo("irrigation_start_triggers.offset_auto",this.hass.language);else{const t=Math.abs(e.offset_minutes),a=Math.floor(t/60),n=t%60,s=e.offset_minutes<0?Eo("common.labels.before",this.hass.language):Eo("common.labels.after",this.hass.language);i=a>0?`${a}h ${n}m ${s}`:`${n}m ${s}`}let n="";return e.type===je&&void 0!==e.azimuth_angle&&(n=` (${e.azimuth_angle}°)`),B`
      <div class="trigger-item ${e.enabled?"enabled":"disabled"}">
        <div class="trigger-main">
          ...
          <div class="trigger-status">
            ${e.enabled?Eo("common.labels.enabled",this.hass.language):Eo("common.labels.disabled",this.hass.language)}
          </div>
        </div>
    ...
    `}_addTrigger(){this._showTriggerDialog({createTrigger:!0})}_editTrigger(e){var t,a;const i=null===(a=null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||void 0===a?void 0:a[e];i&&this._showTriggerDialog({trigger:i,triggerIndex:e})}_deleteTrigger(e){var t,a;if(!(null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||!this.hass)return;const i=(null===(a=this.config.irrigation_start_triggers[e])||void 0===a?void 0:a.name)||"Unknown";if(confirm(Eo("irrigation_start_triggers.confirm_delete",this.hass.language).replace("{name}",i))){const t=[...this.config.irrigation_start_triggers];t.splice(e,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[we]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}}async _showTriggerDialog(e){if(!this.hass)return;const t=document.createElement("smart-irrigation-trigger-dialog");t.hass=this.hass,t.addEventListener("trigger-save",(e=>{this._handleTriggerSave(e.detail)})),t.addEventListener("trigger-delete",(e=>{this._handleTriggerDelete(e.detail)})),document.body.appendChild(t),await t.showDialog(e),t.addEventListener("closed",(e=>{const a=e.target;a&&"ha-dialog"===a.tagName.toLowerCase()&&document.body.removeChild(t)}))}_handleTriggerSave(e){if(!this.config)return;const t=this.config.irrigation_start_triggers?[...this.config.irrigation_start_triggers]:[];e.isNew?t.push(e.trigger):void 0!==e.index&&(t[e.index]=e.trigger),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[we]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}_handleTriggerDelete(e){var t;if(!(null===(t=this.config)||void 0===t?void 0:t.irrigation_start_triggers)||void 0===e.index)return;const a=[...this.config.irrigation_start_triggers];a.splice(e.index,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[we]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}renderWeatherSkipCard(){return this.config&&this.data&&this.hass?B`
      <ha-card header="${Eo("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          ...
          ${this.config.skip_irrigation_on_precipitation?this._numRow(Eo("weather_skip.threshold_label",this.hass.language),Et(this.config,ze),this.config.precipitation_threshold_mm,(e=>this.handleConfigChange({precipitation_threshold_mm:parseFloat(e)})),.1):""}
        </div>
      </ha-card>
    `:B``}renderObservedWateringCard(){if(!this.config||!this.data||!this.hass)return B``;const e=this.hass.language;return B`
      <ha-card header="${Eo("observed_watering.title",e)}">
        <div class="card-content">
          ${Eo("observed_watering.description",e)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("observed_watering.enabled_label",e)}
            </div>
            <ha-switch
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("observed_watering.direct_control_label",e)}
            </div>
            <ha-switch
          ...
          ${this.config.direct_valve_control_enabled?B`
                <div class="card-content">
                  ${Eo("observed_watering.direct_control_description",e)}
                </div>
              `:""}
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("observed_watering.sequencing_label",e)}
            </div>
            <select
              class="field"
            ...
            >
              ...
              >
                ${Eo("observed_watering.sequencing.sequential",e)}
              </option>
              <option
                value="parallel"
                ?selected=${"parallel"===this.config.zone_sequencing}
              >
                ${Eo("observed_watering.sequencing.parallel",e)}
              </option>
            </select>
          </div>
          <div class="card-content">
            ${Eo("observed_watering.sequencing_description",e)}
          </div>
        </div>
      </ha-card>
    `}renderCoordinateCard(){if(!this.config||!this.data||!this.hass)return B``;const e=this.hass.config,t=(null==e?void 0:e.latitude)||0,a=(null==e?void 0:e.longitude)||0,i=(null==e?void 0:e.elevation)||0;return B`
      <ha-card
        header="${Eo("coordinate_config.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Eo("coordinate_config.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("coordinate_config.manual_enabled",this.hass.language)}
            </div>
            <ha-switch
            ...
            ${this.data.manual_coordinates_enabled?B`
                    ${this._numRow(Eo("coordinate_config.latitude",this.hass.language),"",this.data.manual_latitude||t,(e=>this.handleConfigChange({manual_latitude:parseFloat(e)})),.1)}
                    ${this._numRow(Eo("coordinate_config.longitude",this.hass.language),"",this.data.manual_longitude||a,(e=>this.handleConfigChange({manual_longitude:parseFloat(e)})),.1)}
                    ${this._numRow(Eo("coordinate_config.elevation",this.hass.language),"",this.data.manual_elevation||i,(e=>this.handleConfigChange({manual_elevation:parseFloat(e)})),1)}
                  `:B`
                    <div
                      class="zoneline"
                      style="color: var(--secondary-text-color); font-style: italic;"
                    >
                      ${Eo("coordinate_config.current_ha_coords",this.hass.language)}:<br />
                      ${Eo("coordinate_config.latitude",this.hass.language)}:
                      ${t}<br />
                      ${Eo("coordinate_config.longitude",this.hass.language)}:
                      ${a}<br />
                      ${Eo("coordinate_config.elevation",this.hass.language)}:
                      ${i}m
                    </div>
                  `}
                </div>
    ...
    `}renderDaysBetweenIrrigationCard(){return this.config&&this.data&&this.hass?B`
      <ha-card
        header="${Eo("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          ${Eo("days_between_irrigation.description",this.hass.language)}
        </div>

        <div class="card-content">
          ${this._numRow(Eo("days_between_irrigation.label",this.hass.language),"",this.config.days_between_irrigation||0,(e=>this.handleConfigChange({days_between_irrigation:parseInt(e)})),1)}
          <div class="card-content">
            <div
              style="color: var(--secondary-text-color); font-size: 0.875rem; margin-top: 8px;"
            >
              ${Eo("days_between_irrigation.help_text",this.hass.language)}
            </div>
          </div>
        </div>
      </ha-card>
    `:B``}async saveData(e){if(this.hass&&this.data){this.isSaving=!0,this._scheduleUpdate(),this._suppressNextConfigUpdate=!0;try{this.data=Object.assign(Object.assign({},this.data),e),this.config=Object.assign(Object.assign({},this.config),e),this._scheduleUpdate(),await(t=this.hass,a=this.data,t.callApi("POST",_e+"/config",a))}catch(e){this._suppressNextConfigUpdate=!1,console.error("Error saving config:",e),Tt(e,this.shadowRoot.querySelector("ha-card")),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var t,a}}handleConfigChange(e){this.debouncedSave(e)}disconnectedCallback(){super.disconnectedCallback()}_textRow(e,t,a,i){return B`
      <div class="setting-row">
        <div class="setting-label">
    ...
    `}static get styles(){return l`
      ${qo} ${Ro} /* View-specific styles only - most common styles are now in globalStyle */
...
a.version="2.30.1",i(Ya),a.fn=os,a.min=Ja,a.max=Qa,a.now=Xa,a.utc=m,a.unix=ls,a.months=hs,a.isDate=u,a.locale=ma,a.invalid=f,a.duration=Si,a.isMoment=z,a.weekdays=fs,a.parseZone=ds,a.localeData=va,a.isDuration=si,a.monthsShort=vs,a.weekdaysMin=ks,a.defineLocale=ga,a.updateLocale=ha,a.locales=fa,a.weekdaysShort=bs,a.normalizeUnits=te,a.relativeTimeRounding=ar,a.relativeTimeThreshold=ir,a.calendarFormat=Li,a.prototype=os,a.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},a}()),rl.exports),dl=il(ll);let ul=class extends(qt(oe)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){fe().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,t,a,i]=await Promise.all([Mt(this.hass),Ot(this.hass),Pt(this.hass),It(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",_e+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",_e+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",_e+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",_e+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:al.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,t){this.hass&&(this.zones[e]=t,t.id&&this.zoneCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(t).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;if(!this.zones[t]||null==a)return;const i=[...this.zones];var n,s;this.zones=this.zones.filter(((e,a)=>a!==t)),this.zoneCache.delete(a.toString()),this.isSaving=!0,(n=this.hass,s=a.toString(),n.callApi("POST",_e+"/zones",{id:s,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var t;const a=this.zones[e];if(!a||null==a.mapping)return;const i=`#weather-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var t;const a=this.zones[e];if(!a||null==a.id)return;const i=`#calendar-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const t=await Bt(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,t)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const a of this.zones)if(void 0!==a.id)try{const i=await(e=this.hass,t=a.id.toString(),e.callWS({type:_e+"/watering_calendar",zone_id:t}));this.wateringCalendars.set(a.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${a.id}:`,e)}var e,t;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return B``;const t=this.weatherRecords.get(e.id)||[];return B`
              ...
              <div class="weather-table">
                ...
                ${t.slice(0,10).map((e=>B`
                    <div class="weather-row">
                      ...
                      >
                      <span
                        >${e.retrieval_time?dl(e.retrieval_time).format("MM-DD HH:mm"):"-"}</span
                      >
                    </div>
                  `))}
              </div>
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return B``;const t=this.wateringCalendars.get(e.id),a=t&&e.id in t?t[e.id]:null,i=(null==a?void 0:a.monthly_estimates)||[];return B` <div class="watering-calendar">
      ...
      ${0===i.length?B`
          ...
          `:B` <div class="calendar-table">
            ...
            ${(null==a?void 0:a.calculation_method)?B`
                ...
                `:""}`}
    </div>`}async saveToHA(e){if(!this.hass)throw new Error("Home Assistant connection not available");await Nt(this.hass,e)}handleZoneFormFocus(){this.isCreatingZone=!0}handleZoneFormBlur(){var e,t,a,i;(null===(t=null===(e=this.nameInput)||void 0===e?void 0:e.value)||void 0===t?void 0:t.trim())||(null===(a=this.sizeInput)||void 0===a?void 0:a.value)||(null===(i=this.throughputInput)||void 0===i?void 0:i.value)||(this.isCreatingZone=!1)}groupDecidesEngine(e){if(void 0===e.mapping||null===e.mapping)return!1;const t=this.mappings.find((t=>t.id===e.mapping));return void 0!==(null==t?void 0:t.module)&&null!==(null==t?void 0:t.module)}renderTheOptions(e,t){if(this.hass){let a=B`<option value="" ?selected=${void 0===t}">---${Eo("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=B`${a}
            <option
              value="${i.id}"
              ?selected="${t===i.id}"
            >
              ${i.id}: ${i.name}
            </option>`)),a}return B``}renderZone(e,t){var a,i,n,s;if(!this.hass)return B``;const r=this.hass.language,o=e.state===al.Automatic,l=e.state===al.Disabled||e.state===al.Automatic,d=null!=e.explanation&&e.explanation.length>0;if(null!=e.mapping){const t=this.mappings.filter((t=>t.id===e.mapping))[0];null!=t&&null!=t.data&&(e.number_of_data_points=t.data.length)}const u=Eo("panels.zones.labels.states."+e.state,r),c=`${Math.round(Number(e.duration)||0)} s`,p=null!=e.id&&this._expanded.has(e.id);return B`
      <ha-card class="zone-card">
        ...
        ${p?B` <div class="zone-body">
              <div class="zone-meta">
                <div class="meta-item">
                  <span class="meta-label"
                    >${Eo("panels.zones.labels.last_calculated",r)}</span
                  >
                  <span class="meta-value"
                    >${e.last_calculated?dl(e.last_calculated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${Eo("panels.zones.labels.data-last-updated",r)}</span
                  >
                  <span class="meta-value"
                    >${e.last_updated?dl(e.last_updated).format("YYYY-MM-DD HH:mm"):"—"}</span
                  >
                </div>
                <div class="meta-item">
                  <span class="meta-label"
                    >${Eo("panels.zones.labels.data-number-of-data-points",r)}</span
                  >
                  <span class="meta-value"
              ...
              <div class="settings">
                ${this._textRow(Eo("panels.zones.labels.name",r),"",e.name,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ot]:a}))))}
                ${this._numRow(Eo("panels.zones.labels.size",r),Et(this.config,lt),e.size,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[lt]:parseFloat(a)}))),.1)}
                ${this._numRow(Eo("panels.zones.labels.throughput",r),Et(this.config,dt),e.throughput,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[dt]:parseFloat(a)}))),.1)}
                ${this._numRow(Eo("panels.zones.labels.drainage_rate",r),Et(this.config,yt),e.drainage_rate,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[yt]:parseFloat(a)}))),.1)}
                ${this._selectRow(Eo("panels.zones.labels.state",r),B`
                    <option
                      value="${al.Automatic}"
                      ?selected=${e.state===al.Automatic}
                    >
                      ${Eo("panels.zones.labels.states.automatic",r)}
                    </option>
                    <option
                      value="${al.Disabled}"
                      ?selected=${e.state===al.Disabled}
                    >
                      ${Eo("panels.zones.labels.states.disabled",r)}
                    </option>
                    <option
                      value="${al.Manual}"
                      ?selected=${e.state===al.Manual}
                    >
                      ${Eo("panels.zones.labels.states.manual",r)}
                    </option>
                ...
                ${this.groupDecidesEngine(e)?B`<div class="weather-note">
                      ${Eo("panels.zones.module-comes-from-the-group",r)}
                    </div>`:this._selectRow(Eo("common.labels.module",r),this.renderTheOptions(this.modules,e.module),(a=>{const i=a.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[pt]:""===i?void 0:parseInt(i)}))}))}
                ${this._selectRow(Eo("panels.zones.labels.mapping",r),this.renderTheOptions(this.mappings,e.mapping),(a=>{const i=a.target.value;this.handleEditZone(t,Object.assign(Object.assign({},e),{[ht]:""===i?void 0:parseInt(i)}))}))}
                ${this._numRow(Eo("panels.zones.labels.bucket",r),Et(this.config,mt),Number(e.bucket).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[mt]:parseFloat(a)}))),.1)}
                ${this._numRow(Eo("panels.zones.labels.maximum-bucket",r),Et(this.config,mt),Number(e.maximum_bucket).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[bt]:parseFloat(a)}))),.1)}
                ${this._numRow(Eo("panels.zones.labels.irrigation-threshold",r),Et(this.config,mt),Number(null!==(i=e.irrigation_threshold)&&void 0!==i?i:0).toFixed(1),(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[kt]:parseFloat(a)}))),.1)}
                ${this._numRow(Eo("panels.zones.labels.et-deficiency",r),Et(this.config,mt),null!=e.et_deficiency?Number(e.et_deficiency).toFixed(2):"",(()=>{}),.01,!0)}
                ${(null===(n=this.config)||void 0===n?void 0:n.observed_watering_enabled)?this._entityRow(Eo("panels.zones.labels.linked-entity",r),Eo("panels.zones.labels.optional",r),e.linked_entity,["switch","valve","input_boolean","binary_sensor"],(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[_t]:a||void 0}))),Eo("panels.zones.labels.linked-entity-hint",r)):""}
                ${(null===(s=this.config)||void 0===s?void 0:s.observed_watering_enabled)&&e.linked_entity?this._entityRow(Eo("panels.zones.labels.flow-sensor",r),Eo("panels.zones.labels.optional",r),e.flow_sensor,["sensor"],(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[zt]:a||void 0}))),Eo("panels.zones.labels.flow-sensor-hint",r)):""}
                ${this._numRow(Eo("panels.zones.labels.lead-time",r),"s",e.lead_time,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[vt]:parseInt(a,10)}))),1)}
                ${this._numRow(Eo("panels.zones.labels.maximum-duration",r),"s",e.maximum_duration,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ft]:parseInt(a,10)}))),1)}
                ${this._numRow(Eo("panels.zones.labels.multiplier",r),"",e.multiplier,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[gt]:parseFloat(a)}))),.1)}
                ${this._numRow(Eo("panels.zones.labels.duration",r),"s",e.duration,(a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ct]:parseInt(a,10)}))),1,l)}
              </div>

              <div class="zone-actions">
                ${o?B`
                      ${this._actionBtn(To,Eo("panels.zones.actions.calculate",r),(()=>this.handleCalculateZone(t)))}
                      ${this._actionBtn(Lo,Eo("panels.zones.actions.update",r),(()=>this.handleUpdateZone(t)))}
                    `:""}
                ${this._actionBtn(Co,Eo("panels.zones.actions.reset-bucket",r),(()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[mt]:0}))))}
                ${null!=e.mapping?this._actionBtn(Oo,Eo("panels.zones.actions.view-weather-info",r),(()=>this.handleViewWeatherInfo(t))):""}
                ${this._actionBtn("M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z",Eo("panels.zones.actions.view-watering-calendar",r),(()=>this.handleViewWateringCalendar(t)))}
                ${d?this._actionBtn("M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z",Eo("panels.zones.actions.information",r),(()=>this.toggleExplanation(t))):""}
                ${this._actionBtn(No,Eo("common.actions.delete",r),(e=>this.handleRemoveZone(e,t)),!0)}
              </div>
    ...
    `}toggleExplanation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#calcresults"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="explanation")}render(){return this.hass?this.isLoading?B`
        <ha-card header="${Eo("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${Eo("common.loading-messages.general",this.hass.language)}...
          </div>
        </ha-card>
      ...
      <ha-card header="${Eo("panels.zones.title",this.hass.language)}">
        <div class="card-content">
          ${Eo("panels.zones.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Eo("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("panels.zones.labels.name",this.hass.language)}
            </div>
            <input
              id="nameInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("panels.zones.labels.size",this.hass.language)}
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("panels.zones.labels.throughput",this.hass.language)}
              <span class="unit"
          ...
          <div class="add-zone-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Io}></ha-svg-icon>
              ${this.isSaving?Eo("common.saving-messages.adding",this.hass.language):Eo("panels.zones.cards.add-zone.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>

      ${el(this.zones,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderZone(e,t)))}

      <ha-card
        header="${Eo("panels.zones.cards.zone-actions.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zone-actions-grid">
            ${this._actionBtn(To,Eo("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language),(()=>this.handleCalculateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Lo,Eo("panels.zones.cards.zone-actions.actions.update-all",this.hass.language),(()=>this.handleUpdateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Co,Eo("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),(()=>this.handleResetAllBuckets()),!1,this.isSaving)}
            ${this._actionBtn(Oo,Eo("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),(()=>this.handleClearAllWeatherdata()),!1,this.isSaving)}
          </div>
        </div>
      </ha-card>
    ...
    `}};a([ce()],ul.prototype,"config",void 0),a([ce({type:Array})],ul.prototype,"zones",void 0),a([ce({type:Array})],ul.prototype,"modules",void 0),a([ce({type:Array})],ul.prototype,"mappings",void 0),a([ce({type:Map})],ul.prototype,"wateringCalendars",void 0),a([ce({type:Map})],ul.prototype,"weatherRecords",void 0),a([ce({type:Boolean})],ul.prototype,"isLoading",void 0),a([ce({type:Boolean})],ul.prototype,"isSaving",void 0),a([ce({type:Boolean})],ul.prototype,"isCreatingZone",void 0),a([me("#nameInput")],ul.prototype,"nameInput",void 0),a([me("#sizeInput")],ul.prototype,"sizeInput",void 0),a([me("#throughputInput")],ul.prototype,"throughputInput",void 0),ul=a([de("smart-irrigation-view-zones")],ul);let cl=class extends(qt(oe)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[],this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.moduleCache=new Map,this._expanded=new Set,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this._suppressNextConfigUpdate=!0,this.saveToHA(t).catch((()=>{this._suppressNextConfigUpdate=!1})),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleItem(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){fe().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:_e+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{const[e,t,a,i]=await Promise.all([Mt(this.hass),Ot(this.hass),Pt(this.hass),Ht(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.allmodules=i,this.moduleCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}}async handleAddModule(){var e,t;if((null===(t=null===(e=this.moduleInput)||void 0===e?void 0:e.selectedOptions)||void 0===t?void 0:t[0])&&!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.moduleInput.selectedOptions[0].text,t=this.allmodules.find((t=>t.name===e));if(!t)return;const a={name:e,description:t.description,config:t.config,schema:t.schema};this.modules=[...this.modules,a],this.moduleCache.clear(),this._scheduleUpdate(),await this.saveToHA(a),await this._fetchData()}catch(e){console.error("Error adding module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}}}async handleRemoveModule(e,t){if(!this.isSaving){this.isSaving=!0,this._scheduleUpdate();try{const e=this.modules[t],n=null==e?void 0:e.id;this.modules;this.modules=this.modules.filter(((e,a)=>a!==t)),this.moduleCache.clear(),this._scheduleUpdate(),this.hass&&void 0!==n&&await(a=this.hass,i=n.toString(),a.callApi("POST",_e+"/modules",{id:i,remove:!0}))}catch(e){console.error("Error removing module:",e),await this._fetchData()}finally{this.isSaving=!1,this._scheduleUpdate()}var a,i}}async saveToHA(e){if(this.hass)try{await Ct(this.hass,e)}catch(e){throw console.error("Error saving module:",e),e}}renderModule(e,t){var a,i;if(!this.hass)return B``;const n=this.zones.filter((t=>t.module===e.id)).length,s=null!==(a=e.id)&&void 0!==a?a:t,r=this._expanded.has(s),o=e.description||(null===(i=this.allmodules.find((t=>t.name===e.name)))||void 0===i?void 0:i.description)||"",l=`module-${e.id||t}-${r?"open":"closed"}-${JSON.stringify(e)}`;if(this.moduleCache.has(l))return this.moduleCache.get(l);const d=B`
        ...
        ${r?B` <div class="si-body">
              <div class="moduleconfig">
                <label class="subheader"
                  >${Eo("panels.modules.cards.module.labels.configuration",this.hass.language)}
                  (*
                  ${Eo("panels.modules.cards.module.labels.required",this.hass.language)})</label
                >
                <div class="settings">
              ...
              ${n?B`<div class="weather-note">
                    ${Eo("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                  </div>`:B`<div class="si-actions">
                    ${this._actionBtn(No,Eo("common.actions.delete",this.hass.language),(e=>this.handleRemoveModule(e,t)),!0)}
                  </div>`}
            </div>`:""}
      </ha-card>
    `;return this.moduleCache.set(l,d),d}renderConfig(e,t){const a=Object.values(this.modules).at(e);if(!a||!this.hass)return;const i=a.schema[t],n=i.name,s=function(e){if(e)return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}(n);let r="";null==a.config&&(a.config=[]),n in a.config&&(r=a.config[n]);const o=i.required?`${s} *`:null!=s?s:"";if("boolean"==i.type)return B`
      ...
      `;if("float"==i.type||"integer"==i.type)return this._numRow(o,"",a.config[n],(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t})}))),1);if("string"==i.type)return this._textRow(o,"",r,(t=>this.handleEditConfig(e,Object.assign(Object.assign({},a),{config:Object.assign(Object.assign({},a.config),{[n]:t})}))));if("select"==i.type){const t=this.hass.language,s=B`
        ${Object.entries(i.options).map((([e,a])=>B`<option
              ...
              ?selected="${r===$t(a,0)}"
            >
              ${Eo("panels.modules.cards.module.translated-options."+$t(a,1),t)}
            </option>`))}
    ...
    `}handleEditConfig(e,t){this.modules=Object.values(this.modules).map(((a,i)=>i===e?t:a)),this.moduleCache.clear(),this._scheduleUpdate(),this.debouncedSave(t)}renderOption(e,t){return this.hass?B`<option value="${e}>${t}</option>`:B``}render(){return this.hass?B`
      <ha-card header="${Eo("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Eo("panels.modules.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Eo("panels.modules.cards.add-module.header",this.hass.language)}"
      >
        <div class="card-content">
          ${this.isLoading?B`<div class="loading-indicator">
                ...
                <div class="setting-row">
                  <div class="setting-label">
                    ${Eo("common.labels.module",this.hass.language)}
                  </div>
                  <div class="select-wrap">
                    <select
                      id="moduleInput"
                ...
                <div class="si-form-actions">
                  ...
                  >
                    <ha-svg-icon slot="start" .path=${Io}></ha-svg-icon>
                    ${this.isSaving?Eo("common.saving-messages.adding",this.hass.language):Eo("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </ha-button>
                </div>
              `}
        </div>
      ...
      ${this.isLoading?B`<div class="loading-indicator">
            ${Eo("common.loading-messages.modules",this.hass.language)}
          </div>`:el(this.modules,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderModule(e,t)))}
    `:B``}disconnectedCallback(){super.disconnectedCallback(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.moduleCache.clear()}static get styles(){return l`
      ${qo} ${Ro} /* View-specific styles only - most common styles are now in globalStyle */
    `}};a([ce()],cl.prototype,"config",void 0),a([ce({type:Array})],cl.prototype,"zones",void 0),a([ce({type:Array})],cl.prototype,"modules",void 0),a([ce({type:Array})],cl.prototype,"allmodules",void 0),a([ce({type:Boolean})],cl.prototype,"isLoading",void 0),a([ce({type:Boolean})],cl.prototype,"isSaving",void 0),a([me("#moduleInput")],cl.prototype,"moduleInput",void 0),cl=a([de("smart-irrigation-view-modules")],cl);let pl=class extends(qt(oe)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16,this._expanded=new Set,this.modules=[]}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}),this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()})))}_toggleItem(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){fe().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:_e+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,t,a,i]=await Promise.all([Mt(this.hass),Ot(this.hass),It(this.hass),Pt(this.hass)]);this.config=e,this.zones=t,this.mappings=a,this.modules=i,this._fetchWeatherRecords(),this.mappingCache.clear()}catch(t){console.error("Error fetching data:",t),Tt({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"))}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const t=await Bt(this.hass,e.id.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for mapping ${e.id}:`,t),this.weatherRecords.set(e.id,[])}this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass)return B``;const t=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return B`
      <div class="weather-records">
        <h4>
          ${Eo("panels.mappings.weather-records.title",this.hass.language)}
        </h4>
        ${0===t.length?B`
            ...
            `:B`
              <div class="weather-table">
                ...
                ${t.slice(0,10).map((e=>{let t="-",a="-";try{if(e.timestamp&&null!==e.timestamp){const a=dl(e.timestamp);a.isValid()&&(t=a.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting timestamp:",e.timestamp,t)}try{if(e.retrieval_time&&null!==e.retrieval_time){const t=dl(e.retrieval_time);t.isValid()&&(a=t.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting retrieval_time:",e.retrieval_time,t)}return B`
                    <div class="weather-row">
                      <span>${t}</span>
                      <span
                        >${null!==e.temperature&&void 0!==e.temperature?e.temperature.toFixed(1)+"°C":"-"}</span
      ...
      <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            ...
            <div class="setting-row">
              <div class="setting-label">
                ${Eo("panels.mappings.cards.mapping.greenhouse",this.hass.language)}
              </div>
              <ha-switch
            ...
            <div class="setting-row">
              <div class="setting-label">
                ${Eo("panels.mappings.cards.mapping.module",this.hass.language)}
              </div>
              <select
              ...
              >
                ...
                >
                  ---${Eo("common.labels.select",this.hass.language)}---
                </option>
            ...
            <div class="weather-note">
              ${Eo(void 0===e.module||null===e.module?"panels.mappings.cards.mapping.module_undecided":"panels.mappings.cards.mapping.module_description",this.hass.language)}
            </div>
            ${e.greenhouse?B`<div class="weather-note">
                  ${Eo("panels.mappings.cards.mapping.greenhouse_description",this.hass.language)}
                </div>`:""}
            ...
            ${i?B`<div class="weather-note">
                  ${Eo("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:B` <div
                  class="action-button"
                  @click="${e=>this.handleRemoveMapping(e,t)}"
                >
                  <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    <path fill="#404040" d="${No}" />
                  </svg>
                  <span class="action-button-label">
                    ${Eo("common.actions.delete",this.hass.language)}
                  </span>
                </div>`}
          </div>
        </div>
    ...
    `;return this.mappingCache.set(a,n),n}renderMappingSetting(e,t){const a=this.mappings[e];if(!a||!this.hass)return B``;const i=a.mappings[t];return B`
      <div class="si-subgroup">
        <div class="si-subgroup-title">
          ${Eo(`panels.mappings.cards.mapping.items.${t.toLowerCase()}`,this.hass.language)}
        </div>
        ${this._selectRow(Eo("panels.mappings.cards.mapping.source",this.hass.language),this.renderSimpleRadioOptions(e,t,i),(a=>this.handleSimpleSourceChange(e,t,a)))}
        ${this.renderMappingInputs(e,t,i)}
      </div>
    `}renderSimpleRadioOptions(e,t,a){if(!this.hass||!this.config)return B``;const i=t===Oe||t===Le,n=a[Qe],s=t===Pe,r=!!this.config.use_weather_service&&!s,o=i||s,l=i&&this.config.weather_service!==Ve;return B`
      ${r?B`<option
            value="${Re}"
            ?selected=${n===Re}
          >
            ${Eo("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}${l?" (via Open-Meteo)":""}
          </option>`:""}
      ${o?B`<option
            value="${Je}"
            ?selected=${n===Je}
          >
            ${Eo("panels.mappings.cards.mapping.sources.none",this.hass.language)}
          </option>`:""}
      <option
        value="${Fe}"
        ?selected=${n===Fe}
      >
        ${Eo("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </option>
      <option
        value="${We}"
        ?selected=${n===We}
      >
        ${Eo("panels.mappings.cards.mapping.sources.static",this.hass.language)}
      </option>
      ${t===Le?B`<option
            value="${Ye}"
            ?selected=${n===Ye}
          >
            ${Eo("panels.mappings.cards.mapping.sources.illuminance",this.hass.language)}
          </option>`:""}
    `}handleSimpleSourceChange(e,t,a){const i=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Qe]:n,[Xe]:""})})}))}handleSimpleInputChange(e,t,a,i){const n=this.mappings[e],s=i.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[t]:Object.assign(Object.assign({},n.mappings[t]),{[a]:s})})}))}renderSourceOptions(e,t,a){var i;if(!this.hass)return B``;const n=`${t}_${e}`,s=t===Oe||t===Le,r=!!(null===(i=this.config)||void 0===i?void 0:i.use_weather_service);return B`
      <div class="mappingsettingline">
        <label for="${n}_source">
          ${Eo("panels.mappings.cards.mapping.source",this.hass.language)}:
        </label>
      </div>
    ...
    `}renderWeatherServiceOption(e,t,a){if(!this.hass||!this.config)return B``;const i=`${t}_${e}`,n=!this.config.use_weather_service,s=this.config.use_weather_service&&a[Qe]===Re,r=(t===Oe||t===Le)&&this.config.weather_service!==Ve;return B`
      <label class="${n?"strikethrough":""}">
        ...
        />
        ${Eo("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}${r?" (via Open-Meteo)":""}
      </label>
    ...
    `}renderSensorInput(e,t,a){return this.hass?B`
      <div class="setting-row">
        <div class="setting-label">
          ${Eo("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}
        </div>
        <ha-entity-picker
          class="entity-field"
          .hass=${this.hass}
    ...
    `:B``}renderLuminousEfficacyInput(e,t,a){var i;return this.hass?this._numRow(Eo("panels.mappings.cards.mapping.luminous_efficacy",this.hass.language),"lm/W",null!==(i=a[tt])&&void 0!==i?i:110,(a=>this.handleLuminousEfficacyChange(e,t,{target:{value:a}})),1):B``}handleLuminousEfficacyChange(e,t,a){const i=this.mappings[e];this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[tt]:parseFloat(a.target.value)})})}))}renderStaticValueInput(e,t,a){return this.hass?this._numRow(Eo("panels.mappings.cards.mapping.static_value",this.hass.language),"",a[et]||"",(a=>this.handleStaticValueChange(e,t,{target:{value:a}})),.1):B``}renderUnitSelect(e,t,a){return this.hass&&this.config?this._selectRow(Eo("panels.mappings.cards.mapping.input-units",this.hass.language),this.renderUnitOptionsForMapping(t,a),(a=>this.handleUnitChange(e,t,a))):B``}renderPressureTypeSelect(e,t,a){return this.hass?this._selectRow(Eo("panels.mappings.cards.mapping.pressure-type",this.hass.language),this.renderPressureTypes(t,a),(a=>this.handlePressureTypeChange(e,t,a))):B``}renderAggregateSelect(e,t,a){return this.hass?B`
      <div class="setting-row">
        <div class="setting-label">
          ${Eo("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          <span class="unit"
            >${Eo("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</span
          >
        </div>
        <div class="select-wrap">
          <select
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return B`<option value="${e}" ?selected="${e===t}">
        ${Eo("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return B``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=B``;const a=t[Ze];return e=B`${e}
        <option
          value="${Ge}"
          ?selected="${a===Ge}"
        >
          ${Eo("panels.mappings.cards.mapping.pressure_types."+Ge,this.hass.language)}
        </option>
        <option
          value="${Ke}"
          ?selected="${a===Ke}"
        >
          ${Eo("panels.mappings.cards.mapping.pressure_types."+Ke,this.hass.language)}
        </option>`,e}return B``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return B``;const a=function(e){switch(e){case Me:case Be:return[{unit:"°C",system:De},{unit:"°F",system:Te}];case Pe:case Oe:return[{unit:"mm",system:De},{unit:"in",system:Te}];case Ce:return[{unit:st,system:De},{unit:rt,system:Te}];case Ne:return[{unit:"%",system:[De,Te]}];case Ie:return[{unit:"millibar",system:De},{unit:"hPa",system:De},{unit:"psi",system:Te},{unit:"inch Hg",system:Te}];case qe:return[{unit:"km/h",system:De},{unit:"meter/s",system:De},{unit:"mile/h",system:Te},{unit:"knot",system:[De,Te]}];case Le:return[{unit:"W/m2",system:De},{unit:"MJ/day/m2",system:De},{unit:"W/sq ft",system:Te},{unit:"MJ/day/sq ft",system:Te}];default:return[]}}(e);let i=t[at];const n=this.config.units;if(!t[at])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const t of e.system)if(n===t.system){i=e.unit;break}if(i===e.unit)break}return B`
      ${a.map((e=>B`
    ...
    `}render(){return this.hass?this.isLoading?B`
        <ha-card
          header="${Eo("panels.mappings.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Eo("common.loading-messages.general",this.hass.language)}
          </div>
      ...
      >
        <div class="card-content">
          ${Eo("panels.mappings.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Eo("panels.mappings.cards.add-mapping.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Eo("panels.mappings.labels.mapping-name",this.hass.language)}
            </div>
          ...
          <div class="si-form-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Io}></ha-svg-icon>
              ${this.isSaving?Eo("common.saving-messages.adding",this.hass.language):Eo("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
    ...
    `:B``}renderMappingsList(){const e=this.mappings.slice(0,Math.min(this.mappings.length,10)),t=this.mappings.slice(10);return B`
      ${el(e,(e=>{var t;return null!==(t=e.id)&&void 0!==t?t:e.name}),((e,t)=>this.renderMappingCard(e,t)))}
      ${t.length>0?B`
            <div class="si-form-actions">
              ${this._actionBtn(Io,`Load ${t.length} more mappings...`,(()=>this.loadMoreMappings()))}
            </div>
          `:""}
    `}renderMappingCard(e,t){if(!this.hass)return B``;const a=this.hass.language,i=this.zones.filter((t=>t.mapping===e.id)).length,n=Object.keys(e.mappings||{}).length,s=[];s.push(`${n} ${Eo("panels.mappings.title",a).toLowerCase()}`),i&&s.push(`${i} ${Eo("panels.zones.title",a).toLowerCase()}`);const r=s.join(" · "),o=null!=e.id&&this._expanded.has(e.id);return B`
      <ha-card class="si-card">
        <div
          class="si-head"
          role="button"
        ...
        ${o?B`<div class="si-body">
              <div class="settings">
                ${this._textRow(Eo("panels.mappings.labels.mapping-name",a),"",e.name,(a=>this.handleEditMapping(t,Object.assign(Object.assign({},e),{name:a}))))}
                ${this.renderMappingSettings(e,t)}
              </div>
              ${this.renderWeatherRecords(e)}
              <div class="si-actions">
                ${i?B`<div class="weather-note">
                      ${Eo("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",a)}
                    </div>`:this._actionBtn(No,Eo("common.actions.delete",a),(e=>this.handleRemoveMapping(e,t)),!0)}
              </div>
            </div>`:""}
      </ha-card>
      ...
      <ha-card header="${Eo("panels.weatherservice.title",t)}">
        ...
        <div class="card-content">
          ...
          ${this._use?B`
                <div class="setting-row">
                  <div class="setting-label">
                    ${Eo("panels.weatherservice.labels.service",t)}
                  </div>
                  <div class="select-wrap">
                    <select
                      class="field"
                ...
                ${this._service&&Ue.includes(this._service)?"":B`<div class="setting-row">
                      <div class="setting-label">
                        ${Eo("panels.weatherservice.labels.api-key",t)}
                      </div>
                      <input
                        class="field"
                        type="text"
                ...
                ${"Open Weather Map"===this._service?B`<div class="ws-note ws-note--hint">
                      ${Eo("panels.weatherservice.messages.owm-onecall-hint",t)}
                    </div>`:""}
              `:B`<div class="ws-note">
                ${Eo("panels.weatherservice.messages.no-service",t)}
              </div>`}
          ${this._error?B`<div class="ws-msg ws-msg--error">${this._error}</div>`:""}
          ${this._saved?B`<div class="ws-msg ws-msg--success">
                ${Eo("panels.weatherservice.messages.saved",t)}
              </div>`:""}
          ...
          <div class="ws-actions">
            <ha-button
              ...
              @click=${this._save}
            >
              ${this._saving?Eo("panels.weatherservice.actions.saving",t):Eo("panels.weatherservice.actions.save",t)}
            </ha-button>
          </div>
          <div class="ws-note ws-reload-note">
            ${Eo("panels.weatherservice.messages.reload-note",t)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return l`
    ...
    `}};a([ce()],ml.prototype,"narrow",void 0),a([ce()],ml.prototype,"path",void 0),a([pe()],ml.prototype,"_info",void 0),a([pe()],ml.prototype,"_use",void 0),a([pe()],ml.prototype,"_service",void 0),a([pe()],ml.prototype,"_apiKey",void 0),a([pe()],ml.prototype,"_loading",void 0),a([pe()],ml.prototype,"_saving",void 0),a([pe()],ml.prototype,"_error",void 0),a([pe()],ml.prototype,"_saved",void 0),ml=a([de("smart-irrigation-view-weatherservice")],ml);let gl=class extends oe{constructor(){super(...arguments),this._busy=!1,this._error="",this._message="",this._pendingName=""}firstUpdated(){fe().catch((e=>{console.error("Failed to load HA form:",e)}))}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}_reset(){this._error="",this._message="",this._pending=void 0,this._pendingName=""}async _export(){if(this.hass){this._reset(),this._busy=!0;try{const t=await(e=this.hass,e.callApi("GET",_e+"/export")),a=JSON.stringify(t,null,2),i=new Blob([a],{type:"application/json"}),n=URL.createObjectURL(i),s=document.createElement("a");s.href=n;const r=(new Date).toISOString().slice(0,19).replace("T","_").replace(/:/g,"-");s.download=`smart_irrigation_backup_${r}.json`,s.click(),URL.revokeObjectURL(n),this._message=Eo("panels.backuprestore.messages.exported",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e}}async _onFile(e){this._reset();const t=e.target,a=t.files&&t.files[0];if(a)try{const e=await a.text(),t=JSON.parse(e);if(!t||"object"!=typeof t||!t.config)throw new Error(Eo("panels.backuprestore.messages.invalid-file",this.hass.language));this._pending=t,this._pendingName=a.name}catch(e){this._error=this._errText(e)}finally{t.value=""}}async _restore(){if(this.hass&&this._pending){this._busy=!0,this._error="",this._message="";try{const a=await(e=this.hass,t=this._pending,e.callApi("POST",_e+"/restore",t));if(a&&!1===a.success)throw new Error(a.error||"restore failed");this._pending=void 0,this._pendingName="",this._message=Eo("panels.backuprestore.messages.restored",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e,t}}_count(e){const t=this._pending&&this._pending[e];return Array.isArray(t)?t.length:0}render(){if(!this.hass)return B``;const e=this.hass.language;return B`
      <ha-card header="${Eo("panels.backuprestore.title",e)}">
        <div class="card-content br-description">
          ${Eo("panels.backuprestore.description",e)}
        </div>
      </ha-card>

      <ha-card
        header="${Eo("panels.backuprestore.cards.backup.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${Eo("panels.backuprestore.cards.backup.description",e)}
          </div>
          ...
          <div class="br-actions">
            ...
            >
              ...
              ${Eo("panels.backuprestore.actions.export",e)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${Eo("panels.backuprestore.cards.restore.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${Eo("panels.backuprestore.cards.restore.description",e)}
          </div>
          ...
          <label class="br-file">
            <input
              ...
              @change=${this._onFile}
            />
            <ha-svg-icon .path=${Bo}></ha-svg-icon>
            ${Eo("panels.backuprestore.actions.choose-file",e)}
          </label>
                ...
                <div class="br-warning">
                  ...
                  <div>
                    <div class="br-warning-title">
                      ${Eo("panels.backuprestore.messages.confirm-title",e)}
                    </div>
                    <div class="br-file-name">${this._pendingName}</div>
                    <div class="br-summary">
                      ${Eo("panels.backuprestore.messages.summary",e)}:
                      ${this._count("zones")}
                      ${Eo("panels.zones.title",e)} ·
                      ${this._count("modules")}
                      ${Eo("panels.modules.title",e)} ·
                      ${this._count("mappings")}
                      ${Eo("panels.mappings.title",e)}
                    </div>
                    <div class="br-warning-text">
                      ${Eo("panels.backuprestore.messages.confirm-warning",e)}
                    </div>
                  </div>
                </div>
              `:""}
          ...
          ${this._pending?B`<div class="br-actions">
                <ha-button
                  ...
                  @click=${this._restore}
                >
                  <ha-svg-icon slot="start" .path=${Bo}></ha-svg-icon>
                  ${this._busy?Eo("panels.backuprestore.actions.restoring",e):Eo("panels.backuprestore.actions.restore",e)}
                </ha-button>
              </div>`:""}
          <div class="br-note">
            ${Eo("panels.backuprestore.messages.reload-note",e)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return l`
    ...
    `}};a([ce()],gl.prototype,"narrow",void 0),a([ce()],gl.prototype,"path",void 0),a([pe()],gl.prototype,"_busy",void 0),a([pe()],gl.prototype,"_error",void 0),a([pe()],gl.prototype,"_message",void 0),a([pe()],gl.prototype,"_pending",void 0),a([pe()],gl.prototype,"_pendingName",void 0),gl=a([de("smart-irrigation-view-backuprestore")],gl);let hl=class extends(qt(oe)){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){fe().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:_e+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[t,a,i]=await Promise.all([Mt(this.hass),(e=this.hass,e.callWS({type:_e+"/info"})),Ot(this.hass)]);this.config=t,this.info=a,this.zones=i}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}get _lang(){var e,t;return null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en"}t(e){return Eo(`panels.info.${e}`,this._lang)}formatDuration(e){const t=Math.max(0,Math.round(null!=e?e:0)),a=Eo("common.units.hours",this._lang),i=Eo("common.units.minutes",this._lang),n=Eo("common.units.seconds",this._lang);if(t<60)return`${t} ${n}`;if(t<3600)return`${Math.round(t/60)} ${i}`;const s=Math.floor(t/3600),r=Math.round(t%3600/60);return r?`${s} ${a} ${r} ${i}`:`${s} ${a}`}render(){return this.hass?this.isLoading?B`
        <ha-card header="${this.t("title")}">
          <div class="card-content">
            ${Eo("common.loading",this._lang)}...
          </div>
        </ha-card>
      `:this.config?B`
      <ha-card header="${this.t("title")}">
        ...
        <div class="card-content">
          ${(null==a?void 0:a.next_irrigation_start)?B`
                <div class="info-item">
                  ...
                  <span class="value"
                    >${dl(a.next_irrigation_start).format("ddd D MMM, HH:mm")}</span
                  >
                </div>
                <div class="info-item">
    ...
    `}renderCheckNumbers(e){var t,a,i,n,s,r;return"precipitation"===e.id?B`
      ...
      <div class="last-decision">
        ...
        ${t?B`<span class="value"
              >${t.should_skip?this.t("cards.decision.last-skipped"):this.t("cards.decision.last-ran")}${t.evaluated_at?` (${dl(t.evaluated_at).format("ddd D MMM, HH:mm")})`:""}</span
            >`:B`<span class="value"
    ...
    `}};a([ce()],hl.prototype,"config",void 0),a([ce({type:Object})],hl.prototype,"info",void 0),a([ce({type:Array})],hl.prototype,"zones",void 0),a([ce({type:Boolean})],hl.prototype,"isLoading",void 0),hl=a([de("smart-irrigation-view-info")],hl);const vl=[Be,Me,Ne,Ie,qe,Le,Oe,Pe,Ce],fl={service:"PyETO",sensors:"PyETO",et:"Passthrough",static:"Static"};let bl=class extends oe{constructor(){super(...arguments),this.step=0,this.allModules=[],this.modules=[],this.isSaving=!1,this.done=!1,this.zoneName="",this.zoneSize="",this.zoneThroughput="",this.underGlass=!1,this.weather="service",this.sensors={},this.staticDelta=""}firstUpdated(){fe().catch((()=>{})),this._load().catch((e=>console.error("Setup wizard: load failed",e)))}async _load(){if(!this.hass)return;const[e,t,a]=await Promise.all([Mt(this.hass),Ht(this.hass),Pt(this.hass)]);this.config=e,this.allModules=t,this.modules=a,this.usesWeatherService||(this.weather="sensors")}get lng(){var e,t;return null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en"}t(e){return Eo(`panels.setup.${e}`,this.lng)}get usesWeatherService(){var e;return!!(null===(e=this.config)||void 0===e?void 0:e.use_weather_service)}get engineName(){return fl[this.weather]}get sourcesToAsk(){var e;const t=this.allModules.find((e=>e.name===this.engineName)),a=null!==(e=null==t?void 0:t.consumes)&&void 0!==e?e:vl;return vl.filter((e=>a.includes(e)&&!(this.underGlass&&(e===Pe||e===Ce))))}get sensorsToAsk(){return"static"===this.weather?[]:"et"===this.weather?[Oe]:"sensors"===this.weather?this.sourcesToAsk:[]}get steps(){const e=["zone","environment","weather"];return(this.sensorsToAsk.length||"static"===this.weather)&&e.push("sensors"),e.push("review"),e}get currentStep(){return this.steps[Math.min(this.step,this.steps.length-1)]}get canGoOn(){switch(this.currentStep){case"zone":return""!==this.zoneName.trim()&&Number(this.zoneSize)>0&&Number(this.zoneThroughput)>0;case"sensors":return"static"===this.weather?Number(this.staticDelta)>0:this.sensorsToAsk.every((e=>{var t;return""!==(null!==(t=this.sensors[e])&&void 0!==t?t:"")}));default:return!0}}render(){return this.hass?this.done?B`
        <ha-card header="${this.t("title")}">
          <div class="card-content">
    ...
    `}renderSensorsStep(){return"static"===this.weather?B`
      ...
      ${this.underGlass&&this.sensorsToAsk.includes(Le)?B`<div class="note">${this.t("steps.sensors.lux-hint")}</div>`:""}
    ...
    `}sourceFor(e){return this.sensors[e]?{[Qe]:Fe,[Xe]:this.sensors[e],[at]:""}:"service"===this.weather&&this.sourcesToAsk.includes(e)?{[Qe]:Re,[Xe]:"",[at]:""}:!this.underGlass||e!==Pe&&e!==Ce?{[Qe]:Je,[Xe]:"",[at]:""}:{[Qe]:We,[Xe]:"",[at]:"",[et]:0}}async create(){if(this.hass&&!this.isSaving){this.isSaving=!0,this.error=void 0;try{let e=this.modules.find((e=>e.name===this.engineName));if(!e){const t=this.allModules.find((e=>e.name===this.engineName));if(!t)throw new Error(`Unknown calculation engine ${this.engineName}`);const a="static"===this.weather?Object.assign(Object.assign({},t.config),{delta:Number(this.staticDelta)}):t.config;await Ct(this.hass,{name:t.name,description:t.description,config:a,schema:t.schema});const i=await Pt(this.hass);this.modules=i,e=i.find((e=>e.name===this.engineName))}const t={name:this.zoneName.trim(),mappings:Object.fromEntries(vl.map((e=>[e,this.sourceFor(e)]))),greenhouse:this.underGlass,[He]:null==e?void 0:e.id};await Lt(this.hass,t);const a=(await It(this.hass)).find((e=>e.name===t.name));await Nt(this.hass,{name:this.zoneName.trim(),size:Number(this.zoneSize),throughput:Number(this.zoneThroughput),state:"automatic",[ht]:null==a?void 0:a.id}),await Ot(this.hass),this.done=!0}catch(e){console.error("Setup wizard: could not create the zone",e),this.error=this.t("failed")}finally{this.isSaving=!1}}}static get styles(){return l`
      ${qo} ${Ro}
    ...
    `}};a([ce()],bl.prototype,"hass",void 0),a([ce()],bl.prototype,"config",void 0),a([pe()],bl.prototype,"step",void 0),a([pe()],bl.prototype,"allModules",void 0),a([pe()],bl.prototype,"modules",void 0),a([pe()],bl.prototype,"isSaving",void 0),a([pe()],bl.prototype,"error",void 0),a([pe()],bl.prototype,"done",void 0),a([pe()],bl.prototype,"zoneName",void 0),a([pe()],bl.prototype,"zoneSize",void 0),a([pe()],bl.prototype,"zoneThroughput",void 0),a([pe()],bl.prototype,"underGlass",void 0),a([pe()],bl.prototype,"weather",void 0),a([pe()],bl.prototype,"sensors",void 0),a([pe()],bl.prototype,"staticDelta",void 0),bl=a([de("smart-irrigation-view-setup")],bl);const kl=qo,yl=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a},_l=(e,...t)=>{let a={page:e,params:{}};t.forEach((e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}))}));const i=e=>{let t=Object.keys(e);t=t.filter((t=>e[t])),t.sort();let a="";return t.forEach((t=>{const i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`})),a};let n=`/${_e}/${a.page}`;return a.subpage&&(n=`${n}/${a.subpage}`),i(a.params).length&&(n=`${n}/${i(a.params)}`),a.filter&&(n=`${n}/filter/${i(a.filter)}`),n};var zl;!function(e){e.Setup="setup",e.Info="info",e.General="general",e.Zones="zones",e.Modules="modules",e.Mappings="mappings",e.WeatherService="weatherservice",e.BackupRestore="backuprestore",e.Help="help"}(zl||(zl={})),e.SmartIrrigationPanel=class extends oe{constructor(){super(...arguments),this._updateScheduled=!1,this._lastNavigationTime=0,this._navigationThrottleDelay=100}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}async firstUpdated(){const e=yl();e.page&&Object.values(zl).includes(e.page)?(window.addEventListener("location-changed",(()=>{if(!window.location.pathname.includes("smart_irrigation"))return;const e=performance.now();e-this._lastNavigationTime<this._navigationThrottleDelay||(this._lastNavigationTime=e,this._scheduleUpdate())})),fe().then((()=>{this._scheduleUpdate()})).catch((e=>{console.error("Failed to load HA form elements:",e),this._scheduleUpdate()}))):Dt(0,_l(zl.General))}render(){const e=yl(),t=!!customElements.get("ha-tab-group"),a=!!customElements.get("ha-tab-group-tab");return B`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Eo("title",this.hass.language)}</div>
          <div class="version">${"v2026.9.0"}</div>
        </div>

        ${t&&a?B`
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(zl).map((t=>B`
                    <ha-tab-group-tab
                      slot="nav"
                      panel="${t}"
                      .active=${e.page===t}
                    >
                      ${Eo(`panels.${t}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `))}
              </ha-tab-group>
            `:B`
    ...
    `}getView(e){switch(e.page){case"setup":return B`
        ...
        `;case"help":return B`<ha-card
          header="${Eo("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Eo("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
            <a href="https://altmenorg.github.io/HAsmartirrigation/"
              >${Eo("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >.
            ${Eo("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${Eo("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${Eo("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a href="https://github.com/altmenorg/HAsmartirrigation/issues"
              >${Eo("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${Eo("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return B`
        ...
        `}}navigateToPage(e){if(e!==yl().page){const t=_l(e);Dt(0,t),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const t=e.detail.name;if(t!==yl().page){const e=_l(t);Dt(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[kl,l`
        :host {
          color: var(--primary-text-color);
    ...
    `}};a([ce({attribute:!1})],wl.prototype,"hass",void 0),a([pe()],wl.prototype,"_params",void 0),wl=a([de("smart-irrigation-error-dialog")],wl);var xl=Object.freeze({__proto__:null,get ErrorDialog(){return wl}})}({});
