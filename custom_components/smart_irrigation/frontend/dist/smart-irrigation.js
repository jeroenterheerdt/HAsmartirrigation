!(function (e) {
      ...
      : (e) =>
          e instanceof CSSStyleSheet
            ? ((e) => {
                ...
                return ((e) =>
                  new c("string" == typeof e ? e : e + "", void 0, l))(t);
              })(e)
            : e;
  /**
   * @license
  ...
  const E = window,
    $ = E.trustedTypes,
    A = $ ? $.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
    M = "$lit$",
    ...
    Z = (e, t) => {
      ...
      for (let t = 0; t < a; t++) {
        ...
        for (
          ;
          c < a.length && ((r.lastIndex = c), (l = r.exec(a)), null !== l);
        ...
        s +=
          r === C
            ? a + D
            : u >= 0
            ? (i.push(o), a.slice(0, u) + M + a.slice(u) + O + d)
            : a + O + (-2 === u ? (i.push(void 0), t) : d);
      }
      const o = s + (e[a] || "<?>") + (2 === t ? "</svg>" : "");
      if (!Array.isArray(e) || !e.hasOwnProperty("raw"))
        throw Error("invalid template strings array");
      return [void 0 !== A ? A.createHTML(o) : o, i];
    };
  class q {
        ...
        if (1 === i.nodeType) {
          if (i.hasAttributes()) {
            ...
            for (const t of i.getAttributeNames())
              if (t.endsWith(M) || t.startsWith(O)) {
                const a = u[s++];
                if ((e.push(t), void 0 !== a)) {
                  const e = i.getAttribute(a.toLowerCase() + M).split(O),
                    t = /([.?@])?(.*)/.exec(a);
                  o.push({
                    type: 1,
                    index: n,
    ...
    _$AI(e, t = this, a, i) {
      ...
      if (void 0 === n)
        ...
        for (e = n[0], r = 0; r < n.length - 1; r++)
          (o = K(this, i[a + r], t, r)),
            o === G && (o = this._$AH[r]),
            s || (s = !z(o) || o !== this._$AH[r]),
            o === V
              ? (e = V)
              : e !== V && (e += (null != o ? o : "") + n[r + 1]),
            (this._$AH[r] = o);
      }
      s && !i && this.j(e);
    }
  ...
  class ie extends Q {
    ...
    _$AI(e, t = this) {
      var a;
      if ((e = null !== (a = K(this, e, t, 0)) && void 0 !== a ? a : V) === G)
        return;
      const i = this._$AH,
        n =
          (e === V && i !== V) ||
  ...
  function pe(e) {
    return (t, a) => (void 0 !== a ? he(e, t, a) : de(e, t));
    /**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
  ...
  var at,
    ...
    ot = "Smart Irrigation",
    lt = { common: st, panels: rt, title: ot },
    ut = Object.freeze({
      __proto__: null,
      common: st,
      panels: rt,
    ...
    ht = "Smart Irrigation",
    pt = { common: ct, panels: dt, title: ht },
    mt = Object.freeze({
      __proto__: null,
      common: ct,
      panels: dt,
    ...
    vt = "Smart Irrigation",
    bt = { common: gt, panels: ft, title: vt },
    yt = Object.freeze({
      __proto__: null,
      common: gt,
      panels: ft,
    ...
    kt = "Smart Irrigation",
    St = { common: _t, panels: wt, title: kt },
    Et = Object.freeze({
      __proto__: null,
      common: _t,
      panels: wt,
    ...
    Mt = "Irrigazione Intelligente",
    Ot = { common: $t, panels: At, title: Mt },
    Tt = Object.freeze({
      __proto__: null,
      common: $t,
      panels: At,
    ...
    xt = "Smart Irrigation",
    zt = { common: Dt, panels: Ht, title: xt },
    Pt = Object.freeze({
      __proto__: null,
      common: Dt,
      panels: Ht,
    ...
    Rt = {
      ...
      mappings: {
        ...
        description:
          "Pridajte jednu alebo viac skupín senzorov, ktoré získavajú údaje o počasí z OpenWeatherMap, zo senzorov alebo ich kombinácie. Každú skupinu senzorov môžete namapovať na jednu alebo viac zón",
    ...
    It = "Inteligentné zavlažovanie",
    Ut = { common: Bt, panels: Rt, title: It },
    Yt = Object.freeze({
      __proto__: null,
      common: Bt,
      panels: Rt,
    ...
    for (var t = {}, a = 0, n = e; a < n.length; a++) {
      ...
      switch (s.stem) {
        ...
        case "integer-width":
          ...
          s.options[0].replace(oa, function (e, a, i, n, s, r) {
      ...
      if (la.test(s.stem)) t.minimumIntegerDigits = s.stem.length;
      else if (sa.test(s.stem)) {
        if (s.options.length > 1)
          throw new RangeError(
            "Fraction-precision stems only accept a single optional option"
          );
        s.stem.replace(sa, function (e, a, i, n, s, r) {
          return (
            "*" === i
        ...
        "w" === r
          ...
          : r && (t = i(i({}, t), ua(r)));
      } else if (ra.test(s.stem)) t = i(i({}, t), ua(s.stem));
      else {
        var o = ca(s.stem);
        o && (t = i(i({}, t), o));
        var l = da(s.stem);
  ...
  function fa(e) {
    ...
    return (
      ...
      (ga[a || ""] || ga[i || ""] || ga["".concat(i, "-001")] || ga["001"])[0]
    );
  }
  var va = new RegExp("^".concat(ta.source, "*")),
    ba = new RegExp("".concat(ta.source, "*$"));
  function ya(e, t) {
    return { start: e, end: t };
  }
  var _a = !!String.prototype.startsWith,
    wa = !!String.fromCodePoint,
    ka = !!Object.fromEntries,
    Sa = !!String.prototype.codePointAt,
    Ea = !!String.prototype.trimStart,
  ...
  try {
    Ma =
      "a" ===
      (null ===
        (ma = Na("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
          "a"
        )) || void 0 === ma
        ? void 0
        : ma[0]);
  ...
  if (Ma) {
    var Ca = Na("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    Oa = function (e, t) {
      var a;
      return (
        (Ca.lastIndex = t),
        null !== (a = Ca.exec(e)[1]) && void 0 !== a ? a : ""
      );
    };
  } else
    Oa = function (e, t) {
  ...
  var ja = (function () {
    ...
    return (
        ...
        for (var i = []; !this.isEOF(); ) {
          ...
          if (123 === n) {
            ...
            if (35 !== n || ("plural" !== t && "selectordinal" !== t)) {
              ...
              if (60 === n && !this.ignoreTag && La(this.peek() || 0)) {
      ...
      (e.prototype.parseTagName = function () {
        var e = this.offset();
        for (this.bump(); !this.isEOF() && Ba(this.char()); ) this.bump();
      ...
      (e.prototype.tryParseLeftAngleBracket = function () {
        return this.isEOF() ||
          60 !== this.char() ||
          (!this.ignoreTag && (La((e = this.peek() || 0)) || 47 === e))
          ? null
          : (this.bump(), "<");
        var e;
      }),
        ...
        switch (o) {
          ...
          case "time":
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (m = Pa(b.val)).length)
                return this.error(
                  at.EXPECT_ARGUMENT_STYLE,
                  ya(this.clonePosition(), this.clonePosition())
                );
              u = { style: m, styleLocation: ya(c, this.clonePosition()) };
            }
            if ((y = this.tryParseArgumentClose(n)).err) return y;
            var d = ya(n, this.clonePosition());
            if (u && Ta(null == u ? void 0 : u.style, "::", 0)) {
              var h = za(u.style.slice(2));
              if ("number" === o)
              ...
              if (0 === h.length)
                return this.error(at.EXPECT_DATE_TIME_SKELETON, d);
              var p = h;
              this.locale &&
                (p = (function (e, t) {
              ...
              var m = {
                ...
                parsedOptions: this.shouldParseSkeletons ? ia(p) : {},
              };
              return {
                val: {
      ...
      (e.prototype.parseNumberSkeletonFromString = function (e, t) {
        ...
        try {
          a = (function (e) {
            ...
            for (
              var t = e.split(na).filter(function (e) {
                  return e.length > 0;
                }),
                a = [],
                i = 0,
        ...
        return {
          val: {
            ...
            tokens: a,
            location: t,
            parsedOptions: this.shouldParseSkeletons ? pa(a) : {},
          },
          err: null,
        };
      }),
  ...
  function Ua(e) {
    e.forEach(function (e) {
      if ((delete e.location, qt(e) || Kt(e)))
        for (var t in e.options)
          delete e.options[t].location, Ua(e.options[t].value);
      else
        (Ft(e) && Qt(e.style)) || ((Wt(e) || Zt(e)) && ea(e.style))
  ...
  function Ya(e, t) {
    ...
    return (null == t ? void 0 : t.captureLocation) || Ua(a.val), a.val;
  }
  function Ga(e, t) {
    var a = t && t.cache ? t.cache : Ja,
      i = t && t.serializer ? t.serializer : qa;
    return (t && t.strategy ? t.strategy : Za)(e, { cache: a, serializer: i });
  }
  function Va(e, t, a, i) {
    var n,
      s =
  ...
  var Xa,
    ...
    Qa = {
      variadic: function (e, t) {
        return Wa(e, this, Fa, t.cache.create(), t.serializer);
      },
      monadic: function (e, t) {
        return Wa(e, this, Va, t.cache.create(), t.serializer);
      },
    };
  !(function (e) {
  ...
  function ri(e, t, a, i, n, s, r) {
    if (1 === e.length && Gt(e[0]))
      return [{ type: ei.literal, value: e[0].value }];
    for (var o = [], l = 0, u = e; l < u.length; l++) {
      var c = u[l];
      if (Gt(c)) o.push({ type: ei.literal, value: c.value });
      else if (Xt(c))
        "number" == typeof s &&
          o.push({ type: ei.literal, value: a.getNumberFormat(t).format(s) });
      else {
        var d = c.value;
        if (!n || !(d in n)) throw new ni(d, r);
        var h = n[d];
        if (Vt(c))
          ...
          if (Jt(c)) {
            var m = c.children,
              g = c.value,
              f = n[g];
            if (!si(f)) throw new ii(g, "function", r);
            var v = f(
              ri(m, t, a, i, n, s).map(function (e) {
                return e.value;
              })
            );
            Array.isArray(v) || (v = [v]),
          ...
          if (qt(c)) {
            if (!(b = c.options[h] || c.options.other))
              throw new ai(c.value, h, Object.keys(c.options), r);
            o.push.apply(o, ri(b.value, t, a, i, n));
          } else if (Kt(c)) {
            var b;
            if (!(b = c.options["=".concat(h)])) {
              if (!Intl.PluralRules)
                throw new ti(
              ...
              var y = a
                ...
                .select(h - (c.offset || 0));
              b = c.options[y] || c.options.other;
            }
            if (!b) throw new ai(c.value, h, Object.keys(c.options), r);
            o.push.apply(o, ri(b.value, t, a, i, n, h - (c.offset || 0)));
          } else;
        }
      }
    }
  ...
  var ui = (function () {
          ...
          (this.formatters =
              ...
              (r = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: Ga(
                ...
                { cache: li(r.number), strategy: Qa.variadic }
              ),
              getDateTimeFormat: Ga(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                    t[a] = arguments[a];
                ...
                { cache: li(r.dateTime), strategy: Qa.variadic }
              ),
              getPluralRules: Ga(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                ...
                { cache: li(r.pluralRules), strategy: Qa.variadic }
              ),
            }));
      }
      return (
    ...
    ci = ui;
  const di = { de: ut, en: mt, es: yt, fr: Et, it: Tt, nl: Pt, no: Lt, sk: Yt };
  function hi(e, t, ...a) {
    const i = t.replace(/['"]+/g, "");
    let n;
    try {
      n = e.split(".").reduce((e, t) => e[t], di[i]);
    } catch (t) {
      n = e.split(".").reduce((e, t) => e[t], di.en);
    }
    if (
      (void 0 === n && (n = e.split(".").reduce((e, t) => e[t], di.en)),
      !a.length)
    )
      return n;
    const s = {};
   ...
   */ class gi extends mi {
    constructor(e) {
      if ((super(e), (this.et = V), e.type !== pi))
        throw Error(
  ...
  function yi(e, t) {
    switch (t) {
      case Ke:
        return e.units == $e ? Y`${fi("mm")}` : Y`${fi("in")}`;
      case We:
        return e.units == $e ? Y`${fi("m<sup>2</sup>")}` : Y`${fi("sq ft")}`;
      case Ze:
        return e.units == $e ? Y`${fi("l/minute")}` : Y`${fi("gal/minute")}`;
      default:
        return Y``;
    }
  }
...
`;
      ...
      if (this.hass && this.config && this.data) {
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autocalcenabled: vi(e.target.value) });
            }}"
      ...
      >`);
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autoupdateenabled: vi(e.target.value) });
            }}"
      ...
      this.hass.language)}">${t}</ha-card>`);
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${(e) => {
              this.saveData({ autoclearenabled: vi(e.target.value) });
            }}"
    ...
    saveData(e) {
      ...
      this.hass &&
        ...
        ((t = this.hass), (a = this.data), t.callApi("POST", _e + "/config", a))
          .catch((e) => _i(e, this.shadowRoot.querySelector("ha-card")))
          .then());
    }
    toggleInformation(e) {
      var t;
  ...
  var $i;
  n([pe()], Ei.prototype, "narrow", void 0),
    n([pe()], Ei.prototype, "path", void 0),
    n([pe()], Ei.prototype, "data", void 0),
    n([pe()], Ei.prototype, "config", void 0),
    (Ei = n([ce("smart-irrigation-view-general")], Ei)),
    (function (e) {
      (e.Disabled = "disabled"),
        (e.Manual = "manual"),
  ...
  (Oi = Ti).exports = (function () {
    ...
    function U(e, t) {
      return e.isValid()
        ? ((t = Y(t, e.localeData())), (j[t] = j[t] || I(t)), j[t](e))
    ...
    function Y(e, t) {
      ...
      for (C.lastIndex = 0; a >= 0 && C.test(e); )
        (e = e.replace(C, i)), (C.lastIndex = 0), (a -= 1);
      return e;
    }
    var G = {
      LTS: "h:mm:ss A",
    ...
    function ce(e, t) {
      return function (i) {
        return null != i
          ? (he(this, e, i), a.updateOffset(this, t), this)
          : de(this, e);
      };
    }
    function de(e, t) {
    ...
    function Pe(e, t) {
      return r(ge, e) ? ge[e](t._strict, t._locale) : new RegExp(Ne(e));
    }
    function Ne(e) {
      return Ce(
        e
    ...
    function Be(e, t) {
      Le(e, function (e, a, i, n) {
        (i._w = i._w || {}), t(e, i._w, i, n);
      });
    }
    function Re(e, t, a) {
      null != t && r(je, e) && je[e](t, a._a, a, e);
    }
    var Ie,
      Ue = 0,
      Ye = 1,
    ...
    function rt(e, t, a) {
      ...
      return a
        ? "MMM" === t
          ? -1 !== (n = Ie.call(this._shortMonthsParse, r))
            ? n
            : null
          : -1 !== (n = Ie.call(this._longMonthsParse, r))
          ? n
          : null
        : "MMM" === t
        ? -1 !== (n = Ie.call(this._shortMonthsParse, r)) ||
    ...
    function wt(e, t, a) {
      ...
      return (
        r < 1
          ? (i = r + kt((n = e.year() - 1), t, a))
          : r > kt(e.year(), t, a)
          ? ((i = r - kt(e.year(), t, a)), (n = e.year() + 1))
          : ((n = e.year()), (i = r)),
        { week: i, year: n }
      );
    }
    ...
    function Lt(e, t) {
      ...
      return !0 === e ? Ht(a, this._week.dow) : e ? a[e.day()] : a;
    }
    function Bt(e) {
      return !0 === e
    ...
    function It(e, t, a) {
      ...
      return a
        ? "dddd" === t
          ? -1 !== (n = Ie.call(this._weekdaysParse, r))
            ? n
            : null
          : "ddd" === t
          ? -1 !== (n = Ie.call(this._shortWeekdaysParse, r))
            ? n
            : null
          : -1 !== (n = Ie.call(this._minWeekdaysParse, r))
          ? n
          : null
        : "dddd" === t
        ? -1 !== (n = Ie.call(this._weekdaysParse, r)) ||
    ...
    function Ft(e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysRegex") || (this._weekdaysRegex = Nt),
    ...
    function Wt(e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Ct),
    ...
    function Zt(e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = jt),
    ...
    function qt() {
      ...
      for (t = 0; t < 7; t++)
        (a = p([2e3, 1]).day(t)),
          (i = Ce(this.weekdaysMin(a, ""))),
          (n = Ce(this.weekdaysShort(a, ""))),
          (s = Ce(this.weekdays(a, ""))),
          r.push(i),
          o.push(n),
          l.push(s),
          u.push(i),
    ...
    B("H", ["HH", 2], 0, "hour"),
      ...
      Le("hmmss", function (e, t, a) {
        var i = e.length - 4,
          n = e.length - 2;
        (t[Ve] = ue(e.substr(0, i))),
          (t[Fe] = ue(e.substr(i, 2))),
          (t[We] = ue(e.substr(n))),
          (g(a).bigHour = !0);
      }),
      Le("Hmm", function (e, t, a) {
        var i = e.length - 2;
        (t[Ve] = ue(e.substr(0, i))), (t[Fe] = ue(e.substr(i)));
      }),
      Le("Hmmss", function (e, t, a) {
        var i = e.length - 4,
          n = e.length - 2;
    ...
    function ha(e) {
      var t = null;
      if (void 0 === ra[e] && Oi && Oi.exports && da(e))
        try {
          (t = na._abbr), Mi("./locale/" + e), pa(t);
        } catch (t) {
          ra[e] = null;
        }
      return ra[e];
    ...
    function ga(e, t) {
      if (null != t) {
        ...
        null != ra[e] && null != ra[e].parentLocale
          ? ra[e].set(D(ra[e]._config, t))
          : (null != (i = ha(e)) && (n = i._config),
            (t = D(n, t)),
            null == i && (t.abbr = e),
            ((a = new H(t)).parentLocale = ra[e]),
            (ra[e] = a)),
          pa(e);
      } else
        null != ra[e] &&
    ...
    function Ha(e, t, a) {
      return (
        !e ||
        zt.indexOf(e) === new Date(t[0], t[1], t[2]).getDay() ||
    ...
    function za(e) {
      var t,
        a = $a.exec(Da(e._i));
      if (a) {
        if (((t = Oa(a[4], a[3], a[2], a[5], a[6], a[7])), !Ha(a[1], t, e)))
          return;
        (e._a = t),
    ...
    function ja(e) {
      ...
      if (!e._d) {
        for (
          i = Ca(e),
            e._w && null == e._a[Ge] && null == e._a[Ye] && La(e),
            null != e._dayOfYear &&
              ((s = Na(e._a[Ue], i[Ue])),
    ...
    function La(e) {
      ...
      null != (t = e._w).GG || null != t.W || null != t.E
        ? ((s = 1),
          (r = 4),
          (a = Na(t.GG, e._a[Ue], wt(Wa(), 1, 4).year)),
          (i = Na(t.W, 1)),
          ((n = Na(t.E, 1)) < 1 || n > 7) && (l = !0))
        : ((s = e._locale._week.dow),
          (r = e._locale._week.doy),
          (u = wt(Wa(), s, r)),
          (a = Na(t.gg, e._a[Ue], u.year)),
          (i = Na(t.w, u.week)),
          null != t.d
            ? ((n = t.d) < 0 || n > 6) && (l = !0)
            : null != t.e
      ...
      if (e._f !== a.ISO_8601)
        if (e._f !== a.RFC_2822) {
          ...
          var t,
            ...
            d = 0;
          for (
            l = (n = Y(e._f, e._locale).match(N) || []).length, t = 0;
            t < l;
            t++
          )
            (s = n[t]),
      ...
      return (
        ...
        null === t || (void 0 === a && "" === t)
          ...
          : ("string" == typeof t && (e._i = t = e._locale.preparse(t)),
            k(t)
              ? new w(ba(t))
              : (c(t) ? (e._d = t) : n(a) ? Ia(e) : a ? Ba(e) : Va(e),
                f(e) || (e._d = null),
                e))
      );
    }
    ...
    function ti(e) {
      var t,
        ...
        n = ei.length;
      for (t in e)
        if (r(e, t) && (-1 === Ie.call(ei, t) || (null != e[t] && isNaN(e[t]))))
          return !1;
      for (a = 0; a < n; ++a)
        if (e[ei[a]]) {
          if (i) return !1;
    ...
    function di(e, t) {
      ...
      return t._isUTC
        ? ((i = t.clone()),
          (n = (k(e) || c(e) ? e.valueOf() : Wa(e).valueOf()) - i.valueOf()),
    ...
    function pi(e, t, i) {
      ...
      if (null != e) {
        if ("string" == typeof e) {
          if (null === (e = ci(De, e))) return this;
        } else Math.abs(e) < 16 && !i && (e *= 60);
        return (
          !this._isUTC && t && (n = hi(this)),
          (this._offset = e),
          (this._isUTC = !0),
          null != n && this.add(n, "m"),
          s !== e &&
            (!t || this._changeInProgress
              ? zi(this, Ai(e - s, "m"), 1, !1)
    ...
    function Hi(e, t) {
      ...
      return e.isValid() && t.isValid()
        ? ((t = di(t, e)),
          e.isBefore(t)
            ? (a = Di(e, t))
            : (((a = Di(t, e)).milliseconds = -a.milliseconds),
              (a.months = -a.months)),
          a)
    ...
    function zi(e, t, i, n) {
      ...
      e.isValid() &&
        ((n = null == n || n),
        o && lt(e, de(e, "Month") + o * i),
        r && he(e, "Date", de(e, "Date") + r * i),
        s && e._d.setTime(e._d.valueOf() + s * i),
        n && a.updateOffset(e, r || o));
    }
    (Ai.fn = ni.prototype), (Ai.invalid = ii);
    var Pi = xi(1, "add"),
      Ni = xi(-1, "subtract");
    function Ci(e) {
    ...
    function ji(e) {
      return k(e) || c(e) || Ci(e) || u(e) || Bi(e) || Li(e) || null == e;
    }
    function Li(e) {
      var t,
        a,
      ...
      1 === arguments.length &&
        (arguments[0]
          ? ji(arguments[0])
            ...
            : Ri(arguments[0]) && ((t = arguments[0]), (e = void 0))
          : ((e = void 0), (t = void 0)));
      var i = e || Wa(),
    ...
    function Ki(e, t, a) {
      ...
      if (!(i = di(e, this)).isValid()) return NaN;
    ...
    function an(e, t) {
      return this.isValid() && ((k(e) && e.isValid()) || Wa(e).isValid())
        ? Ai({ to: this, from: e }).locale(this.locale()).humanize(!t)
    ...
    function sn(e, t) {
      return this.isValid() && ((k(e) && e.isValid()) || Wa(e).isValid())
        ? Ai({ from: this, to: e }).locale(this.locale()).humanize(!t)
        : this.localeData().invalidDate();
    }
    function rn(e) {
      return this.to(Wa(), e);
    ...
    function vn(e) {
      ...
      switch (((i = this._isUTC ? fn : gn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t -= mn(t + (this._isUTC ? 0 : this.utcOffset() * dn), hn));
          break;
        case "minute":
    ...
    function bn(e) {
      ...
      switch (((i = this._isUTC ? fn : gn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t +=
              hn - mn(t + (this._isUTC ? 0 : this.utcOffset() * dn), hn) - 1);
          break;
        case "minute":
    ...
    function Yn() {
      ...
      for (e = 0, t = r.length; e < t; ++e)
        i.push(Ce(r[e].name)),
          a.push(Ce(r[e].abbr)),
          n.push(Ce(r[e].narrow)),
          s.push(Ce(r[e].name)),
          s.push(Ce(r[e].abbr)),
          s.push(Ce(r[e].narrow));
    ...
    function Xn(e, t, a, i, n) {
      ...
      return null == e
        ? wt(this, i, n).year
        : (t > (s = kt(e, i, n)) && (t = s), Jn.call(this, e, t, a, i, n));
    }
    ...
    B("N", 0, 0, "eraAbbr"),
      ...
      ze("NNNN", Rn),
      ze("NNNNN", In),
      Le(["N", "NN", "NNN", "NNNN", "NNNNN"], function (e, t, a, i) {
      ...
      ze("GGGGG", Ae, _e),
      ze("ggggg", Ae, _e),
      Be(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, a, i) {
        t[i.substr(0, 2)] = ue(e);
      }),
      Be(["gg", "GG"], function (e, t, i, n) {
    ...
    for (is = "S"; is.length <= 9; is += "S") Le(is, rs);
    function os() {
    ...
    (us.add = Pi),
      ...
      (us.zoneAbbr = os),
      (us.zoneName = ls),
      (us.dates = E("dates accessor is deprecated. Use date instead.", es)),
      (us.months = E("months accessor is deprecated. Use month instead", ut)),
      (us.years = E("years accessor is deprecated. Use year instead", gt)),
      (us.zone = E(
    ...
    (ps.calendar = z),
      ...
      (ps.monthsParse = ot),
      (ps.monthsRegex = ht),
      (ps.monthsShortRegex = dt),
      (ps.week = St),
      (ps.firstDayOfYear = At),
      (ps.firstDayOfWeek = $t),
      (ps.weekdays = Lt),
      (ps.weekdaysMin = Rt),
      (ps.weekdaysShort = Bt),
      ...
      (a.lang = E("moment.lang is deprecated. Use moment.locale instead.", pa)),
      (a.langData = E(
    ...
    function ur() {
      ...
      return d
        ? ((e = le(l / 60)),
          ...
          (n = d < 0 ? "-" : ""),
          (s = lr(this._months) !== lr(d) ? "-" : ""),
          (r = lr(this._days) !== lr(d) ? "-" : ""),
          (o = lr(this._milliseconds) !== lr(d) ? "-" : ""),
          n +
            "P" +
            (a ? s + a + "Y" : "") +
            (c ? s + c + "M" : "") +
  ...
  var Di = Ai(Ti.exports);
  let Hi = class extends tt(le) {
    constructor() {
      super(...arguments),
        (this.zones = []),
        (this.modules = []),
    ...
    renderTheOptions(e, t) {
      if (this.hass) {
        let a = Y`<option value="" ?selected=${void 0 === t}">---${hi(
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              ...
              ${
                e.last_calculated
                  ? Di(e.last_calculated).format("YYYY-MM-DD HH:mm:ss")
                  : "-"
              }</label
            >
          </div>
          <div class="card-content">
            <label for="last_updated${t}"
              ...
              ${
                e.last_updated
                  ? Di(e.last_updated).format("YYYY-MM-DD HH:mm:ss")
                  : "-"
              }</label
            >
          </div>
          ...
          <div class="card-content">
            ...
            <div class="zoneline">
              ...
              <input
                ...
                .value="${e.duration}"
                ?readonly="${
                  e.state === $i.Disabled || e.state === $i.Automatic
                }"
                @input="${(a) =>
                  this.handleEditZone(
                    t,
      ...
      return this.hass && this.config
        ...
        <ha-card header="${hi("panels.zones.title", this.hass.language)}">
          ...
          <ha-card header="${hi(
            ...
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${hi(
              ...
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${hi(
            ...
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${hi(
            "panels.zones.cards.zone-actions.actions.update-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleCalculateAllZones}">${hi(
            "panels.zones.cards.zone-actions.actions.calculate-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleResetAllBuckets}">${hi(
            "panels.zones.cards.zone-actions.actions.reset-all-buckets",
            this.hass.language
          )}</button>
      <button @click="${this.handleClearAllWeatherdata}">${hi(
  ...
  n([pe()], Hi.prototype, "config", void 0),
    n([pe({ type: Array })], Hi.prototype, "zones", void 0),
    n([pe({ type: Array })], Hi.prototype, "modules", void 0),
    n([pe({ type: Array })], Hi.prototype, "mappings", void 0),
    n([me("#nameInput")], Hi.prototype, "nameInput", void 0),
    n([me("#sizeInput")], Hi.prototype, "sizeInput", void 0),
    n([me("#throughputInput")], Hi.prototype, "throughputInput", void 0),
    (Hi = n([ce("smart-irrigation-view-zones")], Hi));
  let xi = class extends tt(le) {
    constructor() {
      super(...arguments),
        (this.zones = []),
        (this.modules = []),
        ...
        >
          ${Object.entries(i.options).map(
            ([e, a]) => Y`<option
              ...
              >
                ${hi(
                  "panels.modules.cards.module.translated-options." + bi(a, 1),
                  t
                )}
              </option>`
          )}
  ...
  n([pe()], xi.prototype, "config", void 0),
    n([pe({ type: Array })], xi.prototype, "zones", void 0),
    n([pe({ type: Array })], xi.prototype, "modules", void 0),
    n([pe({ type: Array })], xi.prototype, "allmodules", void 0),
    n([me("#moduleInput")], xi.prototype, "moduleInput", void 0),
    (xi = n([ce("smart-irrigation-view-modules")], xi));
  ...
  n([pe()], zi.prototype, "config", void 0),
    n([pe({ type: Array })], zi.prototype, "zones", void 0),
    n([pe({ type: Array })], zi.prototype, "mappings", void 0),
    n([me("#mappingNameInput")], zi.prototype, "mappingNameInput", void 0),
    (zi = n([ce("smart-irrigation-view-mappings")], zi));
  const Pi = () => {
    const e = (e) => {
        let t = {};
  ...
  n([pe({ attribute: !1 })], Ni.prototype, "hass", void 0),
    n(
      [
        (function (e) {
          return pe({ ...e, state: !0 });
