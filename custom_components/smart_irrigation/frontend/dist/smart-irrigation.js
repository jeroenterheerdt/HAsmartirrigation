!(function (e) {
      ...
      : (e) =>
          e instanceof CSSStyleSheet
            ? ((e) => {
                ...
                return ((e) =>
                  new h("string" == typeof e ? e : e + "", void 0, l))(t);
              })(e)
            : e;
  /**
   * @license
  ...
  class S extends HTMLElement {
    ...
    static finalizeStyles(e) {
      ...
      if (Array.isArray(e)) {
        ...
        for (const e of a) t.unshift(d(e));
  ...
  var E;
  (S[w] = !0),
    (S.elementProperties = new Map()),
    (S.elementStyles = []),
    (S.shadowRootOptions = { mode: "open" }),
    null == v || v({ ReactiveElement: S }),
  ...
  const A = window,
    $ = A.trustedTypes,
    M = $ ? $.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
    k = "$lit$",
    ...
    Z = (e, t) => {
      ...
      for (let t = 0; t < a; t++) {
        ...
        for (
          ;
          h < a.length && ((r.lastIndex = h), (l = r.exec(a)), null !== l);
            ...
            r === L
              ...
              ? ">" === l[0]
                ...
                : ((u = r.lastIndex - l[2].length),
                  (o = l[1]),
                  (r = void 0 === l[3] ? R : '"' === l[3] ? j : I))
              : r === j || r === I
              ? (r = R)
              : r === z || r === B
              ? (r = L)
              : ((r = R), (n = void 0));
        const c = r === R && e[t + 1].startsWith("/>") ? " " : "";
        s +=
          r === L
            ? a + H
            : u >= 0
            ? (i.push(o), a.slice(0, u) + k + a.slice(u) + O + c)
            : a + O + (-2 === u ? (i.push(void 0), t) : c);
      }
      const o = s + (e[a] || "<?>") + (2 === t ? "</svg>" : "");
      if (!Array.isArray(e) || !e.hasOwnProperty("raw"))
        throw Error("invalid template strings array");
      return [void 0 !== M ? M.createHTML(o) : o, i];
    };
  class q {
        ...
        if (1 === i.nodeType) {
          if (i.hasAttributes()) {
            ...
            for (const t of i.getAttributeNames())
              if (t.endsWith(k) || t.startsWith(O)) {
                const a = u[s++];
                if ((e.push(t), void 0 !== a)) {
                  const e = i.getAttribute(a.toLowerCase() + k).split(O),
                    t = /([.?@])?(.*)/.exec(a);
                  o.push({
                    type: 1,
                    index: n,
          ...
          if (i.data === T) o.push({ type: 2, index: n });
          else {
            let e = -1;
            for (; -1 !== (e = i.data.indexOf(O, e + 1)); )
              o.push({ type: 7, index: n }), (e += O.length - 1);
          }
        n++;
      }
    }
    ...
    let l =
      void 0 !== i
        ? null === (n = a._$Co) || void 0 === n
          ...
          : n[i]
        : a._$Cl;
    const u = N(t) ? void 0 : t._$litDirective$;
    return (
  ...
  class J {
    ...
    T(e) {
      ...
      for (const n of e)
        i === t.length
          ? t.push((a = new J(this.k(x()), this.k(x()), this, this.options)))
          : (a = t[i]),
          a._$AI(n),
          i++;
    ...
    _$AI(e, t = this, a, i) {
      ...
      if (void 0 === n)
        ...
        for (e = n[0], r = 0; r < n.length - 1; r++)
          (o = K(this, i[a + r], t, r)),
            o === G && (o = this._$AH[r]),
            s || (s = !N(o) || o !== this._$AH[r]),
            o === F
              ? (e = F)
              : e !== F && (e += (null != o ? o : "") + n[r + 1]),
            (this._$AH[r] = o);
      }
      s && !i && this.j(e);
    }
  ...
  class ie extends Q {
    ...
    _$AI(e, t = this) {
      var a;
      if ((e = null !== (a = K(this, e, t, 0)) && void 0 !== a ? a : F) === G)
        return;
      const i = this._$AH,
        n =
          (e === F && i !== F) ||
  ...
  const se = A.litHtmlPolyfillSupport;
  null == se || se(q, J),
  ...
  function pe(e) {
    return (t, a) => (void 0 !== a ? de(e, t, a) : ce(e, t));
    /**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
  ...
  const ye = async () => {
    ...
    je = "unit",
    Ue = "aggregate",
    Ye = ["average", "first", "last", "maximum", "median", "minimum", "sum"],
    Ge = "size",
    Fe = "throughput",
    Ve = "duration",
    We = "bucket",
    Ze = (e) => e.callWS({ type: _e + "/config" }),
    qe = (e) => e.callWS({ type: _e + "/zones" }),
    Ke = (e) => e.callWS({ type: _e + "/modules" }),
    Xe = (e) => e.callWS({ type: _e + "/mappings" }),
    Je = (e) => {
      class t extends e {
        connectedCallback() {
  ...
  var Qe,
    ...
    it = {
        ...
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-update": "(Erster) Update um",
      ...
      mappings: {
        ...
        description:
          "Füge eine oder mehrere Sensorgruppen hinzu, die Wetterdaten von OpenWeatherMap, Sensoren oder einer Kombination daraus abrufen. Jede Sensorgruppe kann für eine oder mehrere Zonen verwendet werden",
    ...
    nt = "Smart Irrigation",
    st = { common: at, panels: it, title: nt },
    rt = Object.freeze({
      __proto__: null,
      common: at,
      panels: it,
    ...
    lt = {
      ...
      mappings: {
        ...
        description:
          "Add one or more sensor groups that retrieve weather data from OpenWeatherMap, from sensors or a combination of these. You can map each sensor group to one or more zones",
        labels: {
          "mapping-name": "Name",
    ...
    ut = "Smart Irrigation",
    ht = { common: ot, panels: lt, title: ut },
    ct = Object.freeze({
      __proto__: null,
      common: ot,
      panels: lt,
    ...
    pt = {
      ...
      mappings: {
        ...
        description:
          "Añada uno o más grupos de sensores que recuperen datos meteorológicos de OpenWeatherMap, de sensores o de una combinación de éstos. Puede asignar cada grupo de sensores a una o más zonas",
    ...
    mt = "Smart Irrigation",
    gt = { common: dt, panels: pt, title: mt },
    ft = Object.freeze({
      __proto__: null,
      common: dt,
      panels: pt,
    ...
    bt = {
      ...
      mappings: {
        ...
        description:
          "Ajouter un ou plusieurs groupes de capteurs qui récupèrent les données météo de OpenWeatherMap, de capteurs locaux ou d'une combinaison de tous ceux-ci. Vous pouvez associer chaque groupe de capteurs avec une ou plusieurs zones",
    ...
    yt = "Smart Irrigation",
    _t = { common: vt, panels: bt, title: yt },
    wt = Object.freeze({
      __proto__: null,
      common: vt,
      panels: bt,
      ...
      mappings: {
        cards: {
          ...
          mapping: {
            ...
            static_value: "Valore",
            "sensor-units": "Il sensore fornisce valori in",
        ...
        description:
          "Aggiungi uno o più gruppi di sensori che recuperano i dati meteorologici da OpenWeatherMap, da sensori o da una combinazione di questi. È possibile mappare ciascun gruppo di sensori su una o più zone",
    ...
    At = "Irrigazione Intelligente",
    $t = { common: St, panels: Et, title: At },
    Mt = Object.freeze({
      __proto__: null,
      common: St,
      panels: Et,
    ...
    Ot = {
      general: {
        cards: {
          ...
          "automatic-update": {
            errors: {
              "warning-update-time-on-or-after-calc-time":
                "Let op: het automatisch bijwerken van weer gegevens vind plaats op of na de automatische berekening van irrigatietijd",
            },
            header: "Automatisch bijwerken van weer gegevens",
            labels: {
              "auto-update-enabled": "Automatisch weergegevens bijwerken",
              "auto-update-first-update": "(Eerste keer) Bijwerken op ",
      ...
      mappings: {
        ...
        description:
          "Voeg een of meer sensorgroepen toe die weergegevens ophalen van OpenWeatherMap, van sensoren of een combinatie. Elke sensorgroep kan worden gebruikt voor een of meerdere zones",
        labels: {
          "mapping-name": "Name",
    ...
    Tt = "Smart Irrigation",
    Ht = { common: kt, panels: Ot, title: Tt },
    Dt = Object.freeze({
      __proto__: null,
      common: kt,
      panels: Ot,
    ...
    Nt = {
      ...
      mappings: {
        ...
        description:
          "Legg til en eller flere sensorgupper som henter værdata fra OpenWeatherMap, fra sensorer eller en kombinasjon av disse. Du kan tilordne hver sensorguppe til en eller flere soner",
    ...
    for (var t = {}, a = 0, n = e; a < n.length; a++) {
      ...
      switch (s.stem) {
        ...
        case "integer-width":
          ...
          s.options[0].replace(Qt, function (e, a, i, n, s, r) {
      ...
      if (ea.test(s.stem)) t.minimumIntegerDigits = s.stem.length;
      else if (Xt.test(s.stem)) {
        if (s.options.length > 1)
          throw new RangeError(
            "Fraction-precision stems only accept a single optional option"
          );
        s.stem.replace(Xt, function (e, a, i, n, s, r) {
          return (
            "*" === i
        ...
        "w" === r
          ...
          : r && (t = i(i({}, t), ta(r)));
      } else if (Jt.test(s.stem)) t = i(i({}, t), ta(s.stem));
      else {
        var o = aa(s.stem);
        o && (t = i(i({}, t), o));
        var l = ia(s.stem);
  ...
  function la(e) {
    ...
    return (
      ...
      (oa[a || ""] || oa[i || ""] || oa["".concat(i, "-001")] || oa["001"])[0]
    );
  }
  var ua = new RegExp("^".concat(Wt.source, "*")),
    ha = new RegExp("".concat(Wt.source, "*$"));
  function ca(e, t) {
    return { start: e, end: t };
  }
  var da = !!String.prototype.startsWith,
    pa = !!String.fromCodePoint,
    ma = !!Object.fromEntries,
    ga = !!String.prototype.codePointAt,
    fa = !!String.prototype.trimStart,
    va = !!String.prototype.trimEnd,
    ba = !!Number.isSafeInteger
  ...
  try {
    ya =
      "a" ===
      (null ===
        (ra = ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
          "a"
        )) || void 0 === ra
        ? void 0
        : ra[0]);
  ...
  if (ya) {
    var Oa = ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    _a = function (e, t) {
      var a;
      return (
        (Oa.lastIndex = t),
        null !== (a = Oa.exec(e)[1]) && void 0 !== a ? a : ""
      );
    };
  } else
    _a = function (e, t) {
      for (var a = []; ; ) {
        var i = Aa(e, t);
        if (void 0 === i || xa(i) || Na(i)) break;
        a.push(i), (t += i >= 65536 ? 2 : 1);
      }
      return Sa.apply(void 0, a);
    };
  var Ta = (function () {
    function e(e, t) {
      void 0 === t && (t = {}),
    ...
    return (
            ...
            if (35 !== n || ("plural" !== t && "selectordinal" !== t)) {
              if (60 === n && !this.ignoreTag && 47 === this.peek()) {
                ...
                return this.error(
                  ...
                  ca(this.clonePosition(), this.clonePosition())
                );
              }
              if (60 === n && !this.ignoreTag && Ha(this.peek() || 0)) {
              ...
              this.bump(),
                i.push({
                  type: et.pound,
                  location: ca(r, this.clonePosition()),
                });
            }
          }
        }
        ...
        if ((this.bumpSpace(), this.bumpIf("/>")))
          return {
            val: {
              type: et.literal,
              value: "<".concat(i, "/>"),
              location: ca(a, this.clonePosition()),
            },
            err: null,
          };
        if (this.bumpIf(">")) {
          ...
          if (this.bumpIf("</")) {
            if (this.isEOF() || !Ha(this.char()))
              return this.error(Qe.INVALID_TAG, ca(r, this.clonePosition()));
            var o = this.clonePosition();
            return i !== this.parseTagName()
              ? this.error(
                  Qe.UNMATCHED_CLOSING_TAG,
                  ca(o, this.clonePosition())
                )
              : (this.bumpSpace(),
                this.bumpIf(">")
                  ? {
                  ...
                  : this.error(Qe.INVALID_TAG, ca(r, this.clonePosition())));
          }
          return this.error(Qe.UNCLOSED_TAG, ca(a, this.clonePosition()));
        }
        return this.error(Qe.INVALID_TAG, ca(a, this.clonePosition()));
      }),
      ...
      (e.prototype.parseLiteral = function (e, t) {
        ...
        var o = ca(a, this.clonePosition());
        return { val: { type: et.literal, value: i, location: o }, err: null };
      }),
      (e.prototype.tryParseLeftAngleBracket = function () {
        return this.isEOF() ||
          60 !== this.char() ||
          (!this.ignoreTag && (Ha((e = this.peek() || 0)) || 47 === e))
          ? null
          : (this.bump(), "<");
        var e;
      }),
      ...
      (e.prototype.parseArgument = function (e, t) {
        ...
        if ((this.bump(), this.bumpSpace(), this.isEOF()))
          return this.error(
            Qe.EXPECT_ARGUMENT_CLOSING_BRACE,
            ca(a, this.clonePosition())
          );
        if (125 === this.char())
          return (
            this.bump(),
            this.error(Qe.EMPTY_ARGUMENT, ca(a, this.clonePosition()))
          );
        var i = this.parseIdentifierIfPossible().value;
        if (!i)
          return this.error(Qe.MALFORMED_ARGUMENT, ca(a, this.clonePosition()));
      ...
      (e.prototype.parseIdentifierIfPossible = function () {
        var e = this.clonePosition(),
          ...
          i = t + a.length;
        return (
          this.bumpTo(i), { value: a, location: ca(e, this.clonePosition()) }
        );
      }),
      (e.prototype.parseArgumentOptions = function (e, t, a, n) {
        ...
        switch (o) {
          case "":
            return this.error(Qe.EXPECT_ARGUMENT_TYPE, ca(r, l));
          case "number":
          case "date":
          case "time":
            this.bumpSpace();
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (m = Ma(b.val)).length)
                return this.error(
                  Qe.EXPECT_ARGUMENT_STYLE,
                  ca(this.clonePosition(), this.clonePosition())
                );
              u = { style: m, styleLocation: ca(h, this.clonePosition()) };
            }
            if ((y = this.tryParseArgumentClose(n)).err) return y;
            var c = ca(n, this.clonePosition());
            if (u && wa(null == u ? void 0 : u.style, "::", 0)) {
              var d = $a(u.style.slice(2));
              if ("number" === o)
              ...
              if (0 === d.length)
                return this.error(Qe.EXPECT_DATE_TIME_SKELETON, c);
              var p = d;
              this.locale &&
                (p = (function (e, t) {
              ...
              var m = {
                ...
                parsedOptions: this.shouldParseSkeletons ? qt(p) : {},
              };
              return {
                val: {
                  type: "date" === o ? et.date : et.time,
                  value: a,
                  location: c,
                  style: m,
                },
            ...
            return {
              val: {
                type:
                  "number" === o ? et.number : "date" === o ? et.date : et.time,
                value: a,
                location: c,
                style:
          ...
          case "select":
            ...
            if ((this.bumpSpace(), !this.bumpIf(",")))
              return this.error(
                Qe.EXPECT_SELECT_ARGUMENT_OPTIONS,
                ca(g, i({}, g))
              );
            this.bumpSpace();
          ...
          default:
            return this.error(Qe.INVALID_ARGUMENT_TYPE, ca(r, l));
        }
      }),
        ...
        for (var e = 0, t = this.clonePosition(); !this.isEOF(); ) {
          switch (this.char()) {
            case 39:
              ...
              if (!this.bumpUntil("'"))
                return this.error(
                  Qe.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                  ca(a, this.clonePosition())
                );
              this.bump();
              break;
      ...
      (e.prototype.parseNumberSkeletonFromString = function (e, t) {
        ...
        try {
          ...
          return this.error(Qe.INVALID_NUMBER_SKELETON, t);
        }
        return {
          val: {
            type: tt.number,
            tokens: a,
            location: t,
            parsedOptions: this.shouldParseSkeletons ? sa(a) : {},
          },
          err: null,
        };
      }),
      (e.prototype.tryParsePluralOrSelectOptions = function (e, t, a, i) {
        for (
          ...
          if (m.err) return m;
          r.push([l, { value: p.val, location: ca(d, this.clonePosition()) }]),
            o.add(l),
            this.bumpSpace(),
      ...
      (e.prototype.bumpIf = function (e) {
        if (wa(this.message, e, this.offset())) {
      ...
      (e.prototype.bumpSpace = function () {
        for (; !this.isEOF() && xa(this.char()); ) this.bump();
      }),
  ...
  function Pa(e) {
    e.forEach(function (e) {
      if ((delete e.location, jt(e) || Ut(e)))
        for (var t in e.options)
          delete e.options[t].location, Pa(e.options[t].value);
      else
        (Bt(e) && Ft(e.style)) || ((Rt(e) || It(e)) && Vt(e.style))
  ...
  function Ca(e, t) {
    ...
    var a = new Ta(e, t).parse();
    if (a.err) {
      var n = SyntaxError(Qe[a.err.kind]);
      throw (
        ((n.location = a.err.location), (n.originalMessage = a.err.message), n)
      );
    }
    return (null == t ? void 0 : t.captureLocation) || Pa(a.val), a.val;
  }
  function La(e, t) {
    var a = t && t.cache ? t.cache : Ga,
      i = t && t.serializer ? t.serializer : ja;
    return (t && t.strategy ? t.strategy : Ia)(e, { cache: a, serializer: i });
  }
  function za(e, t, a, i) {
    var n,
      s =
  ...
  var Ya,
    ...
    Fa = {
      variadic: function (e, t) {
        return Ra(e, this, Ba, t.cache.create(), t.serializer);
      },
      monadic: function (e, t) {
        return Ra(e, this, za, t.cache.create(), t.serializer);
      },
    };
  !(function (e) {
  ...
  function Ja(e, t, a, i, n, s, r) {
    if (1 === e.length && Lt(e[0]))
      return [{ type: Va.literal, value: e[0].value }];
    for (var o = [], l = 0, u = e; l < u.length; l++) {
      var h = u[l];
      if (Lt(h)) o.push({ type: Va.literal, value: h.value });
      else if (Yt(h))
        "number" == typeof s &&
          o.push({ type: Va.literal, value: a.getNumberFormat(t).format(s) });
      else {
        var c = h.value;
        if (!n || !(c in n)) throw new Ka(c, r);
        var d = n[c];
        if (zt(h))
          (d && "string" != typeof d && "number" != typeof d) ||
            (d = "string" == typeof d || "number" == typeof d ? String(d) : ""),
            o.push({
              type: "string" == typeof d ? Va.literal : Va.object,
              value: d,
            });
        else if (Rt(h)) {
          var p =
          ...
          o.push({
            type: Va.literal,
            value: a.getDateTimeFormat(t, p).format(d),
          });
        } else if (It(h)) {
          p =
            "string" == typeof h.style
          ...
          (p =
            ...
            o.push({
              type: Va.literal,
              value: a.getNumberFormat(t, p).format(d),
            });
        } else {
          if (Gt(h)) {
            var m = h.children,
              g = h.value,
              f = n[g];
            if (!Xa(f)) throw new qa(g, "function", r);
            var v = f(
              Ja(m, t, a, i, n, s).map(function (e) {
                return e.value;
              })
            );
            Array.isArray(v) || (v = [v]),
              o.push.apply(
                ...
                v.map(function (e) {
                  return {
                    type: "string" == typeof e ? Va.literal : Va.object,
                    value: e,
                  };
                })
              );
          ...
          if (jt(h)) {
            if (!(b = h.options[d] || h.options.other))
              throw new Za(h.value, d, Object.keys(h.options), r);
            o.push.apply(o, Ja(b.value, t, a, i, n));
          } else if (Ut(h)) {
            var b;
            if (!(b = h.options["=".concat(d)])) {
              if (!Intl.PluralRules)
                throw new Wa(
            ...
            if (!b) throw new Za(h.value, d, Object.keys(h.options), r);
            o.push.apply(o, Ja(b.value, t, a, i, n, d - (h.offset || 0)));
          } else;
        }
      }
    }
    return (function (e) {
      return e.length < 2
        ...
        : e.reduce(function (e, t) {
            var a = e[e.length - 1];
            return (
              a && a.type === Va.literal && t.type === Va.literal
                ? (a.value += t.value)
                : e.push(t),
              e
            );
  ...
  var ti = (function () {
          ...
          (this.formatters =
              ...
              (r = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: La(
                ...
                { cache: ei(r.number), strategy: Fa.variadic }
              ),
              getDateTimeFormat: La(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                    t[a] = arguments[a];
                ...
                { cache: ei(r.dateTime), strategy: Fa.variadic }
              ),
              getPluralRules: La(
                function () {
                  for (var e, t = [], a = 0; a < arguments.length; a++)
                ...
                { cache: ei(r.pluralRules), strategy: Fa.variadic }
              ),
            }));
      }
      return (
    ...
    ai = ti;
  const ii = { de: rt, en: ct, es: ft, fr: wt, it: Mt, nl: Dt, no: Ct };
  function ni(e, t, ...a) {
    const i = t.replace(/['"]+/g, "");
    let n;
    try {
      n = e.split(".").reduce((e, t) => e[t], ii[i]);
    } catch (t) {
      n = e.split(".").reduce((e, t) => e[t], ii.en);
    }
    if (
      (void 0 === n && (n = e.split(".").reduce((e, t) => e[t], ii.en)),
      !a.length)
    )
      return n;
    const s = {};
   ...
   */ class oi extends ri {
    constructor(e) {
      if ((super(e), (this.et = F), e.type !== si))
        throw Error(
  ...
  function ci(e, t) {
    switch (t) {
      case Ge:
        return e.units == $e ? Y`${li("m<sup>2</sup>")}` : Y`${li("sq ft")}`;
      case Fe:
        return e.units == $e ? Y`${li("l/minute")}` : Y`${li("gal/minute")}`;
      default:
        return Y``;
    }
  }
...
`;
  let mi = class extends Je(le) {
    ...
    async _fetchData() {
      var e, t;
      this.hass &&
        ((this.config = await Ze(this.hass)),
        (this.data =
          ((e = this.config),
          (t = [
            "calctime",
    ...
    render() {
      if (this.hass && this.config && this.data) {
        ...
        <input
          ...
          @change="${(e) => {
            this.saveData({ autocalcenabled: ui(e.target.value) });
          }}"
        ...
        <input
          ...
          @change="${(e) => {
            this.saveData({ autoupdateenabled: ui(e.target.value) });
          }}"
        ...
        this.data.autoupdateenabled &&
          ...
          <div class="card-content">
            ...
            <input
              ...
              @input=${(e) => {
                this.saveData({ autoupdatefirsttime: e.target.value });
              }}
            />
          </div>`),
          this.data.autoupdateenabled &&
            ...
            this.data.calctime &&
            this.data.autoupdatefirsttime >= this.data.calctime &&
            (e = Y`${e}
            <div class="card-content">
              ${ni(
    ...
    saveData(e) {
      ...
      this.hass &&
        ...
        ((t = this.hass), (a = this.data), t.callApi("POST", _e + "/config", a))
          .catch((e) => di(e, this.shadowRoot.querySelector("ha-card")))
          .then());
    }
    static get styles() {
      return c`
  ...
  n([pe()], mi.prototype, "narrow", void 0),
    n([pe()], mi.prototype, "path", void 0),
    n([pe()], mi.prototype, "data", void 0),
    n([pe()], mi.prototype, "config", void 0),
    (mi = n([he("smart-irrigation-view-general")], mi));
  var gi,
    fi =
  ...
  (yi = _i).exports = (function () {
    ...
    function f(e) {
      if (null == e._isValid) {
        var a = g(e),
          i = t.call(a.parsedDateParts, function (e) {
            return null != e;
          }),
          n =
            !isNaN(e._d.getTime()) &&
    ...
    function _(e, t) {
      ...
      if (
        ...
        for (a = 0; a < s; a++) l((n = t[(i = b[a])])) || (e[i] = n);
      return e;
    }
    function w(e) {
      _(this, e),
    ...
    function A(e, t) {
      ...
      return d(function () {
        if (
          (null != a.deprecationHandler && a.deprecationHandler(null, e), i)
        ) {
          var n,
            s,
            o,
          ...
          for (s = 0; s < u; s++) {
            if (((n = ""), "object" == typeof arguments[s])) {
              for (o in ((n += "\n[" + s + "] "), arguments[0]))
                r(arguments[0], o) && (n += o + ": " + arguments[0][o] + ", ");
              n = n.slice(0, -2);
            } else n = arguments[s];
            l.push(n);
          }
    ...
    function T(e) {
      var t, a;
      for (a in e)
        r(e, a) && (O((t = e[a])) ? (this[a] = t) : (this["_" + a] = t));
      (this._config = e),
    ...
    function H(e, t) {
      ...
      for (a in t)
        r(t, a) &&
          (s(e[a]) && s(t[a])
            ? ((i[a] = {}), d(i[a], e[a]), d(i[a], t[a]))
            : null != t[a]
            ? (i[a] = t[a])
            : delete i[a]);
      for (a in e) r(e, a) && !r(t, a) && s(e[a]) && (i[a] = d({}, i[a]));
      return i;
    }
    function D(e) {
      null != e && this.set(e);
    ...
    function U(e, t) {
      return e.isValid()
        ? ((t = Y(t, e.localeData())), (z[t] = z[t] || j(t)), z[t](e))
    ...
    function Y(e, t) {
      ...
      for (L.lastIndex = 0; a >= 0 && L.test(e); )
        (e = e.replace(L, i)), (L.lastIndex = 0), (a -= 1);
      return e;
    }
    var G = {
      LTS: "h:mm:ss A",
    ...
    function ie(e) {
      var t,
        a,
        i = {};
      for (a in e) r(e, a) && (t = ae(a)) && (i[t] = e[a]);
      return i;
    }
    var ne = {};
    function se(e, t) {
    ...
    function re(e) {
      var t,
        a = [];
      for (t in e) r(e, t) && a.push({ unit: t, priority: ne[t] });
      return (
        a.sort(function (e, t) {
    ...
    function he(e, t) {
      return function (i) {
        return null != i
          ? (de(this, e, i), a.updateOffset(this, t), this)
          : ce(this, e);
      };
    }
    function ce(e, t) {
    ...
    function Pe(e, t) {
      return r(ge, e) ? ge[e](t._strict, t._locale) : new RegExp(Ce(e));
    }
    function Ce(e) {
      return Le(
        e
    ...
    function Je(e, t) {
      ...
      var a = Xe(t, 12);
      return (
        (e += (t - a) / 12), 1 === a ? (oe(e) ? 29 : 28) : 31 - ((a % 7) % 2)
      );
    }
    (je = Array.prototype.indexOf
      ...
      Be(["MMM", "MMMM"], function (e, t, a, i) {
        ...
        null != n ? (t[Ye] = n) : (g(a).invalidMonth = e);
      });
    var Qe =
    ...
    function rt(e, t, a) {
      ...
      return a
        ? "MMM" === t
          ? -1 !== (n = je.call(this._shortMonthsParse, r))
            ? n
            : null
          : -1 !== (n = je.call(this._longMonthsParse, r))
          ? n
          : null
        : "MMM" === t
        ? -1 !== (n = je.call(this._shortMonthsParse, r)) ||
    ...
    function ot(e, t, a) {
      var i, n, s;
      if (this._monthsParseExact) return rt.call(this, e, t, a);
      for (
        this._monthsParse ||
          ((this._monthsParse = []),
          (this._longMonthsParse = []),
    ...
    function ut(e) {
      return null != e
        ? (lt(this, e), a.updateOffset(this, !0), this)
        : ce(this, "Month");
    }
    function ht() {
    ...
    function ct(e) {
      return this._monthsParseExact
        ? (r(this, "_monthsRegex") || pt.call(this),
          e ? this._monthsShortStrictRegex : this._monthsShortRegex)
        : (r(this, "_monthsShortRegex") || (this._monthsShortRegex = at),
    ...
    function dt(e) {
      return this._monthsParseExact
        ...
        : (r(this, "_monthsRegex") || (this._monthsRegex = it),
    ...
    R("Y", 0, 0, function () {
      ...
      Be("YYYY", function (e, t) {
        t[Ue] = 2 === e.length ? a.parseTwoDigitYear(e) : ue(e);
      }),
      Be("YY", function (e, t) {
    ...
    function jt(e, t, a) {
      ...
      return a
        ? "dddd" === t
          ? -1 !== (n = je.call(this._weekdaysParse, r))
            ? n
            : null
          : "ddd" === t
          ? -1 !== (n = je.call(this._shortWeekdaysParse, r))
            ? n
            : null
          : -1 !== (n = je.call(this._minWeekdaysParse, r))
          ? n
          : null
        : "dddd" === t
        ? -1 !== (n = je.call(this._weekdaysParse, r)) ||
    ...
    function Vt(e) {
      return this._weekdaysParseExact
        ? (r(this, "_weekdaysRegex") || qt.call(this),
          e ? this._weekdaysStrictRegex : this._weekdaysRegex)
        : (r(this, "_weekdaysRegex") || (this._weekdaysRegex = Ct),
    ...
    function Wt(e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Lt),
    ...
    function Zt(e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = zt),
    ...
    function qt() {
      ...
      for (t = 0; t < 7; t++)
        (a = p([2e3, 1]).day(t)),
          (i = Le(this.weekdaysMin(a, ""))),
          (n = Le(this.weekdaysShort(a, ""))),
          (s = Le(this.weekdays(a, ""))),
          r.push(i),
          o.push(n),
          l.push(s),
          u.push(i),
    ...
    R("H", ["HH", 2], 0, "hour"),
      ...
      R("hmmss", 0, 0, function () {
        return (
          "" + Kt.apply(this) + P(this.minutes(), 2) + P(this.seconds(), 2)
        );
      }),
      R("Hmm", 0, 0, function () {
      ...
      Be(["h", "hh"], function (e, t, a) {
        (t[Fe] = ue(e)), (g(a).bigHour = !0);
      }),
      Be("hmm", function (e, t, a) {
        var i = e.length - 2;
        (t[Fe] = ue(e.substr(0, i))),
          (t[Ve] = ue(e.substr(i))),
          (g(a).bigHour = !0);
      }),
      Be("hmmss", function (e, t, a) {
        var i = e.length - 4,
          n = e.length - 2;
        (t[Fe] = ue(e.substr(0, i))),
          (t[Ve] = ue(e.substr(i, 2))),
          (t[We] = ue(e.substr(n))),
          (g(a).bigHour = !0);
      }),
      Be("Hmm", function (e, t, a) {
        var i = e.length - 2;
        (t[Fe] = ue(e.substr(0, i))), (t[Ve] = ue(e.substr(i)));
      }),
      Be("Hmmss", function (e, t, a) {
        var i = e.length - 4,
          n = e.length - 2;
    ...
    function ha(e) {
      for (var t, a, i, n, s = 0; s < e.length; ) {
        for (
          t = (n = ua(e[s]).split("-")).length,
            a = (a = ua(e[s + 1])) ? a.split("-") : null;
          t > 0;

        ) {
          if ((i = da(n.slice(0, t).join("-")))) return i;
    ...
    function da(e) {
      var t = null;
      if (void 0 === ra[e] && yi && yi.exports && ca(e))
        try {
          (t = na._abbr), bi("./locale/" + e), pa(t);
        } catch (t) {
          ra[e] = null;
        }
      return ra[e];
    ...
    function ma(e, t) {
      if (null !== t) {
        ...
        if (((t.abbr = e), null != ra[e]))
          ...
          if (null != ra[t.parentLocale]) i = ra[t.parentLocale]._config;
          else {
            if (null == (a = da(t.parentLocale)))
              return (
    ...
    function ga(e, t) {
      if (null != t) {
        var a,
          i,
          n = sa;
        null != ra[e] && null != ra[e].parentLocale
          ? ra[e].set(H(ra[e]._config, t))
          : (null != (i = da(e)) && (n = i._config),
            (t = H(n, t)),
            null == i && (t.abbr = e),
            ((a = new D(t)).parentLocale = ra[e]),
            (ra[e] = a)),
          pa(e);
      } else
        null != ra[e] &&
          (null != ra[e].parentLocale
            ? ((ra[e] = ra[e].parentLocale), e === pa() && pa(e))
            : null != ra[e] && delete ra[e]);
      return ra[e];
    }
    function fa(e) {
      var t;
      ...
      return (
        a &&
          ...
          ((t =
            a[Ye] < 0 || a[Ye] > 11
              ? Ye
              : a[Ge] < 1 || a[Ge] > Je(a[Ue], a[Ye])
              ? Ge
              : a[Fe] < 0 ||
                a[Fe] > 24 ||
                (24 === a[Fe] && (0 !== a[Ve] || 0 !== a[We] || 0 !== a[Ze]))
              ? Fe
              : a[Ve] < 0 || a[Ve] > 59
              ? Ve
              : a[We] < 0 || a[We] > 59
              ...
              ? Ze
              : -1),
          g(e)._overflowDayOfYear && (t < Ue || t > Ge) && (t = Ge),
    ...
    function Da(e, t, a) {
      return (
        ...
        ((g(a).weekdayMismatch = !0), (a._isValid = !1), !1)
      );
    }
    function xa(e, t, a) {
      if (e) return Ma[e];
    ...
    function za(e) {
      ...
      if (!e._d) {
        for (
          i = La(e),
            e._w && null == e._a[Ge] && null == e._a[Ye] && Ba(e),
            null != e._dayOfYear &&
              ((s = Ca(e._a[Ue], i[Ue])),
              (e._dayOfYear > mt(s) || 0 === e._dayOfYear) &&
                (g(e)._overflowDayOfYear = !0),
              (a = bt(s, 0, e._dayOfYear)),
        ...
        24 === e._a[Fe] &&
          ...
          (e._d = (e._useUTC ? bt : vt).apply(null, r)),
    ...
    function Ba(e) {
      ...
      null != (t = e._w).GG || null != t.W || null != t.E
        ? ((s = 1),
          (r = 4),
          (a = Ca(t.GG, e._a[Ue], wt(Wa(), 1, 4).year)),
          (i = Ca(t.W, 1)),
          ((n = Ca(t.E, 1)) < 1 || n > 7) && (l = !0))
        : ((s = e._locale._week.dow),
          (r = e._locale._week.doy),
          (u = wt(Wa(), s, r)),
          (a = Ca(t.gg, e._a[Ue], u.year)),
          (i = Ca(t.w, u.week)),
          null != t.d
            ? ((n = t.d) < 0 || n > 6) && (l = !0)
            : null != t.e
      ...
      if (e._f !== a.ISO_8601)
        if (e._f !== a.RFC_2822) {
          ...
          var t,
            ...
            c = 0;
          for (
            l = (n = Y(e._f, e._locale).match(C) || []).length, t = 0;
            t < l;
            t++
          )
            (s = n[t]),
              (i = (u.match(Pe(s, e)) || [])[0]) &&
                ...
                (c += i.length)),
              B[s]
                ? (i ? (g(e).empty = !1) : g(e).unusedTokens.push(s),
                  Ie(s, i, e))
                : e._strict && !i && g(e).unusedTokens.push(s);
          (g(e).charsLeftOver = h - c),
            ...
            (e._a[Fe] = Ia(e._locale, e._a[Fe], e._meridiem)),
            null !== (o = g(e).era) &&
    ...
    function Ia(e, t, a) {
      ...
      return null == a
        ...
        ? e.meridiemHour(t, a)
        : null != e.isPM
        ? ((i = e.isPM(a)) && t < 12 && (t += 12), i || 12 !== t || (t = 0), t)
        : t;
    }
    function ja(e) {
      var t,
      ...
      return (
        ...
        null === t || (void 0 === a && "" === t)
          ...
          : ("string" == typeof t && (e._i = t = e._locale.preparse(t)),
            S(t)
              ? new w(ba(t))
              : (h(t) ? (e._d = t) : n(a) ? ja(e) : a ? Ra(e) : Fa(e),
                f(e) || (e._d = null),
                e))
      );
    }
    ...
    function Va(e, t, a, i, r) {
      ...
      return (
        ...
        ((s(e) && o(e)) || (n(e) && 0 === e.length)) && (e = void 0),
    ...
    function ti(e) {
      var t,
        ...
        n = ei.length;
      for (t in e)
        if (r(e, t) && (-1 === je.call(ei, t) || (null != e[t] && isNaN(e[t]))))
          return !1;
      for (a = 0; a < n; ++a)
        if (e[ei[a]]) {
          if (i) return !1;
          parseFloat(e[ei[a]]) !== ue(e[ei[a]]) && (i = !0);
        }
      return !0;
    }
    function ai() {
    ...
    function ci(e, t) {
      ...
      return t._isUTC
        ? ((i = t.clone()),
          (n = (S(e) || h(e) ? e.valueOf() : Wa(e).valueOf()) - i.valueOf()),
    ...
    function pi(e, t, i) {
      ...
      if (null != e) {
        ...
        return (
          !this._isUTC && t && (n = di(this)),
          (this._offset = e),
          (this._isUTC = !0),
          null != n && this.add(n, "m"),
          s !== e &&
            (!t || this._changeInProgress
              ? Ni(this, Oi(e - s, "m"), 1, !1)
    ...
    function _i(e) {
      return (
        !!this.isValid() &&
        ((e = e ? Wa(e).utcOffset() : 0), (this.utcOffset() - e) % 60 == 0)
      );
    }
    function wi() {
      return (
    ...
    function Si() {
      ...
      return (
        _(t, this),
        (t = Ga(t))._a
          ? ((e = t._isUTC ? p(t._a) : Wa(t._a)),
            (this._isDSTShifted = this.isValid() && oi(t._a, e.toArray()) > 0))
    ...
    function Oi(e, t) {
      ...
      return (
        si(e)
          ...
          : "object" == typeof s &&
            ("from" in s || "to" in s) &&
            ((n = Di(Wa(s.from), Wa(s.to))),
            ((s = {}).ms = n.milliseconds),
            (s.M = n.months)),
        (i = new ni(s)),
        si(e) && r(e, "_locale") && (i._locale = e._locale),
        si(e) && r(e, "_isValid") && (i._isValid = e._isValid),
        i
      );
    }
    function Ti(e, t) {
    ...
    function Di(e, t) {
      ...
      return e.isValid() && t.isValid()
        ? ((t = ci(t, e)),
          e.isBefore(t)
            ? (a = Hi(e, t))
            : (((a = Hi(t, e)).milliseconds = -a.milliseconds),
              (a.months = -a.months)),
          a)
    ...
    function Ni(e, t, i, n) {
      ...
      e.isValid() &&
        ((n = null == n || n),
        o && lt(e, ce(e, "Month") + o * i),
        r && de(e, "Date", ce(e, "Date") + r * i),
        s && e._d.setTime(e._d.valueOf() + s * i),
        n && a.updateOffset(e, r || o));
    }
    (Oi.fn = ni.prototype), (Oi.invalid = ii);
    var Pi = xi(1, "add"),
      Ci = xi(-1, "subtract");
    function Li(e) {
    ...
    function zi(e) {
      return S(e) || h(e) || Li(e) || u(e) || Ri(e) || Bi(e) || null == e;
    }
    function Bi(e) {
      var t,
        a,
    ...
    function an(e, t) {
      return this.isValid() && ((S(e) && e.isValid()) || Wa(e).isValid())
    ...
    function vn(e) {
      ...
      switch (((i = this._isUTC ? fn : gn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t -= mn(t + (this._isUTC ? 0 : this.utcOffset() * cn), dn));
          break;
        case "minute":
    ...
    function bn(e) {
      ...
      switch (((i = this._isUTC ? fn : gn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t +=
              dn - mn(t + (this._isUTC ? 0 : this.utcOffset() * cn), dn) - 1);
          break;
        case "minute":
      ...
      for (i = 0, n = r.length; i < n; ++i)
        switch (
          ("string" == typeof r[i].since &&
            ((s = a(r[i].since).startOf("day")), (r[i].since = s.valueOf())),
          typeof r[i].until)
        ) {
          case "undefined":
            r[i].until = 1 / 0;
            break;
          case "string":
            (s = a(r[i].until).startOf("day").valueOf()),
              (r[i].until = s.valueOf());
        }
      return r;
    }
    ...
    function Cn() {
      ...
      for (e = 0, t = s.length; e < t; ++e)
        if (
          ...
          return (this.year() - a(s[e].since).year()) * i + s[e].offset;
      return this.year();
    }
    function Ln(e) {
      return (
        r(this, "_erasNameRegex") || Yn.call(this),
        e ? this._erasNameRegex : this._erasRegex
      );
    }
    function zn(e) {
      return (
        r(this, "_erasAbbrRegex") || Yn.call(this),
        e ? this._erasAbbrRegex : this._erasRegex
      );
    }
    function Bn(e) {
      return (
        r(this, "_erasNarrowRegex") || Yn.call(this),
    ...
    function Yn() {
      ...
      for (e = 0, t = r.length; e < t; ++e)
        i.push(Le(r[e].name)),
          a.push(Le(r[e].abbr)),
          n.push(Le(r[e].narrow)),
          s.push(Le(r[e].name)),
          s.push(Le(r[e].abbr)),
          s.push(Le(r[e].narrow));
    ...
    R("N", 0, 0, "eraAbbr"),
      ...
      Ne("GGGGG", Me, _e),
      Ne("ggggg", Me, _e),
      Re(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, a, i) {
        t[i.substr(0, 2)] = ue(e);
      }),
      Re(["gg", "GG"], function (e, t, i, n) {
    ...
    (us.add = Pi),
      ...
      (us.months = A("months accessor is deprecated. Use month instead", ut)),
      (us.years = A("years accessor is deprecated. Use year instead", gt)),
      (us.zone = A(
    ...
    (ps.calendar = N),
      ...
      (ps.eras = Tn),
      (ps.erasParse = Hn),
      (ps.erasConvertYear = Dn),
      (ps.erasAbbrRegex = zn),
      (ps.erasNameRegex = Ln),
      (ps.erasNarrowRegex = Bn),
      (ps.months = nt),
      (ps.monthsShort = st),
      (ps.monthsParse = ot),
      (ps.monthsRegex = dt),
      (ps.monthsShortRegex = ct),
      (ps.week = Et),
      ...
      (ps.weekdaysParse = Ut),
      (ps.weekdaysRegex = Vt),
      (ps.weekdaysShortRegex = Wt),
      (ps.weekdaysMinRegex = Zt),
      (ps.isPM = ea),
      (ps.meridiem = ia),
      pa("en", {
        eras: [
      ...
      (a.lang = A("moment.lang is deprecated. Use moment.locale instead.", pa)),
      (a.langData = A(
    ...
    function Ds(e) {
      ...
      if ("month" === (e = ae(e)) || "quarter" === e || "year" === e)
        switch (((t = this._days + i / 864e5), (a = this._months + Ts(t)), e)) {
          case "month":
            return a;
          case "quarter":
            return a / 3;
    ...
    function sr(e, t) {
      return (
        void 0 !== tr[e] &&
        (void 0 === t ? tr[e] : ((tr[e] = t), "s" === e && (tr.ss = t - 1), !0))
      );
    }
    function rr(e, t) {
    ...
    return (
      ...
      (a.weekdaysShort = _s),
      (a.normalizeUnits = ae),
      (a.relativeTimeRounding = nr),
      (a.relativeTimeThreshold = sr),
      (a.calendarFormat = ji),
      (a.prototype = us),
      (a.HTML5_FMT = {
  ...
  var wi = vi(_i.exports);
  let Si = class extends Je(le) {
    constructor() {
      super(...arguments),
        (this.zones = []),
        (this.modules = []),
    ...
    async _fetchData() {
      this.hass &&
        ((this.config = await Ze(this.hass)),
        (this.zones = await qe(this.hass)),
        (this.modules = await Ke(this.hass)),
        (this.mappings = await Xe(this.hass)));
    }
    ...
    renderTheOptions(e, t) {
      if (this.hass) {
        let a = Y`<option value="" ?selected=${void 0 === t}">---${ni(
      ...
      if (this.hass) {
        ...
        const s = Y` <svg
          ...
          @click="${() =>
            this.handleEditZone(
              t,
              Object.assign(Object.assign({}, e), { [We]: 0 })
            )}"}"
        >
          <title>
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <label for="last_calculated${t}"
              ...
              ${
                e.last_calculated
                  ? wi(e.last_calculated).format("YYYY-MM-DD HH:mm:ss")
                  : "-"
              }</label
            >
          </div>
          <div class="card-content">
            ...
            <div class="zoneline">
              ...
              <input
                ...
                .value="${e.duration}"
                ?readonly="${
                  e.state === gi.Disabled || e.state === gi.Automatic
                }"
                @input="${(a) =>
                  this.handleEditZone(
                    t,
                    Object.assign(Object.assign({}, e), {
                      [Ve]: parseInt(a.target.value, 10),
                    })
                  )}"
              />
            </div>
      ...
      return this.hass && this.config
        ...
        <ha-card header="${ni("panels.zones.title", this.hass.language)}">
          ...
          <ha-card header="${ni(
            ...
            <div class="card-content">
              <div class="zoneline"><label for="nameInput">${ni(
              ...
              <div class="zoneline">
              <button @click="${this.handleAddZone}">${ni(
            ...
            <div class="card-content">
                <button @click="${this.handleUpdateAllZones}">${ni(
            "panels.zones.cards.zone-actions.actions.update-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleCalculateAllZones}">${ni(
            "panels.zones.cards.zone-actions.actions.calculate-all",
            this.hass.language
          )}</button>
                <button @click="${this.handleResetAllBuckets}">${ni(
  ...
  n([pe()], Si.prototype, "config", void 0),
    n([pe({ type: Array })], Si.prototype, "zones", void 0),
    n([pe({ type: Array })], Si.prototype, "modules", void 0),
    n([pe({ type: Array })], Si.prototype, "mappings", void 0),
    n([me("#nameInput")], Si.prototype, "nameInput", void 0),
    n([me("#sizeInput")], Si.prototype, "sizeInput", void 0),
    n([me("#throughputInput")], Si.prototype, "throughputInput", void 0),
    (Si = n([he("smart-irrigation-view-zones")], Si));
  let Ei = class extends Je(le) {
    constructor() {
      super(...arguments),
        (this.zones = []),
        (this.modules = []),
    ...
    saveToHA(e) {
      var t, a;
      this.hass &&
        ((t = this.hass), (a = e), t.callApi("POST", _e + "/modules", a));
    }
    renderModule(e, t) {
      if (this.hass) {
        ...
        >
          ...
          ${Object.entries(i.options).map(
            ([e, a]) => Y`<option
              ...
              >
                ${ni(
                  "panels.modules.cards.module.translated-options." + hi(a, 1),
                  t
                )}
              </option>`
          )}
  ...
  n([pe()], Ei.prototype, "config", void 0),
    n([pe({ type: Array })], Ei.prototype, "zones", void 0),
    n([pe({ type: Array })], Ei.prototype, "modules", void 0),
    n([pe({ type: Array })], Ei.prototype, "allmodules", void 0),
    n([me("#moduleInput")], Ei.prototype, "moduleInput", void 0),
    (Ei = n([he("smart-irrigation-view-modules")], Ei));
  let Ai = class extends Je(le) {
    constructor() {
    ...
    saveToHA(e) {
      var t, a;
      this.hass &&
        ((t = this.hass), (a = e), t.callApi("POST", _e + "/mappings", a));
    }
    renderMapping(e, t) {
      if (this.hass) {
        ...
        <div class="card-content">
            <label for="last_calculated${t}"
              ...
              ${
                e.data_last_updated
                  ? wi(e.data_last_updated).format("YYYY-MM-DD HH:mm:ss")
                  : "-"
              }</label
            >
          </div>
    ...
    renderMappingSetting(e, t) {
      ...
      <div class="mappingsettingline">
        ...
        let l = "";
        (null === (a = this.config) || void 0 === a ? void 0 : a.use_owm) ||
          (l = "strikethrough"),
          (o = Y`${o}
        <input
          type="radio"
          ...
          name="${t + e + Be}"
          ?enabled="${
            null === (i = this.config) || void 0 === i ? void 0 : i.use_owm
          }"
          ?checked="${
            (null === (n = this.config) || void 0 === n ? void 0 : n.use_owm) &&
            r[Be] === Pe
          }"
          @change="${(a) =>
            this.handleEditMapping(
      ...
      if (this.hass && this.config) {
        const a = (function (e) {
          switch (e) {
            ...
            case Oe:
              return [{ unit: "%", system: [$e, Ae] }];
            case He:
              return [
                { unit: "millibar", system: $e },
                { unit: "hPa", system: $e },
                { unit: "psi", system: Ae },
                { unit: "inch Hg", system: Ae },
              ];
            case Ne:
              return [
                { unit: "km/h", system: $e },
                { unit: "meter/s", system: $e },
                { unit: "mile/h", system: Ae },
              ];
            case De:
              return [
                { unit: "W/m2", system: $e },
                { unit: "MJ/day/m2", system: $e },
                { unit: "W/sq ft", system: Ae },
                { unit: "MJ/day/sq ft", system: Ae },
              ];
            default:
              return [];
          }
  ...
  n([pe()], Ai.prototype, "config", void 0),
    n([pe({ type: Array })], Ai.prototype, "zones", void 0),
    n([pe({ type: Array })], Ai.prototype, "mappings", void 0),
    n([me("#mappingNameInput")], Ai.prototype, "mappingNameInput", void 0),
    (Ai = n([he("smart-irrigation-view-mappings")], Ai));
  const $i = () => {
    const e = (e) => {
        let t = {};
    ...
    render() {
      ...
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2023.9.0-beta12a"}</div>
        </div>
  ...
  n([pe({ attribute: !1 })], Mi.prototype, "hass", void 0),
    n(
      [
        (function (e) {
          return pe({ ...e, state: !0 });
