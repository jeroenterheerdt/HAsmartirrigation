...
`;let Pn=class extends de{async showDialog(e){this._params=e,e.createTrigger?this._trigger={type:ze,name:"",enabled:!0,offset_minutes:0,azimuth_angle:90,account_for_duration:!0}:e.trigger&&(this._trigger=Object.assign({},e.trigger)),await this.updateComplete}_closeDialog(){this._params=void 0,this._trigger=void 0}_saveTrigger(){var e;if(this._trigger&&this._params)if(null===(e=this._trigger.name)||void 0===e?void 0:e.trim()){if(this._trigger.type===Ee){if(void 0===this._trigger.azimuth_angle||isNaN(this._trigger.azimuth_angle))return void alert(wn("irrigation_start_triggers.validation.azimuth_invalid",this.hass.language));this._trigger.azimuth_angle=this._trigger.azimuth_angle%360,this._trigger.azimuth_angle<0&&(this._trigger.azimuth_angle+=360)}this.dispatchEvent(new CustomEvent("trigger-save",{detail:{trigger:this._trigger,isNew:this._params.createTrigger,index:this._params.triggerIndex}})),this._closeDialog()}else alert(wn("irrigation_start_triggers.validation.name_required",this.hass.language))}_deleteTrigger(){this._params&&!this._params.createTrigger&&(this.dispatchEvent(new CustomEvent("trigger-delete",{detail:{index:this._params.triggerIndex}})),this._closeDialog())}_updateTrigger(e){this._trigger&&(this._trigger=Object.assign(Object.assign({},this._trigger),e),this.requestUpdate())}render(){var e,t;if(!this._params||!this._trigger)return F``;const a=this._params.createTrigger,i=wn(a?"irrigation_start_triggers.dialog.add_title":"irrigation_start_triggers.dialog.edit_title",this.hass.language);return F`
      <ha-dialog
        open
        .heading=${!0}
      ...
      >
        ...
        <div class="wrapper">
          <div class="form-group">
            <ha-textfield
              .label=${wn("irrigation_start_triggers.fields.name.name",this.hass.language)}
          ...
          <div class="form-group">
            <ha-select
              .label=${wn("irrigation_start_triggers.fields.type.name",this.hass.language)}
              .value=${this._trigger.type}
              @selected=${this._typeChanged}
            >
              <mwc-list-item value=${ze}>
                ${wn("irrigation_start_triggers.trigger_types.sunrise",this.hass.language)}
              </mwc-list-item>
              <mwc-list-item value=${"sunset"}>
                ${wn("irrigation_start_triggers.trigger_types.sunset",this.hass.language)}
              </mwc-list-item>
              <mwc-list-item value=${Ee}>
                ${wn("irrigation_start_triggers.trigger_types.solar_azimuth",this.hass.language)}
              </mwc-list-item>
            </ha-select>
          </div>
          ...
          <div class="form-group">
            <ha-formfield
              .label=${wn("irrigation_start_triggers.fields.enabled.name",this.hass.language)}
            >
              <ha-switch
          ...
          <div class="form-group">
            <ha-textfield
              type="number"
              .label=${wn("irrigation_start_triggers.fields.offset_minutes.name",this.hass.language)}
          ...
          <div class="form-group">
            <ha-formfield
              .label=${wn("irrigation_start_triggers.fields.account_for_duration.name",this.hass.language)}
            >
              <ha-switch
          ...
          ${this._trigger.type===Ee?F`
                <div class="form-group">
                  <ha-textfield
                    type="number"
                    .label=${wn("irrigation_start_triggers.fields.azimuth_angle.name",this.hass.language)}
        ...
        <div slot="primaryAction">
          <mwc-button @click=${this._saveTrigger}>
            ${wn("irrigation_start_triggers.dialog.save",this.hass.language)}
          </mwc-button>
        </div>

        <div slot="secondaryAction">
          <mwc-button @click=${this._closeDialog}>
            ${wn("irrigation_start_triggers.dialog.cancel",this.hass.language)}
          </mwc-button>
          ${a?"":F`
                <mwc-button @click=${this._deleteTrigger} class="warning">
                  ${wn("irrigation_start_triggers.dialog.delete",this.hass.language)}
                </mwc-button>
              `}
        </div>
      </ha-dialog>
    `}_nameChanged(e){const t=e.target;this._updateTrigger({name:t.value})}_typeChanged(e){this._updateTrigger({type:e.detail.value})}_enabledChanged(e){const t=e.target;this._updateTrigger({enabled:t.checked})}_offsetChanged(e){const t=e.target;this._updateTrigger({offset_minutes:parseInt(t.value)||0})}_accountForDurationChanged(e){const t=e.target;this._updateTrigger({account_for_duration:t.checked})}_azimuthChanged(e){const t=e.target;this._updateTrigger({azimuth_angle:parseInt(t.value)||90})}static get styles(){return[Hn,c`
        .wrapper {
          color: var(--primary-text-color);
        }
      ...
      `]}};n([pe({attribute:!1})],Pn.prototype,"hass",void 0),n([ge()],Pn.prototype,"_params",void 0),n([ge()],Pn.prototype,"_trigger",void 0),Pn=n([ce("trigger-dialog")],Pn);let Nn=class extends(wt(de)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return t=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(t),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:$e+"_config_updated"})]}async _fetchData(){if(this.hass){this.isLoading=!0,this._scheduleUpdate();try{this.config=await ft(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}var e,t}}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,t;if(!this.hass||!this.config||!this.data)return F`<div class="loading-indicator">
        ...
        <div class="card-content">
          <label class="hidden" id="autocalcdescription">
            ${wn("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <div class="zoneline">
            <label for="autocalcenabled"
              >${wn("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}:</label
            >
            <div>
              <input
                type="radio"
                ...
                @change="${e=>{this.handleConfigChange({autocalcenabled:zn(e.target.value)})}}"
              /><label for="autocalcon"
                >${wn("common.labels.yes",this.hass.language)}</label
              >
              <input
                type="radio"
                id="autocalcoff"
              ...
              /><label for="autocalcoff"
                >${wn("common.labels.no",this.hass.language)}</label
              >
            </div>
          </div>
          ...
          <div class="card-content">
            <div class="zoneline">
              <label for="calctime"
                >${wn("panels.general.cards.automatic-duration-calculation.labels.calc-time",this.hass.language)}:</label
              >
              <input
                id="calctime"
                type="text"
        ...
        header="${wn("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let t=F` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autoupdatedescription">
            ${wn("panels.general.cards.automatic-update.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <div class="zoneline">
            <label for="autoupdateenabled"
              >${wn("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}:</label
            >
            <div>
              <input
                type="radio"
                ...
                @change="${e=>{this.saveData({autoupdateenabled:zn(e.target.value)})}}"
          ...
          <div class="card-content">
            <div class="zoneline">
              <label for="autoupdateinterval"
                >${wn("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}:</label
              >
              <div style="display: flex; gap: 8px; align-items: center;">
                ...
                >
                  ...
                  >
                    ${wn("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                  </option>
                  <option
                    value="${Te}"
                    ?selected="${this.data.autoupdateschedule===Te}"
                  >
                    ${wn("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                  </option>
                  <option
                    value="${Me}"
                    ?selected="${this.data.autoupdateschedule===Me}"
                  >
                    ${wn("panels.general.cards.automatic-update.options.days",this.hass.language)}
                  </option>
                </select>
              </div>
            </div>
          ...
          <div class="card-content">
            <div class="zoneline">
              <label for="updatedelay"
                >${wn("panels.general.cards.automatic-update.labels.auto-update-delay",this.hass.language)}
                (s):</label
              >
              <input
                id="updatedelay"
          ...
          </div>`),t=F`<ha-card header="${wn("panels.general.cards.automatic-update.header",this.hass.language)}",
      this.hass.language)}">${t}</ha-card>`;let a=F` <div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="autocleardescription">
            ${wn("panels.general.cards.automatic-clear.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <div class="zoneline">
            <label for="autoclearenabled"
              >${wn("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}:</label
            >
            <div>
              <input
                type="radio"
                ...
                @change="${e=>{this.handleConfigChange({autoclearenabled:zn(e.target.value)})}}"
          ...
          <div class="card-content">
            <div class="zoneline">
              <label for="calctime"
                >${wn("panels.general.cards.automatic-clear.labels.automatic-clear-time",this.hass.language)}:</label
              >
              <input
                id="cleardatatime"
                type="text"
        ...
        header="${wn("panels.general.cards.automatic-clear.header",this.hass.language)}"
        >${a}</ha-card
      >`;let i=F`<div class="card-content">
        ...
        <div class="card-content">
          <label class="hidden" id="continuousupdatesdescription">
            ${wn("panels.general.cards.continuousupdates.description",this.hass.language)}
          </label>
        </div>
        <div class="card-content">
          <div class="zoneline">
            <label for="continuousupdates"
              >${wn("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}:</label
            >
            <div>
              <input
                type="radio"
                ...
                @change="${e=>{this.handleConfigChange({continuousupdates:zn(e.target.value)})}}"
          ...
          <div class="card-content">
            <div class="zoneline">
              <label for="sensor_debounce"
                >${wn("panels.general.cards.continuousupdates.labels.sensor_debounce",this.hass.language)}
                (ms):</label
              >
              <input
                id="sensor_debounce"
        ...
        header="${wn("panels.general.cards.continuousupdates.header",this.hass.language)}"
        >${i}</ha-card
      > `;const n=this.renderTriggersCard(),s=this.renderWeatherSkipCard(),r=this.renderCoordinateCard(),o=this.renderDaysBetweenIrrigationCard();return F`<ha-card
          header="${wn("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${wn("panels.general.description",this.hass.language)}
          </div> </ha-card
        >${t}${e}${a}${i}${n}${s}${r}${o}`}}renderTriggersCard(){if(!this.config||!this.data||!this.hass)return F``;const e=this.config.irrigation_start_triggers||[];return F`
      <ha-card
        header="${wn("irrigation_start_triggers.title",this.hass.language)}"
      >
        <div class="card-content">
          <svg
            style="width:24px;height:24px"
        ...
        <div class="card-content">
          <label class="hidden" id="triggersdescription">
            ${wn("irrigation_start_triggers.description",this.hass.language)}
          </label>
        </div>
        ...
        <div class="card-content">
          <div class="triggers-list">
            ${0===e.length?F`
                  <div class="no-triggers">
                    ${wn("irrigation_start_triggers.no_triggers",this.hass.language)}
                  </div>
          ...
          <div class="add-trigger-section">
            <ha-button @click="${this._addTrigger}">
              ...
              ${wn("irrigation_start_triggers.add_trigger",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
    `}renderTriggerItem(e,t){if(!this.hass)return F``;const a=wn(`irrigation_start_triggers.trigger_types.${e.type}`,this.hass.language);let i="";if(e.type===ze&&0===e.offset_minutes)i=wn("irrigation_start_triggers.offset_auto",this.hass.language);else{const t=Math.abs(e.offset_minutes),a=Math.floor(t/60),n=t%60,s=e.offset_minutes<0?wn("common.labels.before",this.hass.language):wn("common.labels.after",this.hass.language);i=a>0?`${a}h ${n}m ${s}`:`${n}m ${s}`}let n="";return e.type===Ee&&void 0!==e.azimuth_angle&&(n=` (${e.azimuth_angle}°)`),F`
      <div class="trigger-item ${e.enabled?"enabled":"disabled"}">
        <div class="trigger-main">
          ...
          <div class="trigger-status">
            ${e.enabled?wn("common.labels.enabled",this.hass.language):wn("common.labels.disabled",this.hass.language)}
          </div>
        </div>
        <div class="trigger-actions">
          <ha-icon-button
            ...
            title="${wn("irrigation_start_triggers.edit_trigger",this.hass.language)}"
          ></ha-icon-button>
          <ha-icon-button
            .path="${Dn}"
            @click="${()=>this._deleteTrigger(t)}"
            title="${wn("irrigation_start_triggers.delete_trigger",this.hass.language)}"
          ></ha-icon-button>
        </div>
      </div>
            ...
            ${this.config.skip_irrigation_on_precipitation?F`
                  <div class="zoneline">
                    <label for="precipitation_threshold_mm"
                      >${wn("weather_skip.threshold_label",this.hass.language)}
                      (${An(this.config,Se)}):</label
                    >
                    <input
          ...
          <div class="zoneline">
            <div class="switch-container" style="margin-bottom: 16px;">
              ...
              /><label for="manualcoordson"
                >${wn("coordinate_config.manual_enabled",this.hass.language)}</label
              >
              <input
                type="radio"
                id="manualcoordsoff"
    ...
    `}renderDaysBetweenIrrigationCard(){return this.config&&this.data&&this.hass?F`
      <ha-card
        header="${wn("days_between_irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          <svg
            style="width:24px;height:24px"
        ...
        <div class="card-content">
          <label class="hidden" id="daysbetweenirrigationdescription">
            ${wn("days_between_irrigation.description",this.hass.language)}
          </label>
        </div>
        ...
        <div class="card-content">
          <div class="zoneline">
            <label for="days_between_irrigation"
              >${wn("days_between_irrigation.label",this.hass.language)}:</label
            >
            <input
...
i.version="2.30.1",n(qa),i.fn=ds,i.min=Ja,i.max=Qa,i.now=ei,i.utc=g,i.unix=us,i.months=vs,i.isDate=c,i.locale=ga,i.invalid=b,i.duration=Ei,i.isMoment=$,i.weekdays=_s,i.parseZone=cs,i.localeData=va,i.isDuration=ri,i.monthsShort=bs,i.weekdaysMin=ws,i.defineLocale=ma,i.updateLocale=fa,i.locales=ba,i.weekdaysShort=ys,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Bi,i.prototype=ds,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i}()}(Rn)),Rn.exports),Yn=In(Fn);let Vn=class extends(wt(de)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:$e+"_config_updated"})]}async _fetchData(){if(this.hass)try{this.isLoading=!0;const[e,t,a,i]=await Promise.all([ft(this.hass),vt(this.hass),bt(this.hass),_t(this.hass)]);this.config=e,this.zones=t,this.modules=a,this.mappings=i,this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",$e+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",$e+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",$e+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",$e+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:jn.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,t){this.hass&&(this.zones[e]=t,t.id&&this.zoneCache.delete(t.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this.saveToHA(t).catch((e=>{console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;if(!this.zones[t]||null==a)return;const i=[...this.zones];var n,s;this.zones=this.zones.filter(((e,a)=>a!==t)),this.zoneCache.delete(a.toString()),this.isSaving=!0,(n=this.hass,s=a.toString(),n.callApi("POST",$e+"/zones",{id:s,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",$e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=this.zones[e];var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",$e+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var t;const a=this.zones[e];if(!a||null==a.mapping)return;const i=`#weather-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var t;const a=this.zones[e];if(!a||null==a.id)return;const i=`#calendar-section-${a.id}`,n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const t=await yt(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,t)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const a of this.zones)if(void 0!==a.id)try{const i=await(e=this.hass,t=a.id.toString(),e.callWS({type:$e+"/watering_calendar",zone_id:t}));this.wateringCalendars.set(a.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${a.id}:`,e)}var e,t;this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return F``;const t=this.weatherRecords.get(e.id)||[];return F`
              ...
              <div class="weather-table">
                ...
                ${t.slice(0,10).map((e=>F`
                    <div class="weather-row">
                      ...
                      >
                      <span
                        >${e.retrieval_time?Yn(e.retrieval_time).format("MM-DD HH:mm"):"-"}</span
                      >
                    </div>
                  `))}
              </div>
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return F``;const t=this.wateringCalendars.get(e.id),a=t&&e.id in t?t[e.id]:null,i=(null==a?void 0:a.monthly_estimates)||[];return F` <div class="watering-calendar">
      ...
      ${0===i.length?F`
        ...
        >
          ...
          <path fill="#404040" d="${Cn}" />
        </svg>`,e.state===jn.Automatic&&(a=F` <div
        ...
        </div>`),e.state===jn.Automatic&&(i=F` <div
          class="action-button-left"
      ...
      >
        <span class="action-button-label">
          ${wn("panels.zones.actions.reset-bucket",this.hass.language)}
        </span>
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        >
          <span class="action-button-label">
            ${wn("panels.zones.actions.view-weather-info",this.hass.language)}
          </span>
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
      ...
      >
        <span class="action-button-label">
          ${wn("panels.zones.actions.view-watering-calendar",this.hass.language)}
        </span>
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
      ...
      >
        <span class="action-button-label">
          ${wn("common.actions.delete",this.hass.language)}
        </span>
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
          <path fill="#404040" d="${Dn}" />
        </svg>
        ...
        <ha-card header="${e.name}">
          <div class="card-content">
            <div class="zone-info-table">
              <div class="zone-info-row">
                <span class="zone-info-label">${wn("panels.zones.labels.last_calculated",this.hass.language)}:</span>
                <span class="zone-info-value">${e.last_calculated?Yn(e.last_calculated).format("YYYY-MM-DD HH:mm:ss"):"-"}</span>
              </div>
              <div class="zone-info-row">
                <span class="zone-info-label">${wn("panels.zones.labels.data-last-updated",this.hass.language)}:</span>
                <span class="zone-info-value">${e.last_updated?Yn(e.last_updated).format("YYYY-MM-DD HH:mm:ss"):"-"}</span>
              </div>
              <div class="zone-info-row">
                <span class="zone-info-label">${wn("panels.zones.labels.data-number-of-data-points",this.hass.language)}:</span>
          ...
          <div class="card-content">
            <label for="name${t}"
              >${wn("panels.zones.labels.name",this.hass.language)}:</label
            >
            <input
              id="name${t}"
              type="text"
            ...
            <div class="zoneline">
              <label for="size${t}"
                >${wn("panels.zones.labels.size",this.hass.language)}
                (${An(this.config,nt)}):</label
              >
            ...
            <div class="zoneline">
              <label for="throughput${t}"
                >${wn("panels.zones.labels.throughput",this.hass.language)}
                (${An(this.config,st)}):</label
              >
              <input
                class="shortinput"
                id="throughput${t}"
            ...
            <div class="zoneline">
              <label for="drainage_rate${t}"
                >${wn("panels.zones.labels.drainage_rate",this.hass.language)}
                (${An(this.config,mt)}):</label
              >
              <input
                class="shortinput"
                id="drainage_rate${t}"
            ...
            <div class="zoneline">
              <label for="state${t}"
                >${wn("panels.zones.labels.state",this.hass.language)}:</label
              >
              <select
                required
                id="state${t}"
              ...
              >
                <option
                  value="${jn.Automatic}"
                  ?selected="${e.state===jn.Automatic}"
                >
                  ${wn("panels.zones.labels.states.automatic",this.hass.language)}
                </option>
                <option
                  value="${jn.Disabled}"
                  ?selected="${e.state===jn.Disabled}"
                >
                  ${wn("panels.zones.labels.states.disabled",this.hass.language)}
                </option>
                <option
                  value="${jn.Manual}"
                  ?selected="${e.state===jn.Manual}"
                >
                  ${wn("panels.zones.labels.states.manual",this.hass.language)}
                </option>
              </select>
              <label for="module${t}"
                >${wn("common.labels.module",this.hass.language)}:</label
              >
              ...
              <label for="module${t}"
                >${wn("panels.zones.labels.mapping",this.hass.language)}:</label
              >
            ...
            <div class="zoneline">
              ...
              <label for="maximum-bucket${t}"
                >${wn("panels.zones.labels.maximum-bucket",this.hass.language)}
                (${An(this.config,dt)}):</label
              >
              <input
                class="shortinput"
            ...
            <div class="zoneline">
              <label for="lead_time${t}"
                >${wn("panels.zones.labels.lead-time",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
            ...
            <div class="zoneline">
              <label for="maximum-duration${t}"
                >${wn("panels.zones.labels.maximum-duration",this.hass.language)}
                (s):</label
              >
              <input
                class="shortinput"
            ...
            <div class="zoneline">
              <label for="multiplier${t}"
                >${wn("panels.zones.labels.multiplier",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="multiplier${t}"
              ...
              <label for="duration${t}"
                >${wn("panels.zones.labels.duration",this.hass.language)}
                (${"s"}):</label
              >
              <input
                class="shortinput"
                ...
                type="number"
                .value="${e.duration}"
                ?readonly="${e.state===jn.Disabled||e.state===jn.Automatic}"
      ...
      <ha-card header="${wn("panels.zones.title",this.hass.language)}">
        <div class="card-content">
          ${wn("panels.zones.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${wn("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zoneline">
            <label for="nameInput"
          ...
          <div class="zoneline">
            <label for="sizeInput"
              >${wn("panels.zones.labels.size",this.hass.language)}:</label
            >
            <input
              id="sizeInput"
              type="number"
          ...
          <div class="zoneline">
            <label for="throughputInput"
              >${wn("panels.zones.labels.throughput",this.hass.language)}:</label
            >
            <input
              id="throughputInput"
              type="number"
          ...
          <div class="zoneline">
            ...
            <button @click="${this.handleAddZone}" ?disabled="${this.isSaving}">
              ${this.isSaving?wn("common.saving-messages.adding",this.hass.language):wn("panels.zones.cards.add-zone.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${wn("panels.zones.cards.zone-actions.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="action-buttons">
            <button
            ...
            <button
              ...
              ?disabled="${this.isSaving}"
            >
              ${wn("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}
            </button>
            <button
              @click="${this.handleClearAllWeatherdata}"
              ?disabled="${this.isSaving}"
            >
              ${wn("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `;if("boolean"==i.type)o=F`${o}<input
        ...
        >
          ${Object.entries(i.options).map((([e,a])=>F`<option
                ...
                ?selected="${r===En(a,0)}"
              >
                ${wn("panels.modules.cards.module.translated-options."+En(a,1),t)}
              </option>`))}
      ...
      <ha-card header="${wn("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${wn("panels.modules.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${wn("panels.modules.cards.add-module.header",this.hass.language)}"
      >
        <div class="card-content">
          ${this.isLoading?F`<div class="loading-indicator">${wn("common.loading-messages.general",this.hass.language)}</div>`:F`
                <div class="zoneline">
                ...
                <div class="zoneline">
                  ...
                  >
                    ${this.isSaving?wn("common.saving-messages.adding",this.hass.language):wn("panels.modules.cards.add-module.actions.add",this.hass.language)}
                  </button>
                </div>
              `}
        </div>
      ...
      ${this.isLoading?F`<div class="loading-indicator">${wn("common.loading-messages.modules",this.hass.language)}</div>`:Object.entries(this.modules).map((([e,t])=>this.renderModule(t,parseInt(e))))}
    ...
    `}};n([pe()],Wn.prototype,"config",void 0),n([pe({type:Array})],Wn.prototype,"zones",void 0),n([pe({type:Array})],Wn.prototype,"modules",void 0),n([pe({type:Array})],Wn.prototype,"allmodules",void 0),n([pe({type:Boolean})],Wn.prototype,"isLoading",void 0),n([pe({type:Boolean})],Wn.prototype,"isSaving",void 0),n([me("#moduleInput")],Wn.prototype,"moduleInput",void 0),Wn=n([ce("smart-irrigation-view-modules")],Wn);let Gn=class extends(wt(de)){constructor(){super(...arguments),this.zones=[],this.mappings=[],this.weatherRecords=new Map,this.isLoading=!0,this.isSaving=!1,this.debounceTimers=new Map,this.globalDebounceTimer=null,this.mappingCache=new Map,this._updateScheduled=!1,this._lastUpdateTime=0,this._updateThrottleDelay=16}_scheduleUpdate(){if(this._updateScheduled)return;const e=performance.now()-this._lastUpdateTime;e<this._updateThrottleDelay?setTimeout((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()}),this._updateThrottleDelay-e):(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this._lastUpdateTime=performance.now(),this.requestUpdate()})))}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:$e+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[e,t,a]=await Promise.all([ft(this.hass),vt(this.hass),_t(this.hass)]);this.config=e,this.zones=t,this.mappings=a,this._fetchWeatherRecords(),this.mappingCache.clear()}catch(t){console.error("Error fetching data:",t),Tn({body:{message:"Failed to load mapping data"},error:"Data fetch error"},null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-card"))}finally{this.isLoading=!1,this._scheduleUpdate()}}async _fetchWeatherRecords(){if(this.hass){for(const e of this.mappings)if(void 0!==e.id)try{const t=await yt(this.hass,e.id.toString(),10);this.weatherRecords.set(e.id,t)}catch(t){console.error(`Failed to fetch weather records for mapping ${e.id}:`,t),this.weatherRecords.set(e.id,[])}this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass)return F``;const t=void 0!==e.id&&this.weatherRecords.get(e.id)||[];return F`
      <div class="weather-records">
        <h4>
          ${wn("panels.mappings.weather-records.title",this.hass.language)}
        </h4>
        ${0===t.length?F`
            ...
            `:F`
              <div class="weather-table">
                ...
                ${t.slice(0,10).map((e=>{let t="-",a="-";try{if(e.timestamp&&null!==e.timestamp){const a=Yn(e.timestamp);a.isValid()&&(t=a.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting timestamp:",e.timestamp,t)}try{if(e.retrieval_time&&null!==e.retrieval_time){const t=Yn(e.retrieval_time);t.isValid()&&(a=t.format("MM-DD HH:mm"))}}catch(t){console.warn("Error formatting retrieval_time:",e.retrieval_time,t)}return F`
                    <div class="weather-row">
                      <span>${t}</span>
                      <span
      ...
      <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            ...
            ${i?F`<div class="weather-note">
                  ${wn("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}
                </div>`:F` <div
                  class="action-button"
    ...
    `;return this.mappingCache.set(a,n),n}renderMappingSetting(e,t){const a=this.mappings[e];if(!a||!this.hass)return F``;const i=a.mappings[t];return F`
      <div class="mappingline">
        <div class="mappingsettingname">
          <label for="${`${t}_${e}`}">
            ${wn(`panels.mappings.cards.mapping.items.${t.toLowerCase()}`,this.hass.language)}
          </label>
        </div>
        <div class="mappingsettingline">
          <label
            >${wn("panels.mappings.cards.mapping.source",this.hass.language)}:</label
          >
    ...
    `}renderSimpleRadioOptions(e,t,a){if(!this.hass||!this.config)return F``;const i=t===He||t===Ie,n=a[Ze];return F`
      ${!i&&this.config.use_weather_service?F`
            <label>
              ...
              />
              ${wn("panels.mappings.cards.mapping.sources.weather_service",this.hass.language)}
            </label>
          `:""}
      ${i?F`
            <label>
              <input
                ...
                @change="${a=>this.handleSimpleSourceChange(e,t,a)}"
              />
              ${wn("panels.mappings.cards.mapping.sources.none",this.hass.language)}
            </label>
          `:""}
      ...
      <label>
        <input
          ...
          @change="${a=>this.handleSimpleSourceChange(e,t,a)}"
        />
        ${wn("panels.mappings.cards.mapping.sources.sensor",this.hass.language)}
      </label>
    ...
    `}renderWeatherServiceOption(e,t,a){if(!this.hass||!this.config)return F``;const i=`${t}_${e}`,n=!this.config.use_weather_service,s=this.config.use_weather_service&&a[Ze]===Re;return F`
    ...
    `}renderNoneOption(e,t,a){if(!this.hass)return F``;const i=`${t}_${e}`,n=a[Ze]===qe;return F`
      <label>
        <input
          type="radio"
          id="${i}_none"
    ...
    `}renderSensorOption(e,t,a){if(!this.hass)return F``;const i=`${t}_${e}`,n=a[Ze]===Fe;return F`
      <label>
        <input
          type="radio"
          id="${i}_sensor"
    ...
    `}renderStaticValueOption(e,t,a){if(!this.hass)return F``;const i=`${t}_${e}`,n=a[Ze]===Ye;return F`
      <label>
        <input
          type="radio"
          id="${i}_static"
    ...
    `}handleSourceChange(e,t,a){const i=this.mappings[e],n=a.target.value;this.handleEditMapping(e,Object.assign(Object.assign({},i),{mappings:Object.assign(Object.assign({},i.mappings),{[t]:Object.assign(Object.assign({},i.mappings[t]),{[Ze]:n,[Ke]:""})})}))}renderMappingInputs(e,t,a){if(!this.hass)return F``;const i=a[Ze];return F`
    ...
    `}renderSensorInput(e,t,a){if(!this.hass)return F``;const i=`${t}_${e}`;return F`
      <div class="mappingsettingline">
        <label for="${i}_sensor_entity">
          ${wn("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}:
        </label>
        <input
          type="text"
          id="${i}_sensor_entity"
    ...
    `}renderStaticValueInput(e,t,a){if(!this.hass)return F``;const i=`${t}_${e}`;return F`
      <div class="mappingsettingline">
        <label for="${i}_static_value">
          ${wn("panels.mappings.cards.mapping.static_value",this.hass.language)}:
        </label>
        <input
          type="text"
          id="${i}_static_value"
    ...
    `}renderUnitSelect(e,t,a){if(!this.hass||!this.config)return F``;const i=`${t}_${e}`;return F`
      <div class="mappingsettingline">
        <label for="${i}_unit">
          ${wn("panels.mappings.cards.mapping.input-units",this.hass.language)}:
        </label>
        <select
          id="${i}_unit"
    ...
    `}renderPressureTypeSelect(e,t,a){if(!this.hass)return F``;const i=`${t}_${e}`;return F`
      <div class="mappingsettingline">
        <label for="${i}_pressure_type">
          ${wn("panels.mappings.cards.mapping.pressure-type",this.hass.language)}:
        </label>
        <select
          id="${i}_pressure_type"
    ...
    `}renderAggregateSelect(e,t,a){if(!this.hass)return F``;const i=`${t}_${e}`;return F`
      <div class="mappingsettingline">
        <label for="${i}_aggregate">
          ${wn("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
        </label>
        <select
          id="${i}_aggregate"
        ...
        <label for="${i}_aggregate">
          ${wn("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}
        </label>
      </div>
    ...
    `}renderAggregateOption(e,t){if(this.hass&&this.config){return F`<option value="${e}" ?selected="${e===t}">
        ${wn("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return F``}renderPressureTypes(e,t){if(this.hass&&this.config){let e=F``;const a=t[Ve];return e=F`${e}
        <option
          value="${We}"
          ?selected="${a===We}"
        >
          ${wn("panels.mappings.cards.mapping.pressure_types."+We,this.hass.language)}
        </option>
        <option
          value="${Ge}"
          ?selected="${a===Ge}"
        >
          ${wn("panels.mappings.cards.mapping.pressure_types."+Ge,this.hass.language)}
        </option>`,e}return F``}renderUnitOptionsForMapping(e,t){if(!this.hass||!this.config)return F``;const a=function(e){switch(e){case Oe:case Be:return[{unit:"°C",system:Ce},{unit:"°F",system:De}];case Ne:case He:return[{unit:"mm",system:Ce},{unit:"in",system:De}];case Le:return[{unit:tt,system:Ce},{unit:at,system:De}];case Pe:return[{unit:"%",system:[Ce,De]}];case je:return[{unit:"millibar",system:Ce},{unit:"hPa",system:Ce},{unit:"psi",system:De},{unit:"inch Hg",system:De}];case Ue:return[{unit:"km/h",system:Ce},{unit:"meter/s",system:Ce},{unit:"mile/h",system:De}];case Ie:return[{unit:"W/m2",system:Ce},{unit:"MJ/day/m2",system:Ce},{unit:"W/sq ft",system:De},{unit:"MJ/day/sq ft",system:De}];default:return[]}}(e);let i=t[Je];const n=this.config.units;if(!t[Je])for(const e of a)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const t of e.system)if(n===t.system){i=e.unit;break}if(i===e.unit)break}return F`
      ${a.map((e=>F`
    ...
    `}render(){return this.hass?this.isLoading?F`
        <ha-card header="${wn("panels.mappings.title",this.hass.language)}">
          <div class="card-content">
            ${wn("common.loading-messages.general",this.hass.language)}
          </div>
        </ha-card>
      ...
      <ha-card header="${wn("panels.mappings.title",this.hass.language)}">
        <div class="card-content">
          ${wn("panels.mappings.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${wn("panels.mappings.cards.add-mapping.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zoneline">
          ...
          <div class="zoneline">
            ...
            <button @click="${this.handleAddMapping}">
              ${wn("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </button>
          </div>
        </div>
      </ha-card>
    ...
    `}loadMoreMappings(){this._scheduleUpdate()}static get styles(){return c`
      ${On}/* View-specific styles only - most common styles are now in globalStyle */
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach((e=>{clearTimeout(e)})),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};n([pe()],Gn.prototype,"config",void 0),n([pe({type:Array})],Gn.prototype,"zones",void 0),n([pe({type:Array})],Gn.prototype,"mappings",void 0),n([pe({type:Map})],Gn.prototype,"weatherRecords",void 0),n([pe({type:Boolean})],Gn.prototype,"isLoading",void 0),n([pe({type:Boolean})],Gn.prototype,"isSaving",void 0),n([me("#mappingNameInput")],Gn.prototype,"mappingNameInput",void 0),Gn=n([ce("smart-irrigation-view-mappings")],Gn);let qn=class extends(wt(de)){constructor(){super(...arguments),this.zones=[],this.isLoading=!0,this._updateScheduled=!1}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}firstUpdated(){ke().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:$e+"_config_updated"})]}async _fetchData(){var e;if(this.hass)try{this.isLoading=!0;const[t,a,i]=await Promise.all([ft(this.hass),(e=this.hass,e.callWS({type:$e+"/info"})),vt(this.hass)]);this.config=t,this.info=a,this.zones=i}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._scheduleUpdate()}}render(){return this.hass?this.isLoading?F`
        <ha-card header="${wn("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${wn("common.loading",this.hass.language)}...
          </div>
        </ha-card>
      `:this.config?F`
      <ha-card header="${wn("panels.info.title",this.hass.language)}">
        <div class="card-content">
          ${wn("panels.info.description",this.hass.language)}
        </div>
      </ha-card>
    ...
    `:F`
        <ha-card header="${wn("panels.info.title",this.hass.language)}">
          <div class="card-content">
            ${wn("panels.info.configuration-not-available",this.hass.language)}
          </div>
        </ha-card>
      `:F``}renderZoneBucketsCard(){if(!this.hass)return F``;if(!this.zones||0===this.zones.length)return F`
        <ha-card
          header="${wn("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
        >
          <div class="card-content">
            <div class="info-item">
              <span class="value"
                >${wn("panels.info.cards.zone-bucket-values.no-zones",this.hass.language)}</span
              >
            </div>
          </div>
        </ha-card>
      `;const e=this.config?An(this.config,dt):"mm";return F`
      <ha-card
        header="${wn("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
      >
        <div class="card-content">
              ...
              <div class="info-item zone-info">
                ...
                <div class="zone-details">
                  <div class="zone-bucket">
                    <span class="label"
                      >${wn("panels.info.cards.zone-bucket-values.labels.bucket",null!==(i=null===(a=this.hass)||void 0===a?void 0:a.language)&&void 0!==i?i:"en")}:</span
                    >
                    <span class="value">
                  ...
                  <div class="zone-duration">
                    <span class="label"
                      >${wn("panels.info.cards.zone-bucket-values.labels.duration",null!==(s=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==s?s:"en")}:</span
                    >
                    <span class="value">
                      ${t.duration?`${Math.round(t.duration)} ${wn("common.units.seconds",null!==(o=null===(r=this.hass)||void 0===r?void 0:r.language)&&void 0!==o?o:"en")}`:`0 ${wn("common.units.seconds",null!==(d=null===(l=this.hass)||void 0===l?void 0:l.language)&&void 0!==d?d:"en")}`}
                    </span>
                  </div>
                </div>
              </div>
    ...
    `}renderNextIrrigationCard(){var e,t,a,i,n,s,r,o;return this.hass&&this.info?F`
      <ha-card
        header="${wn("panels.info.cards.next-irrigation.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${wn("panels.info.cards.next-irrigation.labels.next-start",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.next_irrigation_start?Yn(this.info.next_irrigation_start).format("YYYY-MM-DD HH:mm:ss"):wn("panels.info.cards.next-irrigation.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.next_irrigation_duration?F`
                <div class="info-item">
                  <label
                    >${wn("panels.info.cards.next-irrigation.labels.duration",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${this.info.next_irrigation_duration}
                    ${wn("common.units.seconds",this.hass.language)}</span
                  >
                </div>
              `:""}
          ${this.info.next_irrigation_zones&&this.info.next_irrigation_zones.length>0?F`
                <div class="info-item">
                  <label
                    >${wn("panels.info.cards.next-irrigation.labels.zones",this.hass.language)}:</label
                  >
                  <span class="value"
    ...
    `:F`
        <ha-card
          header="${wn("panels.info.cards.next-irrigation.title",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${wn("panels.info.cards.next-irrigation.labels.next-start",null!==(i=null===(a=this.hass)||void 0===a?void 0:a.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${wn("panels.info.cards.next-irrigation.no-data",null!==(s=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==s?s:"en")}
              </span>
            </div>
            <div class="info-note">
              ${wn("panels.info.cards.next-irrigation.backend-todo",null!==(o=null===(r=this.hass)||void 0===r?void 0:r.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}renderIrrigationReasonCard(){var e,t,a,i,n,s,r,o;return this.hass&&this.info?F`
      <ha-card
        header="${wn("panels.info.cards.irrigation-reason.title",this.hass.language)}"
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${wn("panels.info.cards.irrigation-reason.labels.reason",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.irrigation_reason||wn("panels.info.cards.irrigation-reason.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.sunrise_time?F`
                <div class="info-item">
                  <label
                    >${wn("panels.info.cards.irrigation-reason.labels.sunrise",this.hass.language)}:</label
                  >
                  <span class="value"
                    >${Yn(this.info.sunrise_time).format("HH:mm:ss")}</span
                  >
                </div>
              `:""}
          ${void 0!==this.info.total_irrigation_duration?F`
                <div class="info-item">
                  <label
                    >${wn("panels.info.cards.irrigation-reason.labels.total-duration",this.hass.language)}:</label
                  >
                  <span class="value"
          ...
          ${this.info.irrigation_explanation?F`
                <div class="info-item explanation">
                  <label
                    >${wn("panels.info.cards.irrigation-reason.labels.explanation",this.hass.language)}:</label
                  >
    ...
    `:F`
        <ha-card
          header="${wn("panels.info.cards.irrigation-reason.title",null!==(t=null===(e=this.hass)||void 0===e?void 0:e.language)&&void 0!==t?t:"en")}"
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${wn("panels.info.cards.irrigation-reason.labels.reason",null!==(i=null===(a=this.hass)||void 0===a?void 0:a.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${wn("panels.info.cards.irrigation-reason.no-data",null!==(s=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==s?s:"en")}
              </span>
            </div>
            <div class="info-note">
              ${wn("panels.info.cards.irrigation-reason.backend-todo",null!==(o=null===(r=this.hass)||void 0===r?void 0:r.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      ...
      <div class="header">
        ...
        >
          <sl-tab slot="nav" panel="info" .active=${"info"===e.page}>
            ${wn("panels.info.title",this.hass.language)}
          </sl-tab>
          <sl-tab slot="nav" panel="general" .active=${"general"===e.page}>
            ${wn("panels.general.title",this.hass.language)}
          </sl-tab>
          ...
          <sl-tab slot="nav" panel="modules" .active=${"modules"===e.page}>
            ${wn("panels.modules.title",this.hass.language)}
          </sl-tab>
          <sl-tab
            slot="nav"
            panel="mappings"
          ...
          >
            ${wn("panels.mappings.title",this.hass.language)}
          </sl-tab>
          <sl-tab slot="nav" panel="help" .active=${"help"===e.page}>
            ${wn("panels.help.title",this.hass.language)}
          </sl-tab>
        </sl-tab-group>
      </div>
    ...
    `}getView(e){switch(e.page){case"info":return F`
        ...
        `;case"help":return F`<ha-card
          header="${wn("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
            ${wn("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
            <a href="https://github.com/jeroenterheerdt/HAsmartirrigation/wiki"
              >${wn("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >.
            ${wn("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${wn("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${wn("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a
              href="https://github.com/jeroenterheerdt/HAsmartirrigation/issues"
              >${wn("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${wn("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return F`
    ...
    `}};n([pe({attribute:!1})],Xn.prototype,"hass",void 0),n([ge()],Xn.prototype,"_params",void 0),Xn=n([ce("error-dialog")],Xn);var Jn=Object.freeze({__proto__:null,get ErrorDialog(){return Xn}});Object.defineProperty(e,"__esModule",{value:!0})}({});
