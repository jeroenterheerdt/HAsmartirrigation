!function (e) {
  ...
  const q = (e, t) => {
    ...
    for (let t = 0; t < a; t++) {
      ...
      let o,
        ...
        d = -1,
        u = 0;
      for (; u < a.length && (r.lastIndex = u, l = r.exec(a), null !== l);) u = r.lastIndex, r === N ? "!--" === l[1] ? r = L : void 0 !== l[1] ? r = j : void 0 !== l[2] ? (R.test(l[2]) && (n = RegExp("</" + l[2], "g")), r = I) : void 0 !== l[3] && (r = I) : r === I ? ">" === l[0] ? (r = null != n ? n : N, d = -1) : void 0 === l[1] ? d = -2 : (d = r.lastIndex - l[2].length, o = l[1], r = void 0 === l[3] ? I : '"' === l[3] ? U : B) : r === U || r === B ? r = I : r === L || r === j ? r = N : (r = I, n = void 0);
      const c = r === I && e[t + 1].startsWith("/>") ? " " : "";
      s += r === N ? a + T : d >= 0 ? (i.push(o), a.slice(0, d) + E + a.slice(d) + A + c) : a + A + (-2 === d ? (i.push(void 0), t) : c);
    }
  ...
  const $e = "smart_irrigation",
    ...
    Je = "unit",
    Qe = "aggregate",
    et = ["average", "first", "last", "maximum", "median", "minimum", "riemannsum", "sum"],
    tt = "mm/h",
    at = "in/h",
    it = "name",
    nt = "size",
  ...
  var kt = {
    ...
    Rt = {
      ...
      weather_skip: It,
      coordinate_config: Bt,
      days_between_irrigation: Ut
    },
    Ft = Object.freeze({
      __proto__: null,
      common: Ct,
  ...
  function qa(e, t) {
    var a = t && t.cache ? t.cache : si,
      i = t && t.serializer ? t.serializer : ei;
  ...
  function Ja(e, t, a, i, n) {
    return a.bind(t, e, i, n);
  }
  function Qa(e, t) {
    return Ja(e, this, 1 === e.length ? Ka : Xa, t.cache.create(), t.serializer);
  }
  var ei = function () {
  ...
  var ai,
    ...
    ri = {
      variadic: function (e, t) {
        return Ja(e, this, Xa, t.cache.create(), t.serializer);
      },
      monadic: function (e, t) {
        return Ja(e, this, Ka, t.cache.create(), t.serializer);
      }
    };
  function oi(e) {
  ...
  function fi(e) {
    return !(!e || "object" != typeof e || e.type !== ni.number);
  }
  function vi(e) {
    return !(!e || "object" != typeof e || e.type !== ni.dateTime);
  }
  !function (e) {
  ...
  var bi = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/,
    _i = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
  function yi(e) {
    var t = {};
  ...
  function zi(e) {
    var t = {};
    return "r" === e[e.length - 1] ? t.roundingPriority = "morePrecision" : "s" === e[e.length - 1] && (t.roundingPriority = "lessPrecision"), e.replace($i, function (e, a, i) {
  ...
  function Ti(e) {
    for (var t = {}, a = 0, n = e; a < n.length; a++) {
      ...
      if (xi.test(s.stem)) t.minimumIntegerDigits = s.stem.length;else if (ki.test(s.stem)) {
        if (s.options.length > 1) throw new RangeError("Fraction-precision stems only accept a single optional option");
        s.stem.replace(ki, function (e, a, i, n, s, r) {
      ...
      } else if ($i.test(s.stem)) t = i(i({}, t), zi(s.stem));else {
        var o = Ei(s.stem);
        o && (t = i(i({}, t), o));
        var l = Ai(s.stem);
        l && (t = i(i({}, t), l));
  ...
  function Oi(e) {
    ...
    var a,
      i = e.language;
    return "root" !== i && (a = e.maximize().region), (Ci[a || ""] || Ci[i || ""] || Ci["".concat(i, "-001")] || Ci["001"])[0];
  }
  var Hi = new RegExp("^".concat(bi.source, "*")),
  ...
  var Li = !!String.prototype.startsWith && "_a".startsWith("a", 1),
    ...
    Ri = !!String.prototype.trimEnd,
    Fi = !!Number.isSafeInteger ? Number.isSafeInteger : function (e) {
      return "number" == typeof e && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
    },
    Yi = !0;
  try {
    Yi = "a" === (null === (Di = Ji("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) || void 0 === Di ? void 0 : Di[0]);
  } catch (L) {
    Yi = !1;
  }
  var Vi,
    Wi = Li ? function (e, t, a) {
      return e.startsWith(t, a);
    } : function (e, t, a) {
      return e.slice(a, a + t.length) === t;
    },
    Gi = ji ? String.fromCodePoint : function () {
    ...
    Zi = Ii ? Object.fromEntries : function (e) {
  ...
  if (Yi) {
    var Qi = Ji("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    Vi = function (e, t) {
      var a;
      return Qi.lastIndex = t, null !== (a = Qi.exec(e)[1]) && void 0 !== a ? a : "";
    };
  } else Vi = function (e, t) {
    for (var a = [];;) {
      var i = qi(e, t);
      if (void 0 === i || sn(i) || rn(i)) break;
      a.push(i), t += i >= 65536 ? 2 : 1;
    }
    return Gi.apply(void 0, a);
  };
  var en,
    tn = function () {
      function e(e, t) {
      ...
      return e.prototype.parse = function () {
          ...
          if (123 === n) {
            ...
            if (35 !== n || "plural" !== t && "selectordinal" !== t) {
              if (60 === n && !this.ignoreTag && 47 === this.peek()) {
                if (a) break;
                return this.error(ai.UNMATCHED_CLOSING_TAG, Ni(this.clonePosition(), this.clonePosition()));
              }
              if (60 === n && !this.ignoreTag && an(this.peek() || 0)) {
        ...
        if (this.bumpSpace(), this.bumpIf("/>")) return {
          val: {
            type: ii.literal,
            value: "<".concat(i, "/>"),
            location: Ni(a, this.clonePosition())
          },
          err: null
        };
        if (this.bumpIf(">")) {
          ...
          if (this.bumpIf("</")) {
            if (this.isEOF() || !an(this.char())) return this.error(ai.INVALID_TAG, Ni(r, this.clonePosition()));
            var o = this.clonePosition();
            return i !== this.parseTagName() ? this.error(ai.UNMATCHED_CLOSING_TAG, Ni(o, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">") ? {
              val: {
                type: ii.tag,
                value: i,
                children: s,
              ...
              err: null
            } : this.error(ai.INVALID_TAG, Ni(r, this.clonePosition())));
          }
          return this.error(ai.UNCLOSED_TAG, Ni(a, this.clonePosition()));
        }
        return this.error(ai.INVALID_TAG, Ni(a, this.clonePosition()));
        ...
        return this.isEOF() || 60 !== this.char() || !this.ignoreTag && (an(e = this.peek() || 0) || 47 === e) ? null : (this.bump(), "<");
        var e;
        ...
        return Gi.apply(void 0, t);
      }, e.prototype.tryParseUnquoted = function (e, t) {
        if (this.isEOF()) return null;
        var a = this.char();
        return 60 === a || 123 === a || 35 === a && ("plural" === t || "selectordinal" === t) || 125 === a && e > 0 ? null : (this.bump(), Gi(a));
      }, e.prototype.parseArgument = function (e, t) {
        var a = this.clonePosition();
        if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(ai.EXPECT_ARGUMENT_CLOSING_BRACE, Ni(a, this.clonePosition()));
        if (125 === this.char()) return this.bump(), this.error(ai.EMPTY_ARGUMENT, Ni(a, this.clonePosition()));
        var i = this.parseIdentifierIfPossible().value;
        if (!i) return this.error(ai.MALFORMED_ARGUMENT, Ni(a, this.clonePosition()));
        if (this.bumpSpace(), this.isEOF()) return this.error(ai.EXPECT_ARGUMENT_CLOSING_BRACE, Ni(a, this.clonePosition()));
        switch (this.char()) {
          case 125:
            return this.bump(), {
              val: {
          ...
          case 44:
            return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(ai.EXPECT_ARGUMENT_CLOSING_BRACE, Ni(a, this.clonePosition())) : this.parseArgumentOptions(e, t, i, a);
          default:
            return this.error(ai.MALFORMED_ARGUMENT, Ni(a, this.clonePosition()));
        }
        ...
        switch (o) {
          case "":
            return this.error(ai.EXPECT_ARGUMENT_TYPE, Ni(r, l));
          case "number":
          case "date":
          case "time":
            this.bumpSpace();
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (g = Xi(b.val)).length) return this.error(ai.EXPECT_ARGUMENT_STYLE, Ni(this.clonePosition(), this.clonePosition()));
              d = {
                style: g,
                styleLocation: Ni(u, this.clonePosition())
              };
            }
            if ((_ = this.tryParseArgumentClose(n)).err) return _;
            var c = Ni(n, this.clonePosition());
            if (d && Wi(null == d ? void 0 : d.style, "::", 0)) {
              var h = Ki(d.style.slice(2));
              ...
              if (0 === h.length) return this.error(ai.EXPECT_DATE_TIME_SKELETON, c);
              var p = h;
              ...
              var g = {
                ...
                parsedOptions: this.shouldParseSkeletons ? yi(p) : {}
              };
              return {
                val: {
                  type: "date" === o ? ii.date : ii.time,
                  value: a,
                  location: c,
                  style: g
                },
            ...
            return {
              val: {
                type: "number" === o ? ii.number : "date" === o ? ii.date : ii.time,
                value: a,
                location: c,
          ...
          case "select":
            ...
            if (this.bumpSpace(), !this.bumpIf(",")) return this.error(ai.EXPECT_SELECT_ARGUMENT_OPTIONS, Ni(m, i({}, m)));
            this.bumpSpace();
            var f = this.parseIdentifierIfPossible(),
              v = 0;
            if ("select" !== o && "offset" === f.value) {
              if (!this.bumpIf(":")) return this.error(ai.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, Ni(this.clonePosition(), this.clonePosition()));
              var b;
              if (this.bumpSpace(), (b = this.tryParseDecimalInteger(ai.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, ai.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE)).err) return b;
          ...
          default:
            return this.error(ai.INVALID_ARGUMENT_TYPE, Ni(r, l));
        }
      }, e.prototype.tryParseArgumentClose = function (e) {
        return this.isEOF() || 125 !== this.char() ? this.error(ai.EXPECT_ARGUMENT_CLOSING_BRACE, Ni(e, this.clonePosition())) : (this.bump(), {
          val: !0,
          err: null
        });
        ...
        for (var e = 0, t = this.clonePosition(); !this.isEOF();) {
          switch (this.char()) {
            case 39:
              this.bump();
              var a = this.clonePosition();
              if (!this.bumpUntil("'")) return this.error(ai.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, Ni(a, this.clonePosition()));
              this.bump();
              break;
            case 123:
              e += 1, this.bump();
        ...
        try {
          ...
          return this.error(ai.INVALID_NUMBER_SKELETON, t);
        }
        return {
          val: {
            type: ni.number,
            tokens: a,
            location: t,
            parsedOptions: this.shouldParseSkeletons ? Ti(a) : {}
          },
          err: null
        };
        ...
        for (var n, s = !1, r = [], o = new Set(), l = i.value, d = i.location;;) {
          if (0 === l.length) {
            ...
            var c = this.tryParseDecimalInteger(ai.EXPECT_PLURAL_ARGUMENT_SELECTOR, ai.INVALID_PLURAL_ARGUMENT_SELECTOR);
            if (c.err) return c;
            d = Ni(u, this.clonePosition()), l = this.message.slice(u.offset, this.offset());
          }
          if (o.has(l)) return this.error("select" === t ? ai.DUPLICATE_SELECT_ARGUMENT_SELECTOR : ai.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, d);
          "other" === l && (s = !0), this.bumpSpace();
          var h = this.clonePosition();
          if (!this.bumpIf("{")) return this.error("select" === t ? ai.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : ai.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, Ni(this.clonePosition(), this.clonePosition()));
          ...
          r.push([l, {
            value: p.val,
            location: Ni(h, this.clonePosition())
          }]), o.add(l), this.bumpSpace(), l = (n = this.parseIdentifierIfPossible()).value, d = n.location;
        }
        return 0 === r.length ? this.error("select" === t ? ai.EXPECT_SELECT_ARGUMENT_SELECTOR : ai.EXPECT_PLURAL_ARGUMENT_SELECTOR, Ni(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !s ? this.error(ai.MISSING_OTHER_CLAUSE, Ni(this.clonePosition(), this.clonePosition())) : {
          val: r,
          err: null
        };
  ...
  function on(e) {
    e.forEach(function (e) {
      if (delete e.location, hi(e) || pi(e)) for (var t in e.options) delete e.options[t].location, on(e.options[t].value);else di(e) && fi(e.style) || (ui(e) || ci(e)) && vi(e.style) ? delete e.style.location : mi(e) && on(e.children);
    });
  }
  function ln(e, t) {
    void 0 === t && (t = {}), t = i({
    ...
    var a = new tn(e, t).parse();
    if (a.err) {
      var n = SyntaxError(ai[a.err.kind]);
      throw n.location = a.err.location, n.originalMessage = a.err.message, n;
    }
    return (null == t ? void 0 : t.captureLocation) || on(a.val), a.val;
  }
  !function (e) {
  ...
  var dn,
    ...
    cn = function (e) {
      function t(t, a, i, n) {
        return e.call(this, 'Invalid values for "'.concat(t, '": "').concat(a, '". Options are "').concat(Object.keys(i).join('", "'), '"'), en.INVALID_VALUE, n) || this;
      }
      return a(t, e), t;
    }(un),
    hn = function (e) {
      function t(t, a, i) {
        return e.call(this, 'Value for "'.concat(t, '" must be of type ').concat(a), en.INVALID_VALUE, i) || this;
      }
      return a(t, e), t;
    }(un),
    pn = function (e) {
      function t(t, a) {
        return e.call(this, 'The intl string context variable "'.concat(t, '" was not provided to the string "').concat(a, '"'), en.MISSING_VALUE, a) || this;
      }
      return a(t, e), t;
    }(un);
  function gn(e) {
  ...
  function mn(e, t, a, i, n, s, r) {
    ...
    for (var o = [], l = 0, d = e; l < d.length; l++) {
      ...
      if (oi(u)) o.push({
        type: dn.literal,
        value: u.value
      });else if (gi(u)) "number" == typeof s && o.push({
        type: dn.literal,
        value: a.getNumberFormat(t).format(s)
      });else {
        var c = u.value;
        if (!n || !(c in n)) throw new pn(c, r);
        var h = n[c];
        if (li(u)) h && "string" != typeof h && "number" != typeof h || (h = "string" == typeof h || "number" == typeof h ? String(h) : ""), o.push({
          type: "string" == typeof h ? dn.literal : dn.object,
          value: h
        });else if (ui(u)) {
          var p = "string" == typeof u.style ? i.date[u.style] : vi(u.style) ? u.style.parsedOptions : void 0;
          o.push({
            type: dn.literal,
            value: a.getDateTimeFormat(t, p).format(h)
          });
        } else if (ci(u)) {
          p = "string" == typeof u.style ? i.time[u.style] : vi(u.style) ? u.style.parsedOptions : i.time.medium;
          o.push({
            type: dn.literal,
            value: a.getDateTimeFormat(t, p).format(h)
          });
        } else if (di(u)) {
          (p = "string" == typeof u.style ? i.number[u.style] : fi(u.style) ? u.style.parsedOptions : void 0) && p.scale && (h *= p.scale || 1), o.push({
            type: dn.literal,
          ...
          if (mi(u)) {
            var g = u.children,
              m = u.value,
              f = n[m];
            if (!gn(f)) throw new hn(m, "function", r);
            var v = f(mn(g, t, a, i, n, s).map(function (e) {
              return e.value;
            }));
            Array.isArray(v) || (v = [v]), o.push.apply(o, v.map(function (e) {
              return {
                type: "string" == typeof e ? dn.literal : dn.object,
                value: e
              };
            }));
          }
          if (hi(u)) {
            if (!(b = u.options[h] || u.options.other)) throw new cn(u.value, h, Object.keys(u.options), r);
            o.push.apply(o, mn(b.value, t, a, i, n));
          } else if (pi(u)) {
            var b;
            if (!(b = u.options["=".concat(h)])) {
              if (!Intl.PluralRules) throw new un('Intl.PluralRules is not available in this environment.\nTry polyfilling it using "@formatjs/intl-pluralrules"\n', en.MISSING_INTL_API, r);
              var _ = a.getPluralRules(t, {
                type: u.pluralType
              }).select(h - (u.offset || 0));
              b = u.options[_] || u.options.other;
            }
            if (!b) throw new cn(u.value, h, Object.keys(u.options), r);
    ...
    return function (e) {
      return e.length < 2 ? e : e.reduce(function (e, t) {
        var a = e[e.length - 1];
        return a && a.type === dn.literal && t.type === dn.literal ? a.value += t.value : e.push(t), e;
      }, []);
    }(o);
  }
  function fn(e, t) {
      ...
      function e(t, a, n, r) {
        ...
        if (this.formatterCache = {
          ...
          var a = t.reduce(function (e, t) {
            return e.length && t.type === dn.literal && "string" == typeof e[e.length - 1] ? e[e.length - 1] += t.value : e.push(t.value), e;
          }, []);
        ...
        this.formats = fn(e.formats, n), this.formatters = r && r.formatters || (void 0 === (o = this.formatterCache) && (o = {
          number: {},
          dateTime: {},
          pluralRules: {}
        }), {
  ...
  class Sn extends $n {
    constructor(e) {
      if (super(e), this.et = V, e.type !== kn) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
    }
    render(e) {
  ...
  function An(e, t) {
    switch (t) {
      case mt:
        return e.units == Ce ? F`${xn(tt)}` : F`${xn(at)}`;
      case Se:
      case dt:
        return e.units == Ce ? F`${xn("mm")}` : F`${xn("in")}`;
      case nt:
        return e.units == Ce ? F`${xn("m<sup>2</sup>")}` : F`${xn("sq ft")}`;
      case st:
        return e.units == Ce ? F`${xn("l/minute")}` : F`${xn("gal/minute")}`;
      default:
        return F``;
    }
  }
  ...
  var Tn = "M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",
    Dn = "M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",
    Cn = "M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";
  const On = c`
...
`;
  let Pn = class extends de {
    ...
    _saveTrigger() {
      ...
      if (this._trigger && this._params) if (null === (e = this._trigger.name) || void 0 === e ? void 0 : e.trim()) {
        if (this._trigger.type === Ee) {
          if (void 0 === this._trigger.azimuth_angle || isNaN(this._trigger.azimuth_angle)) return void alert(wn("irrigation_start_triggers.validation.azimuth_invalid", this.hass.language));
      ...
      } else alert(wn("irrigation_start_triggers.validation.name_required", this.hass.language));
    }
    _deleteTrigger() {
    ...
    render() {
      ...
      const a = this._params.createTrigger,
        i = wn(a ? "irrigation_start_triggers.dialog.add_title" : "irrigation_start_triggers.dialog.edit_title", this.hass.language);
      return F`
      <ha-dialog
        open
        .heading=${!0}
    ...
    _azimuthChanged(e) {
      const t = e.target;
      this._updateTrigger({
        azimuth_angle: parseInt(t.value) || 90
      });
    }
    static get styles() {
      return [Hn, c`
  ...
  n([pe({
    attribute: !1
  })], Pn.prototype, "hass", void 0), n([ge()], Pn.prototype, "_params", void 0), n([ge()], Pn.prototype, "_trigger", void 0), Pn = n([ce("trigger-dialog")], Pn);
  let Nn = class extends wt(de) {
    constructor() {
      ...
      </div>`;
      {
        ...
        <div class="card-content">
          ...
          this.handleConfigChange({
            autocalcenabled: zn(e.target.value)
          });
        }}"
          ...
          <div class="zoneline">
            ...
            <div>
              <input
                ...
                @change="${e => {
          this.saveData({
            autoupdateenabled: zn(e.target.value)
          });
        }}"
          ...
          <div class="zoneline">
            ...
            <div>
              <input
                ...
                @change="${e => {
          this.handleConfigChange({
            autoclearenabled: zn(e.target.value)
          });
        }}"
          ...
          <div class="zoneline">
            ...
            <div>
              <input
                ...
                @change="${e => {
          this.handleConfigChange({
            continuousupdates: zn(e.target.value)
          });
        }}"
    ...
    renderTriggerItem(e, t) {
      ...
      const a = wn(`irrigation_start_triggers.trigger_types.${e.type}`, this.hass.language);
      let i = "";
      if (e.type === ze && 0 === e.offset_minutes) i = wn("irrigation_start_triggers.offset_auto", this.hass.language);else {
        const t = Math.abs(e.offset_minutes),
          a = Math.floor(t / 60),
          n = t % 60,
          s = e.offset_minutes < 0 ? wn("common.labels.before", this.hass.language) : wn("common.labels.after", this.hass.language);
    ...
    _deleteTrigger(e) {
      ...
      if (confirm(wn("irrigation_start_triggers.confirm_delete", this.hass.language).replace("{name}", i))) {
    ...
    renderCoordinateCard() {
      ...
      return F`
      <ha-card header="${wn("coordinate_config.title", this.hass.language)}">
        <div class="card-content">
          <div class="zoneline">
            <div style="margin-bottom: 16px;">
          ...
          manual_elevation: parseFloat(e.target.value)
                ...
                ` : F`
                  <div class="zoneline" style="color: var(--secondary-text-color); font-style: italic;">
                    ...
                    ${wn("coordinate_config.latitude", this.hass.language)}: ${t}<br/>
                    ${wn("coordinate_config.longitude", this.hass.language)}: ${a}<br/>
                    ${wn("coordinate_config.elevation", this.hass.language)}: ${i}m
                  </div>
                `}
          </div>
        </div>
    ...
    renderDaysBetweenIrrigationCard() {
      return this.config && this.data && this.hass ? F`
      <ha-card header="${wn("days_between_irrigation.title", this.hass.language)}">
        <div class="card-content">
          <svg
            style="width:24px;height:24px"
            viewBox="0 0 24 24"
    ...
    async saveData(e) {
      if (this.hass && this.data) {
        ...
        try {
          ...
          console.error("Error saving config:", e), Mn(e, this.shadowRoot.querySelector("ha-card")), await this._fetchData();
        } finally {
  ...
  n([pe()], Nn.prototype, "narrow", void 0), n([pe()], Nn.prototype, "path", void 0), n([pe()], Nn.prototype, "data", void 0), n([pe()], Nn.prototype, "config", void 0), n([pe({
    type: Boolean
  })], Nn.prototype, "isLoading", void 0), n([pe({
    type: Boolean
  })], Nn.prototype, "isSaving", void 0), Nn = n([ce("smart-irrigation-view-general")], Nn), function (e) {
  ...
  var Fn = (Un || (Un = 1, function (e) {
      e.exports = function () {
        ...
        function tn(e, t) {
          return this.isValid() && ($(e) && e.isValid() || Za(e).isValid()) ? Ei({
            to: this,
            from: e
        ...
        B("N", 0, 0, "eraAbbr"), B("NN", 0, 0, "eraAbbr"), B("NNN", 0, 0, "eraAbbr"), B("NNNN", 0, 0, "eraName"), B("NNNNN", 0, 0, "eraNarrow"), B("y", ["y", 1], "yo", "eraYear"), B("y", ["yy", 2], 0, "eraYear"), B("y", ["yyy", 3], 0, "eraYear"), B("y", ["yyyy", 4], 0, "eraYear"), ze("N", jn), ze("NN", jn), ze("NNN", jn), ze("NNNN", In), ze("NNNNN", Un), Oe(["N", "NN", "NNN", "NNNN", "NNNNN"], function (e, t, a, i) {
          var n = a._locale.erasParse(e, i, a._strict);
          n ? f(a).era = n : f(a).invalidEra = e;
        }), ze("y", be), ze("yy", be), ze("yyy", be), ze("yyyy", be), ze("yo", Rn), Oe(["y", "yy", "yyy", "yyyy"], Le), Oe(["yo"], function (e, t, a, i) {
          var n;
        ...
        ps.calendar = H, ps.longDateFormat = W, ps.invalidDate = Z, ps.ordinal = X, ps.preparse = hs, ps.postformat = hs, ps.relativeTime = Q, ps.pastFuture = ee, ps.set = T, ps.eras = An, ps.erasParse = Mn, ps.erasConvertYear = Tn, ps.erasAbbrRegex = Nn, ps.erasNameRegex = Pn, ps.erasNarrowRegex = Ln, ps.months = lt, ps.monthsShort = dt, ps.monthsParse = ct, ps.monthsRegex = ft, ps.monthsShortRegex = mt, ps.week = St, ps.firstDayOfYear = Et, ps.firstDayOfWeek = zt, ps.weekdays = It, ps.weekdaysMin = Ut, ps.weekdaysShort = Bt, ps.weekdaysParse = Ft, ps.weekdaysRegex = Gt, ps.weekdaysShortRegex = Zt, ps.weekdaysMinRegex = qt, ps.isPM = ta, ps.meridiem = na, ga("en", {
          eras: [{
            since: "0001-01-01",
            until: 1 / 0,
            offset: 1,
  ...
  let Vn = class extends wt(de) {
    ...
    async _fetchData() {
      if (this.hass) try {
        this.isLoading = !0;
        const [e, t, a, i] = await Promise.all([ft(this.hass), vt(this.hass), bt(this.hass), _t(this.hass)]);
    ...
    renderTheOptions(e, t) {
      if (this.hass) {
        let a = F`<option value="" ?selected=${void 0 === t}">---${wn("common.labels.select", this.hass.language)}---</option>`;
    ...
    renderZone(e, t) {
      ...
      >
        ...
        let d;
        return null != e.mapping && (d = this.mappings.filter(t => t.id === e.mapping)[0], null != d && null != d.data_last_updated && (e.last_updated = d.data_last_updated, null != d.data && (e.number_of_data_points = d.data.length))), F`
  ...
  n([pe()], Vn.prototype, "config", void 0), n([pe({
    ...
    type: Array
  })], Vn.prototype, "modules", void 0), n([pe({
    type: Array
  })], Vn.prototype, "mappings", void 0), n([pe({
    type: Map
  })], Vn.prototype, "wateringCalendars", void 0), n([pe({
    type: Map
  })], Vn.prototype, "weatherRecords", void 0), n([pe({
    type: Boolean
  })], Vn.prototype, "isLoading", void 0), n([pe({
    type: Boolean
  })], Vn.prototype, "isSaving", void 0), n([pe({
    type: Boolean
  })], Vn.prototype, "isCreatingZone", void 0), n([me("#nameInput")], Vn.prototype, "nameInput", void 0), n([me("#sizeInput")], Vn.prototype, "sizeInput", void 0), n([me("#throughputInput")], Vn.prototype, "throughputInput", void 0), Vn = n([ce("smart-irrigation-view-zones")], Vn);
  let Wn = class extends wt(de) {
    constructor() {
    ...
    async _fetchData() {
      if (this.hass) {
        this.isLoading = !0, this._scheduleUpdate();
        try {
          const [t, a, i, n] = await Promise.all([ft(this.hass), vt(this.hass), bt(this.hass), (e = this.hass, e.callWS({
            type: $e + "/allmodules"
          }))]);
  ...
  n([pe()], Wn.prototype, "config", void 0), n([pe({
    type: Array
  })], Wn.prototype, "zones", void 0), n([pe({
    type: Array
  })], Wn.prototype, "modules", void 0), n([pe({
    type: Array
  })], Wn.prototype, "allmodules", void 0), n([pe({
    type: Boolean
  })], Wn.prototype, "isLoading", void 0), n([pe({
    type: Boolean
  })], Wn.prototype, "isSaving", void 0), n([me("#moduleInput")], Wn.prototype, "moduleInput", void 0), Wn = n([ce("smart-irrigation-view-modules")], Wn);
  let Gn = class extends wt(de) {
    constructor() {
    ...
    async _fetchData() {
      ...
      if (this.hass) try {
        this.isLoading = !0;
        const [e, t, a] = await Promise.all([ft(this.hass), vt(this.hass), _t(this.hass)]);
        this.config = e, this.zones = t, this.mappings = a, this._fetchWeatherRecords(), this.mappingCache.clear();
      } catch (t) {
        console.error("Error fetching data:", t), Mn({
          body: {
    ...
    async saveToHA(e) {
      ...
      if (a.length > 0) {
        ...
        throw e && Mn({
          body: {
            message: wn("panels.mappings.cards.mapping.errors.source_does_not_exist", this.hass.language) + ": " + a.join(", ")
          },
          error: wn("panels.mappings.cards.mapping.errors.invalid_source", this.hass.language)
    ...
    renderWeatherServiceOption(e, t, a) {
      ...
      const i = `${t}_${e}`,
        ...
        s = this.config.use_weather_service && a[qe] === Re;
      return F`
    ...
    renderAggregateOptionsForMapping(e, t) {
      if (!this.hass || !this.config) return F``;
      let a = "average";
      return e === Ne && (a = "maximum"), e === Le && (a = "last"), t[Qe] && (a = t[Qe]), F`
    ...
    renderUnitOptionsForMapping(e, t) {
      ...
      if (!t[Je]) for (const e of a) if ("string" == typeof e.system) {
        if (n === e.system) {
          i = e.unit;
          break;
        }
  ...
  n([pe()], Gn.prototype, "config", void 0), n([pe({
    ...
    type: Boolean
  })], Gn.prototype, "isSaving", void 0), n([me("#mappingNameInput")], Gn.prototype, "mappingNameInput", void 0), Gn = n([ce("smart-irrigation-view-mappings")], Gn);
  let Zn = class extends wt(de) {
    constructor() {
    ...
    async _fetchData() {
      ...
      if (this.hass) try {
        this.isLoading = !0;
        const [t, a, i] = await Promise.all([ft(this.hass), (e = this.hass, e.callWS({
          type: $e + "/info"
        })), vt(this.hass)]);
    ...
    renderZoneBucketsCard() {
      ...
      `;
      const e = this.config ? An(this.config, dt) : "mm";
      return F`
      <ha-card
        header="${wn("panels.info.cards.zone-bucket-values.title", this.hass.language)}"
      >
  ...
  n([pe()], Zn.prototype, "config", void 0), n([pe({
    type: Object
  })], Zn.prototype, "info", void 0), n([pe({
    type: Array
  })], Zn.prototype, "zones", void 0), n([pe({
    type: Boolean
  })], Zn.prototype, "isLoading", void 0), Zn = n([ce("smart-irrigation-view-info")], Zn);
  const qn = On,
    Kn = () => {
      const e = e => {
          let t = {};
  ...
  e.SmartIrrigationPanel = class extends de {
    constructor() {
  ...
  n([pe({
    attribute: !1
  })], Xn.prototype, "hass", void 0), n([ge()], Xn.prototype, "_params", void 0), Xn = n([ce("error-dialog")], Xn);
