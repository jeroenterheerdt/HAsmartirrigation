...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
var S;k[w]=!0,k.elementProperties=new Map,k.elementStyles=[],k.shadowRootOptions={mode:"open"},null==v||v({ReactiveElement:k}),(null!==(p=m.reactiveElementVersions)&&void 0!==p?p:m.reactiveElementVersions=[]).push("1.6.3");const E=window,$=E.trustedTypes,A=$?$.createPolicy("lit-html",{createHTML:e=>e}):void 0,M="$lit$",T=`lit$${(Math.random()+"").slice(9)}$`,O="?"+T,x=`<${O}>`,D=document,z=()=>D.createComment(""),H=e=>null===e||"object"!=typeof e&&"function"!=typeof e,P=Array.isArray,N="[ \t\n\f\r]",C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,j=/-->/g,L=/>/g,B=RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),I=/'/g,R=/"/g,U=/^(?:script|style|textarea|title)$/i,Y=(e=>(t,...a)=>({_$litType$:e,strings:t,values:a}))(1),V=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),G=new WeakMap,W=D.createTreeWalker(D,129,null,!1);function Z(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==A?A.createHTML(t):t}const q=(e,t)=>{const a=e.length-1,i=[];let n,s=2===t?"<svg>":"",r=C;for(let t=0;t<a;t++){const a=e[t];let o,l,u=-1,d=0;for(;d<a.length&&(r.lastIndex=d,l=r.exec(a),null!==l);)d=r.lastIndex,r===C?"!--"===l[1]?r=j:void 0!==l[1]?r=L:void 0!==l[2]?(U.test(l[2])&&(n=RegExp("</"+l[2],"g")),r=B):void 0!==l[3]&&(r=B):r===B?">"===l[0]?(r=null!=n?n:C,u=-1):void 0===l[1]?u=-2:(u=r.lastIndex-l[2].length,o=l[1],r=void 0===l[3]?B:'"'===l[3]?R:I):r===R||r===I?r=B:r===j||r===L?r=C:(r=B,n=void 0);const c=r===B&&e[t+1].startsWith("/>")?" ":"";s+=r===C?a+x:u>=0?(i.push(o),a.slice(0,u)+M+a.slice(u)+T+c):a+T+(-2===u?(i.push(void 0),t):c)}return[Z(e,s+(e[a]||"<?>")+(2===t?"</svg>":"")),i]};class K{constructor({strings:e,_$litType$:t},a){let i;this.parts=[];let n=0,s=0;const r=e.length-1,o=this.parts,[l,u]=q(e,t);if(this.el=K.createElement(l,a),W.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(i=W.nextNode())&&o.length<r;){if(1===i.nodeType){if(i.hasAttributes()){const e=[];for(const t of i.getAttributeNames())if(t.endsWith(M)||t.startsWith(T)){const a=u[s++];if(e.push(t),void 0!==a){const e=i.getAttribute(a.toLowerCase()+M).split(T),t=/([.?@])?(.*)/.exec(a);o.push({type:1,index:n,name:t[2],strings:e,ctor:"."===t[1]?te:"?"===t[1]?ie:"@"===t[1]?ne:ee})}else o.push({type:6,index:n})}for(const t of e)i.removeAttribute(t)}if(U.test(i.tagName)){const e=i.textContent.split(T),t=e.length-1;if(t>0){i.textContent=$?$.emptyScript:"";for(let a=0;a<t;a++)i.append(e[a],z()),W.nextNode(),o.push({type:2,index:++n});i.append(e[t],z())}}}else if(8===i.nodeType)if(i.data===O)o.push({type:2,index:n});else{let e=-1;for(;-1!==(e=i.data.indexOf(T,e+1));)o.push({type:7,index:n}),e+=T.length-1}n++}}static createElement(e,t){const a=D.createElement("template");return a.innerHTML=e,a}}function X(e,t,a=e,i){var n,s,r,o;if(t===V)return t;let l=void 0!==i?null===(n=a._$Co)||void 0===n?void 0:n[i]:a._$Cl;const u=H(t)?void 0:t._$litDirective$;return(null==l?void 0:l.constructor)!==u&&(null===(s=null==l?void 0:l._$AO)||void 0===s||s.call(l,!1),void 0===u?l=void 0:(l=new u(e),l._$AT(e,a,i)),void 0!==i?(null!==(r=(o=a)._$Co)&&void 0!==r?r:o._$Co=[])[i]=l:a._$Cl=l),void 0!==l&&(t=X(e,l._$AS(e,t.values),l,i)),t}class J{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:a},parts:i}=this._$AD,n=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:D).importNode(a,!0);W.currentNode=n;let s=W.nextNode(),r=0,o=0,l=i[0];for(;void 0!==l;){if(r===l.index){let t;2===l.type?t=new Q(s,s.nextSibling,this,e):1===l.type?t=new l.ctor(s,l.name,l.strings,this,e):6===l.type&&(t=new se(s,this,e)),this._$AV.push(t),l=i[++o]}r!==(null==l?void 0:l.index)&&(s=W.nextNode(),r++)}return W.currentNode=D,n}v(e){let t=0;for(const a of this._$AV)void 0!==a&&(void 0!==a.strings?(a._$AI(e,a,t),t+=a.strings.length-2):a._$AI(e[t])),t++}}class Q{constructor(e,t,a,i){var n;this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=a,this.options=i,this._$Cp=null===(n=null==i?void 0:i.isConnected)||void 0===n||n}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===(null==e?void 0:e.nodeType)&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=X(this,e,t),H(e)?e===F||null==e||""===e?(this._$AH!==F&&this._$AR(),this._$AH=F):e!==this._$AH&&e!==V&&this._(e):void 0!==e._$litType$?this.g(e):void 0!==e.nodeType?this.$(e):(e=>P(e)||"function"==typeof(null==e?void 0:e[Symbol.iterator]))(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==F&&H(this._$AH)?this._$AA.nextSibling.data=e:this.$(D.createTextNode(e)),this._$AH=e}g(e){var t;const{values:a,_$litType$:i}=e,n="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=K.createElement(Z(i.h,i.h[0]),this.options)),i);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===n)this._$AH.v(a);else{const e=new J(n,this),t=e.u(this.options);e.v(a),this.$(t),this._$AH=e}}_$AC(e){let t=G.get(e.strings);return void 0===t&&G.set(e.strings,t=new K(e)),t}T(e){P(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let a,i=0;for(const n of e)i===t.length?t.push(a=new Q(this.k(z()),this.k(z()),this,this.options)):a=t[i],a._$AI(n),i++;i<t.length&&(this._$AR(a&&a._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var a;for(null===(a=this._$AP)||void 0===a||a.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$Cp=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class ee{constructor(e,t,a,i,n){this.type=1,this._$AH=F,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,a.length>2||""!==a[0]||""!==a[1]?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=F}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,a,i){const n=this.strings;let s=!1;if(void 0===n)e=X(this,e,t,0),s=!H(e)||e!==this._$AH&&e!==V,s&&(this._$AH=e);else{const i=e;let r,o;for(e=n[0],r=0;r<n.length-1;r++)o=X(this,i[a+r],t,r),o===V&&(o=this._$AH[r]),s||(s=!H(o)||o!==this._$AH[r]),o===F?e=F:e!==F&&(e+=(null!=o?o:"")+n[r+1]),this._$AH[r]=o}s&&!i&&this.j(e)}j(e){e===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class te extends ee{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===F?void 0:e}}const ae=$?$.emptyScript:"";class ie extends ee{constructor(){super(...arguments),this.type=4}j(e){e&&e!==F?this.element.setAttribute(this.name,ae):this.element.removeAttribute(this.name)}}class ne extends ee{constructor(e,t,a,i,n){super(e,t,a,i,n),this.type=5}_$AI(e,t=this){var a;if((e=null!==(a=X(this,e,t,0))&&void 0!==a?a:F)===V)return;const i=this._$AH,n=e===F&&i!==F||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==F&&(i===F||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,a;"function"==typeof this._$AH?this._$AH.call(null!==(a=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==a?a:this.element,e):this._$AH.handleEvent(e)}}class se{constructor(e,t,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){X(this,e)}}const re=E.litHtmlPolyfillSupport;null==re||re(K,Q),(null!==(S=E.litHtmlVersions)&&void 0!==S?S:E.litHtmlVersions=[]).push("2.8.0");
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
var oe,le;class ue extends k{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const a=super.createRenderRoot();return null!==(e=(t=this.renderOptions).renderBefore)&&void 0!==e||(t.renderBefore=a.firstChild),a}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,a)=>{var i,n;const s=null!==(i=null==a?void 0:a.renderBefore)&&void 0!==i?i:t;let r=s._$litPart$;if(void 0===r){const e=null!==(n=null==a?void 0:a.renderBefore)&&void 0!==n?n:null;s._$litPart$=r=new Q(t.insertBefore(z(),e),e,void 0,null!=a?a:{})}return r._$AI(e),r})(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._$Do)||void 0===e||e.setConnected(!1)}render(){return V}}ue.finalized=!0,ue._$litElement$=!0,null===(oe=globalThis.litElementHydrateSupport)||void 0===oe||oe.call(globalThis,{LitElement:ue});const de=globalThis.litElementPolyfillSupport;null==de||de({LitElement:ue}),(null!==(le=globalThis.litElementVersions)&&void 0!==le?le:globalThis.litElementVersions=[]).push("3.3.3");
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
`;var sn="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",rn="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z";let on=class extends(pt(ue)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e,t;this.hass&&(this.config=await ut(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{}))}firstUpdated(){(async()=>{await ye()})()}render(){if(this.hass&&this.config&&this.data){let e=Y` <div class="card-content">
          <svg
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${e=>{this.saveData({autocalcenabled:Qi(e.target.value)})}}"
      ...
      >`;let t=Y` <div class="card-content">
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${e=>{this.saveData({autoupdateenabled:Qi(e.target.value)})}}"
      ...
      this.hass.language)}">${t}</ha-card>`;let a=Y` <div class="card-content">
        ...
        <div class="card-content">
          ...
          <input
            ...
            @change="${e=>{this.saveData({autoclearenabled:Qi(e.target.value)})}}"
          ...
          <div class="card-content">
            ...
            />
          </div>`),a=Y`<ha-card header="${Zi("panels.general.cards.automatic-clear.header",this.hass.language)}" >${a}</div></ha-card>`;let i=Y`<ha-card
...
<input
            ...
            @change="${e=>{this.saveData({continuousupdates:Qi(e.target.value)})}}"
      ...
      </ha-card> `;return Y`<ha-card
          header="${Zi("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Zi("panels.general.description",this.hass.language)}
          </div> </ha-card
        >${t}${e}${a}${i}`}return Y``}saveData(e){var t,a;this.hass&&this.data&&(this.data=Object.assign(Object.assign({},this.data),e),(t=this.hass,a=this.data,t.callApi("POST",_e+"/config",a)).catch((e=>an(e,this.shadowRoot.querySelector("ha-card")))).then())}toggleInformation(e){var t;const a=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#"+e);a&&("hidden"!=a.className?a.className="hidden":a.className="information")}static get styles(){return c`
      ${nn}
      .hidden {
        display: none;
      }
...
i.version="2.30.1",n(Za),i.fn=us,i.min=Ja,i.max=Qa,i.now=ei,i.utc=m,i.unix=ds,i.months=vs,i.isDate=c,i.locale=ma,i.invalid=b,i.duration=Mi,i.isMoment=S,i.weekdays=ys,i.parseZone=cs,i.localeData=va,i.isDuration=ri,i.monthsShort=bs,i.weekdaysMin=ws,i.defineLocale=ga,i.updateLocale=fa,i.locales=ba,i.weekdaysShort=_s,i.normalizeUnits=ae,i.relativeTimeRounding=nr,i.relativeTimeThreshold=sr,i.calendarFormat=Ii,i.prototype=us,i.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},i}()}(hn)),hn.exports),mn=un(pn);let gn=class extends(pt(ue)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await ut(this.hass),this.zones=await dt(this.hass),this.modules=await ct(this.hass),this.mappings=await ht(this.hass))}handleCalculateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{calculate_all:!0})}handleUpdateAllZones(){this.hass&&this.hass.callApi("POST",_e+"/zones",{update_all:!0})}handleResetAllBuckets(){this.hass&&this.hass.callApi("POST",_e+"/zones",{reset_all_buckets:!0})}handleClearAllWeatherdata(){this.hass&&this.hass.callApi("POST",_e+"/zones",{clear_all_weatherdata:!0})}handleAddZone(){const e={name:this.nameInput.value,size:parseFloat(this.sizeInput.value),throughput:parseFloat(this.throughputInput.value),state:ln.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0};this.zones=[...this.zones,e],this.saveToHA(e)}handleEditZone(e,t){this.hass&&(this.zones=Object.values(this.zones).map(((a,i)=>i===e?t:a)),this.saveToHA(t))}handleRemoveZone(e,t){if(!this.hass)return;const a=this.zones[t].id;var i,n;Object.values(this.zones).at(t)&&null!=a&&(this.zones=this.zones.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/zones",{id:n,remove:!0})))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&null!=t.id&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",_e+"/zones",{id:i,update:!0})))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=Y`<option value="" ?selected=${void 0===t}">---${Zi("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=Y`${a}
        ...
        >
          ...
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
          @click="${()=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[at]:0}))}"}"
        >
          <title>
        ...
        <ha-card header="${e.name}">
          ...
          <div class="card-content">
            ...
            <input
              ...
              type="text"
              .value="${e.name}"
              @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Ke]:a.target.value}))}"
            />
            <div class="zoneline">
              <label for="size${t}"
            ...
            <div class="zoneline">
              ...
              <input
                ...
                type="number"
                .value="${e.throughput}"
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Je]:parseFloat(a.target.value)}))}"
              />
            </div>
            <div class="zoneline">
              ...
              <input
                ...
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[lt]:parseFloat(a.target.value)}))}"
              />
            </div>
            <div class="zoneline">
              <label for="state${t}"
              ...
              <select
                required
                id="state${t}"
                @change="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[Qe]:a.target.value,[et]:0}))}"
              >
                <option
                  value="${ln.Automatic}"
              ...
              <select
                id="module${t}"
                @change="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[tt]:parseInt(a.target.value)}))}"
              >
              ...
              <select
                id="mapping${t}"
                @change="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[nt]:parseInt(a.target.value)}))}"
              >
            ...
            <div class="zoneline">
              ...
              <input
                ...
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[at]:parseFloat(a.target.value)}))}"
              />
              ...
              <input
                ...
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[ot]:parseFloat(a.target.value)}))}"
              />
              <br />
              ...
              <input
                ...
                type="number"
                .value="${e.lead_time}"
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[st]:parseInt(a.target.value,10)}))}"
              />
              ...
              <input
                ...
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[rt]:parseInt(a.target.value,10)}))}"
              />
            </div>
            <div class="zoneline">
              ...
              <input
                ...
                type="number"
                .value="${e.multiplier}"
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[it]:parseFloat(a.target.value)}))}"
              />
              ...
              <input
                ...
                @input="${a=>this.handleEditZone(t,Object.assign(Object.assign({},e),{[et]:parseInt(a.target.value,10)}))}"
              />
            </div>
            <div class="zoneline">
              ${n} ${i}
    ...
    `}};n([pe()],gn.prototype,"config",void 0),n([pe({type:Array})],gn.prototype,"zones",void 0),n([pe({type:Array})],gn.prototype,"modules",void 0),n([pe({type:Array})],gn.prototype,"mappings",void 0),n([me("#nameInput")],gn.prototype,"nameInput",void 0),n([me("#sizeInput")],gn.prototype,"sizeInput",void 0),n([me("#throughputInput")],gn.prototype,"throughputInput",void 0),gn=n([ce("smart-irrigation-view-zones")],gn);let fn=class extends(pt(ue)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){var e;this.hass&&(this.config=await ut(this.hass),this.zones=await dt(this.hass),this.modules=await ct(this.hass),this.allmodules=await(e=this.hass,e.callWS({type:_e+"/allmodules"})))}handleAddModule(){const e=this.allmodules.filter((e=>e.name==this.moduleInput.selectedOptions[0].text))[0];if(!e)return;const t={name:this.moduleInput.selectedOptions[0].text,description:e.description,config:e.config,schema:e.schema};this.modules=[...this.modules,t],this.saveToHA(t)}handleRemoveModule(e,t){const a=this.modules[t].id;var i,n;(this.modules=this.modules.filter(((e,a)=>a!==t)),this.hass&&null!=a)&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/modules",{id:n,remove:!0}))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",_e+"/modules",a),this._fetchData())}renderModule(e,t){if(this.hass){const a=this.zones.filter((t=>t.module===e.id)).length;return Y`
    ...
    `}};n([pe()],fn.prototype,"config",void 0),n([pe({type:Array})],fn.prototype,"zones",void 0),n([pe({type:Array})],fn.prototype,"modules",void 0),n([pe({type:Array})],fn.prototype,"allmodules",void 0),n([me("#moduleInput")],fn.prototype,"moduleInput",void 0),fn=n([ce("smart-irrigation-view-modules")],fn);let vn=class extends(pt(ue)){constructor(){super(...arguments),this.zones=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:_e+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await ut(this.hass),this.zones=await dt(this.hass),this.mappings=await ht(this.hass))}handleAddMapping(){const e={[Ae]:"",[Me]:"",[Te]:"",[Oe]:"",[xe]:"",[De]:"",[ze]:"",[He]:"",[Pe]:""},t={name:this.mappingNameInput.value,mappings:e};this.mappings=[...this.mappings,t],this.saveToHA(t),this._fetchData()}handleRemoveMapping(e,t){const a=this.mappings[t].id;var i,n;null!=a&&(this.mappings=this.mappings.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,n=a.toString(),i.callApi("POST",_e+"/mappings",{id:n,remove:!0})))}handleEditMapping(e,t){this.mappings=Object.values(this.mappings).map(((a,i)=>i===e?t:a)),console.log(t),this.saveToHA(t)}saveToHA(e){if(!this.hass)return;let t=!0;for(const a in e.mappings)if(null!=e.mappings[a].sensorentity&&""!=e.mappings[a].sensorentity.trim()&&(e.mappings[a].sensorentity=e.mappings[a].sensorentity.trim(),!(e.mappings[a].sensorentity in this.hass.states))){t=!1,an({body:{message:Zi("panels.mappings.cards.mapping.errors.source_does_not_exist",this.hass.language)+": "+e.mappings[a].sensorentity},error:Zi("panels.mappings.cards.mapping.errors.invalid_source",this.hass.language)},this.shadowRoot.querySelector("ha-card"));break}var a,i;t&&(a=this.hass,i=e,a.callApi("POST",_e+"/mappings",i))}renderMapping(e,t){if(this.hass){const a=this.zones.filter((t=>t.mapping===e.id)).length;return Y`
        <ha-card header="${e.id}: ${e.name}">
        <div class="card-content">
          <div class="card-content">
            <label for="name${e.id}"
      ...
      <div class="mappingsettingline">
        ...
        <input
          ...
          name="${t+e+Ue}"
          ?checked="${r[Ue]===Re}"
          @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ue]:a.target.value,[Ye]:""})})}))}"
        /><label for="${t+e+Re}"
          >${Zi("panels.mappings.cards.mapping.sources.none",this.hass.language)}</label
        > `;else{let l="";(null===(a=this.config)||void 0===a?void 0:a.use_weather_service)||(l="strikethrough"),o=Y`${o}
        <input
          type="radio"
          id="${t+e+Ne}"
          value="${Ne}"
        ...
        <input
          ...
          name="${t+e+Ue}"
          ?checked="${r[Ue]===Ce}"
          @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ue]:a.target.value})})}))}"
        /><label for="${t+e+Ce}"
      ...
      >
        ...
        <div class="mappingsettingline">
          ...
          <input
            ...
            id="${t+e+Ye}"
            value="${r[Ye]}"
            @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ye]:a.target.value})})}))}"
          />
        </div>`),r[Ue]==je&&(o=Y`${o}
        <div class="mappingsettingline">
          <label for="${t+e+Ve}"
          ...
          <input
            ...
            id="${t+e+Ve}"
            value="${r[Ve]}"
            @input="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},s),{mappings:Object.assign(Object.assign({},s.mappings),{[t]:Object.assign(Object.assign({},s.mappings[t]),{[Ve]:a.target.value})})}))}"
          />
        ...
        <div class="mappingsettingline">
          ...
          >
        </div>`),o=Y`<div class="mappingline">${o}</div>`,o}renderAggregateOptionsForMapping(e,t){if(this.hass&&this.config){let a=Y``,i="average";e===Oe&&(i="maximum"),e===xe&&(i="last"),t[Ge]&&(i=t[Ge]);for(const e of We){const t=this.renderAggregateOption(e,i);a=Y`${a}${t}`}return a}return Y``}renderAggregateOption(e,t){if(this.hass&&this.config){return Y`<option value="${e}" ?selected="${e===t}">
        ...
        </option>`,e}return Y``}renderUnitOptionsForMapping(e,t){if(this.hass&&this.config){const a=function(e){switch(e){case Ae:case He:return[{unit:"°C",system:$e},{unit:"°F",system:Ee}];case Oe:case Me:return[{unit:"mm",system:$e},{unit:"in",system:Ee}];case xe:return[{unit:Ze,system:$e},{unit:qe,system:Ee}];case Te:return[{unit:"%",system:[$e,Ee]}];case De:return[{unit:"millibar",system:$e},{unit:"hPa",system:$e},{unit:"psi",system:Ee},{unit:"inch Hg",system:Ee}];case Pe:return[{unit:"km/h",system:$e},{unit:"meter/s",system:$e},{unit:"mile/h",system:Ee}];case ze:return[{unit:"W/m2",system:$e},{unit:"MJ/day/m2",system:$e},{unit:"W/sq ft",system:Ee},{unit:"MJ/day/sq ft",system:Ee}];default:return[]}}(e);let i=Y``,n=t[Fe];const s=this.config.units;return t[Fe]||a.forEach((function(e){"string"==typeof e.system?s==e.system&&(n=e.unit):e.system.forEach((function(t){s==t.system&&(n=e.unit)}))})),a.forEach((function(e){i=Y`${i}
    ...
    `}};n([pe()],vn.prototype,"config",void 0),n([pe({type:Array})],vn.prototype,"zones",void 0),n([pe({type:Array})],vn.prototype,"mappings",void 0),n([me("#mappingNameInput")],vn.prototype,"mappingNameInput",void 0),vn=n([ce("smart-irrigation-view-mappings")],vn);const bn=()=>{const e=e=>{let t={};for(let a=0;a<e.length;a+=2){const i=e[a],n=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:n})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex((e=>"filter"==e)),n=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(n)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a};e.SmartIrrigationPanel=class extends ue{async firstUpdated(){window.addEventListener("location-changed",(()=>{window.location.pathname.includes("smart-irrigation")&&this.requestUpdate()})),await ye(),this.requestUpdate()}render(){if(!customElements.get("ha-panel-config"))return Y` loading... `;const e=bn();return Y`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            .hass=${this.hass}
          ...
          <div class="version">${"v2024.10.3"}</div>
        </div>
        ...
        >
          ...
          <paper-tab page-name="modules"
            >${Zi("panels.modules.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="mappings"
            >${Zi("panels.mappings.title",this.hass.language)}</paper-tab
          >
          <paper-tab page-name="help"
            >${Zi("panels.help.title",this.hass.language)}</paper-tab
          >
        </ha-tabs>
      </div>
    ...
    `}},n([pe()],e.SmartIrrigationPanel.prototype,"hass",void 0),n([pe({type:Boolean,reflect:!0})],e.SmartIrrigationPanel.prototype,"narrow",void 0),e.SmartIrrigationPanel=n([ce("smart-irrigation")],e.SmartIrrigationPanel);let yn=class extends ue{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?Y`
      <ha-dialog
        open
        .heading=${!0}
    ...
    `}};n([pe({attribute:!1})],yn.prototype,"hass",void 0),n([function(e){return pe({...e,state:!0})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],yn.prototype,"_params",void 0),yn=n([ce("error-dialog")],yn);var _n=Object.freeze({__proto__:null,get ErrorDialog(){return yn}});Object.defineProperty(e,"__esModule",{value:!0})}({});
