...
`;let fi=class extends(et(le)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:Ee+"_config_updated"})]}async _fetchData(){var e,t;this.hass&&(this.config=await Xe(this.hass),this.data=(e=this.config,t=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval"],e?Object.entries(e).filter((([e])=>t.includes(e))).reduce(((e,[t,a])=>Object.assign(e,{[t]:a})),{}):{}))}firstUpdated(){(async()=>{await ye()})()}render(){if(this.hass&&this.config&&this.data){let e=G` <div class="card-content">
        ...
        <input
          ...
          @change="${e=>{this.saveData({autocalcenabled:ci(e.target.value)})}}"
        ...
        <input
          ...
          @change="${e=>{this.saveData({autoupdateenabled:ci(e.target.value)})}}"
      ...
      this.hass.language)}">${t}</ha-card>`;return G`<ha-card
        ...
        >${t}${e}`}return G``}saveData(e){var t,a;this.hass&&this.data&&(this.data=Object.assign(Object.assign({},this.data),e),(t=this.hass,a=this.data,t.callApi("POST",Ee+"/config",a)).catch((e=>mi(e,this.shadowRoot.querySelector("ha-card")))).then())}static get styles(){return c`
      ${gi}
      .hidden {
        display: none;
      }
    ...
    `}};s([pe()],fi.prototype,"narrow",void 0),s([pe()],fi.prototype,"path",void 0),s([pe()],fi.prototype,"data",void 0),s([pe()],fi.prototype,"config",void 0),fi=s([he("smart-irrigation-view-general")],fi);var bi,vi="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";!function(e){e.Disabled="disabled",e.Manual="manual",e.Automatic="automatic"}(bi||(bi={}));let yi=class extends(et(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:Ee+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Xe(this.hass),this.zones=await Ye(this.hass),this.modules=await Je(this.hass),this.mappings=await Qe(this.hass))}handleCalculateAllZones(){this.hass&&this.hass.callApi("POST",Ee+"/zones",{calculate_all:!0})}handleUpdateAllZones(){this.hass&&this.hass.callApi("POST",Ee+"/zones",{update_all:!0})}handleResetAllBuckets(){this.hass&&this.hass.callApi("POST",Ee+"/zones",{reset_all_buckets:!0})}handleAddZone(){const e={id:this.zones.length,name:this.nameInput.value,size:parseFloat(this.sizeInput.value),throughput:parseFloat(this.throughputInput.value),state:bi.Automatic,duration:0,bucket:0,module:void 0,old_bucket:0,delta:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0};this.zones=[...this.zones,e],this.saveToHA(e)}handleEditZone(e,t){this.hass&&(this.zones=Object.values(this.zones).map(((a,i)=>i===e?t:a)),this.saveToHA(t))}handleRemoveZone(e,t){if(!this.hass)return;const a=Object.values(this.zones).at(t);var i,s;a&&(this.zones=this.zones.filter(((e,a)=>a!==t)),this.hass&&(i=this.hass,s=a.id.toString(),i.callApi("POST",Ee+"/zones",{id:s,remove:!0})))}handleCalculateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",Ee+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const t=Object.values(this.zones).at(e);var a,i;t&&(this.hass&&(a=this.hass,i=t.id.toString(),a.callApi("POST",Ee+"/zones",{id:i,update:!0})))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",Ee+"/zones",a))}renderTheOptions(e,t){if(this.hass){let a=G`<option value="" ?selected=${void 0===t}">---${ri("common.labels.select",this.hass.language)}---</option>`;return Object.entries(e).map((([e,i])=>a=G`${a}
            <option
              value="${i.id}"
              ?selected="${t===i.id}"
            >
        ...
        </svg>`),e.state===bi.Automatic&&(i=G` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        </svg>`),e.state===bi.Automatic&&(s=G` <svg
          style="width:24px;height:24px"
          viewBox="0 0 24 24"
        ...
        >
          <title>
            ${ri("panels.zones.actions.reset-bucket",this.hass.language)}
          </title>
          ...
          <div class="card-content">
            ...
            <div class="zoneline">
              ...
              <label for="maximum-bucket${t}"
                >${ri("panels.zones.labels.maximum-bucket",this.hass.language)}:</label
              >
              <input
                class="shortinput"
                id="maximum-bucket${t}"
            ...
            <div class="zoneline">
              ...
              <input
                ...
                type="number"
                .value="${e.duration}"
                ?readonly="${e.state===bi.Disabled||e.state===bi.Automatic}"
        ...
        <ha-card header="${ri("panels.zones.title",this.hass.language)}">
          ...
          <ha-card header="${ri("panels.zones.cards.add-zone.header",this.hass.language)}">
            <div class="card-content">
              ...
              <div class="zoneline">
              <label for="sizeInput">${ri("panels.zones.labels.size",this.hass.language)} (${pi(this.config,Ze)}):</label>
              <input class="shortinput" id="sizeInput" type="number"/>
              </div>
              <div class="zoneline">
              <label for="throughputInput">${ri("panels.zones.labels.throughput",this.hass.language)} (${pi(this.config,We)}):</label>
            ...
            <div class="card-content">
                ...
                <button @click="${this.handleResetAllBuckets}">${ri("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language)}</button>
            </div>
          </ha-card>
    ...
    `}};s([pe()],yi.prototype,"config",void 0),s([pe({type:Array})],yi.prototype,"zones",void 0),s([pe({type:Array})],yi.prototype,"modules",void 0),s([pe({type:Array})],yi.prototype,"mappings",void 0),s([me("#nameInput")],yi.prototype,"nameInput",void 0),s([me("#sizeInput")],yi.prototype,"sizeInput",void 0),s([me("#throughputInput")],yi.prototype,"throughputInput",void 0),yi=s([he("smart-irrigation-view-zones")],yi);let Ei=class extends(et(le)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.allmodules=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:Ee+"_config_updated"})]}async _fetchData(){var e;this.hass&&(this.config=await Xe(this.hass),this.zones=await Ye(this.hass),this.modules=await Je(this.hass),this.allmodules=await(e=this.hass,e.callWS({type:Ee+"/allmodules"})))}handleAddModule(){const e=this.allmodules.filter((e=>e.name==this.moduleInput.selectedOptions[0].text))[0];if(!e)return;const t={id:this.modules.length,name:this.moduleInput.selectedOptions[0].text,description:e.description,config:e.config,schema:e.schema};this.modules=[...this.modules,t],this.saveToHA(t),this._fetchData()}handleRemoveModule(e,t){var a,i;(this.modules=this.modules.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",Ee+"/modules",{id:i,remove:!0}))}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",Ee+"/modules",a))}renderModule(e,t){if(this.hass){const a=this.zones.filter((t=>t.module===e.id)).length;return G`
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            ...
            ${a?G` ${ri("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}.`:G` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
    ...
    `;if("boolean"==i.type)o=G`${o}<input
        ...
        >
          ...
          ${Object.entries(i.options).map((([e,a])=>G`<option
                ...
                ?selected="${r===di(a,0)}"
              >
                ${ri("panels.modules.cards.module.translated-options."+di(a,1),t)}
              </option>`))}
    ...
    `}};s([pe()],Ei.prototype,"config",void 0),s([pe({type:Array})],Ei.prototype,"zones",void 0),s([pe({type:Array})],Ei.prototype,"modules",void 0),s([pe({type:Array})],Ei.prototype,"allmodules",void 0),s([me("#moduleInput")],Ei.prototype,"moduleInput",void 0),Ei=s([he("smart-irrigation-view-modules")],Ei);let $i=class extends(et(le)){constructor(){super(...arguments),this.zones=[],this.mappings=[]}firstUpdated(){(async()=>{await ye()})()}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage((()=>this._fetchData()),{type:Ee+"_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Xe(this.hass),this.zones=await Ye(this.hass),this.mappings=await Qe(this.hass))}handleAddMapping(){const e={[He]:"",[Te]:"",[Oe]:"",[Me]:"",[ze]:"",[Be]:"",[ke]:"",[Ce]:"",[xe]:"",[Pe]:""},t={id:this.mappings.length,name:this.mappingNameInput.value,mappings:e};this.mappings=[...this.mappings,t],this.saveToHA(t),this._fetchData()}handleRemoveMapping(e,t){var a,i;(this.mappings=this.mappings.filter(((e,a)=>a!==t)),this.hass)&&(a=this.hass,i=t.toString(),a.callApi("POST",Ee+"/mappings",{id:i,remove:!0}))}handleEditMapping(e,t){this.mappings=Object.values(this.mappings).map(((a,i)=>i===e?t:a)),this.saveToHA(t)}saveToHA(e){var t,a;this.hass&&(t=this.hass,a=e,t.callApi("POST",Ee+"/mappings",a))}renderMapping(e,t){if(this.hass){const a=this.zones.filter((t=>t.mapping===e.id)).length;return G`
        <ha-card header="${e.id}: ${e.name}">
          <div class="card-content">
            <label for="name${e.id}"
            ...
            ${a?G`${ri("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",this.hass.language)}`:G` <svg
                  style="width:24px;height:24px"
                  viewBox="0 0 24 24"
                  id="deleteZone${t}"
      ...
      <div class="mappingsettingline">
        ...
        <input
          ...
          ?checked="${(null===(s=this.config)||void 0===s?void 0:s.use_owm)&&r[Re]===Le}"
          @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[t]:Object.assign(Object.assign({},n.mappings[t]),{source:a.target.value})})}))}"
        /><label
          class="${l}"
          for="${t+e+Le}"
        ...
        <input
          ...
          name="${t+e+Re}"
          ?checked="${r[Re]===Ne}"
          @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[t]:Object.assign(Object.assign({},n.mappings[t]),{[Re]:a.target.value})})}))}"
        /><label for="${t+e+Ne}"
      ...
      <input
        ...
        @change="${a=>this.handleEditMapping(e,Object.assign(Object.assign({},n),{mappings:Object.assign(Object.assign({},n.mappings),{[t]:Object.assign(Object.assign({},n.mappings[t]),{[Re]:a.target.value})})}))}"
      /><label for="${t+e+Ie}"
        >${ri("panels.mappings.cards.mapping.sources.static",this.hass.language)}</label
      >
    </div>`,r[Re]==Ne&&(o=G`${o}
        <div class="mappingsettingline">
          <label for="${t+e+De}"
        ...
        <div class="mappingsettingline">
          <label for="${t+e+Ue}"
            >${ri("panels.mappings.cards.mapping.static_value",this.hass.language)}:</label
          >
          <input
            type="text"
            id="${t+e+Ue}"
          ...
          />
        </div>`),r[Re]!=Ne&&r[Re]!=Ie||(o=G`${o}
        <div class="mappingsettingline">
          <label for="${t+e+Ge}"
            >${ri("panels.mappings.cards.mapping.input-units",this.hass.language)}:</label
          >
          <select
            type="text"
            id="${t+e+Ge}"
        ...
        <div class="mappingsettingline">
          ...
          >
        </div>`),o=G`<div class="mappingline">${o}</div>`,o}renderAggregateOptionsForMapping(e,t){if(this.hass&&this.config){let a=G``,i="average";e===Be?i="last":e===Me?i="maximum":e===ze&&(i="minimum"),t[Fe]&&(i=t[Fe]);for(const e of Ve){const t=this.renderAggregateOption(e,i);a=G`${a}${t}`}return a}return G``}renderAggregateOption(e,t){if(this.hass&&this.config){return G`<option value="${e}" ?selected="${e===t}">
        ${ri("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return G``}renderUnitOptionsForMapping(e,t){if(this.hass&&this.config){const a=function(e){switch(e){case He:case ze:case Me:case xe:return[{unit:"°C",system:Se},{unit:"°F",system:we}];case Be:case Te:return[{unit:"mm",system:Se},{unit:"in",system:we}];case Oe:return[{unit:"%",system:[Se,we]}];case ke:return[{unit:"millibar",system:Se},{unit:"hPa",system:Se},{unit:"psi",system:we},{unit:"inch Hg",system:we}];case Pe:return[{unit:"km/h",system:Se},{unit:"meter/s",system:Se},{unit:"mile/h",system:we}];case Ce:return[{unit:"W/m2",system:Se},{unit:"MJ/day/m2",system:Se},{unit:"W/sq ft",system:we},{unit:"MJ/day/sq ft",system:we}];default:return[]}}(e);let i=G``,s=t[Ge];const n=this.config.units;return t[Ge]||a.forEach((function(e){"string"==typeof e.system?n==e.system&&(s=e.unit):e.system.forEach((function(t){n==t.system&&(s=e.unit)}))})),a.forEach((function(e){i=G`${i}
    ...
    `}getView(e){switch(e.page){case"general":return G`
        ...
        `;case"help":return G`<ha-card
          header="${ri("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
          ${ri("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)} <a href="https://github.com/jeroenterheerdt/HAsmartirrigation/wiki"
              >${ri("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >. ${ri("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${ri("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${ri("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a
              href="https://github.com/jeroenterheerdt/HAsmartirrigation/issues"
              >${ri("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
            (${ri("panels.help.cards.how-to-get-help.english-only",this.hass.language)}).
          </div></ha-card
        >`;default:return G`
    ...
    `}};s([pe({attribute:!1})],Ai.prototype,"hass",void 0),s([function(e){return pe({...e,state:!0})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */()],Ai.prototype,"_params",void 0),Ai=s([he("error-dialog")],Ai);var wi=Object.freeze({__proto__:null,get ErrorDialog(){return Ai}});Object.defineProperty(e,"__esModule",{value:!0})}({});
